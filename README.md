# Guide for Exploration of the Optimization Space (GEOS)  [![Build Status](https://travis-ci.org/vandersonmr/GEOS.svg?branch=v1.0-port3.7)](https://travis-ci.org/vandersonmr/GEOS)
