...
define noalias %struct.Random_struct* @new_Random_seed(i32 %seed) #0 {
  ...
  tail call fastcc void @initialize(%struct.Random_struct* %2, i32 %seed), !dbg !94
...
define noalias %struct.Random_struct* @new_Random(i32 %seed, double %left, double %right) #0 {
  ...
  tail call fastcc void @initialize(%struct.Random_struct* %2, i32 %seed), !dbg !140
...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  %6 = tail call double @Random_nextDouble(%struct.Random_struct* %R), !dbg !173
...
; <label>:10                                      ; preds = %.lr.ph4, %._crit_edge
  ...
  br i1 %14, label %16, label %.preheader, !dbg !187

.preheader:                                       ; preds = %10
  br i1 %9, label %.lr.ph, label %._crit_edge, !dbg !183

.lr.ph:                                           ; preds = %.preheader
  %15 = load double** %13, align 8, !dbg !189, !tbaa !185
  br label %17, !dbg !183

; <label>:16                                      ; preds = %10
  tail call void @free(i8* %3) #3, !dbg !190
  br label %.loopexit, !dbg !192

; <label>:17                                      ; preds = %17, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %17 ]
  %18 = tail call double @Random_nextDouble(%struct.Random_struct* %R), !dbg !189
  %19 = getelementptr inbounds double* %15, i64 %indvars.iv, !dbg !189
  store double %18, double* %19, align 8, !dbg !189, !tbaa !111
  ...
  br i1 %exitcond, label %._crit_edge, label %17, !dbg !183

._crit_edge:                                      ; preds = %17, %.preheader
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !179
  %20 = trunc i64 %indvars.iv.next6 to i32, !dbg !179
  %21 = icmp slt i32 %20, %M, !dbg !179
  br i1 %21, label %10, label %.loopexit, !dbg !179

.loopexit:                                        ; preds = %._crit_edge, %.preheader1, %0, %16
  %.0 = phi double** [ null, %16 ], [ null, %0 ], [ %4, %.preheader1 ], [ %4, %._crit_edge ]
...
!189 = metadata !{i32 166, i32 0, metadata !184, null}
!190 = metadata !{i32 162, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !1, metadata !188, i32 161, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/Random.c]
!192 = metadata !{i32 163, i32 0, metadata !191, null}
