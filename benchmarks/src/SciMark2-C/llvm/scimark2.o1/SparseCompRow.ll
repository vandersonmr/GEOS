...
.lr.ph4:                                          ; preds = %.preheader, %._crit_edge
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %._crit_edge ], [ 0, %.preheader ]
  tail call void @llvm.dbg.value(metadata !49, i64 0, metadata !31), !dbg !50
  %3 = getelementptr inbounds i32* %row, i64 %indvars.iv8, !dbg !51
  %4 = load i32* %3, align 4, !dbg !51, !tbaa !52
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !36), !dbg !51
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1, !dbg !48
  %5 = getelementptr inbounds i32* %row, i64 %indvars.iv.next9, !dbg !56
  %6 = load i32* %5, align 4, !dbg !56, !tbaa !52
...
; <label>:9                                       ; preds = %.lr.ph, %9
  ...
  %11 = load i32* %10, align 4, !dbg !59, !tbaa !52
...
._crit_edge:                                      ; preds = %9, %.lr.ph4
  %sum.0.lcssa = phi double [ 0.000000e+00, %.lr.ph4 ], [ %18, %9 ]
  ...
  br i1 %exitcond, label %._crit_edge5, label %.lr.ph4, !dbg !48
...
!49 = metadata !{double 0.000000e+00}
!50 = metadata !{i32 34, i32 0, metadata !32, null}
!51 = metadata !{i32 35, i32 0, metadata !32, null}
...
!61 = metadata !{metadata !"double", metadata !54, i64 0}
