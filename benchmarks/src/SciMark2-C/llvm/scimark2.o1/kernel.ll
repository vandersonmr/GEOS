...
; <label>:2                                       ; preds = %2, %0
  %cycles.0 = phi i32 [ 1, %0 ], [ %6, %2 ]
  tail call void @Stopwatch_start(%struct.Stopwatch_struct* %1) #5, !dbg !154
  %3 = shl nsw i32 %cycles.0, 16, !dbg !156
  %4 = tail call double @MonteCarlo_integrate(i32 %3) #5, !dbg !156
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %1) #5, !dbg !157
  %5 = icmp sgt i32 %cycles.0, 4096, !dbg !158
  %6 = shl nsw i32 %cycles.0, 1, !dbg !160
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !64), !dbg !160
  br i1 %5, label %7, label %2, !dbg !158

; <label>:7                                       ; preds = %2
  %8 = tail call double @MonteCarlo_num_flops(i32 8192) #5, !dbg !161
  %9 = tail call double @Stopwatch_read(%struct.Stopwatch_struct* %1) #5, !dbg !161
  %10 = fdiv double %8, %9, !dbg !161
  %11 = fmul double %10, 1.000000e-06, !dbg !161
  tail call void @llvm.dbg.value(metadata !{double %11}, i64 0, metadata !62), !dbg !161
  tail call void @Stopwatch_delete(%struct.Stopwatch_struct* %1) #5, !dbg !162
  ret double %11, !dbg !163
}
...
define double @kernel_measureSparseMatMult(i32 %N, i32 %nz, double %min_time, %struct.Random_struct* %R) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %N}, i64 0, metadata !69), !dbg !164
  tail call void @llvm.dbg.value(metadata !{i32 %nz}, i64 0, metadata !70), !dbg !164
  tail call void @llvm.dbg.value(metadata !{double %min_time}, i64 0, metadata !71), !dbg !165
  tail call void @llvm.dbg.value(metadata !{%struct.Random_struct* %R}, i64 0, metadata !72), !dbg !165
  %1 = tail call double* @RandomVector(i32 %N, %struct.Random_struct* %R) #5, !dbg !166
  tail call void @llvm.dbg.value(metadata !{double* %1}, i64 0, metadata !73), !dbg !166
  %2 = sext i32 %N to i64, !dbg !167
  %3 = shl nsw i64 %2, 3, !dbg !167
  %4 = tail call noalias i8* @malloc(i64 %3) #5, !dbg !167
  %5 = bitcast i8* %4 to double*, !dbg !167
  tail call void @llvm.dbg.value(metadata !{double* %5}, i64 0, metadata !74), !dbg !167
  tail call void @llvm.dbg.value(metadata !113, i64 0, metadata !75), !dbg !168
  %6 = sdiv i32 %nz, %N, !dbg !169
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !76), !dbg !169
  %7 = mul nsw i32 %6, %N, !dbg !170
  tail call void @llvm.dbg.value(metadata !{i32 %7}, i64 0, metadata !77), !dbg !170
  %8 = tail call double* @RandomVector(i32 %7, %struct.Random_struct* %R) #5, !dbg !171
  tail call void @llvm.dbg.value(metadata !{double* %8}, i64 0, metadata !78), !dbg !171
  %9 = sext i32 %nz to i64, !dbg !172
  %10 = shl nsw i64 %9, 2, !dbg !172
  %11 = tail call noalias i8* @malloc(i64 %10) #5, !dbg !172
  %12 = bitcast i8* %11 to i32*, !dbg !172
  tail call void @llvm.dbg.value(metadata !{i32* %12}, i64 0, metadata !79), !dbg !172
  %13 = add nsw i32 %N, 1, !dbg !173
  %14 = sext i32 %13 to i64, !dbg !173
  %15 = shl nsw i64 %14, 2, !dbg !173
  %16 = tail call noalias i8* @malloc(i64 %15) #5, !dbg !173
  %17 = bitcast i8* %16 to i32*, !dbg !173
  tail call void @llvm.dbg.value(metadata !{i32* %17}, i64 0, metadata !81), !dbg !173
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !82), !dbg !174
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !83), !dbg !175
  %18 = tail call %struct.Stopwatch_struct* @new_Stopwatch() #5, !dbg !176
  tail call void @llvm.dbg.value(metadata !{%struct.Stopwatch_struct* %18}, i64 0, metadata !84), !dbg !176
  store i32 0, i32* %17, align 4, !dbg !177, !tbaa !178
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !82), !dbg !182
  %19 = icmp sgt i32 %N, 0, !dbg !182
  br i1 %19, label %.lr.ph3, label %.preheader, !dbg !182

.lr.ph3:                                          ; preds = %0
  %20 = icmp sgt i32 %6, 0, !dbg !183
  br label %21, !dbg !182

.loopexit:                                        ; preds = %30, %21
  %lftr.wideiv6 = trunc i64 %indvars.iv.next5 to i32, !dbg !182
  %exitcond7 = icmp eq i32 %lftr.wideiv6, %N, !dbg !182
  br i1 %exitcond7, label %.preheader, label %21, !dbg !182

; <label>:21                                      ; preds = %.loopexit, %.lr.ph3
  %indvars.iv4 = phi i64 [ 0, %.lr.ph3 ], [ %indvars.iv.next5, %.loopexit ]
  %22 = getelementptr inbounds i32* %17, i64 %indvars.iv4, !dbg !185
  %23 = load i32* %22, align 4, !dbg !185, !tbaa !178
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !85), !dbg !185
  %24 = trunc i64 %indvars.iv4 to i32, !dbg !186
  %25 = sdiv i32 %24, %6, !dbg !186
  tail call void @llvm.dbg.value(metadata !{i32 %25}, i64 0, metadata !88), !dbg !186
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !187
  %26 = add nsw i32 %23, %6, !dbg !188
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1, !dbg !182
  %27 = getelementptr inbounds i32* %17, i64 %indvars.iv.next5, !dbg !188
  store i32 %26, i32* %27, align 4, !dbg !188, !tbaa !178
  %28 = icmp slt i32 %25, 1, !dbg !189
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !88), !dbg !189
  %. = select i1 %28, i32 1, i32 %25, !dbg !189
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !183
  br i1 %20, label %.lr.ph, label %.loopexit, !dbg !183

.lr.ph:                                           ; preds = %21
  %29 = sext i32 %23 to i64, !dbg !183
  br label %30, !dbg !183

; <label>:30                                      ; preds = %30, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %30 ]
  %31 = trunc i64 %indvars.iv to i32, !dbg !191
  %32 = mul nsw i32 %31, %., !dbg !191
  %33 = add nsw i64 %indvars.iv, %29, !dbg !191
  %34 = getelementptr inbounds i32* %12, i64 %33, !dbg !191
  store i32 %32, i32* %34, align 4, !dbg !191, !tbaa !178
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !183
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !183
  %exitcond = icmp eq i32 %lftr.wideiv, %6, !dbg !183
  br i1 %exitcond, label %.loopexit, label %30, !dbg !183

.preheader:                                       ; preds = %0, %.loopexit, %.preheader
  %cycles.0 = phi i32 [ %37, %.preheader ], [ 1, %.loopexit ], [ 1, %0 ]
  tail call void @Stopwatch_start(%struct.Stopwatch_struct* %18) #5, !dbg !192
  %35 = shl nsw i32 %cycles.0, 6, !dbg !194
  tail call void @SparseCompRow_matmult(i32 %N, double* %5, double* %8, i32* %17, i32* %12, double* %1, i32 %35) #5, !dbg !194
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %18) #5, !dbg !195
  %36 = icmp sgt i32 %cycles.0, 4096, !dbg !196
  %37 = shl nsw i32 %cycles.0, 1, !dbg !198
  tail call void @llvm.dbg.value(metadata !{i32 %37}, i64 0, metadata !83), !dbg !198
  br i1 %36, label %38, label %.preheader, !dbg !196

; <label>:38                                      ; preds = %.preheader
  %39 = tail call double @SparseCompRow_num_flops(i32 %N, i32 %nz, i32 8192) #5, !dbg !199
  %40 = tail call double @Stopwatch_read(%struct.Stopwatch_struct* %18) #5, !dbg !200
  %41 = fdiv double %39, %40, !dbg !200
  %42 = fmul double %41, 1.000000e-06, !dbg !200
  tail call void @llvm.dbg.value(metadata !{double %42}, i64 0, metadata !75), !dbg !200
  tail call void @Stopwatch_delete(%struct.Stopwatch_struct* %18) #5, !dbg !201
  tail call void @free(i8* %16) #5, !dbg !202
  tail call void @free(i8* %11) #5, !dbg !203
  %43 = bitcast double* %8 to i8*, !dbg !204
  tail call void @free(i8* %43) #5, !dbg !204
  tail call void @free(i8* %4) #5, !dbg !205
  %44 = bitcast double* %1 to i8*, !dbg !206
  tail call void @free(i8* %44) #5, !dbg !206
  ret double %42, !dbg !207
}
...
define double @kernel_measureLU(i32 %N, double %min_time, %struct.Random_struct* %R) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %N}, i64 0, metadata !92), !dbg !208
  tail call void @llvm.dbg.value(metadata !{double %min_time}, i64 0, metadata !93), !dbg !208
  tail call void @llvm.dbg.value(metadata !{%struct.Random_struct* %R}, i64 0, metadata !94), !dbg !208
  tail call void @llvm.dbg.value(metadata !209, i64 0, metadata !95), !dbg !210
  tail call void @llvm.dbg.value(metadata !209, i64 0, metadata !96), !dbg !211
  tail call void @llvm.dbg.value(metadata !212, i64 0, metadata !97), !dbg !213
  %1 = tail call %struct.Stopwatch_struct* @new_Stopwatch() #5, !dbg !214
  tail call void @llvm.dbg.value(metadata !{%struct.Stopwatch_struct* %1}, i64 0, metadata !98), !dbg !214
  tail call void @llvm.dbg.value(metadata !113, i64 0, metadata !99), !dbg !215
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !100), !dbg !216
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !101), !dbg !217
  %2 = tail call double** @RandomMatrix(i32 %N, i32 %N, %struct.Random_struct* %R) #5, !dbg !218
  tail call void @llvm.dbg.value(metadata !{double** %2}, i64 0, metadata !95), !dbg !218
  %3 = icmp eq double** %2, null, !dbg !218
  br i1 %3, label %4, label %5, !dbg !218
...
; <label>:5                                       ; preds = %0
  %6 = tail call double** @new_Array2D_double(i32 %N, i32 %N) #5, !dbg !220
  tail call void @llvm.dbg.value(metadata !{double** %6}, i64 0, metadata !96), !dbg !220
  %7 = icmp eq double** %6, null, !dbg !220
  br i1 %7, label %8, label %9, !dbg !220
...
; <label>:9                                       ; preds = %5
  %10 = sext i32 %N to i64, !dbg !222
  %11 = shl nsw i64 %10, 2, !dbg !222
  %12 = tail call noalias i8* @malloc(i64 %11) #5, !dbg !222
  %13 = bitcast i8* %12 to i32*, !dbg !222
  tail call void @llvm.dbg.value(metadata !{i32* %13}, i64 0, metadata !97), !dbg !222
  %14 = icmp eq i8* %12, null, !dbg !222
  br i1 %14, label %15, label %.preheader, !dbg !222
...
.preheader:                                       ; preds = %9, %.preheader.backedge
  ...
  tail call void @Stopwatch_start(%struct.Stopwatch_struct* %1) #5, !dbg !224
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !100), !dbg !226
  %16 = icmp sgt i32 %cycles.0, 0, !dbg !226
  br i1 %16, label %.lr.ph, label %._crit_edge.thread, !dbg !226

._crit_edge.thread:                               ; preds = %.preheader
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %1) #5, !dbg !228
  br label %.preheader.backedge, !dbg !229

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %i.01 = phi i32 [ %18, %.lr.ph ], [ 0, %.preheader ]
  tail call void @Array2D_double_copy(i32 %N, i32 %N, double** %6, double** %2) #5, !dbg !231
  %17 = tail call i32 @LU_factor(i32 %N, i32 %N, double** %6, i32* %13) #5, !dbg !233
  %18 = add nsw i32 %i.01, 1, !dbg !226
  tail call void @llvm.dbg.value(metadata !{i32 %18}, i64 0, metadata !100), !dbg !226
  %exitcond = icmp eq i32 %18, %cycles.0, !dbg !226
  br i1 %exitcond, label %._crit_edge, label %.lr.ph, !dbg !226

._crit_edge:                                      ; preds = %.lr.ph
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %1) #5, !dbg !228
  %19 = icmp sgt i32 %cycles.0, 4096, !dbg !229
  br i1 %19, label %20, label %.preheader.backedge, !dbg !229

.preheader.backedge:                              ; preds = %._crit_edge, %._crit_edge.thread
  %cycles.0.be = shl nsw i32 %cycles.0, 1, !dbg !234
  br label %.preheader

; <label>:20                                      ; preds = %._crit_edge
  %21 = tail call double @LU_num_flops(i32 %N) #5, !dbg !235
  %22 = fmul double %21, 8.192000e+03, !dbg !235
  %23 = tail call double @Stopwatch_read(%struct.Stopwatch_struct* %1) #5, !dbg !235
  %24 = fdiv double %22, %23, !dbg !235
  %25 = fmul double %24, 1.000000e-06, !dbg !235
  tail call void @llvm.dbg.value(metadata !{double %25}, i64 0, metadata !99), !dbg !235
  tail call void @Stopwatch_delete(%struct.Stopwatch_struct* %1) #5, !dbg !236
  tail call void @free(i8* %12) #5, !dbg !237
  tail call void @Array2D_double_delete(i32 %N, i32 %N, double** %6) #5, !dbg !238
  tail call void @Array2D_double_delete(i32 %N, i32 %N, double** %2) #5, !dbg !239
  ret double %25, !dbg !240
}
...
!153 = metadata !{i32 88, i32 0, metadata !56, null}
!154 = metadata !{i32 90, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !1, metadata !56, i32 89, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!156 = metadata !{i32 91, i32 0, metadata !155, null}
!157 = metadata !{i32 92, i32 0, metadata !155, null}
!158 = metadata !{i32 93, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !1, metadata !155, i32 93, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!160 = metadata !{i32 95, i32 0, metadata !155, null}
!161 = metadata !{i32 98, i32 0, metadata !56, null}
!162 = metadata !{i32 99, i32 0, metadata !56, null}
!163 = metadata !{i32 100, i32 0, metadata !56, null}
!164 = metadata !{i32 104, i32 0, metadata !65, null}
!165 = metadata !{i32 105, i32 0, metadata !65, null}
!166 = metadata !{i32 110, i32 0, metadata !65, null}
!167 = metadata !{i32 111, i32 0, metadata !65, null}
!168 = metadata !{i32 113, i32 0, metadata !65, null}
!169 = metadata !{i32 138, i32 0, metadata !65, null}
!170 = metadata !{i32 139, i32 0, metadata !65, null}
!171 = metadata !{i32 142, i32 0, metadata !65, null}
!172 = metadata !{i32 143, i32 0, metadata !65, null}
!173 = metadata !{i32 144, i32 0, metadata !65, null}
!174 = metadata !{i32 145, i32 0, metadata !65, null}
!175 = metadata !{i32 146, i32 0, metadata !65, null}
!176 = metadata !{i32 148, i32 0, metadata !65, null}
!177 = metadata !{i32 150, i32 0, metadata !65, null}
...
!182 = metadata !{i32 151, i32 0, metadata !87, null}
!183 = metadata !{i32 163, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !1, metadata !86, i32 163, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!185 = metadata !{i32 155, i32 0, metadata !86, null}
!186 = metadata !{i32 156, i32 0, metadata !86, null}
!187 = metadata !{i32 157, i32 0, metadata !86, null}
!188 = metadata !{i32 159, i32 0, metadata !86, null}
!189 = metadata !{i32 160, i32 0, metadata !190, null}
!190 = metadata !{i32 786443, metadata !1, metadata !86, i32 160, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!191 = metadata !{i32 164, i32 0, metadata !184, null}
!192 = metadata !{i32 171, i32 0, metadata !193, null}
!193 = metadata !{i32 786443, metadata !1, metadata !65, i32 170, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!194 = metadata !{i32 172, i32 0, metadata !193, null}
!195 = metadata !{i32 173, i32 0, metadata !193, null}
!196 = metadata !{i32 174, i32 0, metadata !197, null}
!197 = metadata !{i32 786443, metadata !1, metadata !193, i32 174, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!198 = metadata !{i32 176, i32 0, metadata !193, null}
!199 = metadata !{i32 179, i32 0, metadata !65, null}
!200 = metadata !{i32 180, i32 0, metadata !65, null}
!201 = metadata !{i32 182, i32 0, metadata !65, null}
!202 = metadata !{i32 183, i32 0, metadata !65, null}
!203 = metadata !{i32 184, i32 0, metadata !65, null}
!204 = metadata !{i32 185, i32 0, metadata !65, null}
!205 = metadata !{i32 186, i32 0, metadata !65, null}
!206 = metadata !{i32 187, i32 0, metadata !65, null}
!207 = metadata !{i32 189, i32 0, metadata !65, null}
!208 = metadata !{i32 193, i32 0, metadata !90, null}
!209 = metadata !{double** null}
!210 = metadata !{i32 196, i32 0, metadata !90, null}
!211 = metadata !{i32 197, i32 0, metadata !90, null}
!212 = metadata !{i32* null}
!213 = metadata !{i32 198, i32 0, metadata !90, null}
!214 = metadata !{i32 202, i32 0, metadata !90, null}
!215 = metadata !{i32 203, i32 0, metadata !90, null}
!216 = metadata !{i32 204, i32 0, metadata !90, null}
!217 = metadata !{i32 205, i32 0, metadata !90, null}
!218 = metadata !{i32 207, i32 0, metadata !219, null}
!219 = metadata !{i32 786443, metadata !1, metadata !90, i32 207, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!220 = metadata !{i32 208, i32 0, metadata !221, null}
!221 = metadata !{i32 786443, metadata !1, metadata !90, i32 208, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!222 = metadata !{i32 209, i32 0, metadata !223, null}
!223 = metadata !{i32 786443, metadata !1, metadata !90, i32 209, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!224 = metadata !{i32 214, i32 0, metadata !225, null}
!225 = metadata !{i32 786443, metadata !1, metadata !90, i32 213, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!226 = metadata !{i32 215, i32 0, metadata !227, null}
!227 = metadata !{i32 786443, metadata !1, metadata !225, i32 215, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!228 = metadata !{i32 220, i32 0, metadata !225, null}
!229 = metadata !{i32 221, i32 0, metadata !230, null}
!230 = metadata !{i32 786443, metadata !1, metadata !225, i32 221, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!231 = metadata !{i32 217, i32 0, metadata !232, null}
!232 = metadata !{i32 786443, metadata !1, metadata !227, i32 216, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!233 = metadata !{i32 218, i32 0, metadata !232, null}
!234 = metadata !{i32 223, i32 0, metadata !225, null}
!235 = metadata !{i32 226, i32 0, metadata !90, null}
!236 = metadata !{i32 228, i32 0, metadata !90, null}
!237 = metadata !{i32 229, i32 0, metadata !90, null}
!238 = metadata !{i32 230, i32 0, metadata !90, null}
!239 = metadata !{i32 231, i32 0, metadata !90, null}
!240 = metadata !{i32 233, i32 0, metadata !90, null}
