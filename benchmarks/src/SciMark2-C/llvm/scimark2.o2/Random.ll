...
; <label>:15                                      ; preds = %.lr.ph4, %._crit_edge
  ...
  %16 = tail call noalias i8* @malloc(i64 %8) #3, !dbg !232
  %17 = bitcast i8* %16 to double*, !dbg !232
  %18 = getelementptr inbounds double** %4, i64 %indvars.iv5, !dbg !232
  store double* %17, double** %18, align 8, !dbg !232, !tbaa !241
  %19 = icmp eq i8* %16, null, !dbg !243
  br i1 %19, label %20, label %.preheader, !dbg !243

.preheader:                                       ; preds = %15
  br i1 %9, label %.lr.ph, label %._crit_edge, !dbg !234

.lr.ph:                                           ; preds = %.preheader
  %.pre = load i32* %10, align 4, !dbg !236, !tbaa !133
  %.pre7 = load i32* %11, align 4, !dbg !238, !tbaa !135
  br label %21, !dbg !234

; <label>:20                                      ; preds = %15
  tail call void @free(i8* %3) #3, !dbg !245
  br label %.loopexit, !dbg !247

; <label>:21                                      ; preds = %Random_nextDouble.exit, %.lr.ph
  %22 = phi i32 [ %.pre7, %.lr.ph ], [ %J.0.i, %Random_nextDouble.exit ], !dbg !248
  %23 = phi i32 [ %.pre, %.lr.ph ], [ %I.0.i, %Random_nextDouble.exit ], !dbg !248
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %Random_nextDouble.exit ]
  tail call void @llvm.dbg.value(metadata !{%struct.Random_struct* %R}, i64 0, metadata !249), !dbg !248
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !250), !dbg !236
  tail call void @llvm.dbg.value(metadata !{i32 %22}, i64 0, metadata !251), !dbg !238
  %24 = sext i32 %23 to i64, !dbg !252
  %25 = getelementptr inbounds %struct.Random_struct* %R, i64 0, i32 0, i64 %24, !dbg !252
  %26 = load i32* %25, align 4, !dbg !252, !tbaa !131
  %27 = sext i32 %22 to i64, !dbg !252
  %28 = getelementptr inbounds %struct.Random_struct* %R, i64 0, i32 0, i64 %27, !dbg !252
  %29 = load i32* %28, align 4, !dbg !252, !tbaa !131
  %30 = sub nsw i32 %26, %29, !dbg !252
  tail call void @llvm.dbg.value(metadata !{i32 %30}, i64 0, metadata !253), !dbg !252
  %31 = icmp slt i32 %30, 0, !dbg !254
  %32 = add nsw i32 %30, 2147483647, !dbg !254
  tail call void @llvm.dbg.value(metadata !{i32 %32}, i64 0, metadata !253), !dbg !254
  %..i = select i1 %31, i32 %32, i32 %30, !dbg !254
  store i32 %..i, i32* %28, align 4, !dbg !255, !tbaa !131
  %33 = icmp eq i32 %23, 0, !dbg !256
  %34 = add nsw i32 %23, -1, !dbg !257
  tail call void @llvm.dbg.value(metadata !{i32 %34}, i64 0, metadata !250), !dbg !257
  %I.0.i = select i1 %33, i32 16, i32 %34, !dbg !256
  store i32 %I.0.i, i32* %10, align 4, !dbg !258, !tbaa !133
  %35 = icmp eq i32 %22, 0, !dbg !259
  %36 = add nsw i32 %22, -1, !dbg !260
  tail call void @llvm.dbg.value(metadata !{i32 %36}, i64 0, metadata !251), !dbg !260
  %J.0.i = select i1 %35, i32 16, i32 %36, !dbg !259
  store i32 %J.0.i, i32* %11, align 4, !dbg !261, !tbaa !135
  %37 = load i32* %12, align 4, !dbg !239, !tbaa !143
  %38 = icmp eq i32 %37, 0, !dbg !239
  br i1 %38, label %47, label %39, !dbg !239

; <label>:39                                      ; preds = %21
  %40 = load double* %13, align 8, !dbg !240, !tbaa !137
  %41 = load double* @dm1, align 8, !dbg !240, !tbaa !99
  %42 = sitofp i32 %..i to double, !dbg !240
  %43 = fmul double %42, %41, !dbg !240
  %44 = load double* %14, align 8, !dbg !240, !tbaa !141
  %45 = fmul double %43, %44, !dbg !240
  %46 = fadd double %40, %45, !dbg !240
  br label %Random_nextDouble.exit, !dbg !240

; <label>:47                                      ; preds = %21
  %48 = load double* @dm1, align 8, !dbg !262, !tbaa !99
  %49 = sitofp i32 %..i to double, !dbg !262
  %50 = fmul double %49, %48, !dbg !262
  br label %Random_nextDouble.exit, !dbg !262

Random_nextDouble.exit:                           ; preds = %39, %47
  %.0.i = phi double [ %46, %39 ], [ %50, %47 ]
  %51 = getelementptr inbounds double* %17, i64 %indvars.iv, !dbg !237
  store double %.0.i, double* %51, align 8, !dbg !237, !tbaa !99
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !234
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !234
  %exitcond = icmp eq i32 %lftr.wideiv, %N, !dbg !234
  br i1 %exitcond, label %._crit_edge, label %21, !dbg !234

._crit_edge:                                      ; preds = %Random_nextDouble.exit, %.preheader
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !230
  %52 = trunc i64 %indvars.iv.next6 to i32, !dbg !230
  %53 = icmp slt i32 %52, %M, !dbg !230
  br i1 %53, label %15, label %.loopexit, !dbg !230

.loopexit:                                        ; preds = %._crit_edge, %.preheader1, %0, %20
  %.0 = phi double** [ null, %20 ], [ null, %0 ], [ %4, %.preheader1 ], [ %4, %._crit_edge ]
...
!245 = metadata !{i32 162, i32 0, metadata !246, null}
!246 = metadata !{i32 786443, metadata !1, metadata !244, i32 161, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/Random.c]
!247 = metadata !{i32 163, i32 0, metadata !246, null}
!248 = metadata !{i32 70, i32 0, metadata !42, metadata !237}
!249 = metadata !{i32 786689, metadata !42, metadata !"R", metadata !5, i32 16777286, metadata !8, i32 0, metadata !237} ; [ DW_TAG_arg_variable ] [R] [line 70]
!250 = metadata !{i32 786688, metadata !42, metadata !"I", metadata !5, i32 74, metadata !15, i32 0, metadata !237} ; [ DW_TAG_auto_variable ] [I] [line 74]
!251 = metadata !{i32 786688, metadata !42, metadata !"J", metadata !5, i32 75, metadata !15, i32 0, metadata !237} ; [ DW_TAG_auto_variable ] [J] [line 75]
!252 = metadata !{i32 78, i32 0, metadata !42, metadata !237}
!253 = metadata !{i32 786688, metadata !42, metadata !"k", metadata !5, i32 72, metadata !15, i32 0, metadata !237} ; [ DW_TAG_auto_variable ] [k] [line 72]
!254 = metadata !{i32 79, i32 0, metadata !186, metadata !237}
!255 = metadata !{i32 80, i32 0, metadata !42, metadata !237}
!256 = metadata !{i32 82, i32 0, metadata !189, metadata !237}
!257 = metadata !{i32 84, i32 0, metadata !189, metadata !237}
!258 = metadata !{i32 85, i32 0, metadata !42, metadata !237}
!259 = metadata !{i32 87, i32 0, metadata !193, metadata !237}
!260 = metadata !{i32 89, i32 0, metadata !193, metadata !237}
!261 = metadata !{i32 90, i32 0, metadata !42, metadata !237}
!262 = metadata !{i32 95, i32 0, metadata !197, metadata !237}
