...
.lr.ph6:                                          ; preds = %0
  ...
  %7 = and i32 %N, 3
  %8 = icmp ugt i32 %7, 1
  %.op = add i32 %7, -1, !dbg !81
  %9 = zext i32 %.op to i64
  %.op20 = add i64 %9, 1, !dbg !81
  %10 = select i1 %8, i64 %.op20, i64 1, !dbg !81
  %11 = and i32 %N, 3
  %12 = icmp ugt i32 %11, 1
  %.op21 = add i32 %11, -1, !dbg !81
  %13 = zext i32 %.op21 to i64
  %14 = select i1 %12, i64 %13, i64 0
  br label %15, !dbg !81

; <label>:15                                      ; preds = %._crit_edge, %.lr.ph6
  %indvars.iv10 = phi i64 [ 0, %.lr.ph6 ], [ %indvars.iv.next11, %._crit_edge ]
  %16 = getelementptr inbounds double** %B, i64 %indvars.iv10, !dbg !86
  %17 = load double** %16, align 8, !dbg !86, !tbaa !55
  tail call void @llvm.dbg.value(metadata !{double* %17}, i64 0, metadata !37), !dbg !86
  %18 = getelementptr inbounds double** %A, i64 %indvars.iv10, !dbg !87
  %19 = load double** %18, align 8, !dbg !87, !tbaa !55
  tail call void @llvm.dbg.value(metadata !{double* %19}, i64 0, metadata !40), !dbg !87
  tail call void @llvm.dbg.value(metadata !45, i64 0, metadata !36), !dbg !82
  br i1 %3, label %.preheader, label %.lr.ph.preheader, !dbg !82

.lr.ph.preheader:                                 ; preds = %15
  %n.vec = and i64 %10, -4, !dbg !82
  %cmp.zero = icmp eq i64 %n.vec, 0, !dbg !82
  br i1 %cmp.zero, label %middle.block, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.preheader
  %scevgep14 = getelementptr double* %19, i64 %14
  %scevgep = getelementptr double* %17, i64 %14
  %bound1 = icmp ule double* %19, %scevgep
  %bound0 = icmp ule double* %17, %scevgep14
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %middle.block, label %vector.body

vector.body:                                      ; preds = %vector.memcheck, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.memcheck ], !dbg !82
  %20 = getelementptr inbounds double* %19, i64 %index, !dbg !88
  %21 = bitcast double* %20 to <2 x double>*, !dbg !88
  %wide.load = load <2 x double>* %21, align 8, !dbg !88
  %.sum22 = or i64 %index, 2, !dbg !88
  %22 = getelementptr double* %19, i64 %.sum22, !dbg !88
  %23 = bitcast double* %22 to <2 x double>*, !dbg !88
  %wide.load17 = load <2 x double>* %23, align 8, !dbg !88
  %24 = getelementptr inbounds double* %17, i64 %index, !dbg !88
  %25 = bitcast double* %24 to <2 x double>*, !dbg !88
  store <2 x double> %wide.load, <2 x double>* %25, align 8, !dbg !88
  %.sum23 = or i64 %index, 2, !dbg !88
  %26 = getelementptr double* %17, i64 %.sum23, !dbg !88
  %27 = bitcast double* %26 to <2 x double>*, !dbg !88
  store <2 x double> %wide.load17, <2 x double>* %27, align 8, !dbg !88
  %index.next = add i64 %index, 4, !dbg !82
  %28 = icmp eq i64 %index.next, %n.vec, !dbg !82
  br i1 %28, label %middle.block, label %vector.body, !dbg !82, !llvm.loop !89

middle.block:                                     ; preds = %vector.body, %vector.memcheck, %.lr.ph.preheader
  %resume.val = phi i64 [ 0, %.lr.ph.preheader ], [ 0, %vector.memcheck ], [ %n.vec, %vector.body ]
  %cmp.n = icmp eq i64 %10, %resume.val
  br i1 %cmp.n, label %.preheader, label %.lr.ph

.preheader:                                       ; preds = %.lr.ph, %middle.block, %15
...
.lr.ph:                                           ; preds = %middle.block, %.lr.ph
  ...
  %29 = getelementptr inbounds double* %19, i64 %indvars.iv, !dbg !88
  %30 = load double* %29, align 8, !dbg !88, !tbaa !92
  %31 = getelementptr inbounds double* %17, i64 %indvars.iv, !dbg !88
  store double %30, double* %31, align 8, !dbg !88, !tbaa !92
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !82
  %32 = trunc i64 %indvars.iv.next to i32, !dbg !82
  %33 = icmp slt i32 %32, %1, !dbg !82
  br i1 %33, label %.lr.ph, label %.preheader, !dbg !82, !llvm.loop !94

.lr.ph3:                                          ; preds = %.preheader, %.lr.ph3
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %.lr.ph3 ], [ %6, %.preheader ]
  %j.12 = phi i32 [ %49, %.lr.ph3 ], [ %1, %.preheader ]
  %34 = getelementptr inbounds double* %19, i64 %indvars.iv8, !dbg !95
  %35 = load double* %34, align 8, !dbg !95, !tbaa !92
  %36 = getelementptr inbounds double* %17, i64 %indvars.iv8, !dbg !95
  store double %35, double* %36, align 8, !dbg !95, !tbaa !92
  %37 = add nsw i64 %indvars.iv8, 1, !dbg !97
  %38 = getelementptr inbounds double* %19, i64 %37, !dbg !97
  %39 = load double* %38, align 8, !dbg !97, !tbaa !92
  %40 = getelementptr inbounds double* %17, i64 %37, !dbg !97
  store double %39, double* %40, align 8, !dbg !97, !tbaa !92
  %41 = add nsw i64 %indvars.iv8, 2, !dbg !98
  %42 = getelementptr inbounds double* %19, i64 %41, !dbg !98
  %43 = load double* %42, align 8, !dbg !98, !tbaa !92
  %44 = getelementptr inbounds double* %17, i64 %41, !dbg !98
  store double %43, double* %44, align 8, !dbg !98, !tbaa !92
  %45 = add nsw i64 %indvars.iv8, 3, !dbg !99
  %46 = getelementptr inbounds double* %19, i64 %45, !dbg !99
  %47 = load double* %46, align 8, !dbg !99, !tbaa !92
  %48 = getelementptr inbounds double* %17, i64 %45, !dbg !99
  store double %47, double* %48, align 8, !dbg !99, !tbaa !92
  %49 = add nsw i32 %j.12, 4, !dbg !84
  tail call void @llvm.dbg.value(metadata !{i32 %49}, i64 0, metadata !36), !dbg !84
  %50 = icmp slt i32 %49, %N, !dbg !84
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 4, !dbg !84
  br i1 %50, label %.lr.ph3, label %._crit_edge, !dbg !84
...
._crit_edge:                                      ; preds = %.lr.ph3, %.preheader
  ...
  br i1 %exitcond, label %._crit_edge7, label %15, !dbg !81
...
!93 = metadata !{metadata !"double", metadata !57, i64 0}
!94 = metadata !{metadata !94, metadata !90, metadata !91}
!95 = metadata !{i32 71, i32 0, metadata !96, null}
!96 = metadata !{i32 786443, metadata !1, metadata !85, i32 70, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/array.c]
!97 = metadata !{i32 72, i32 0, metadata !96, null}
!98 = metadata !{i32 73, i32 0, metadata !96, null}
!99 = metadata !{i32 74, i32 0, metadata !96, null}
!100 = metadata !{i32 77, i32 0, metadata !26, null}
