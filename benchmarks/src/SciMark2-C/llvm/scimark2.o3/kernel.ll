...
.lr.ph.us.preheader:                              ; preds = %.lr.ph3
  %21 = add i32 %6, -1, !dbg !183
  %22 = zext i32 %21 to i64
  %23 = add i64 %22, 1, !dbg !183
  br label %.lr.ph.us, !dbg !183

scalar.ph:                                        ; preds = %middle.block, %scalar.ph
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %scalar.ph ], [ %resume.val, %middle.block ]
  %24 = trunc i64 %indvars.iv4 to i32, !dbg !184
  %25 = mul nsw i32 %24, %..us, !dbg !184
  %26 = add nsw i64 %indvars.iv4, %34, !dbg !184
  %27 = getelementptr inbounds i32* %12, i64 %26, !dbg !184
  store i32 %25, i32* %27, align 4, !dbg !184, !tbaa !176
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1, !dbg !181
  %lftr.wideiv6 = trunc i64 %indvars.iv.next5 to i32, !dbg !181
  %exitcond7 = icmp eq i32 %lftr.wideiv6, %6, !dbg !181
  br i1 %exitcond7, label %.loopexit.us, label %scalar.ph, !dbg !181, !llvm.loop !185

.loopexit.us:                                     ; preds = %middle.block, %scalar.ph
  %lftr.wideiv10 = trunc i64 %indvars.iv.next9 to i32, !dbg !180
  %exitcond11 = icmp eq i32 %lftr.wideiv10, %N, !dbg !180
  br i1 %exitcond11, label %.preheader, label %.lr.ph.us, !dbg !180

.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %.loopexit.us
  %28 = phi i32 [ %31, %.loopexit.us ], [ 0, %.lr.ph.us.preheader ], !dbg !183
  %indvars.iv8 = phi i64 [ %indvars.iv.next9, %.loopexit.us ], [ 0, %.lr.ph.us.preheader ]
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !85), !dbg !183
  %29 = trunc i64 %indvars.iv8 to i32, !dbg !188
  %30 = sdiv i32 %29, %6, !dbg !188
  tail call void @llvm.dbg.value(metadata !{i32 %30}, i64 0, metadata !88), !dbg !188
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !189
  %31 = add nsw i32 %28, %6, !dbg !190
  %indvars.iv.next9 = add nuw nsw i64 %indvars.iv8, 1, !dbg !180
  %32 = getelementptr inbounds i32* %17, i64 %indvars.iv.next9, !dbg !190
  store i32 %31, i32* %32, align 4, !dbg !190, !tbaa !176
  %33 = icmp slt i32 %30, 1, !dbg !191
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !88), !dbg !191
  %..us = select i1 %33, i32 1, i32 %30, !dbg !191
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !181
  %34 = sext i32 %28 to i64, !dbg !181
...
vector.ph:                                        ; preds = %.lr.ph.us
  %broadcast.splatinsert18 = insertelement <4 x i32> undef, i32 %..us, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %35 = trunc i64 %index to i32, !dbg !184
  %broadcast.splatinsert14 = insertelement <4 x i32> undef, i32 %35, i32 0, !dbg !184
  %broadcast.splat15 = shufflevector <4 x i32> %broadcast.splatinsert14, <4 x i32> undef, <4 x i32> zeroinitializer, !dbg !184
  %induction16 = add <4 x i32> %broadcast.splat15, <i32 0, i32 1, i32 2, i32 3>, !dbg !184
  %induction17 = add <4 x i32> %broadcast.splat15, <i32 4, i32 5, i32 6, i32 7>, !dbg !184
  %36 = mul nsw <4 x i32> %induction16, %broadcast.splat19, !dbg !184
  %37 = mul nsw <4 x i32> %induction17, %broadcast.splat19, !dbg !184
  %38 = add i64 %index, %34, !dbg !184
  %39 = getelementptr inbounds i32* %12, i64 %38, !dbg !184
  %40 = bitcast i32* %39 to <4 x i32>*, !dbg !184
  store <4 x i32> %36, <4 x i32>* %40, align 4, !dbg !184
  %.sum = add i64 %38, 4, !dbg !184
  %41 = getelementptr i32* %12, i64 %.sum, !dbg !184
  %42 = bitcast i32* %41 to <4 x i32>*, !dbg !184
  store <4 x i32> %37, <4 x i32>* %42, align 4, !dbg !184
  %index.next = add i64 %index, 8, !dbg !181
  %43 = icmp eq i64 %index.next, %n.vec, !dbg !181
  br i1 %43, label %middle.block, label %vector.body, !dbg !181, !llvm.loop !193

middle.block:                                     ; preds = %vector.body, %.lr.ph.us
  %resume.val = phi i64 [ 0, %.lr.ph.us ], [ %n.vec, %vector.body ]
  %cmp.n = icmp eq i64 %end.idx, %resume.val
  br i1 %cmp.n, label %.loopexit.us, label %scalar.ph

.loopexit:                                        ; preds = %.lr.ph3, %.loopexit
  %44 = phi i32 [ %45, %.loopexit ], [ 0, %.lr.ph3 ], !dbg !183
  %indvars.iv = phi i64 [ %indvars.iv.next, %.loopexit ], [ 0, %.lr.ph3 ]
  tail call void @llvm.dbg.value(metadata !{i32 %44}, i64 0, metadata !85), !dbg !183
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !189
  %45 = add nsw i32 %44, %6, !dbg !190
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !180
  %46 = getelementptr inbounds i32* %17, i64 %indvars.iv.next, !dbg !190
  store i32 %45, i32* %46, align 4, !dbg !190, !tbaa !176
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !88), !dbg !191
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !181
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !180
  %exitcond = icmp eq i32 %lftr.wideiv, %N, !dbg !180
  br i1 %exitcond, label %.preheader, label %.loopexit, !dbg !180

.preheader:                                       ; preds = %0, %.loopexit.us, %.loopexit, %.preheader
  %cycles.0 = phi i32 [ %49, %.preheader ], [ 1, %.loopexit ], [ 1, %.loopexit.us ], [ 1, %0 ]
  tail call void @Stopwatch_start(%struct.Stopwatch_struct* %18) #5, !dbg !194
  %47 = shl nsw i32 %cycles.0, 6, !dbg !196
  tail call void @SparseCompRow_matmult(i32 %N, double* %5, double* %8, i32* %17, i32* %12, double* %1, i32 %47) #5, !dbg !196
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %18) #5, !dbg !197
  %48 = icmp sgt i32 %cycles.0, 4096, !dbg !198
  %49 = shl nsw i32 %cycles.0, 1, !dbg !200
  tail call void @llvm.dbg.value(metadata !{i32 %49}, i64 0, metadata !83), !dbg !200
  br i1 %48, label %50, label %.preheader, !dbg !198

; <label>:50                                      ; preds = %.preheader
  %51 = tail call double @SparseCompRow_num_flops(i32 %N, i32 %nz, i32 8192) #5, !dbg !201
  %52 = tail call double @Stopwatch_read(%struct.Stopwatch_struct* %18) #5, !dbg !202
  %53 = fdiv double %51, %52, !dbg !202
  %54 = fmul double %53, 1.000000e-06, !dbg !202
  tail call void @llvm.dbg.value(metadata !{double %54}, i64 0, metadata !75), !dbg !202
  ...
  %55 = bitcast double* %8 to i8*, !dbg !206
  tail call void @free(i8* %55) #5, !dbg !206
  tail call void @free(i8* %4) #5, !dbg !207
  %56 = bitcast double* %1 to i8*, !dbg !208
  tail call void @free(i8* %56) #5, !dbg !208
  ret double %54, !dbg !209
}
...
!184 = metadata !{i32 164, i32 0, metadata !182, null}
...
!188 = metadata !{i32 156, i32 0, metadata !86, null}
!189 = metadata !{i32 157, i32 0, metadata !86, null}
!190 = metadata !{i32 159, i32 0, metadata !86, null}
!191 = metadata !{i32 160, i32 0, metadata !192, null}
!192 = metadata !{i32 786443, metadata !1, metadata !86, i32 160, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C/kernel.c]
!193 = metadata !{metadata !193, metadata !186, metadata !187}
