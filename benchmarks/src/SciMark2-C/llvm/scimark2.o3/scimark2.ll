...
; <label>:3                                       ; preds = %0
  ...
  %6 = tail call i32 @strcmp(i8* %5, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0)) #6, !dbg !130
...
; <label>:25                                      ; preds = %24, %3
  ...
  %27 = tail call i64 @fwrite(i8* getelementptr inbounds ([32 x i8]* @.str2, i64 0, i64 0), i64 31, i64 1, %struct._IO_FILE* %26) #7, !dbg !149
  tail call void @exit(i32 0) #8, !dbg !151
  unreachable, !dbg !151

; <label>:28                                      ; preds = %24
  tail call void @llvm.dbg.value(metadata !152, i64 0, metadata !69), !dbg !153
  %29 = tail call i32 @strcmp(i8* %5, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0)) #6, !dbg !153
  ...
  %. = select i1 %30, i32 2, i32 1, !dbg !153
  %.26 = select i1 %30, i32 1000, i32 100, !dbg !153
  %.27 = select i1 %30, i32 1000000, i32 5000, !dbg !153
  %.28 = select i1 %30, i32 100000, i32 1000, !dbg !153
  %.29 = select i1 %30, i32 1048576, i32 1024, !dbg !153
  %31 = icmp slt i32 %., %argc, !dbg !165
  br i1 %31, label %32, label %37, !dbg !165

; <label>:32                                      ; preds = %28
  %33 = zext i32 %. to i64, !dbg !167
  %34 = getelementptr inbounds i8** %argv, i64 %33, !dbg !167
  %35 = load i8** %34, align 8, !dbg !167, !tbaa !131
  tail call void @llvm.dbg.value(metadata !{i8* %35}, i64 0, metadata !169) #6, !dbg !170
  %36 = tail call double @strtod(i8* nocapture %35, i8** null) #6, !dbg !171
  tail call void @llvm.dbg.value(metadata !{double %36}, i64 0, metadata !15), !dbg !167
  br label %37, !dbg !173

; <label>:37                                      ; preds = %28, %32, %0
  %LU_size.1 = phi i32 [ %.26, %32 ], [ %.26, %28 ], [ 100, %0 ]
  %Sparse_size_nz.1 = phi i32 [ %.27, %32 ], [ %.27, %28 ], [ 5000, %0 ]
  %Sparse_size_M.1 = phi i32 [ %.28, %32 ], [ %.28, %28 ], [ 1000, %0 ]
  %FFT_size.1 = phi i32 [ %.29, %32 ], [ %.29, %28 ], [ 1024, %0 ]
  %min_time.0 = phi double [ %36, %32 ], [ 2.000000e+00, %28 ], [ 2.000000e+00, %0 ]
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str18, i64 0, i64 0)) #6, !dbg !174
  %puts1.i = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str16, i64 0, i64 0)) #6, !dbg !176
  %puts2.i = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str17, i64 0, i64 0)) #6, !dbg !177
  %puts3.i = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str18, i64 0, i64 0)) #6, !dbg !178
  %38 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([42 x i8]* @.str4, i64 0, i64 0), double %min_time.0) #6, !dbg !179
  %39 = tail call double @kernel_measureFFT(i32 %FFT_size.1, double %min_time.0, %struct.Random_struct* %1) #6, !dbg !180
  %40 = tail call double @kernel_measureSOR(i32 %LU_size.1, double %min_time.0, %struct.Random_struct* %1) #6, !dbg !181
  %41 = tail call double @kernel_measureMonteCarlo(double %min_time.0, %struct.Random_struct* %1) #6, !dbg !182
  %42 = tail call double @kernel_measureSparseMatMult(i32 %Sparse_size_M.1, i32 %Sparse_size_nz.1, double %min_time.0, %struct.Random_struct* %1) #6, !dbg !183
  %43 = tail call double @kernel_measureLU(i32 %LU_size.1, double %min_time.0, %struct.Random_struct* %1) #6, !dbg !184
  tail call void @llvm.dbg.value(metadata !185, i64 0, metadata !22), !dbg !186
  %44 = fadd double %39, %40, !dbg !187
  %45 = fadd double %44, %41, !dbg !187
  %46 = fadd double %45, %42, !dbg !187
  %47 = fadd double %46, %43, !dbg !187
  %48 = fdiv double %47, 5.000000e+00, !dbg !187
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([59 x i8]* @str, i64 0, i64 0)), !dbg !188
  %49 = fdiv double %48, 1.000000e+07, !dbg !189
  %50 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([31 x i8]* @.str6, i64 0, i64 0), double %49) #6, !dbg !189
  %51 = fdiv double %39, 1.000000e+07, !dbg !190
  %52 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([41 x i8]* @.str7, i64 0, i64 0), double %51, i32 %FFT_size.1) #6, !dbg !190
  %53 = fdiv double %40, 1.000000e+07, !dbg !191
  %54 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str8, i64 0, i64 0), double %53, i32 %LU_size.1, i32 %LU_size.1) #6, !dbg !191
  %55 = fdiv double %41, 1.000000e+07, !dbg !192
  %56 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([31 x i8]* @.str9, i64 0, i64 0), double %55) #6, !dbg !192
  %57 = fdiv double %42, 1.000000e+07, !dbg !193
  %58 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([48 x i8]* @.str10, i64 0, i64 0), double %57, i32 %Sparse_size_M.1, i32 %Sparse_size_nz.1) #6, !dbg !193
  %59 = fdiv double %43, 1.000000e+07, !dbg !194
  %60 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([47 x i8]* @.str11, i64 0, i64 0), double %59, i32 %LU_size.1, i32 %LU_size.1) #6, !dbg !194
  tail call void @Random_delete(%struct.Random_struct* %1) #6, !dbg !195
  ret i32 0, !dbg !196
}
...
define void @print_banner() #0 {
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str18, i64 0, i64 0)), !dbg !197
  %puts1 = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str16, i64 0, i64 0)), !dbg !198
  %puts2 = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str17, i64 0, i64 0)), !dbg !199
  %puts3 = tail call i32 @puts(i8* getelementptr inbounds ([67 x i8]* @str18, i64 0, i64 0)), !dbg !200
  ret void, !dbg !201
}
...
!75 = metadata !{null}
!76 = metadata !{i32 786478, metadata !77, metadata !78, metadata !"atof", metadata !"atof", metadata !"", i32 26, metadata !79, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, null, null, null, metadata !83, i32 27} ; [ DW_TAG_subprogram ] [line 26] [def] [scope 27] [atof]
...
!169 = metadata !{i32 786689, metadata !76, metadata !"__nptr", metadata !78, i32 16777242, metadata !81, i32 0, metadata !167} ; [ DW_TAG_arg_variable ] [__nptr] [line 26]
!170 = metadata !{i32 26, i32 0, metadata !76, metadata !167}
!171 = metadata !{i32 28, i32 0, metadata !172, metadata !167}
!172 = metadata !{i32 786443, metadata !77, metadata !76} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/SciMark2-C//usr/include/x86_64-linux-gnu/bits/stdlib-float.h]
!173 = metadata !{i32 56, i32 0, metadata !168, null}
!174 = metadata !{i32 98, i32 0, metadata !73, metadata !175}
!175 = metadata !{i32 61, i32 0, metadata !4, null}
!176 = metadata !{i32 99, i32 0, metadata !73, metadata !175}
!177 = metadata !{i32 100, i32 0, metadata !73, metadata !175}
!178 = metadata !{i32 101, i32 0, metadata !73, metadata !175}
!179 = metadata !{i32 62, i32 0, metadata !4, null}
!180 = metadata !{i32 64, i32 0, metadata !4, null}
!181 = metadata !{i32 65, i32 0, metadata !4, null}
!182 = metadata !{i32 66, i32 0, metadata !4, null}
!183 = metadata !{i32 67, i32 0, metadata !4, null}
!184 = metadata !{i32 69, i32 0, metadata !4, null}
!185 = metadata !{i32 10000000}
!186 = metadata !{i32 73, i32 0, metadata !4, null}
!187 = metadata !{i32 75, i32 0, metadata !4, null}
!188 = metadata !{i32 78, i32 0, metadata !4, null}
!189 = metadata !{i32 79, i32 0, metadata !4, null}
!190 = metadata !{i32 80, i32 0, metadata !4, null}
!191 = metadata !{i32 81, i32 0, metadata !4, null}
!192 = metadata !{i32 83, i32 0, metadata !4, null}
!193 = metadata !{i32 84, i32 0, metadata !4, null}
!194 = metadata !{i32 86, i32 0, metadata !4, null}
!195 = metadata !{i32 90, i32 0, metadata !4, null}
!196 = metadata !{i32 94, i32 0, metadata !4, null}
!197 = metadata !{i32 98, i32 0, metadata !73, null}
!198 = metadata !{i32 99, i32 0, metadata !73, null}
!199 = metadata !{i32 100, i32 0, metadata !73, null}
!200 = metadata !{i32 101, i32 0, metadata !73, null}
!201 = metadata !{i32 102, i32 0, metadata !73, null}
