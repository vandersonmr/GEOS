...
define double @FFT_num_flops(i32 %N) #0 {
  ...
  %2 = tail call fastcc i32 @int_log2(i32 %N) #4, !dbg !97
...
; <label>:7                                       ; preds = %._crit_edge
  %8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([43 x i8]* @.str, i64 0, i64 0), i32 %n) #5, !dbg !108
...
; <label>:5                                       ; preds = %._crit_edge, %.lr.ph7
  ...
  %6 = trunc i64 %indvars.iv to i32, !dbg !119
  %7 = shl i32 %6, 1, !dbg !119
  tail call void @llvm.dbg.value(metadata !{i32 %7}, i64 0, metadata !25), !dbg !119
  %8 = shl i32 %j.04, 1, !dbg !120
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !28), !dbg !120
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !29), !dbg !118
  %9 = icmp slt i32 %6, %j.04, !dbg !121
  br i1 %9, label %10, label %.preheader, !dbg !121

; <label>:10                                      ; preds = %5
  %11 = sext i32 %7 to i64, !dbg !122
  %12 = getelementptr inbounds double* %data, i64 %11, !dbg !122
  %13 = load double* %12, align 8, !dbg !122, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %13}, i64 0, metadata !30), !dbg !122
  %14 = or i32 %7, 1, !dbg !127
  %15 = sext i32 %14 to i64, !dbg !127
  %16 = getelementptr inbounds double* %data, i64 %15, !dbg !127
  %17 = load double* %16, align 8, !dbg !127, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %17}, i64 0, metadata !33), !dbg !127
  %18 = sext i32 %8 to i64, !dbg !128
  %19 = getelementptr inbounds double* %data, i64 %18, !dbg !128
  %20 = load double* %19, align 8, !dbg !128, !tbaa !123
  store double %20, double* %12, align 8, !dbg !128, !tbaa !123
  %21 = or i32 %8, 1, !dbg !129
  %22 = sext i32 %21 to i64, !dbg !129
  %23 = getelementptr inbounds double* %data, i64 %22, !dbg !129
  %24 = load double* %23, align 8, !dbg !129, !tbaa !123
  store double %24, double* %16, align 8, !dbg !129, !tbaa !123
  store double %13, double* %19, align 8, !dbg !130, !tbaa !123
  store double %17, double* %23, align 8, !dbg !131, !tbaa !123
  br label %.preheader, !dbg !131

.preheader:                                       ; preds = %10, %5
  %25 = icmp slt i32 %j.04, %4, !dbg !132
  br i1 %25, label %._crit_edge, label %.lr.ph, !dbg !132

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %j.12 = phi i32 [ %26, %.lr.ph ], [ %j.04, %.preheader ]
  %k.01 = phi i32 [ %27, %.lr.ph ], [ %4, %.preheader ]
  %26 = sub nsw i32 %j.12, %k.01, !dbg !133
  tail call void @llvm.dbg.value(metadata !{i32 %26}, i64 0, metadata !24), !dbg !133
  %27 = ashr i32 %k.01, 1, !dbg !135
  tail call void @llvm.dbg.value(metadata !{i32 %27}, i64 0, metadata !29), !dbg !135
  %28 = icmp slt i32 %26, %27, !dbg !132
  br i1 %28, label %._crit_edge, label %.lr.ph, !dbg !132

._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %j.1.lcssa = phi i32 [ %j.04, %.preheader ], [ %26, %.lr.ph ]
  %k.0.lcssa = phi i32 [ %4, %.preheader ], [ %27, %.lr.ph ]
  %29 = add nsw i32 %j.1.lcssa, %k.0.lcssa, !dbg !136
  tail call void @llvm.dbg.value(metadata !{i32 %29}, i64 0, metadata !24), !dbg !136
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !117
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !117
  %exitcond = icmp eq i32 %lftr.wideiv, %2, !dbg !117
  br i1 %exitcond, label %._crit_edge8, label %5, !dbg !117
...
define void @FFT_transform(i32 %N, double* nocapture %data) #0 {
  ...
  tail call fastcc void @FFT_transform_internal(i32 %N, double* %data, i32 -1) #4, !dbg !139
  ret void, !dbg !140
}
...
; <label>:4                                       ; preds = %0
  %5 = tail call fastcc i32 @int_log2(i32 %1) #4, !dbg !147
...
; <label>:7                                       ; preds = %4
  tail call void @FFT_bitreverse(i32 %N, double* %data) #4, !dbg !150
...
; <label>:13                                      ; preds = %._crit_edge12, %.lr.ph16
  %bit.014 = phi i32 [ 0, %.lr.ph16 ], [ %100, %._crit_edge12 ]
  %dual.013 = phi i32 [ 1, %.lr.ph16 ], [ %101, %._crit_edge12 ]
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !56), !dbg !155
  tail call void @llvm.dbg.value(metadata !156, i64 0, metadata !59), !dbg !157
  %14 = sitofp i32 %dual.013 to double, !dbg !152
  %15 = fmul double %14, 2.000000e+00, !dbg !152
  %16 = fdiv double %11, %15, !dbg !152
  tail call void @llvm.dbg.value(metadata !{double %16}, i64 0, metadata !62), !dbg !152
  %17 = tail call double @sin(double %16) #5, !dbg !158
  tail call void @llvm.dbg.value(metadata !{double %17}, i64 0, metadata !63), !dbg !158
  %18 = fmul double %16, 5.000000e-01, !dbg !159
  %19 = tail call double @sin(double %18) #5, !dbg !159
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !64), !dbg !159
  %20 = fmul double %19, 2.000000e+00, !dbg !160
  %21 = fmul double %19, %20, !dbg !160
  tail call void @llvm.dbg.value(metadata !{double %21}, i64 0, metadata !65), !dbg !160
...
.lr.ph:                                           ; preds = %13
  %22 = shl i32 %dual.013, 1, !dbg !153
  %23 = sext i32 %22 to i64
  %24 = zext i32 %dual.013 to i64, !dbg !153
  br label %29, !dbg !153

.preheader:                                       ; preds = %29, %13
  %25 = icmp sgt i32 %dual.013, 1, !dbg !161
  br i1 %25, label %.lr.ph11, label %._crit_edge12, !dbg !161

.lr.ph11:                                         ; preds = %.preheader
  %26 = shl i32 %dual.013, 1, !dbg !161
  %27 = sext i32 %26 to i64
  %28 = zext i32 %dual.013 to i64, !dbg !161
  br label %57, !dbg !161

; <label>:29                                      ; preds = %.lr.ph, %29
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %29 ]
  %30 = trunc i64 %indvars.iv to i32, !dbg !162
  %31 = shl nsw i32 %30, 1, !dbg !162
  tail call void @llvm.dbg.value(metadata !{i32 %31}, i64 0, metadata !66), !dbg !162
  %32 = add nsw i64 %indvars.iv, %24, !dbg !163
  %33 = trunc i64 %32 to i32, !dbg !163
  %34 = shl nsw i32 %33, 1, !dbg !163
  tail call void @llvm.dbg.value(metadata !{i32 %34}, i64 0, metadata !69), !dbg !163
  %35 = sext i32 %34 to i64, !dbg !164
  %36 = getelementptr inbounds double* %data, i64 %35, !dbg !164
  %37 = load double* %36, align 8, !dbg !164, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %37}, i64 0, metadata !70), !dbg !164
  %38 = or i32 %34, 1, !dbg !165
  %39 = sext i32 %38 to i64, !dbg !165
  %40 = getelementptr inbounds double* %data, i64 %39, !dbg !165
  %41 = load double* %40, align 8, !dbg !165, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %41}, i64 0, metadata !71), !dbg !165
  %42 = sext i32 %31 to i64, !dbg !166
  %43 = getelementptr inbounds double* %data, i64 %42, !dbg !166
  %44 = load double* %43, align 8, !dbg !166, !tbaa !123
  %45 = fsub double %44, %37, !dbg !166
  store double %45, double* %36, align 8, !dbg !166, !tbaa !123
  %46 = or i32 %31, 1, !dbg !167
  %47 = sext i32 %46 to i64, !dbg !167
  %48 = getelementptr inbounds double* %data, i64 %47, !dbg !167
  %49 = load double* %48, align 8, !dbg !167, !tbaa !123
  %50 = fsub double %49, %41, !dbg !167
  store double %50, double* %40, align 8, !dbg !167, !tbaa !123
  %51 = load double* %43, align 8, !dbg !168, !tbaa !123
  %52 = fadd double %37, %51, !dbg !168
  store double %52, double* %43, align 8, !dbg !168, !tbaa !123
  %53 = load double* %48, align 8, !dbg !169, !tbaa !123
  %54 = fadd double %41, %53, !dbg !169
  store double %54, double* %48, align 8, !dbg !169, !tbaa !123
  %indvars.iv.next = add nsw i64 %indvars.iv, %23, !dbg !153
  %55 = trunc i64 %indvars.iv.next to i32, !dbg !153
  %56 = icmp slt i32 %55, %1, !dbg !153
  br i1 %56, label %29, label %.preheader, !dbg !153

; <label>:57                                      ; preds = %._crit_edge, %.lr.ph11
  %indvars.iv19 = phi i64 [ 1, %.lr.ph11 ], [ %indvars.iv.next20, %._crit_edge ]
  %w_real.010 = phi double [ 1.000000e+00, %.lr.ph11 ], [ %61, %._crit_edge ]
  %w_imag.09 = phi double [ 0.000000e+00, %.lr.ph11 ], [ %65, %._crit_edge ]
  %58 = fmul double %17, %w_imag.09, !dbg !170
  %59 = fsub double %w_real.010, %58, !dbg !170
  %60 = fmul double %21, %w_real.010, !dbg !170
  %61 = fsub double %59, %60, !dbg !170
  tail call void @llvm.dbg.value(metadata !{double %61}, i64 0, metadata !72), !dbg !170
  %62 = fmul double %17, %w_real.010, !dbg !171
  %63 = fadd double %w_imag.09, %62, !dbg !171
  %64 = fmul double %21, %w_imag.09, !dbg !171
  %65 = fsub double %63, %64, !dbg !171
  tail call void @llvm.dbg.value(metadata !{double %65}, i64 0, metadata !76), !dbg !171
  tail call void @llvm.dbg.value(metadata !{double %61}, i64 0, metadata !56), !dbg !172
  tail call void @llvm.dbg.value(metadata !{double %65}, i64 0, metadata !59), !dbg !173
  tail call void @llvm.dbg.value(metadata !102, i64 0, metadata !61), !dbg !174
  br i1 %12, label %.lr.ph7, label %._crit_edge, !dbg !174

.lr.ph7:                                          ; preds = %57, %.lr.ph7
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %.lr.ph7 ], [ 0, %57 ]
  %66 = add nsw i64 %indvars.iv17, %indvars.iv19, !dbg !175
  %67 = trunc i64 %66 to i32, !dbg !175
  %68 = shl nsw i32 %67, 1, !dbg !175
  tail call void @llvm.dbg.value(metadata !{i32 %68}, i64 0, metadata !77), !dbg !175
  %69 = add nsw i64 %66, %28, !dbg !176
  %70 = trunc i64 %69 to i32, !dbg !176
  %71 = shl nsw i32 %70, 1, !dbg !176
  tail call void @llvm.dbg.value(metadata !{i32 %71}, i64 0, metadata !80), !dbg !176
  %72 = sext i32 %71 to i64, !dbg !177
  %73 = getelementptr inbounds double* %data, i64 %72, !dbg !177
  %74 = load double* %73, align 8, !dbg !177, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %74}, i64 0, metadata !81), !dbg !177
  %75 = or i32 %71, 1, !dbg !178
  %76 = sext i32 %75 to i64, !dbg !178
  %77 = getelementptr inbounds double* %data, i64 %76, !dbg !178
  %78 = load double* %77, align 8, !dbg !178, !tbaa !123
  tail call void @llvm.dbg.value(metadata !{double %78}, i64 0, metadata !82), !dbg !178
  %79 = fmul double %61, %74, !dbg !179
  %80 = fmul double %65, %78, !dbg !179
  %81 = fsub double %79, %80, !dbg !179
  tail call void @llvm.dbg.value(metadata !{double %81}, i64 0, metadata !83), !dbg !179
  %82 = fmul double %61, %78, !dbg !180
  %83 = fmul double %65, %74, !dbg !180
  %84 = fadd double %83, %82, !dbg !180
  tail call void @llvm.dbg.value(metadata !{double %84}, i64 0, metadata !84), !dbg !180
  %85 = sext i32 %68 to i64, !dbg !181
  %86 = getelementptr inbounds double* %data, i64 %85, !dbg !181
  %87 = load double* %86, align 8, !dbg !181, !tbaa !123
  %88 = fsub double %87, %81, !dbg !181
  store double %88, double* %73, align 8, !dbg !181, !tbaa !123
  %89 = or i32 %68, 1, !dbg !182
  %90 = sext i32 %89 to i64, !dbg !182
  %91 = getelementptr inbounds double* %data, i64 %90, !dbg !182
  %92 = load double* %91, align 8, !dbg !182, !tbaa !123
  %93 = fsub double %92, %84, !dbg !182
  store double %93, double* %77, align 8, !dbg !182, !tbaa !123
  %94 = load double* %86, align 8, !dbg !183, !tbaa !123
  %95 = fadd double %81, %94, !dbg !183
  store double %95, double* %86, align 8, !dbg !183, !tbaa !123
  %96 = load double* %91, align 8, !dbg !184, !tbaa !123
  %97 = fadd double %84, %96, !dbg !184
  store double %97, double* %91, align 8, !dbg !184, !tbaa !123
  %indvars.iv.next18 = add nsw i64 %indvars.iv17, %27, !dbg !174
  %98 = trunc i64 %indvars.iv.next18 to i32, !dbg !174
  %99 = icmp slt i32 %98, %1, !dbg !174
  br i1 %99, label %.lr.ph7, label %._crit_edge, !dbg !174

._crit_edge:                                      ; preds = %.lr.ph7, %57
  %indvars.iv.next20 = add nuw nsw i64 %indvars.iv19, 1, !dbg !161
  %lftr.wideiv = trunc i64 %indvars.iv.next20 to i32, !dbg !161
  %exitcond = icmp eq i32 %lftr.wideiv, %dual.013, !dbg !161
  br i1 %exitcond, label %._crit_edge12, label %57, !dbg !161

._crit_edge12:                                    ; preds = %._crit_edge, %.preheader
  %100 = add nsw i32 %bit.014, 1, !dbg !151
  tail call void @llvm.dbg.value(metadata !{i32 %100}, i64 0, metadata !53), !dbg !151
  %101 = shl nsw i32 %dual.013, 1, !dbg !151
  tail call void @llvm.dbg.value(metadata !{i32 %101}, i64 0, metadata !55), !dbg !151
  %exitcond21 = icmp eq i32 %100, %5, !dbg !151
  br i1 %exitcond21, label %.loopexit, label %13, !dbg !151
...
define void @FFT_inverse(i32 %N, double* nocapture %data) #0 {
  ...
  tail call void @llvm.dbg.value(metadata !156, i64 0, metadata !43), !dbg !188
  tail call void @llvm.dbg.value(metadata !102, i64 0, metadata !44), !dbg !189
  tail call fastcc void @FFT_transform_internal(i32 %N, double* %data, i32 1) #4, !dbg !190
...
!154 = metadata !{double 1.000000e+00}
!155 = metadata !{i32 53, i32 0, metadata !57, null}
!156 = metadata !{double 0.000000e+00}
!157 = metadata !{i32 54, i32 0, metadata !57, null}
!158 = metadata !{i32 59, i32 0, metadata !57, null}
!159 = metadata !{i32 60, i32 0, metadata !57, null}
!160 = metadata !{i32 61, i32 0, metadata !57, null}
!161 = metadata !{i32 77, i32 0, metadata !75, null}
!162 = metadata !{i32 64, i32 0, metadata !67, null}
!163 = metadata !{i32 65, i32 0, metadata !67, null}
!164 = metadata !{i32 67, i32 0, metadata !67, null}
!165 = metadata !{i32 68, i32 0, metadata !67, null}
!166 = metadata !{i32 70, i32 0, metadata !67, null}
!167 = metadata !{i32 71, i32 0, metadata !67, null}
!168 = metadata !{i32 72, i32 0, metadata !67, null}
!169 = metadata !{i32 73, i32 0, metadata !67, null}
!170 = metadata !{i32 80, i32 0, metadata !73, null}
!171 = metadata !{i32 81, i32 0, metadata !73, null}
!172 = metadata !{i32 82, i32 0, metadata !73, null}
!173 = metadata !{i32 83, i32 0, metadata !73, null}
!174 = metadata !{i32 85, i32 0, metadata !79, null}
