...
; <label>:21                                      ; preds = %.loopexit, %.lr.ph3
  %22 = phi i32 [ 0, %.lr.ph3 ], [ %25, %.loopexit ], !dbg !185
  %indvars.iv4 = phi i64 [ 0, %.lr.ph3 ], [ %indvars.iv.next5, %.loopexit ]
  tail call void @llvm.dbg.value(metadata !{i32 %22}, i64 0, metadata !85), !dbg !185
  %23 = trunc i64 %indvars.iv4 to i32, !dbg !186
  %24 = sdiv i32 %23, %6, !dbg !186
  tail call void @llvm.dbg.value(metadata !{i32 %24}, i64 0, metadata !88), !dbg !186
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !187
  %25 = add nsw i32 %22, %6, !dbg !188
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1, !dbg !182
  %26 = getelementptr inbounds i32* %17, i64 %indvars.iv.next5, !dbg !188
  store i32 %25, i32* %26, align 4, !dbg !188, !tbaa !178
  %27 = icmp slt i32 %24, 1, !dbg !189
  tail call void @llvm.dbg.value(metadata !135, i64 0, metadata !88), !dbg !189
  %. = select i1 %27, i32 1, i32 %24, !dbg !189
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !89), !dbg !183
  br i1 %20, label %.lr.ph, label %.loopexit, !dbg !183

.lr.ph:                                           ; preds = %21
  %28 = sext i32 %22 to i64, !dbg !183
  br label %29, !dbg !183

; <label>:29                                      ; preds = %29, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %29 ]
  %30 = trunc i64 %indvars.iv to i32, !dbg !191
  %31 = mul nsw i32 %30, %., !dbg !191
  %32 = add nsw i64 %indvars.iv, %28, !dbg !191
  %33 = getelementptr inbounds i32* %12, i64 %32, !dbg !191
  store i32 %31, i32* %33, align 4, !dbg !191, !tbaa !178
  ...
  br i1 %exitcond, label %.loopexit, label %29, !dbg !183

.preheader:                                       ; preds = %0, %.loopexit, %.preheader
  %cycles.0 = phi i32 [ %36, %.preheader ], [ 1, %.loopexit ], [ 1, %0 ]
  tail call void @Stopwatch_start(%struct.Stopwatch_struct* %18) #5, !dbg !192
  %34 = shl nsw i32 %cycles.0, 6, !dbg !194
  tail call void @SparseCompRow_matmult(i32 %N, double* %5, double* %8, i32* %17, i32* %12, double* %1, i32 %34) #5, !dbg !194
  tail call void @Stopwatch_stop(%struct.Stopwatch_struct* %18) #5, !dbg !195
  %35 = icmp sgt i32 %cycles.0, 4096, !dbg !196
  %36 = shl nsw i32 %cycles.0, 1, !dbg !198
  tail call void @llvm.dbg.value(metadata !{i32 %36}, i64 0, metadata !83), !dbg !198
  br i1 %35, label %37, label %.preheader, !dbg !196

; <label>:37                                      ; preds = %.preheader
  %38 = tail call double @SparseCompRow_num_flops(i32 %N, i32 %nz, i32 8192) #5, !dbg !199
  %39 = tail call double @Stopwatch_read(%struct.Stopwatch_struct* %18) #5, !dbg !200
  %40 = fdiv double %38, %39, !dbg !200
  %41 = fmul double %40, 1.000000e-06, !dbg !200
  tail call void @llvm.dbg.value(metadata !{double %41}, i64 0, metadata !75), !dbg !200
  ...
  %42 = bitcast double* %8 to i8*, !dbg !204
  tail call void @free(i8* %42) #5, !dbg !204
  tail call void @free(i8* %4) #5, !dbg !205
  %43 = bitcast double* %1 to i8*, !dbg !206
  tail call void @free(i8* %43) #5, !dbg !206
  ret double %41, !dbg !207
}
