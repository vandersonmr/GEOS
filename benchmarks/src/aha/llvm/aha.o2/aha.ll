...
; <label>:7                                       ; preds = %2
  %8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str28, i64 0, i64 0), i32 %5) #5, !dbg !341
  br label %.loopexit, !dbg !341

; <label>:9                                       ; preds = %2
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str29, i64 0, i64 0), i32 %5) #5, !dbg !344
  br label %.loopexit
...
; <label>:14                                      ; preds = %11
  ...
  %22 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str31, i64 0, i64 0), i8* %21) #5, !dbg !352
...
; <label>:34                                      ; preds = %27
  ...
  %36 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str31, i64 0, i64 0), i8* %35) #5, !dbg !359
  br label %38, !dbg !359
...
.lr.ph7:                                          ; preds = %0, %._crit_edge
  ...
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str33, i64 0, i64 0), i8* %7, i32 %8) #5, !dbg !370
...
; <label>:21                                      ; preds = %16
  %22 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str28, i64 0, i64 0), i32 %19) #5, !dbg !380
  br label %32, !dbg !380

; <label>:23                                      ; preds = %16
  %24 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str29, i64 0, i64 0), i32 %19) #5, !dbg !382
  br label %32
...
; <label>:27                                      ; preds = %25
  %28 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str34, i64 0, i64 0)) #5, !dbg !383
  br label %32, !dbg !383

; <label>:29                                      ; preds = %25
  %30 = add nsw i32 %14, -11, !dbg !385
  %31 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str35, i64 0, i64 0), i32 %30) #5, !dbg !385
  br label %32
...
._crit_edge8:                                     ; preds = %._crit_edge, %0
  %44 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str38, i64 0, i64 0)) #5, !dbg !390
  %45 = load i32* @numi, align 4, !dbg !391, !tbaa !302
  %46 = add nsw i32 %45, 11, !dbg !391
  tail call void @print_expr(i32 %46), !dbg !391
...
; <label>:2                                       ; preds = %2, %0
  ...
  %23 = tail call i32 %22(i32 %7, i32 %12, i32 %17) #5, !dbg !407
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %76 = tail call i32 %75(i32 %60, i32 %65, i32 %70) #5, !dbg !440
...
; <label>:3                                       ; preds = %increment.exit, %0
  ...
  %4 = tail call i32 @check(i32 %i.0), !dbg !489
...
; <label>:6                                       ; preds = %3
  ...
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str39, i64 0, i64 0), i32 %8) #5, !dbg !495
  tail call void @print_pgm() #5, !dbg !496
...
; <label>:47                                      ; preds = %46
  ...
  tail call void @fix_operands(i32 %48) #5, !dbg !533
...
; <label>:51                                      ; preds = %49
  ...
  tail call void @fix_operands(i32 %52) #5, !dbg !544
...
; <label>:64                                      ; preds = %49
  ...
  tail call void @fix_operands(i32 %73) #5, !dbg !550
...
; <label>:1                                       ; preds = %0, %._crit_edge8
  ...
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str40, i64 0, i64 0), i32 %storemerge9) #5, !dbg !556
...
; <label>:5                                       ; preds = %5, %1
  ...
  %8 = tail call i32 @userfun(i32 %7) #5, !dbg !561
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  tail call void @fix_operands(i32 %19), !dbg !568
...
._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %23 = tail call i32 @search(), !dbg !569
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !180), !dbg !569
  %24 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @.str41, i64 0, i64 0), i32 %23) #5, !dbg !570
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !181), !dbg !571
  %25 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str42, i64 0, i64 0)) #5, !dbg !572
...
.lr.ph7:                                          ; preds = %._crit_edge, %.lr.ph7
  ...
  %30 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str43, i64 0, i64 0), i32 %29) #5, !dbg !575
...
._crit_edge8:                                     ; preds = %.lr.ph7, %._crit_edge
  ...
  %36 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str44, i64 0, i64 0), i32 %total.0.lcssa) #5, !dbg !578
