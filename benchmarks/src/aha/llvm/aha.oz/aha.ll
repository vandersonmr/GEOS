...
; <label>:13                                      ; preds = %11
  %putchar1 = tail call i32 @putchar(i32 120) #6, !dbg !345
...
; <label>:27                                      ; preds = %.lr.ph, %38
  ...
  tail call void @print_expr(i32 %29) #8, !dbg !362
...
; <label>:37                                      ; preds = %27
  %putchar = tail call i32 @putchar(i32 41) #6, !dbg !364
  br label %38
...
; <label>:37                                      ; preds = %32
  %putchar3 = tail call i32 @putchar(i32 44) #6, !dbg !386
...
._crit_edge:                                      ; preds = %38, %.lr.ph7
  %putchar2 = tail call i32 @putchar(i32 10) #6, !dbg !388
...
._crit_edge8:                                     ; preds = %._crit_edge, %0
  %44 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str38, i64 0, i64 0)) #7, !dbg !390
  %45 = load i32* @numi, align 4, !dbg !391, !tbaa !302
  %46 = add nsw i32 %45, 11, !dbg !391
  tail call void @print_expr(i32 %46) #8, !dbg !391
  %putchar = tail call i32 @putchar(i32 10) #6, !dbg !392
  ret void, !dbg !393
}
...
; <label>:1                                       ; preds = %1, %0
  %.0 = phi i32 [ %i, %0 ], [ %5, %1 ]
  tail call fastcc void @simulate_one_instruction(i32 %.0) #8, !dbg !397
...
; <label>:17                                      ; preds = %.thread
  %18 = icmp slt i32 %40, 16, !dbg !409
  br i1 %18, label %.preheader, label %.loopexit, !dbg !409

.preheader:                                       ; preds = %10, %17
  %19 = phi i32 [ %.lcssa7, %17 ], [ %2, %10 ], !dbg !411
  %kx.04 = phi i32 [ %40, %17 ], [ 0, %10 ]
  %20 = load i32* @check.itrialx, align 4, !dbg !411, !tbaa !302
  %21 = add nsw i32 %20, 1, !dbg !411
  %22 = icmp sgt i32 %20, 15, !dbg !413
  %. = select i1 %22, i32 0, i32 %21, !dbg !413
  store i32 %., i32* @check.itrialx, align 4, !dbg !413, !tbaa !302
  %23 = sext i32 %. to i64, !dbg !415
  %24 = getelementptr inbounds [17 x i32]* @trialx, i64 0, i64 %23, !dbg !415
  %25 = load i32* %24, align 4, !dbg !415, !tbaa !302
  store i32 %25, i32* getelementptr inbounds ([17 x i32]* @r, i64 0, i64 11), align 4, !dbg !415, !tbaa !302
  %26 = getelementptr inbounds [17 x i32]* @correct_result, i64 0, i64 %23, !dbg !416
  %27 = load i32* %26, align 4, !dbg !416, !tbaa !302
  store i32 %27, i32* @corr_result, align 4, !dbg !416, !tbaa !302
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !155), !dbg !417
  %28 = icmp sgt i32 %19, 0, !dbg !417
  br i1 %28, label %.lr.ph, label %.thread, !dbg !417

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %.13 = phi i32 [ %29, %.lr.ph ], [ 0, %.preheader ]
  tail call fastcc void @simulate_one_instruction(i32 %.13) #8, !dbg !419
  %29 = add nsw i32 %.13, 1, !dbg !417
  tail call void @llvm.dbg.value(metadata !{i32 %29}, i64 0, metadata !155), !dbg !417
  %30 = load i32* @numi, align 4, !dbg !417, !tbaa !302
  %31 = icmp slt i32 %29, %30, !dbg !417
  br i1 %31, label %.lr.ph, label %32, !dbg !417

; <label>:32                                      ; preds = %.lr.ph
  %.pre = load i32* @unacceptable, align 4, !dbg !421, !tbaa !302
  %phitmp = icmp eq i32 %.pre, 0, !dbg !417
  br i1 %phitmp, label %.thread, label %33, !dbg !421

; <label>:33                                      ; preds = %32
  store i32 0, i32* @unacceptable, align 4, !dbg !423, !tbaa !302
  br label %.loopexit, !dbg !423

.thread:                                          ; preds = %.preheader, %32
  %.lcssa7 = phi i32 [ %30, %32 ], [ %19, %.preheader ]
  %34 = add nsw i32 %.lcssa7, 11, !dbg !425
  %35 = sext i32 %34 to i64, !dbg !425
  %36 = getelementptr inbounds [17 x i32]* @r, i64 0, i64 %35, !dbg !425
  %37 = load i32* %36, align 4, !dbg !425, !tbaa !302
  %38 = load i32* @corr_result, align 4, !dbg !425, !tbaa !302
  %39 = icmp eq i32 %37, %38, !dbg !425
  %40 = add nsw i32 %kx.04, 1, !dbg !409
  tail call void @llvm.dbg.value(metadata !{i32 %40}, i64 0, metadata !156), !dbg !409
  br i1 %39, label %17, label %.loopexit, !dbg !425

.loopexit:                                        ; preds = %17, %.thread, %10, %33, %9
  %.01 = phi i32 [ 0, %9 ], [ 0, %33 ], [ 0, %10 ], [ 1, %17 ], [ 0, %.thread ]
  ret i32 %.01, !dbg !427
}
...
define void @fix_operands(i32 %i) #1 {
  ...
  br i1 %6, label %7, label %52, !dbg !439
...
; <label>:19                                      ; preds = %13, %7, %17
  ...
  br i1 %21, label %22, label %52, !dbg !449
...
; <label>:22                                      ; preds = %19
  ...
  br i1 %27, label %52, label %28, !dbg !449
...
; <label>:28                                      ; preds = %22
  ...
  br i1 %31, label %52, label %32, !dbg !449
...
; <label>:32                                      ; preds = %28
  ...
  %36 = icmp eq i32 %11, %20, !dbg !449
  %or.cond = or i1 %35, %36, !dbg !449
  br i1 %or.cond, label %52, label %37, !dbg !449

; <label>:37                                      ; preds = %32
  %38 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 2, !dbg !449
  %39 = load i32* %38, align 4, !dbg !449, !tbaa !302
  %40 = icmp eq i32 %39, %20, !dbg !449
  br i1 %40, label %52, label %41, !dbg !449

; <label>:41                                      ; preds = %37
  %42 = getelementptr inbounds [3 x i32]* %9, i64 0, i64 0, !dbg !451
  %43 = load i32* %42, align 4, !dbg !451, !tbaa !302
  %44 = icmp slt i32 %43, %20, !dbg !451
  br i1 %44, label %45, label %46, !dbg !451

; <label>:45                                      ; preds = %41
  store i32 %20, i32* %42, align 4, !dbg !451, !tbaa !302
  br label %52, !dbg !451

; <label>:46                                      ; preds = %41
  %47 = sext i32 %3 to i64, !dbg !454
  %48 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %47, i32 1, !dbg !454
  %49 = load i32* %48, align 8, !dbg !454, !tbaa !358
  %50 = icmp sgt i32 %49, 1, !dbg !454
  br i1 %50, label %51, label %52, !dbg !454
...
; <label>:52                                      ; preds = %37, %32, %28, %22, %19, %46, %51, %45, %0
  %53 = sext i32 %3 to i64, !dbg !456
  %54 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %53, i32 2, !dbg !456
  %55 = load i32* %54, align 4, !dbg !456, !tbaa !458
  %56 = icmp eq i32 %55, 0, !dbg !456
  br i1 %56, label %64, label %57, !dbg !456

; <label>:57                                      ; preds = %52
  %58 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 0, !dbg !459
  %59 = load i32* %58, align 4, !dbg !459, !tbaa !302
  %60 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 1, !dbg !459
  %61 = load i32* %60, align 4, !dbg !459, !tbaa !302
  %62 = icmp slt i32 %59, %61, !dbg !459
  br i1 %62, label %63, label %78, !dbg !459

; <label>:63                                      ; preds = %57
  store i32 %61, i32* %58, align 4, !dbg !462, !tbaa !302
  br label %78, !dbg !462

; <label>:64                                      ; preds = %52
  br i1 %6, label %78, label %65, !dbg !463

; <label>:65                                      ; preds = %64
  %66 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 0, !dbg !465
  %67 = load i32* %66, align 4, !dbg !465, !tbaa !302
  %68 = icmp slt i32 %67, 11, !dbg !465
  br i1 %68, label %69, label %78, !dbg !465

; <label>:69                                      ; preds = %65
  %70 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 1, !dbg !465
  %71 = load i32* %70, align 4, !dbg !465, !tbaa !302
  %72 = icmp slt i32 %71, 11, !dbg !465
  br i1 %72, label %73, label %78, !dbg !465

; <label>:73                                      ; preds = %69
  %74 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %1, i32 1, i64 2, !dbg !465
  %75 = load i32* %74, align 4, !dbg !465, !tbaa !302
  %76 = icmp slt i32 %75, 11, !dbg !465
  br i1 %76, label %77, label %78, !dbg !465

; <label>:77                                      ; preds = %73
  store i32 11, i32* %66, align 4, !dbg !468, !tbaa !302
  br label %78, !dbg !470
...
; Function Attrs: minsize nounwind optsize uwtable
define i32 @search() #1 {
  %1 = load i32* getelementptr inbounds ([17 x i32]* @trialx, i64 0, i64 0), align 16, !dbg !472, !tbaa !302
  store i32 %1, i32* getelementptr inbounds ([17 x i32]* @r, i64 0, i64 11), align 4, !dbg !472, !tbaa !302
  %2 = load i32* getelementptr inbounds ([17 x i32]* @correct_result, i64 0, i64 0), align 16, !dbg !473, !tbaa !302
  store i32 %2, i32* @corr_result, align 4, !dbg !473, !tbaa !302
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !169), !dbg !474
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !168), !dbg !475
  br label %3, !dbg !476
...
; <label>:3                                       ; preds = %increment.exit, %0
  ...
  %4 = tail call i32 @check(i32 %i.0) #8, !dbg !477
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !167), !dbg !477
  %5 = icmp eq i32 %4, 0, !dbg !479
  br i1 %5, label %11, label %6, !dbg !479

; <label>:6                                       ; preds = %3
  %7 = add nsw i32 %num_solutions.0, 1, !dbg !481
  tail call void @llvm.dbg.value(metadata !{i32 %7}, i64 0, metadata !169), !dbg !481
  %8 = load i32* @numi, align 4, !dbg !483, !tbaa !302
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([32 x i8]* @.str39, i64 0, i64 0), i32 %8) #7, !dbg !483
  tail call void @print_pgm() #7, !dbg !484
  %10 = icmp eq i32 %7, 5, !dbg !485
  br i1 %10, label %increment.exit.thread, label %11, !dbg !485

; <label>:11                                      ; preds = %3, %6
  %num_solutions.1 = phi i32 [ %7, %6 ], [ %num_solutions.0, %3 ]
  %12 = load i32* @numi, align 4, !dbg !487, !tbaa !302
  %13 = icmp sgt i32 %12, 0, !dbg !487
  br i1 %13, label %.lr.ph28.i, label %increment.exit.thread, !dbg !487
...
; <label>:15                                      ; preds = %64, %.lr.ph28.i
  ...
  %indvars.iv.next65.i = add nsw i64 %indvars.iv64.i, -1, !dbg !487
  %i.027.i = add nsw i32 %i.027.in.i, -1, !dbg !487
  %16 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 0, !dbg !490
  %17 = load i32* %16, align 16, !dbg !490, !tbaa !350
  tail call void @llvm.dbg.value(metadata !{i32 %17}, i64 0, metadata !492) #6, !dbg !490
  %18 = sext i32 %17 to i64, !dbg !493
  %19 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %18, i32 1, !dbg !493
  %20 = load i32* %19, align 8, !dbg !493, !tbaa !358
  tail call void @llvm.dbg.value(metadata !{i32 %20}, i64 0, metadata !494) #6, !dbg !493
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !495) #6, !dbg !496
  %21 = icmp sgt i32 %20, 0, !dbg !496
  br i1 %21, label %.lr.ph.i, label %..loopexit1_crit_edge.i, !dbg !496

.lr.ph.i:                                         ; preds = %15
  %22 = add nsw i32 %i.027.in.i, 10, !dbg !498
  br label %23, !dbg !496

; <label>:23                                      ; preds = %39, %.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %39 ]
  %24 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 %indvars.iv.i, !dbg !503
  %25 = load i32* %24, align 4, !dbg !503, !tbaa !302
  tail call void @llvm.dbg.value(metadata !{i32 %25}, i64 0, metadata !504) #6, !dbg !503
  %26 = icmp slt i32 %25, 6, !dbg !505
  br i1 %26, label %27, label %30, !dbg !505

; <label>:27                                      ; preds = %23
  %28 = trunc i64 %indvars.iv.i to i32, !dbg !506
  %29 = add nsw i32 %25, 1, !dbg !506
  store i32 %29, i32* %24, align 4, !dbg !506, !tbaa !302
  br label %.loopexit.i, !dbg !508

; <label>:30                                      ; preds = %23
  %31 = icmp eq i32 %25, 6, !dbg !509
  br i1 %31, label %32, label %34, !dbg !509

; <label>:32                                      ; preds = %30
  %33 = trunc i64 %indvars.iv.i to i32, !dbg !510
  store i32 11, i32* %24, align 4, !dbg !510, !tbaa !302
  br label %.loopexit.i, !dbg !512

; <label>:34                                      ; preds = %30
  %35 = icmp slt i32 %25, %22, !dbg !498
  br i1 %35, label %36, label %39, !dbg !498

; <label>:36                                      ; preds = %34
  %37 = trunc i64 %indvars.iv.i to i32, !dbg !513
  %38 = add nsw i32 %25, 1, !dbg !513
  store i32 %38, i32* %24, align 4, !dbg !513, !tbaa !302
  br label %.loopexit.i, !dbg !515

; <label>:39                                      ; preds = %34
  %40 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %18, i32 3, i64 %indvars.iv.i, !dbg !516
  %41 = load i32* %40, align 4, !dbg !516, !tbaa !302
  store i32 %41, i32* %24, align 4, !dbg !516, !tbaa !302
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !496
  %42 = trunc i64 %indvars.iv.next.i to i32, !dbg !496
  %43 = icmp slt i32 %42, %20, !dbg !496
  br i1 %43, label %23, label %.loopexit.i, !dbg !496

.loopexit.i:                                      ; preds = %39, %36, %32, %27
  %44 = phi i1 [ true, %36 ], [ true, %32 ], [ true, %27 ], [ false, %39 ]
  %j.05.i = phi i32 [ %37, %36 ], [ %33, %32 ], [ %28, %27 ], [ %42, %39 ]
  %45 = icmp eq i32 %j.05.i, 0, !dbg !517
  br i1 %45, label %..loopexit1_crit_edge.i, label %46, !dbg !517

; <label>:46                                      ; preds = %.loopexit.i
  br i1 %44, label %47, label %49, !dbg !519

; <label>:47                                      ; preds = %46
  %48 = trunc i64 %indvars.iv.next65.i to i32, !dbg !521
  tail call void @fix_operands(i32 %48) #7, !dbg !521
  br label %increment.exit, !dbg !523

; <label>:49                                      ; preds = %46
  %50 = icmp slt i32 %17, 12, !dbg !524
  br i1 %50, label %51, label %64, !dbg !524

; <label>:51                                      ; preds = %49
  %52 = trunc i64 %indvars.iv.next65.i to i32, !dbg !526
  %53 = add nsw i32 %17, 1, !dbg !526
  tail call void @llvm.dbg.value(metadata !{i32 %53}, i64 0, metadata !492) #6, !dbg !526
  store i32 %53, i32* %16, align 16, !dbg !528, !tbaa !350
  %54 = sext i32 %53 to i64, !dbg !529
  %55 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %54, i32 3, i64 0, !dbg !529
  %56 = load i32* %55, align 8, !dbg !529, !tbaa !302
  %57 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 0, !dbg !529
  store i32 %56, i32* %57, align 4, !dbg !529, !tbaa !302
  %58 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %54, i32 3, i64 1, !dbg !530
  %59 = load i32* %58, align 4, !dbg !530, !tbaa !302
  %60 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 1, !dbg !530
  store i32 %59, i32* %60, align 4, !dbg !530, !tbaa !302
  %61 = getelementptr inbounds [13 x %struct.anon]* @isa, i64 0, i64 %54, i32 3, i64 2, !dbg !531
  %62 = load i32* %61, align 8, !dbg !531, !tbaa !302
  %63 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 2, !dbg !531
  store i32 %62, i32* %63, align 4, !dbg !531, !tbaa !302
  tail call void @fix_operands(i32 %52) #7, !dbg !532
  br label %increment.exit, !dbg !533

; <label>:64                                      ; preds = %49
  store i32 0, i32* %16, align 16, !dbg !534, !tbaa !350
  %65 = load i64* bitcast (i32* getelementptr inbounds ([13 x %struct.anon]* @isa, i64 0, i64 0, i32 3, i64 0) to i64*), align 16, !dbg !535
  %66 = trunc i64 %65 to i32, !dbg !535
  %67 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 0, !dbg !535
  store i32 %66, i32* %67, align 4, !dbg !535, !tbaa !302
  %68 = lshr i64 %65, 32
  %69 = trunc i64 %68 to i32
  %70 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 1, !dbg !536
  store i32 %69, i32* %70, align 4, !dbg !536, !tbaa !302
  %71 = load i32* getelementptr inbounds ([13 x %struct.anon]* @isa, i64 0, i64 0, i32 3, i64 2), align 8, !dbg !537, !tbaa !302
  %72 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv.next65.i, i32 1, i64 2, !dbg !537
  store i32 %71, i32* %72, align 4, !dbg !537, !tbaa !302
  %73 = trunc i64 %indvars.iv.next65.i to i32, !dbg !538
  tail call void @fix_operands(i32 %73) #7, !dbg !538
  %74 = icmp sgt i32 %73, 0, !dbg !487
  br i1 %74, label %15, label %increment.exit.thread, !dbg !487

..loopexit1_crit_edge.i:                          ; preds = %.loopexit.i, %15
  %75 = trunc i64 %indvars.iv.next65.i to i32, !dbg !517
  br label %increment.exit, !dbg !517

increment.exit:                                   ; preds = %47, %51, %..loopexit1_crit_edge.i
  %.0.i = phi i32 [ %48, %47 ], [ %52, %51 ], [ %75, %..loopexit1_crit_edge.i ]
  tail call void @llvm.dbg.value(metadata !{i32 %.0.i}, i64 0, metadata !168), !dbg !489
  %76 = icmp sgt i32 %.0.i, -1, !dbg !539
  br i1 %76, label %3, label %increment.exit.thread, !dbg !539
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #1 {
  tail call void @llvm.dbg.value(metadata !{i32 %argc}, i64 0, metadata !177), !dbg !541
  tail call void @llvm.dbg.value(metadata !{i8** %argv}, i64 0, metadata !178), !dbg !541
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !180), !dbg !542
  store i32 1, i32* @numi, align 4, !dbg !543, !tbaa !302
  br label %1, !dbg !543

; <label>:1                                       ; preds = %0, %._crit_edge8
  %storemerge9 = phi i32 [ 1, %0 ], [ %38, %._crit_edge8 ]
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str40, i64 0, i64 0), i32 %storemerge9) #7, !dbg !544
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !179), !dbg !545
  br label %5, !dbg !545

.preheader:                                       ; preds = %5
  %3 = load i32* @numi, align 4, !dbg !547, !tbaa !302
  %4 = icmp sgt i32 %3, 0, !dbg !547
  br i1 %4, label %.lr.ph, label %._crit_edge, !dbg !547

; <label>:5                                       ; preds = %5, %1
  %indvars.iv = phi i64 [ 0, %1 ], [ %indvars.iv.next, %5 ]
  %6 = getelementptr inbounds [17 x i32]* @trialx, i64 0, i64 %indvars.iv, !dbg !549
  %7 = load i32* %6, align 4, !dbg !549, !tbaa !302
  %8 = tail call i32 @userfun(i32 %7) #7, !dbg !549
  %9 = getelementptr inbounds [17 x i32]* @correct_result, i64 0, i64 %indvars.iv, !dbg !549
  store i32 %8, i32* %9, align 4, !dbg !549, !tbaa !302
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !545
  %exitcond = icmp eq i64 %indvars.iv.next, 17, !dbg !545
  br i1 %exitcond, label %.preheader, label %5, !dbg !545

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %.lr.ph ], [ 0, %.preheader ]
  %10 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv10, i32 0, !dbg !551
  store i32 0, i32* %10, align 16, !dbg !551, !tbaa !350
  %11 = load i64* bitcast (i32* getelementptr inbounds ([13 x %struct.anon]* @isa, i64 0, i64 0, i32 3, i64 0) to i64*), align 16, !dbg !553
  %12 = trunc i64 %11 to i32, !dbg !553
  %13 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv10, i32 1, i64 0, !dbg !553
  store i32 %12, i32* %13, align 4, !dbg !553, !tbaa !302
  %14 = lshr i64 %11, 32
  %15 = trunc i64 %14 to i32
  %16 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv10, i32 1, i64 1, !dbg !554
  store i32 %15, i32* %16, align 4, !dbg !554, !tbaa !302
  %17 = load i32* getelementptr inbounds ([13 x %struct.anon]* @isa, i64 0, i64 0, i32 3, i64 2), align 8, !dbg !555, !tbaa !302
  %18 = getelementptr inbounds [5 x %struct.anon.0]* @pgm, i64 0, i64 %indvars.iv10, i32 1, i64 2, !dbg !555
  store i32 %17, i32* %18, align 4, !dbg !555, !tbaa !302
  %19 = trunc i64 %indvars.iv10 to i32, !dbg !556
  tail call void @fix_operands(i32 %19) #8, !dbg !556
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1, !dbg !547
  %20 = load i32* @numi, align 4, !dbg !547, !tbaa !302
  %21 = trunc i64 %indvars.iv.next11 to i32, !dbg !547
  %22 = icmp slt i32 %21, %20, !dbg !547
  br i1 %22, label %.lr.ph, label %._crit_edge, !dbg !547

._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %23 = tail call i32 @search() #8, !dbg !557
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !180), !dbg !557
  %24 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @.str41, i64 0, i64 0), i32 %23) #7, !dbg !558
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !181), !dbg !559
  %25 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str42, i64 0, i64 0)) #7, !dbg !560
  tail call void @llvm.dbg.value(metadata !264, i64 0, metadata !179), !dbg !561
  %26 = load i32* @numi, align 4, !dbg !561, !tbaa !302
  %27 = icmp sgt i32 %26, 0, !dbg !561
  br i1 %27, label %.lr.ph7, label %._crit_edge8, !dbg !561
...
.lr.ph7:                                          ; preds = %._crit_edge, %.lr.ph7
  ...
  %28 = getelementptr inbounds [5 x i32]* @counter, i64 0, i64 %indvars.iv12, !dbg !563
  %29 = load i32* %28, align 4, !dbg !563, !tbaa !302
  %30 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str43, i64 0, i64 0), i32 %29) #7, !dbg !563
  %31 = load i32* %28, align 4, !dbg !565, !tbaa !302
  %32 = add i32 %31, %total.05, !dbg !565
  tail call void @llvm.dbg.value(metadata !{i32 %32}, i64 0, metadata !181), !dbg !565
  %indvars.iv.next13 = add nuw nsw i64 %indvars.iv12, 1, !dbg !561
  %33 = load i32* @numi, align 4, !dbg !561, !tbaa !302
  %34 = trunc i64 %indvars.iv.next13 to i32, !dbg !561
  %35 = icmp slt i32 %34, %33, !dbg !561
  br i1 %35, label %.lr.ph7, label %._crit_edge8, !dbg !561

._crit_edge8:                                     ; preds = %.lr.ph7, %._crit_edge
  %total.0.lcssa = phi i32 [ 0, %._crit_edge ], [ %32, %.lr.ph7 ]
  %36 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str44, i64 0, i64 0), i32 %total.0.lcssa) #7, !dbg !566
  %37 = load i32* @numi, align 4, !dbg !543, !tbaa !302
  %38 = add nsw i32 %37, 1, !dbg !543
  %phitmp = icmp eq i32 %23, 0, !dbg !543
  store i32 %38, i32* @numi, align 4, !dbg !543, !tbaa !302
  %39 = icmp slt i32 %38, 6, !dbg !543
  %or.cond = and i1 %39, %phitmp, !dbg !543
  br i1 %or.cond, label %1, label %.critedge, !dbg !543
...
attributes #3 = { inlinehint minsize nounwind optsize uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #4 = { minsize optsize "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!468 = metadata !{i32 275, i32 0, metadata !469, null}
!469 = metadata !{i32 786443, metadata !1, metadata !466, i32 273, i32 0, i32 68} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!470 = metadata !{i32 276, i32 0, metadata !469, null}
!471 = metadata !{i32 278, i32 0, metadata !157, null}
!472 = metadata !{i32 399, i32 0, metadata !163, null}
!473 = metadata !{i32 400, i32 0, metadata !163, null}
!474 = metadata !{i32 406, i32 0, metadata !163, null}
!475 = metadata !{i32 407, i32 0, metadata !163, null}
!476 = metadata !{i32 408, i32 0, metadata !163, null}
!477 = metadata !{i32 409, i32 0, metadata !478, null}
!478 = metadata !{i32 786443, metadata !1, metadata !163, i32 408, i32 0, i32 70} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!479 = metadata !{i32 410, i32 0, metadata !480, null}
!480 = metadata !{i32 786443, metadata !1, metadata !478, i32 410, i32 0, i32 71} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!481 = metadata !{i32 411, i32 0, metadata !482, null}
!482 = metadata !{i32 786443, metadata !1, metadata !480, i32 410, i32 0, i32 72} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!483 = metadata !{i32 412, i32 0, metadata !482, null}
!484 = metadata !{i32 413, i32 0, metadata !482, null}
!485 = metadata !{i32 414, i32 0, metadata !486, null}
!486 = metadata !{i32 786443, metadata !1, metadata !482, i32 414, i32 0, i32 73} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!487 = metadata !{i32 320, i32 0, metadata !488, metadata !489}
!488 = metadata !{i32 786443, metadata !1, metadata !186, i32 320, i32 0, i32 84} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!489 = metadata !{i32 416, i32 11, metadata !478, null}
!490 = metadata !{i32 321, i32 0, metadata !491, metadata !489}
!491 = metadata !{i32 786443, metadata !1, metadata !488, i32 320, i32 0, i32 85} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!492 = metadata !{i32 786688, metadata !186, metadata !"k", metadata !134, i32 318, metadata !9, i32 0, metadata !489} ; [ DW_TAG_auto_variable ] [k] [line 318]
!493 = metadata !{i32 322, i32 0, metadata !491, metadata !489}
!494 = metadata !{i32 786688, metadata !186, metadata !"nopnds", metadata !134, i32 318, metadata !9, i32 0, metadata !489} ; [ DW_TAG_auto_variable ] [nopnds] [line 318]
!495 = metadata !{i32 786688, metadata !186, metadata !"j", metadata !134, i32 318, metadata !9, i32 0, metadata !489} ; [ DW_TAG_auto_variable ] [j] [line 318]
!496 = metadata !{i32 323, i32 0, metadata !497, metadata !489}
!497 = metadata !{i32 786443, metadata !1, metadata !491, i32 323, i32 0, i32 86} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!498 = metadata !{i32 334, i32 0, metadata !499, metadata !489}
!499 = metadata !{i32 786443, metadata !1, metadata !500, i32 334, i32 0, i32 92} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!500 = metadata !{i32 786443, metadata !1, metadata !501, i32 330, i32 0, i32 90} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!501 = metadata !{i32 786443, metadata !1, metadata !502, i32 326, i32 0, i32 88} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!502 = metadata !{i32 786443, metadata !1, metadata !497, i32 323, i32 0, i32 87} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!503 = metadata !{i32 324, i32 0, metadata !502, metadata !489}
!504 = metadata !{i32 786688, metadata !186, metadata !"opndj", metadata !134, i32 318, metadata !9, i32 0, metadata !489} ; [ DW_TAG_auto_variable ] [opndj] [line 318]
!505 = metadata !{i32 326, i32 0, metadata !501, metadata !489}
!506 = metadata !{i32 327, i32 0, metadata !507, metadata !489}
!507 = metadata !{i32 786443, metadata !1, metadata !501, i32 326, i32 0, i32 89} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!508 = metadata !{i32 328, i32 0, metadata !507, metadata !489}
!509 = metadata !{i32 330, i32 0, metadata !500, metadata !489}
!510 = metadata !{i32 331, i32 0, metadata !511, metadata !489}
!511 = metadata !{i32 786443, metadata !1, metadata !500, i32 330, i32 0, i32 91} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!512 = metadata !{i32 332, i32 0, metadata !511, metadata !489}
!513 = metadata !{i32 335, i32 0, metadata !514, metadata !489}
!514 = metadata !{i32 786443, metadata !1, metadata !499, i32 334, i32 0, i32 93} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!515 = metadata !{i32 336, i32 0, metadata !514, metadata !489}
!516 = metadata !{i32 339, i32 0, metadata !502, metadata !489}
!517 = metadata !{i32 344, i32 0, metadata !518, metadata !489}
!518 = metadata !{i32 786443, metadata !1, metadata !491, i32 344, i32 0, i32 94} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!519 = metadata !{i32 347, i32 0, metadata !520, metadata !489}
!520 = metadata !{i32 786443, metadata !1, metadata !491, i32 347, i32 0, i32 95} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!521 = metadata !{i32 357, i32 0, metadata !522, metadata !489}
...
!523 = metadata !{i32 358, i32 0, metadata !522, metadata !489}
!524 = metadata !{i32 364, i32 0, metadata !525, metadata !489}
!525 = metadata !{i32 786443, metadata !1, metadata !491, i32 364, i32 0, i32 97} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!526 = metadata !{i32 365, i32 0, metadata !527, metadata !489}
...
!528 = metadata !{i32 366, i32 0, metadata !527, metadata !489}
!529 = metadata !{i32 367, i32 0, metadata !527, metadata !489}
!530 = metadata !{i32 368, i32 0, metadata !527, metadata !489}
!531 = metadata !{i32 369, i32 0, metadata !527, metadata !489}
!532 = metadata !{i32 371, i32 0, metadata !527, metadata !489}
!533 = metadata !{i32 372, i32 0, metadata !527, metadata !489}
!534 = metadata !{i32 380, i32 0, metadata !491, metadata !489}
!535 = metadata !{i32 381, i32 0, metadata !491, metadata !489}
!536 = metadata !{i32 382, i32 0, metadata !491, metadata !489}
!537 = metadata !{i32 383, i32 0, metadata !491, metadata !489}
!538 = metadata !{i32 385, i32 0, metadata !491, metadata !489}
!539 = metadata !{i32 417, i32 0, metadata !478, null}
!540 = metadata !{i32 419, i32 0, metadata !163, null}
!541 = metadata !{i32 423, i32 0, metadata !170, null}
!542 = metadata !{i32 424, i32 0, metadata !170, null}
!543 = metadata !{i32 426, i32 0, metadata !185, null}
!544 = metadata !{i32 427, i32 0, metadata !184, null}
!545 = metadata !{i32 431, i32 0, metadata !546, null}
!546 = metadata !{i32 786443, metadata !1, metadata !184, i32 431, i32 0, i32 76} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!547 = metadata !{i32 444, i32 0, metadata !548, null}
!548 = metadata !{i32 786443, metadata !1, metadata !184, i32 444, i32 0, i32 78} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!549 = metadata !{i32 433, i32 0, metadata !550, null}
!550 = metadata !{i32 786443, metadata !1, metadata !546, i32 431, i32 0, i32 77} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!551 = metadata !{i32 445, i32 0, metadata !552, null}
!552 = metadata !{i32 786443, metadata !1, metadata !548, i32 444, i32 0, i32 79} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!553 = metadata !{i32 446, i32 0, metadata !552, null}
!554 = metadata !{i32 447, i32 0, metadata !552, null}
!555 = metadata !{i32 448, i32 0, metadata !552, null}
!556 = metadata !{i32 453, i32 0, metadata !552, null}
!557 = metadata !{i32 457, i32 0, metadata !184, null}
!558 = metadata !{i32 459, i32 0, metadata !184, null}
!559 = metadata !{i32 461, i32 0, metadata !182, null}
!560 = metadata !{i32 462, i32 0, metadata !182, null}
!561 = metadata !{i32 463, i32 0, metadata !562, null}
!562 = metadata !{i32 786443, metadata !1, metadata !182, i32 463, i32 0, i32 82} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!563 = metadata !{i32 464, i32 0, metadata !564, null}
!564 = metadata !{i32 786443, metadata !1, metadata !562, i32 463, i32 0, i32 83} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/aha/aha.c]
!565 = metadata !{i32 465, i32 0, metadata !564, null}
!566 = metadata !{i32 467, i32 0, metadata !182, null}
!567 = metadata !{i32 470, i32 0, metadata !170, null}
