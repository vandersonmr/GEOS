...
define i32 @main(i32 %argc, i8** nocapture readonly %argv) #1 {
  ...
  br i1 %1, label %2, label %7, !dbg !42

; <label>:2                                       ; preds = %0
  %3 = getelementptr inbounds i8** %argv, i64 1, !dbg !43
  %4 = load i8** %3, align 8, !dbg !43, !tbaa !44
  tail call void @llvm.dbg.value(metadata !{i8* %4}, i64 0, metadata !48) #4, !dbg !49
  %5 = tail call i64 @strtol(i8* nocapture %4, i8** null, i32 10) #4, !dbg !50
  %6 = trunc i64 %5 to i32, !dbg !50
  br label %7, !dbg !43

; <label>:7                                       ; preds = %0, %2
  %8 = phi i32 [ %6, %2 ], [ 8, %0 ], !dbg !43
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !21), !dbg !43
  %9 = tail call i32 @Ack(i32 3, i32 %8), !dbg !52
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %8, i32 %9) #4, !dbg !52
  ret i32 0, !dbg !53
}
...
!48 = metadata !{i32 786689, metadata !22, metadata !"__nptr", metadata !24, i32 16777494, metadata !27, i32 0, metadata !43} ; [ DW_TAG_arg_variable ] [__nptr] [line 278]
!49 = metadata !{i32 278, i32 0, metadata !22, metadata !43}
!50 = metadata !{i32 280, i32 0, metadata !51, metadata !43}
...
!52 = metadata !{i32 20, i32 0, metadata !12, null}
!53 = metadata !{i32 21, i32 0, metadata !12, null}
