...
define void @Bubble(i32 %run) #0 {
  ...
  store i64 74755, i64* @seed, align 8, !dbg !136, !tbaa !111
  store i32 0, i32* @biggest, align 4, !dbg !139, !tbaa !121
  store i32 0, i32* @littlest, align 4, !dbg !139, !tbaa !121
  tail call void @llvm.dbg.value(metadata !123, i64 0, metadata !140), !dbg !141
  br label %1, !dbg !141

; <label>:1                                       ; preds = %17, %0
  %2 = phi i32 [ 0, %0 ], [ %18, %17 ]
  %3 = phi i32 [ 0, %0 ], [ %19, %17 ], !dbg !142
  %indvars.iv.i = phi i64 [ 1, %0 ], [ %indvars.iv.next.i, %17 ]
  %4 = phi i64 [ 74755, %0 ], [ %7, %17 ], !dbg !142
  %5 = mul nsw i64 %4, 1309, !dbg !142
  %6 = add nsw i64 %5, 13849, !dbg !142
  %7 = and i64 %6, 65535, !dbg !142
  tail call void @llvm.dbg.value(metadata !{i64 %7}, i64 0, metadata !144), !dbg !143
  %8 = urem i64 %7, 100000, !dbg !145
  %9 = add nsw i64 %8, 4294917296, !dbg !145
  %10 = trunc i64 %9 to i32, !dbg !145
  %11 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv.i, !dbg !145
  store i32 %10, i32* %11, align 4, !dbg !145, !tbaa !121
  %12 = icmp sgt i32 %10, %3, !dbg !146
  br i1 %12, label %13, label %14, !dbg !146

; <label>:13                                      ; preds = %1
  store i32 %10, i32* @biggest, align 4, !dbg !146, !tbaa !121
  br label %17, !dbg !146

; <label>:14                                      ; preds = %1
  %15 = icmp slt i32 %10, %2, !dbg !147
  br i1 %15, label %16, label %17, !dbg !147

; <label>:16                                      ; preds = %14
  store i32 %10, i32* @littlest, align 4, !dbg !147, !tbaa !121
  br label %17, !dbg !147

; <label>:17                                      ; preds = %16, %14, %13
  %18 = phi i32 [ %2, %13 ], [ %10, %16 ], [ %2, %14 ]
  %19 = phi i32 [ %10, %13 ], [ %3, %16 ], [ %3, %14 ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !141
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 501, !dbg !141
  br i1 %exitcond.i, label %bInitarr.exit, label %1, !dbg !141

bInitarr.exit:                                    ; preds = %17
  store i64 %7, i64* @seed, align 8, !dbg !142, !tbaa !111
  store i32 500, i32* @top, align 4, !dbg !148, !tbaa !121
  br label %.lr.ph, !dbg !150

.lr.ph:                                           ; preds = %._crit_edge, %bInitarr.exit
  %indvars.iv5 = phi i32 [ 500, %bInitarr.exit ], [ %indvars.iv.next6, %._crit_edge ]
  %.pre = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !151, !tbaa !121
  br label %20, !dbg !154

; <label>:20                                      ; preds = %.backedge, %.lr.ph
  %21 = phi i32 [ %.pre, %.lr.ph ], [ %27, %.backedge ], !dbg !151
  %indvars.iv = phi i64 [ 1, %.lr.ph ], [ %indvars.iv.next, %.backedge ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !154
  %22 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv.next, !dbg !151
  %23 = load i32* %22, align 4, !dbg !151, !tbaa !121
  %24 = icmp sgt i32 %21, %23, !dbg !151
  br i1 %24, label %25, label %.backedge, !dbg !151

; <label>:25                                      ; preds = %20
  %26 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv, !dbg !151
  tail call void @llvm.dbg.value(metadata !{i32 %21}, i64 0, metadata !23), !dbg !155
  store i32 %23, i32* %26, align 4, !dbg !157, !tbaa !121
  store i32 %21, i32* %22, align 4, !dbg !158, !tbaa !121
  br label %.backedge, !dbg !159

.backedge:                                        ; preds = %25, %20
  %27 = phi i32 [ %21, %25 ], [ %23, %20 ]
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32, !dbg !154
  %exitcond = icmp eq i32 %lftr.wideiv, %indvars.iv5, !dbg !154
  br i1 %exitcond, label %._crit_edge, label %20, !dbg !154

._crit_edge:                                      ; preds = %.backedge
  %indvars.iv.next6 = add nsw i32 %indvars.iv5, -1, !dbg !150
  %28 = icmp sgt i32 %indvars.iv.next6, 1, !dbg !150
  br i1 %28, label %.lr.ph, label %29, !dbg !150

; <label>:29                                      ; preds = %._crit_edge
  store i32 1, i32* @top, align 4, !dbg !154, !tbaa !121
  %30 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !160, !tbaa !121
  %31 = icmp eq i32 %30, %18, !dbg !160
  %32 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 500), align 16
  %33 = icmp eq i32 %32, %19, !dbg !160
  %or.cond = and i1 %31, %33, !dbg !160
  br i1 %or.cond, label %35, label %34, !dbg !160

; <label>:34                                      ; preds = %29
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)), !dbg !162
  br label %35, !dbg !162

; <label>:35                                      ; preds = %29, %34
  %36 = add nsw i32 %run, 1, !dbg !163
  %37 = sext i32 %36 to i64, !dbg !163
  %38 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %37, !dbg !163
  %39 = load i32* %38, align 4, !dbg !163, !tbaa !121
  %40 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %39) #3, !dbg !163
  ret void, !dbg !164
}
...
; <label>:1                                       ; preds = %1, %0
  ...
  tail call void @Bubble(i32 %i.01), !dbg !166
  %2 = add nsw i32 %i.01, 1, !dbg !166
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !26), !dbg !166
  %exitcond = icmp eq i32 %2, 100, !dbg !166
  br i1 %exitcond, label %3, label %1, !dbg !166
...
!137 = metadata !{i32 130, i32 0, metadata !12, metadata !138}
!138 = metadata !{i32 143, i32 0, metadata !17, null}
!139 = metadata !{i32 131, i32 0, metadata !12, metadata !138}
!140 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 128, metadata !11, i32 0, metadata !138} ; [ DW_TAG_auto_variable ] [i] [line 128]
!141 = metadata !{i32 132, i32 0, metadata !125, metadata !138}
!142 = metadata !{i32 120, i32 0, metadata !8, metadata !143}
!143 = metadata !{i32 133, i32 0, metadata !128, metadata !138}
!144 = metadata !{i32 786688, metadata !12, metadata !"temp", metadata !5, i32 129, metadata !16, i32 0, metadata !138} ; [ DW_TAG_auto_variable ] [temp] [line 129]
!145 = metadata !{i32 135, i32 0, metadata !128, metadata !138}
!146 = metadata !{i32 136, i32 0, metadata !131, metadata !138}
!147 = metadata !{i32 137, i32 0, metadata !133, metadata !138}
!148 = metadata !{i32 159, i32 0, metadata !149, null}
!149 = metadata !{i32 786443, metadata !1, metadata !17, i32 146, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!150 = metadata !{i32 146, i32 0, metadata !17, null}
!151 = metadata !{i32 151, i32 0, metadata !152, null}
!152 = metadata !{i32 786443, metadata !1, metadata !153, i32 151, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!153 = metadata !{i32 786443, metadata !1, metadata !149, i32 149, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!154 = metadata !{i32 149, i32 0, metadata !149, null}
!155 = metadata !{i32 152, i32 0, metadata !156, null}
!156 = metadata !{i32 786443, metadata !1, metadata !152, i32 151, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!157 = metadata !{i32 153, i32 0, metadata !156, null}
!158 = metadata !{i32 154, i32 0, metadata !156, null}
!159 = metadata !{i32 155, i32 0, metadata !156, null}
!160 = metadata !{i32 161, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !17, i32 161, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!162 = metadata !{i32 162, i32 0, metadata !161, null}
!163 = metadata !{i32 163, i32 0, metadata !17, null}
!164 = metadata !{i32 164, i32 0, metadata !17, null}
!165 = metadata !{i32 0}
!166 = metadata !{i32 169, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !1, metadata !24, i32 169, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/bubblesort.c]
!168 = metadata !{i32 170, i32 0, metadata !24, null}
