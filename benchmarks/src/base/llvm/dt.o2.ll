...
; <label>:23                                      ; preds = %7
  ...
  %scevgep = getelementptr double* %24, i64 2047
  %scevgep4 = getelementptr double* %20, i64 2047
  br label %vector.memcheck, !dbg !62

vector.memcheck:                                  ; preds = %23, %44
  %j.02.i = phi i64 [ 0, %23 ], [ %45, %44 ]
  %bound1 = icmp ule double* %20, %scevgep
  %bound0 = icmp ule double* %24, %scevgep4
  %memcheck.conflict = and i1 %bound0, %bound1
  br i1 %memcheck.conflict, label %middle.block, label %vector.body

vector.body:                                      ; preds = %vector.memcheck, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.memcheck ], !dbg !64
  %25 = getelementptr inbounds double* %20, i64 %index, !dbg !66
  %26 = bitcast double* %25 to <2 x double>*, !dbg !66
  %wide.load = load <2 x double>* %26, align 8, !dbg !66
  %.sum10 = or i64 %index, 2, !dbg !66
  %27 = getelementptr double* %20, i64 %.sum10, !dbg !66
  %28 = bitcast double* %27 to <2 x double>*, !dbg !66
  %wide.load7 = load <2 x double>* %28, align 8, !dbg !66
  %29 = getelementptr inbounds double* %24, i64 %index, !dbg !66
  %30 = bitcast double* %29 to <2 x double>*, !dbg !66
  %wide.load8 = load <2 x double>* %30, align 8, !dbg !66
  %.sum11 = or i64 %index, 2, !dbg !66
  %31 = getelementptr double* %24, i64 %.sum11, !dbg !66
  %32 = bitcast double* %31 to <2 x double>*, !dbg !66
  %wide.load9 = load <2 x double>* %32, align 8, !dbg !66
  %33 = fdiv <2 x double> %wide.load8, %wide.load, !dbg !66
  %34 = fdiv <2 x double> %wide.load9, %wide.load7, !dbg !66
  %35 = bitcast double* %29 to <2 x double>*, !dbg !66
  store <2 x double> %33, <2 x double>* %35, align 8, !dbg !66
  %36 = bitcast double* %31 to <2 x double>*, !dbg !66
  store <2 x double> %34, <2 x double>* %36, align 8, !dbg !66
  %index.next = add i64 %index, 4, !dbg !64
  %37 = icmp eq i64 %index.next, 2048, !dbg !64
  br i1 %37, label %middle.block, label %vector.body, !dbg !64, !llvm.loop !67

middle.block:                                     ; preds = %vector.body, %vector.memcheck
  %resume.val = phi i1 [ false, %vector.memcheck ], [ true, %vector.body ]
  %trunc.resume.val = phi i64 [ 0, %vector.memcheck ], [ 2048, %vector.body ]
  br i1 %resume.val, label %44, label %scalar.ph

scalar.ph:                                        ; preds = %middle.block, %scalar.ph
  %i.01.i = phi i64 [ %43, %scalar.ph ], [ %trunc.resume.val, %middle.block ]
  %38 = getelementptr inbounds double* %20, i64 %i.01.i, !dbg !66
  %39 = load double* %38, align 8, !dbg !66, !tbaa !53
  %40 = getelementptr inbounds double* %24, i64 %i.01.i, !dbg !66
  %41 = load double* %40, align 8, !dbg !66, !tbaa !53
  %42 = fdiv double %41, %39, !dbg !66
  store double %42, double* %40, align 8, !dbg !66, !tbaa !53
  %43 = add nsw i64 %i.01.i, 1, !dbg !64
  tail call void @llvm.dbg.value(metadata !{i64 %43}, i64 0, metadata !70), !dbg !64
  %exitcond.i = icmp eq i64 %43, 2048, !dbg !64
  br i1 %exitcond.i, label %44, label %scalar.ph, !dbg !64, !llvm.loop !71

; <label>:44                                      ; preds = %middle.block, %scalar.ph
  %45 = add nsw i64 %j.02.i, 1, !dbg !62
  tail call void @llvm.dbg.value(metadata !{i64 %45}, i64 0, metadata !61), !dbg !62
  %exitcond3.i = icmp eq i64 %45, 131072, !dbg !62
  br i1 %exitcond3.i, label %double_array_divs_variable.exit, label %vector.memcheck, !dbg !62

double_array_divs_variable.exit:                  ; preds = %44
  call void @llvm.dbg.value(metadata !{double** %dvec1}, i64 0, metadata !20), !dbg !72
  %46 = load double* %24, align 8, !dbg !72, !tbaa !53
  %47 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0), double %46) #3, !dbg !72
  ret i32 0, !dbg !73
}
...
!67 = metadata !{metadata !67, metadata !68, metadata !69}
!68 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!69 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!70 = metadata !{i32 786688, metadata !26, metadata !"i", metadata !10, i32 13, metadata !25, i32 0, metadata !56} ; [ DW_TAG_auto_variable ] [i] [line 13]
!71 = metadata !{metadata !71, metadata !68, metadata !69}
!72 = metadata !{i32 48, i32 0, metadata !9, null}
!73 = metadata !{i32 49, i32 0, metadata !9, null}
