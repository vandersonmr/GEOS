...
define i32 @main() #0 {
  ...
  %1 = tail call noalias i8* @malloc(i64 1048592) #5, !dbg !90
...
; <label>:4                                       ; preds = %0
  ...
  %6 = tail call i64 @fwrite(i8* getelementptr inbounds ([28 x i8]* @.str, i64 0, i64 0), i64 27, i64 1, %struct._IO_FILE* %5) #6, !dbg !93
...
.preheader3:                                      ; preds = %20, %.preheader3
  ...
  tail call fastcc void @fourn(double* %2, i32 1) #8, !dbg !111
  tail call fastcc void @fourn(double* %2, i32 -1) #8, !dbg !114
...
; <label>:52                                      ; preds = %49
  ...
  %56 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %54, i8* getelementptr inbounds ([48 x i8]* @.str1, i64 0, i64 0), i32 %34, i32 %55, i32 %50, i32 %45) #9, !dbg !137
  br label %57, !dbg !138
...
; <label>:62                                      ; preds = %59
  %63 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([35 x i8]* @.str2, i64 0, i64 0), i32 63) #9, !dbg !141
  br label %66, !dbg !143

; <label>:64                                      ; preds = %59
  %65 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %61, i8* getelementptr inbounds ([35 x i8]* @.str3, i64 0, i64 0), i32 63, i32 %m.2) #9, !dbg !144
  br label %66
...
; <label>:55                                      ; preds = %.lr.ph22, %.loopexit
  ...
  %61 = tail call double @sin(double %60) #5, !dbg !188
  ...
  %64 = tail call double @sin(double %59) #5, !dbg !190
...
attributes #9 = { cold nounwind optsize }
