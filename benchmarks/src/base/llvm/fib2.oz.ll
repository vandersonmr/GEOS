...
tailrecurse:                                      ; preds = %0, %tailrecurse
  ...
  %3 = tail call i64 @fib(i64 %2) #5, !dbg !28
...
; <label>:2                                       ; preds = %0
  ...
  %5 = tail call i32 @atoi(i8* %4) #6, !dbg !31
  %phitmp = sext i32 %5 to i64, !dbg !31
  br label %6, !dbg !31

; <label>:6                                       ; preds = %0, %2
  %7 = phi i64 [ %phitmp, %2 ], [ 43, %0 ]
  %8 = tail call i64 @fib(i64 %7) #5, !dbg !36
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0), i64 %8) #6, !dbg !36
  ret i32 0, !dbg !37
}
