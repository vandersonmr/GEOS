...
define i32 @main() #0 {
  ...
  %4 = load i64* %loops, align 8, !dbg !82
  %5 = sitofp i64 %4 to double, !dbg !82
  %6 = fdiv double 1.000000e+06, %5, !dbg !82
  store double %6, double* getelementptr inbounds ([36 x double]* @T, i32 0, i64 1), align 8, !dbg !82
  store double 1.000000e+00, double* @TLimit, align 8, !dbg !83
  store i64 512000000, i64* %NLimit, align 8, !dbg !84
  store double 0x400921FB54442D18, double* @piref, align 8, !dbg !85
  store double 1.000000e+00, double* @one, align 8, !dbg !86
  store double 2.000000e+00, double* @two, align 8, !dbg !87
  store double 3.000000e+00, double* @three, align 8, !dbg !88
  store double 4.000000e+00, double* @four, align 8, !dbg !89
  store double 5.000000e+00, double* @five, align 8, !dbg !90
  %7 = load double* @one, align 8, !dbg !91
  store double %7, double* @scale, align 8, !dbg !91
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([48 x i8]* @.str2, i32 0, i32 0)), !dbg !92
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str3, i32 0, i32 0)), !dbg !93
  %10 = load i64* %loops, align 8, !dbg !94
  %11 = mul nsw i64 %10, 10000, !dbg !94
  store i64 %11, i64* %n, align 8, !dbg !94
  store double 0.000000e+00, double* @sa, align 8, !dbg !95
  %12 = load i64* %n, align 8, !dbg !96
  %13 = mul nsw i64 2, %12, !dbg !96
  store i64 %13, i64* %n, align 8, !dbg !96
  %14 = load double* @one, align 8, !dbg !97
  %15 = load i64* %n, align 8, !dbg !97
  %16 = sitofp i64 %15 to double, !dbg !97
  %17 = fdiv double %14, %16, !dbg !97
  store double %17, double* %x, align 8, !dbg !97
  store double 0.000000e+00, double* %s, align 8, !dbg !98
  store double 0.000000e+00, double* %v, align 8, !dbg !99
  %18 = load double* @one, align 8, !dbg !100
  store double %18, double* %w, align 8, !dbg !100
  store i64 1, i64* %i, align 8, !dbg !101
  br label %19, !dbg !101

; <label>:19                                      ; preds = %56, %0
  %20 = load i64* %i, align 8, !dbg !101
  %21 = load i64* %n, align 8, !dbg !101
  %22 = sub nsw i64 %21, 1, !dbg !101
  %23 = icmp sle i64 %20, %22, !dbg !101
  br i1 %23, label %24, label %59, !dbg !101

; <label>:24                                      ; preds = %19
  %25 = load double* %v, align 8, !dbg !103
  %26 = load double* %w, align 8, !dbg !103
  %27 = fadd double %25, %26, !dbg !103
  store double %27, double* %v, align 8, !dbg !103
  %28 = load double* %v, align 8, !dbg !105
  %29 = load double* %x, align 8, !dbg !105
  %30 = fmul double %28, %29, !dbg !105
  store double %30, double* %u, align 8, !dbg !105
  %31 = load double* %s, align 8, !dbg !106
  %32 = load double* @D1, align 8, !dbg !106
  %33 = load double* %u, align 8, !dbg !106
  %34 = load double* @D2, align 8, !dbg !106
  %35 = load double* %u, align 8, !dbg !106
  %36 = load double* @D3, align 8, !dbg !106
  %37 = fmul double %35, %36, !dbg !106
  %38 = fadd double %34, %37, !dbg !106
  %39 = fmul double %33, %38, !dbg !106
  %40 = fadd double %32, %39, !dbg !106
  %41 = load double* %w, align 8, !dbg !106
  %42 = load double* %u, align 8, !dbg !106
  %43 = load double* @D1, align 8, !dbg !106
  %44 = load double* %u, align 8, !dbg !106
  %45 = load double* @E2, align 8, !dbg !106
  %46 = load double* %u, align 8, !dbg !106
  %47 = load double* @E3, align 8, !dbg !106
  %48 = fmul double %46, %47, !dbg !106
  %49 = fadd double %45, %48, !dbg !106
  %50 = fmul double %44, %49, !dbg !106
  %51 = fadd double %43, %50, !dbg !106
  %52 = fmul double %42, %51, !dbg !106
  %53 = fadd double %41, %52, !dbg !106
  %54 = fdiv double %40, %53, !dbg !106
  %55 = fadd double %31, %54, !dbg !106
  store double %55, double* %s, align 8, !dbg !106
  br label %56, !dbg !107

; <label>:56                                      ; preds = %24
  %57 = load i64* %i, align 8, !dbg !101
  %58 = add nsw i64 %57, 1, !dbg !101
  store i64 %58, i64* %i, align 8, !dbg !101
  br label %19, !dbg !101

; <label>:59                                      ; preds = %19
  %60 = load double* @D1, align 8, !dbg !108
  %61 = load double* @D2, align 8, !dbg !108
  %62 = fadd double %60, %61, !dbg !108
  %63 = load double* @D3, align 8, !dbg !108
  %64 = fadd double %62, %63, !dbg !108
  %65 = load double* @one, align 8, !dbg !108
  %66 = load double* @D1, align 8, !dbg !108
  %67 = fadd double %65, %66, !dbg !108
  %68 = load double* @E2, align 8, !dbg !108
  %69 = fadd double %67, %68, !dbg !108
  %70 = load double* @E3, align 8, !dbg !108
  %71 = fadd double %69, %70, !dbg !108
  %72 = fdiv double %64, %71, !dbg !108
  store double %72, double* @sa, align 8, !dbg !108
  %73 = load double* @D1, align 8, !dbg !109
  store double %73, double* @sb, align 8, !dbg !109
  %74 = load double* %x, align 8, !dbg !110
  %75 = load double* @sa, align 8, !dbg !110
  %76 = load double* @sb, align 8, !dbg !110
  %77 = fadd double %75, %76, !dbg !110
  %78 = load double* @two, align 8, !dbg !110
  %79 = load double* %s, align 8, !dbg !110
  %80 = fmul double %78, %79, !dbg !110
  %81 = fadd double %77, %80, !dbg !110
  %82 = fmul double %74, %81, !dbg !110
  %83 = load double* @two, align 8, !dbg !110
  %84 = fdiv double %82, %83, !dbg !110
  store double %84, double* @sa, align 8, !dbg !110
  %85 = load double* @one, align 8, !dbg !111
  %86 = load double* @sa, align 8, !dbg !111
  %87 = fdiv double %85, %86, !dbg !111
  store double %87, double* @sb, align 8, !dbg !111
  %88 = load double* @sb, align 8, !dbg !112
  %89 = fptosi double %88 to i64, !dbg !112
  %90 = mul nsw i64 40000, %89, !dbg !112
  %91 = sitofp i64 %90 to double, !dbg !112
  %92 = load double* @scale, align 8, !dbg !112
  %93 = fdiv double %91, %92, !dbg !112
  %94 = fptosi double %93 to i64, !dbg !112
  store i64 %94, i64* %n, align 8, !dbg !112
  %95 = load double* @sb, align 8, !dbg !113
  %96 = fsub double %95, 2.520000e+01, !dbg !113
  store double %96, double* @sc, align 8, !dbg !113
  %97 = load double* @sc, align 8, !dbg !114
  %98 = fmul double %97, 1.000000e-30, !dbg !114
  %99 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %98, double 0.000000e+00, double 0.000000e+00), !dbg !114
  ret i32 0, !dbg !115
}
...
!83 = metadata !{i32 209, i32 0, metadata !4, null}
!84 = metadata !{i32 210, i32 0, metadata !4, null}
!85 = metadata !{i32 212, i32 0, metadata !4, null}
!86 = metadata !{i32 213, i32 0, metadata !4, null}
!87 = metadata !{i32 214, i32 0, metadata !4, null}
!88 = metadata !{i32 215, i32 0, metadata !4, null}
!89 = metadata !{i32 216, i32 0, metadata !4, null}
!90 = metadata !{i32 217, i32 0, metadata !4, null}
!91 = metadata !{i32 218, i32 0, metadata !4, null}
!92 = metadata !{i32 220, i32 0, metadata !4, null}
!93 = metadata !{i32 221, i32 0, metadata !4, null}
!94 = metadata !{i32 234, i32 0, metadata !4, null}
!95 = metadata !{i32 236, i32 0, metadata !4, null}
!96 = metadata !{i32 238, i32 0, metadata !4, null}
!97 = metadata !{i32 239, i32 0, metadata !4, null}
!98 = metadata !{i32 240, i32 0, metadata !4, null}
!99 = metadata !{i32 241, i32 0, metadata !4, null}
!100 = metadata !{i32 242, i32 0, metadata !4, null}
!101 = metadata !{i32 244, i32 0, metadata !102, null}
!102 = metadata !{i32 786443, metadata !1, metadata !4, i32 244, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-1.c]
!103 = metadata !{i32 246, i32 0, metadata !104, null}
!104 = metadata !{i32 786443, metadata !1, metadata !102, i32 245, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-1.c]
!105 = metadata !{i32 247, i32 0, metadata !104, null}
!106 = metadata !{i32 248, i32 0, metadata !104, null}
!107 = metadata !{i32 249, i32 0, metadata !104, null}
!108 = metadata !{i32 251, i32 0, metadata !4, null}
!109 = metadata !{i32 252, i32 0, metadata !4, null}
!110 = metadata !{i32 254, i32 0, metadata !4, null}
!111 = metadata !{i32 255, i32 0, metadata !4, null}
!112 = metadata !{i32 256, i32 0, metadata !4, null}
!113 = metadata !{i32 257, i32 0, metadata !4, null}
!114 = metadata !{i32 262, i32 0, metadata !4, null}
!115 = metadata !{i32 266, i32 0, metadata !4, null}
