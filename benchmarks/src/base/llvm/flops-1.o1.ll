...
; <label>:30                                      ; preds = %13
  %31 = load double* @D1, align 8, !dbg !115, !tbaa !82
  %32 = load double* @D2, align 8, !dbg !115, !tbaa !82
  %33 = fadd double %31, %32, !dbg !115
  %34 = load double* @D3, align 8, !dbg !115, !tbaa !82
  %35 = fadd double %33, %34, !dbg !115
  %36 = load double* @one, align 8, !dbg !115, !tbaa !82
  %37 = fadd double %31, %36, !dbg !115
  %38 = load double* @E2, align 8, !dbg !115, !tbaa !82
  %39 = fadd double %37, %38, !dbg !115
  %40 = load double* @E3, align 8, !dbg !115, !tbaa !82
  %41 = fadd double %39, %40, !dbg !115
  %42 = fdiv double %35, %41, !dbg !115
  %43 = load double* @D1, align 8, !dbg !116, !tbaa !82
  %44 = fadd double %42, %43, !dbg !117
  %45 = load double* @two, align 8, !dbg !117, !tbaa !82
  %46 = fmul double %28, %45, !dbg !117
  %47 = fadd double %44, %46, !dbg !117
  %48 = fmul double %2, %47, !dbg !117
  %49 = fdiv double %48, %45, !dbg !117
  store double %49, double* @sa, align 8, !dbg !117, !tbaa !82
  %50 = load double* @one, align 8, !dbg !118, !tbaa !82
  %51 = fdiv double %50, %49, !dbg !118
  store double %51, double* @sb, align 8, !dbg !118, !tbaa !82
  %52 = fadd double %51, -2.520000e+01, !dbg !119
  store double %52, double* @sc, align 8, !dbg !119, !tbaa !82
  %53 = fmul double %52, 1.000000e-30, !dbg !120
  %54 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %53, double 0.000000e+00, double 0.000000e+00) #3, !dbg !120
  ret i32 0, !dbg !121
}
...
!116 = metadata !{i32 252, i32 0, metadata !4, null}
!117 = metadata !{i32 254, i32 0, metadata !4, null}
!118 = metadata !{i32 255, i32 0, metadata !4, null}
!119 = metadata !{i32 257, i32 0, metadata !4, null}
!120 = metadata !{i32 262, i32 0, metadata !4, null}
