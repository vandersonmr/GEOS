...
define i32 @main() #0 {
  ...
  %9 = load double* @five, align 8, !dbg !94
  %10 = fsub double -0.000000e+00, %9, !dbg !94
  store double %10, double* %s, align 8, !dbg !94
  %11 = load double* @one, align 8, !dbg !95
  %12 = fsub double -0.000000e+00, %11, !dbg !95
  store double %12, double* @sa, align 8, !dbg !95
  store i64 1, i64* %i, align 8, !dbg !96
  br label %13, !dbg !96

; <label>:13                                      ; preds = %23, %0
  %14 = load i64* %i, align 8, !dbg !96
  %15 = load i64* %m, align 8, !dbg !96
  %16 = icmp sle i64 %14, %15, !dbg !96
  br i1 %16, label %17, label %26, !dbg !96

; <label>:17                                      ; preds = %13
  %18 = load double* %s, align 8, !dbg !98
  %19 = fsub double -0.000000e+00, %18, !dbg !98
  store double %19, double* %s, align 8, !dbg !98
  %20 = load double* @sa, align 8, !dbg !100
  %21 = load double* %s, align 8, !dbg !100
  %22 = fadd double %20, %21, !dbg !100
  store double %22, double* @sa, align 8, !dbg !100
  br label %23, !dbg !101

; <label>:23                                      ; preds = %17
  %24 = load i64* %i, align 8, !dbg !96
  %25 = add nsw i64 %24, 1, !dbg !96
  store i64 %25, i64* %i, align 8, !dbg !96
  br label %13, !dbg !96

; <label>:26                                      ; preds = %13
  %27 = load i64* %m, align 8, !dbg !102
  %28 = sitofp i64 %27 to double, !dbg !102
  store double %28, double* @sc, align 8, !dbg !102
  %29 = load double* @sa, align 8, !dbg !103
  store double %29, double* %u, align 8, !dbg !103
  store double 0.000000e+00, double* %v, align 8, !dbg !104
  store double 0.000000e+00, double* %w, align 8, !dbg !105
  store double 0.000000e+00, double* %x, align 8, !dbg !106
  store i64 1, i64* %i, align 8, !dbg !107
  br label %30, !dbg !107

; <label>:30                                      ; preds = %58, %26
  %31 = load i64* %i, align 8, !dbg !107
  %32 = load i64* %m, align 8, !dbg !107
  %33 = icmp sle i64 %31, %32, !dbg !107
  br i1 %33, label %34, label %61, !dbg !107

; <label>:34                                      ; preds = %30
  %35 = load double* %s, align 8, !dbg !109
  %36 = fsub double -0.000000e+00, %35, !dbg !109
  store double %36, double* %s, align 8, !dbg !109
  %37 = load double* @sa, align 8, !dbg !111
  %38 = load double* %s, align 8, !dbg !111
  %39 = fadd double %37, %38, !dbg !111
  store double %39, double* @sa, align 8, !dbg !111
  %40 = load double* %u, align 8, !dbg !112
  %41 = load double* @two, align 8, !dbg !112
  %42 = fadd double %40, %41, !dbg !112
  store double %42, double* %u, align 8, !dbg !112
  %43 = load double* %x, align 8, !dbg !113
  %44 = load double* %s, align 8, !dbg !113
  %45 = load double* %u, align 8, !dbg !113
  %46 = fsub double %44, %45, !dbg !113
  %47 = fadd double %43, %46, !dbg !113
  store double %47, double* %x, align 8, !dbg !113
  %48 = load double* %v, align 8, !dbg !114
  %49 = load double* %s, align 8, !dbg !114
  %50 = load double* %u, align 8, !dbg !114
  %51 = fmul double %49, %50, !dbg !114
  %52 = fsub double %48, %51, !dbg !114
  store double %52, double* %v, align 8, !dbg !114
  %53 = load double* %w, align 8, !dbg !115
  %54 = load double* %s, align 8, !dbg !115
  %55 = load double* %u, align 8, !dbg !115
  %56 = fdiv double %54, %55, !dbg !115
  %57 = fadd double %53, %56, !dbg !115
  store double %57, double* %w, align 8, !dbg !115
  br label %58, !dbg !116

; <label>:58                                      ; preds = %34
  %59 = load i64* %i, align 8, !dbg !107
  %60 = add nsw i64 %59, 1, !dbg !107
  store i64 %60, i64* %i, align 8, !dbg !107
  br label %30, !dbg !107

; <label>:61                                      ; preds = %30
  %62 = load double* @sa, align 8, !dbg !117
  %63 = load double* %x, align 8, !dbg !117
  %64 = fmul double %62, %63, !dbg !117
  %65 = load double* @sc, align 8, !dbg !117
  %66 = fdiv double %64, %65, !dbg !117
  %67 = fptosi double %66 to i64, !dbg !117
  store i64 %67, i64* %m, align 8, !dbg !117
  %68 = load double* @four, align 8, !dbg !118
  %69 = load double* %w, align 8, !dbg !118
  %70 = fmul double %68, %69, !dbg !118
  %71 = load double* @five, align 8, !dbg !118
  %72 = fdiv double %70, %71, !dbg !118
  store double %72, double* @sa, align 8, !dbg !118
  %73 = load double* @sa, align 8, !dbg !119
  %74 = load double* @five, align 8, !dbg !119
  %75 = load double* %v, align 8, !dbg !119
  %76 = fdiv double %74, %75, !dbg !119
  %77 = fadd double %73, %76, !dbg !119
  store double %77, double* @sb, align 8, !dbg !119
  store double 3.125000e+01, double* @sc, align 8, !dbg !120
  %78 = load double* @sb, align 8, !dbg !121
  %79 = load double* @sc, align 8, !dbg !121
  %80 = load double* %v, align 8, !dbg !121
  %81 = load double* %v, align 8, !dbg !121
  %82 = fmul double %80, %81, !dbg !121
  %83 = load double* %v, align 8, !dbg !121
  %84 = fmul double %82, %83, !dbg !121
  %85 = fdiv double %79, %84, !dbg !121
  %86 = fsub double %78, %85, !dbg !121
  store double %86, double* @piprg, align 8, !dbg !121
  %87 = load double* @piprg, align 8, !dbg !122
  %88 = load double* @piref, align 8, !dbg !122
  %89 = fsub double %87, %88, !dbg !122
  store double %89, double* @pierr, align 8, !dbg !122
  %90 = load double* @pierr, align 8, !dbg !123
  %91 = fmul double %90, 1.000000e-30, !dbg !123
  %92 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %91, double 0.000000e+00, double 0.000000e+00), !dbg !123
  ret i32 0, !dbg !124
}
...
!93 = metadata !{i32 233, i32 0, metadata !4, null}
!94 = metadata !{i32 235, i32 0, metadata !4, null}
!95 = metadata !{i32 236, i32 0, metadata !4, null}
!96 = metadata !{i32 238, i32 0, metadata !97, null}
!97 = metadata !{i32 786443, metadata !1, metadata !4, i32 238, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-2.c]
!98 = metadata !{i32 240, i32 0, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !97, i32 239, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-2.c]
!100 = metadata !{i32 241, i32 0, metadata !99, null}
!101 = metadata !{i32 242, i32 0, metadata !99, null}
!102 = metadata !{i32 244, i32 0, metadata !4, null}
!103 = metadata !{i32 246, i32 0, metadata !4, null}
!104 = metadata !{i32 247, i32 0, metadata !4, null}
!105 = metadata !{i32 248, i32 0, metadata !4, null}
!106 = metadata !{i32 249, i32 0, metadata !4, null}
!107 = metadata !{i32 251, i32 0, metadata !108, null}
!108 = metadata !{i32 786443, metadata !1, metadata !4, i32 251, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-2.c]
!109 = metadata !{i32 253, i32 0, metadata !110, null}
!110 = metadata !{i32 786443, metadata !1, metadata !108, i32 252, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-2.c]
!111 = metadata !{i32 254, i32 0, metadata !110, null}
!112 = metadata !{i32 255, i32 0, metadata !110, null}
!113 = metadata !{i32 256, i32 0, metadata !110, null}
!114 = metadata !{i32 257, i32 0, metadata !110, null}
!115 = metadata !{i32 258, i32 0, metadata !110, null}
!116 = metadata !{i32 259, i32 0, metadata !110, null}
!117 = metadata !{i32 261, i32 0, metadata !4, null}
!118 = metadata !{i32 262, i32 0, metadata !4, null}
!119 = metadata !{i32 263, i32 0, metadata !4, null}
!120 = metadata !{i32 264, i32 0, metadata !4, null}
!121 = metadata !{i32 265, i32 0, metadata !4, null}
!122 = metadata !{i32 266, i32 0, metadata !4, null}
!123 = metadata !{i32 268, i32 0, metadata !4, null}
!124 = metadata !{i32 273, i32 0, metadata !4, null}
