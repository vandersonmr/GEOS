...
; <label>:18                                      ; preds = %10
  ...
  %21 = fdiv double %20, %1, !dbg !119
  store double %21, double* @sa, align 8, !dbg !119, !tbaa !82
  %22 = fdiv double %1, %14, !dbg !120
  %23 = fadd double %21, %22, !dbg !120
  store double %23, double* @sb, align 8, !dbg !120, !tbaa !82
  store double 3.125000e+01, double* @sc, align 8, !dbg !121, !tbaa !82
  %24 = fmul double %14, %14, !dbg !122
  %25 = fmul double %14, %24, !dbg !122
  %26 = fdiv double 3.125000e+01, %25, !dbg !122
  %27 = fsub double %23, %26, !dbg !122
  store double %27, double* @piprg, align 8, !dbg !122, !tbaa !82
  %28 = load double* @piref, align 8, !dbg !123, !tbaa !82
  %29 = fsub double %27, %28, !dbg !123
  store double %29, double* @pierr, align 8, !dbg !123, !tbaa !82
  %30 = fmul double %29, 1.000000e-30, !dbg !124
  %31 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %30, double 0.000000e+00, double 0.000000e+00) #4, !dbg !124
  ret i32 0, !dbg !125
}
