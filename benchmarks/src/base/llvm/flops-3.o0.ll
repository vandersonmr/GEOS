...
; <label>:15                                      ; preds = %59, %0
  ...
  br i1 %19, label %20, label %62, !dbg !97

; <label>:20                                      ; preds = %15
  %21 = load double* %v, align 8, !dbg !99
  %22 = load double* @one, align 8, !dbg !99
  %23 = fadd double %21, %22, !dbg !99
  store double %23, double* %v, align 8, !dbg !99
  %24 = load double* %v, align 8, !dbg !101
  %25 = load double* %x, align 8, !dbg !101
  %26 = fmul double %24, %25, !dbg !101
  store double %26, double* %u, align 8, !dbg !101
  %27 = load double* %u, align 8, !dbg !102
  %28 = load double* %u, align 8, !dbg !102
  %29 = fmul double %27, %28, !dbg !102
  store double %29, double* %w, align 8, !dbg !102
  %30 = load double* %s, align 8, !dbg !103
  %31 = load double* %u, align 8, !dbg !103
  %32 = load double* @A6, align 8, !dbg !103
  %33 = load double* %w, align 8, !dbg !103
  %34 = fmul double %32, %33, !dbg !103
  %35 = load double* @A5, align 8, !dbg !103
  %36 = fsub double %34, %35, !dbg !103
  %37 = load double* %w, align 8, !dbg !103
  %38 = fmul double %36, %37, !dbg !103
  %39 = load double* @A4, align 8, !dbg !103
  %40 = fadd double %38, %39, !dbg !103
  %41 = load double* %w, align 8, !dbg !103
  %42 = fmul double %40, %41, !dbg !103
  %43 = load double* @A3, align 8, !dbg !103
  %44 = fsub double %42, %43, !dbg !103
  %45 = load double* %w, align 8, !dbg !103
  %46 = fmul double %44, %45, !dbg !103
  %47 = load double* @A2, align 8, !dbg !103
  %48 = fadd double %46, %47, !dbg !103
  %49 = load double* %w, align 8, !dbg !103
  %50 = fmul double %48, %49, !dbg !103
  %51 = load double* @A1, align 8, !dbg !103
  %52 = fadd double %50, %51, !dbg !103
  %53 = load double* %w, align 8, !dbg !103
  %54 = fmul double %52, %53, !dbg !103
  %55 = load double* @one, align 8, !dbg !103
  %56 = fadd double %54, %55, !dbg !103
  %57 = fmul double %31, %56, !dbg !103
  %58 = fadd double %30, %57, !dbg !103
  store double %58, double* %s, align 8, !dbg !103
  br label %59, !dbg !104

; <label>:59                                      ; preds = %20
  %60 = load i64* %i, align 8, !dbg !97
  %61 = add nsw i64 %60, 1, !dbg !97
  store i64 %61, i64* %i, align 8, !dbg !97
  br label %15, !dbg !97

; <label>:62                                      ; preds = %15
  %63 = load double* @piref, align 8, !dbg !105
  %64 = load double* @three, align 8, !dbg !105
  %65 = fdiv double %63, %64, !dbg !105
  store double %65, double* %u, align 8, !dbg !105
  %66 = load double* %u, align 8, !dbg !106
  %67 = load double* %u, align 8, !dbg !106
  %68 = fmul double %66, %67, !dbg !106
  store double %68, double* %w, align 8, !dbg !106
  %69 = load double* %u, align 8, !dbg !107
  %70 = load double* @A6, align 8, !dbg !107
  %71 = load double* %w, align 8, !dbg !107
  %72 = fmul double %70, %71, !dbg !107
  %73 = load double* @A5, align 8, !dbg !107
  %74 = fsub double %72, %73, !dbg !107
  %75 = load double* %w, align 8, !dbg !107
  %76 = fmul double %74, %75, !dbg !107
  %77 = load double* @A4, align 8, !dbg !107
  %78 = fadd double %76, %77, !dbg !107
  %79 = load double* %w, align 8, !dbg !107
  %80 = fmul double %78, %79, !dbg !107
  %81 = load double* @A3, align 8, !dbg !107
  %82 = fsub double %80, %81, !dbg !107
  %83 = load double* %w, align 8, !dbg !107
  %84 = fmul double %82, %83, !dbg !107
  %85 = load double* @A2, align 8, !dbg !107
  %86 = fadd double %84, %85, !dbg !107
  %87 = load double* %w, align 8, !dbg !107
  %88 = fmul double %86, %87, !dbg !107
  %89 = load double* @A1, align 8, !dbg !107
  %90 = fadd double %88, %89, !dbg !107
  %91 = load double* %w, align 8, !dbg !107
  %92 = fmul double %90, %91, !dbg !107
  %93 = load double* @one, align 8, !dbg !107
  %94 = fadd double %92, %93, !dbg !107
  %95 = fmul double %69, %94, !dbg !107
  store double %95, double* @sa, align 8, !dbg !107
  %96 = load double* %x, align 8, !dbg !108
  %97 = load double* @sa, align 8, !dbg !108
  %98 = load double* @two, align 8, !dbg !108
  %99 = load double* %s, align 8, !dbg !108
  %100 = fmul double %98, %99, !dbg !108
  %101 = fadd double %97, %100, !dbg !108
  %102 = fmul double %96, %101, !dbg !108
  %103 = load double* @two, align 8, !dbg !108
  %104 = fdiv double %102, %103, !dbg !108
  store double %104, double* @sa, align 8, !dbg !108
  store double 5.000000e-01, double* @sb, align 8, !dbg !109
  %105 = load double* @sa, align 8, !dbg !110
  %106 = load double* @sb, align 8, !dbg !110
  %107 = fsub double %105, %106, !dbg !110
  store double %107, double* @sc, align 8, !dbg !110
  %108 = load double* @sc, align 8, !dbg !111
  %109 = fmul double %108, 1.000000e-30, !dbg !111
  %110 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %109, double 0.000000e+00, double 0.000000e+00), !dbg !111
  ret i32 0, !dbg !112
}
...
!98 = metadata !{i32 786443, metadata !1, metadata !4, i32 243, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-3.c]
!99 = metadata !{i32 245, i32 0, metadata !100, null}
!100 = metadata !{i32 786443, metadata !1, metadata !98, i32 244, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-3.c]
...
!108 = metadata !{i32 255, i32 0, metadata !4, null}
!109 = metadata !{i32 256, i32 0, metadata !4, null}
!110 = metadata !{i32 257, i32 0, metadata !4, null}
!111 = metadata !{i32 262, i32 0, metadata !4, null}
!112 = metadata !{i32 267, i32 0, metadata !4, null}
