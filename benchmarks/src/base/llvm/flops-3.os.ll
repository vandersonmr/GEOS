...
; <label>:31                                      ; preds = %12
  %32 = fdiv double %1, %2, !dbg !111
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !12), !dbg !111
  %33 = fmul double %32, %32, !dbg !112
  tail call void @llvm.dbg.value(metadata !{double %33}, i64 0, metadata !14), !dbg !112
  %34 = fmul double %6, %33, !dbg !113
  %35 = fsub double %34, %7, !dbg !113
  %36 = fmul double %33, %35, !dbg !113
  %37 = fadd double %8, %36, !dbg !113
  %38 = fmul double %33, %37, !dbg !113
  %39 = fsub double %38, %9, !dbg !113
  %40 = fmul double %33, %39, !dbg !113
  %41 = fadd double %10, %40, !dbg !113
  %42 = fmul double %33, %41, !dbg !113
  %43 = fadd double %11, %42, !dbg !113
  %44 = fmul double %33, %43, !dbg !113
  %45 = fadd double %5, %44, !dbg !113
  %46 = fmul double %32, %45, !dbg !113
  %47 = load double* @two, align 8, !dbg !114, !tbaa !82
  %48 = fmul double %29, %47, !dbg !114
  %49 = fadd double %48, %46, !dbg !114
  %50 = fmul double %4, %49, !dbg !114
  %51 = fdiv double %50, %47, !dbg !114
  store double %51, double* @sa, align 8, !dbg !114, !tbaa !82
  store double 5.000000e-01, double* @sb, align 8, !dbg !115, !tbaa !82
  %52 = fadd double %51, -5.000000e-01, !dbg !116
  store double %52, double* @sc, align 8, !dbg !116, !tbaa !82
  %53 = fmul double %52, 1.000000e-30, !dbg !117
  %54 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %53, double 0.000000e+00, double 0.000000e+00) #4, !dbg !117
  ret i32 0, !dbg !118
}
