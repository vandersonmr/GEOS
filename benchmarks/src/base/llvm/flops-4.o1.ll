...
define i32 @main() #0 {
  ...
  %1 = load double* @A3, align 8, !dbg !99, !tbaa !82
  %2 = fsub double -0.000000e+00, %1, !dbg !99
  store double %2, double* @A3, align 8, !dbg !99, !tbaa !82
  %3 = load double* @A5, align 8, !dbg !100, !tbaa !82
  %4 = fsub double -0.000000e+00, %3, !dbg !100
  store double %4, double* @A5, align 8, !dbg !100, !tbaa !82
  %5 = load double* @piref, align 8, !dbg !101, !tbaa !82
  %6 = load double* @three, align 8, !dbg !101, !tbaa !82
  %7 = fmul double %6, 1.562500e+08, !dbg !101
  %8 = fdiv double %5, %7, !dbg !101
  tail call void @llvm.dbg.value(metadata !{double %8}, i64 0, metadata !15), !dbg !101
  tail call void @llvm.dbg.value(metadata !102, i64 0, metadata !10), !dbg !103
  tail call void @llvm.dbg.value(metadata !102, i64 0, metadata !13), !dbg !104
  tail call void @llvm.dbg.value(metadata !105, i64 0, metadata !19), !dbg !106
  %9 = load double* @B6, align 8, !dbg !108, !tbaa !82
  %10 = load double* @B5, align 8, !dbg !108, !tbaa !82
  %11 = load double* @B4, align 8, !dbg !108, !tbaa !82
  %12 = load double* @B3, align 8, !dbg !108, !tbaa !82
  %13 = load double* @B2, align 8, !dbg !108, !tbaa !82
  %14 = load double* @B1, align 8, !dbg !108, !tbaa !82
  %15 = load double* @one, align 8, !dbg !108, !tbaa !82
  br label %16, !dbg !106

; <label>:16                                      ; preds = %16, %0
  %s.04 = phi double [ 0.000000e+00, %0 ], [ %32, %16 ]
  %i.03 = phi i64 [ 1, %0 ], [ %33, %16 ]
  %17 = sitofp i64 %i.03 to double, !dbg !110
  %18 = fmul double %8, %17, !dbg !110
  tail call void @llvm.dbg.value(metadata !{double %18}, i64 0, metadata !12), !dbg !110
  %19 = fmul double %18, %18, !dbg !111
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !14), !dbg !111
  %20 = fmul double %19, %9, !dbg !108
  %21 = fadd double %20, %10, !dbg !108
  %22 = fmul double %19, %21, !dbg !108
  %23 = fadd double %11, %22, !dbg !108
  %24 = fmul double %19, %23, !dbg !108
  %25 = fadd double %12, %24, !dbg !108
  %26 = fmul double %19, %25, !dbg !108
  %27 = fadd double %13, %26, !dbg !108
  %28 = fmul double %19, %27, !dbg !108
  %29 = fadd double %14, %28, !dbg !108
  %30 = fmul double %19, %29, !dbg !108
  %31 = fadd double %s.04, %30, !dbg !108
  %32 = fadd double %15, %31, !dbg !108
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !10), !dbg !108
  %33 = add nsw i64 %i.03, 1, !dbg !106
  tail call void @llvm.dbg.value(metadata !{i64 %33}, i64 0, metadata !19), !dbg !106
  %exitcond = icmp eq i64 %33, 156250000, !dbg !106
  br i1 %exitcond, label %34, label %16, !dbg !106

; <label>:34                                      ; preds = %16
  %35 = load double* @piref, align 8, !dbg !112, !tbaa !82
  %36 = load double* @three, align 8, !dbg !112, !tbaa !82
  %37 = fdiv double %35, %36, !dbg !112
  tail call void @llvm.dbg.value(metadata !{double %37}, i64 0, metadata !12), !dbg !112
  %38 = fmul double %37, %37, !dbg !113
  tail call void @llvm.dbg.value(metadata !{double %38}, i64 0, metadata !14), !dbg !113
  %39 = load double* @B6, align 8, !dbg !114, !tbaa !82
  %40 = fmul double %39, %38, !dbg !114
  %41 = load double* @B5, align 8, !dbg !114, !tbaa !82
  %42 = fadd double %40, %41, !dbg !114
  %43 = fmul double %38, %42, !dbg !114
  %44 = load double* @B4, align 8, !dbg !114, !tbaa !82
  %45 = fadd double %44, %43, !dbg !114
  %46 = fmul double %38, %45, !dbg !114
  %47 = load double* @B3, align 8, !dbg !114, !tbaa !82
  %48 = fadd double %47, %46, !dbg !114
  %49 = fmul double %38, %48, !dbg !114
  %50 = load double* @B2, align 8, !dbg !114, !tbaa !82
  %51 = fadd double %50, %49, !dbg !114
  %52 = fmul double %38, %51, !dbg !114
  %53 = load double* @B1, align 8, !dbg !114, !tbaa !82
  %54 = fadd double %53, %52, !dbg !114
  %55 = fmul double %38, %54, !dbg !114
  %56 = load double* @one, align 8, !dbg !114, !tbaa !82
  %57 = fadd double %56, %55, !dbg !114
  %58 = fadd double %56, %57, !dbg !115
  %59 = load double* @two, align 8, !dbg !115, !tbaa !82
  %60 = fmul double %32, %59, !dbg !115
  %61 = fadd double %60, %58, !dbg !115
  %62 = fmul double %8, %61, !dbg !115
  %63 = fdiv double %62, %59, !dbg !115
  store double %63, double* @sa, align 8, !dbg !115, !tbaa !82
  %64 = load double* @piref, align 8, !dbg !116, !tbaa !82
  %65 = load double* @three, align 8, !dbg !116, !tbaa !82
  %66 = fdiv double %64, %65, !dbg !116
  tail call void @llvm.dbg.value(metadata !{double %66}, i64 0, metadata !12), !dbg !116
  %67 = fmul double %66, %66, !dbg !117
  tail call void @llvm.dbg.value(metadata !{double %67}, i64 0, metadata !14), !dbg !117
  %68 = load double* @A6, align 8, !dbg !118, !tbaa !82
  %69 = fmul double %68, %67, !dbg !118
  %70 = load double* @A5, align 8, !dbg !118, !tbaa !82
  %71 = fadd double %69, %70, !dbg !118
  %72 = fmul double %67, %71, !dbg !118
  %73 = load double* @A4, align 8, !dbg !118, !tbaa !82
  %74 = fadd double %73, %72, !dbg !118
  %75 = fmul double %67, %74, !dbg !118
  %76 = load double* @A3, align 8, !dbg !118, !tbaa !82
  %77 = fadd double %76, %75, !dbg !118
  %78 = fmul double %67, %77, !dbg !118
  %79 = load double* @A2, align 8, !dbg !118, !tbaa !82
  %80 = fadd double %79, %78, !dbg !118
  %81 = fmul double %67, %80, !dbg !118
  %82 = load double* @A1, align 8, !dbg !118, !tbaa !82
  %83 = fadd double %82, %81, !dbg !118
  %84 = fmul double %67, %83, !dbg !118
  %85 = load double* @A0, align 8, !dbg !118, !tbaa !82
  %86 = fadd double %85, %84, !dbg !118
  %87 = fmul double %66, %86, !dbg !118
  store double %87, double* @sb, align 8, !dbg !118, !tbaa !82
  %88 = load double* @sa, align 8, !dbg !119, !tbaa !82
  %89 = fsub double %88, %87, !dbg !119
  store double %89, double* @sc, align 8, !dbg !119, !tbaa !82
  %90 = fmul double %89, 1.000000e-30, !dbg !120
  %91 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %90, double 0.000000e+00, double 0.000000e+00) #3, !dbg !120
  ret i32 0, !dbg !121
}
...
!99 = metadata !{i32 238, i32 0, metadata !4, null}
!100 = metadata !{i32 239, i32 0, metadata !4, null}
!101 = metadata !{i32 240, i32 0, metadata !4, null}
!102 = metadata !{double 0.000000e+00}
!103 = metadata !{i32 241, i32 0, metadata !4, null}
!104 = metadata !{i32 242, i32 0, metadata !4, null}
!105 = metadata !{i64 1}
!106 = metadata !{i32 244, i32 0, metadata !107, null}
!107 = metadata !{i32 786443, metadata !1, metadata !4, i32 244, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-4.c]
!108 = metadata !{i32 248, i32 0, metadata !109, null}
!109 = metadata !{i32 786443, metadata !1, metadata !107, i32 245, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-4.c]
!110 = metadata !{i32 246, i32 0, metadata !109, null}
!111 = metadata !{i32 247, i32 0, metadata !109, null}
...
!115 = metadata !{i32 255, i32 0, metadata !4, null}
!116 = metadata !{i32 256, i32 0, metadata !4, null}
...
!121 = metadata !{i32 269, i32 0, metadata !4, null}
