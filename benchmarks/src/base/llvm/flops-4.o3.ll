...
; <label>:34                                      ; preds = %16
  %35 = fdiv double %5, %6, !dbg !112
  tail call void @llvm.dbg.value(metadata !{double %35}, i64 0, metadata !12), !dbg !112
  %36 = fmul double %35, %35, !dbg !113
  tail call void @llvm.dbg.value(metadata !{double %36}, i64 0, metadata !14), !dbg !113
  %37 = fmul double %9, %36, !dbg !114
  %38 = fadd double %37, %10, !dbg !114
  %39 = fmul double %36, %38, !dbg !114
  %40 = fadd double %11, %39, !dbg !114
  %41 = fmul double %36, %40, !dbg !114
  %42 = fadd double %12, %41, !dbg !114
  %43 = fmul double %36, %42, !dbg !114
  %44 = fadd double %13, %43, !dbg !114
  %45 = fmul double %36, %44, !dbg !114
  %46 = fadd double %14, %45, !dbg !114
  %47 = fmul double %36, %46, !dbg !114
  %48 = fadd double %15, %47, !dbg !114
  %49 = fadd double %15, %48, !dbg !115
  %50 = load double* @two, align 8, !dbg !115, !tbaa !82
  %51 = fmul double %32, %50, !dbg !115
  %52 = fadd double %51, %49, !dbg !115
  %53 = fmul double %8, %52, !dbg !115
  %54 = fdiv double %53, %50, !dbg !115
  store double %54, double* @sa, align 8, !dbg !115, !tbaa !82
  tail call void @llvm.dbg.value(metadata !{double %35}, i64 0, metadata !12), !dbg !116
  tail call void @llvm.dbg.value(metadata !{double %36}, i64 0, metadata !14), !dbg !117
  %55 = load double* @A6, align 8, !dbg !118, !tbaa !82
  %56 = fmul double %55, %36, !dbg !118
  %57 = fsub double %56, %3, !dbg !118
  %58 = fmul double %36, %57, !dbg !118
  %59 = load double* @A4, align 8, !dbg !118, !tbaa !82
  %60 = fadd double %59, %58, !dbg !118
  %61 = fmul double %36, %60, !dbg !118
  %62 = fsub double %61, %1, !dbg !118
  %63 = fmul double %36, %62, !dbg !118
  %64 = load double* @A2, align 8, !dbg !118, !tbaa !82
  %65 = fadd double %64, %63, !dbg !118
  %66 = fmul double %36, %65, !dbg !118
  %67 = load double* @A1, align 8, !dbg !118, !tbaa !82
  %68 = fadd double %67, %66, !dbg !118
  %69 = fmul double %36, %68, !dbg !118
  %70 = load double* @A0, align 8, !dbg !118, !tbaa !82
  %71 = fadd double %70, %69, !dbg !118
  %72 = fmul double %35, %71, !dbg !118
  store double %72, double* @sb, align 8, !dbg !118, !tbaa !82
  %73 = fsub double %54, %72, !dbg !119
  store double %73, double* @sc, align 8, !dbg !119, !tbaa !82
  %74 = fmul double %73, 1.000000e-30, !dbg !120
  %75 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %74, double 0.000000e+00, double 0.000000e+00) #3, !dbg !120
  ret i32 0, !dbg !121
}
