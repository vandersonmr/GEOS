...
define i32 @main() #0 {
  ...
  %2 = load double* @four, align 8, !dbg !99, !tbaa !82
...
; <label>:57                                      ; preds = %28
  ...
  %85 = fmul double %72, %84, !dbg !116
  %86 = load double* @two, align 8, !dbg !117, !tbaa !82
  %87 = fmul double %55, %86, !dbg !117
  %88 = fadd double %87, %85, !dbg !117
  %89 = fmul double %4, %88, !dbg !117
  %90 = fdiv double %89, %86, !dbg !117
  store double %90, double* @sa, align 8, !dbg !117, !tbaa !82
  store double 2.500000e-01, double* @sb, align 8, !dbg !118, !tbaa !82
  %91 = fadd double %90, -2.500000e-01, !dbg !119
  store double %91, double* @sc, align 8, !dbg !119, !tbaa !82
  %92 = fmul double %91, 1.000000e-30, !dbg !120
  %93 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %92, double 0.000000e+00, double 0.000000e+00) #3, !dbg !120
  ret i32 0, !dbg !121
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"Ubuntu clang version 3.5-1ubuntu1 (trunk) (based on LLVM 3.5)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !22, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-6.c] [DW_LANG_C99]
!1 = metadata !{metadata !"flops-6.c", metadata !"/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base"}
!2 = metadata !{}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-6.c]
...
!105 = metadata !{i32 786443, metadata !1, metadata !4, i32 243, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-6.c]
!106 = metadata !{i32 247, i32 0, metadata !107, null}
!107 = metadata !{i32 786443, metadata !1, metadata !105, i32 244, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-6.c]
