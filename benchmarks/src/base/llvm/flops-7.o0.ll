...
define i32 @main() #0 {
  ...
  store double 0.000000e+00, double* %s, align 8, !dbg !94
  %9 = load double* @one, align 8, !dbg !95
  store double %9, double* %w, align 8, !dbg !95
  store double 0x40599541F7F192A4, double* @sa, align 8, !dbg !96
  %10 = load double* @sa, align 8, !dbg !97
  %11 = load i64* %m, align 8, !dbg !97
  %12 = sitofp i64 %11 to double, !dbg !97
  %13 = fdiv double %10, %12, !dbg !97
  store double %13, double* %v, align 8, !dbg !97
  store i64 1, i64* %i, align 8, !dbg !98
  br label %14, !dbg !98

; <label>:14                                      ; preds = %48, %0
  %15 = load i64* %i, align 8, !dbg !98
  %16 = load i64* %m, align 8, !dbg !98
  %17 = sub nsw i64 %16, 1, !dbg !98
  %18 = icmp sle i64 %15, %17, !dbg !98
  br i1 %18, label %19, label %51, !dbg !98

; <label>:19                                      ; preds = %14
  %20 = load i64* %i, align 8, !dbg !100
  %21 = sitofp i64 %20 to double, !dbg !100
  %22 = load double* %v, align 8, !dbg !100
  %23 = fmul double %21, %22, !dbg !100
  store double %23, double* %x, align 8, !dbg !100
  %24 = load double* %x, align 8, !dbg !102
  %25 = load double* %x, align 8, !dbg !102
  %26 = fmul double %24, %25, !dbg !102
  store double %26, double* %u, align 8, !dbg !102
  %27 = load double* %s, align 8, !dbg !103
  %28 = load double* %w, align 8, !dbg !103
  %29 = load double* %x, align 8, !dbg !103
  %30 = load double* %w, align 8, !dbg !103
  %31 = fadd double %29, %30, !dbg !103
  %32 = fdiv double %28, %31, !dbg !103
  %33 = fsub double %27, %32, !dbg !103
  %34 = load double* %x, align 8, !dbg !103
  %35 = load double* %u, align 8, !dbg !103
  %36 = load double* %w, align 8, !dbg !103
  %37 = fadd double %35, %36, !dbg !103
  %38 = fdiv double %34, %37, !dbg !103
  %39 = fsub double %33, %38, !dbg !103
  %40 = load double* %u, align 8, !dbg !103
  %41 = load double* %x, align 8, !dbg !103
  %42 = load double* %u, align 8, !dbg !103
  %43 = fmul double %41, %42, !dbg !103
  %44 = load double* %w, align 8, !dbg !103
  %45 = fadd double %43, %44, !dbg !103
  %46 = fdiv double %40, %45, !dbg !103
  %47 = fsub double %39, %46, !dbg !103
  store double %47, double* %s, align 8, !dbg !103
  br label %48, !dbg !104

; <label>:48                                      ; preds = %19
  %49 = load i64* %i, align 8, !dbg !98
  %50 = add nsw i64 %49, 1, !dbg !98
  store i64 %50, i64* %i, align 8, !dbg !98
  br label %14, !dbg !98

; <label>:51                                      ; preds = %14
  %52 = load double* @sa, align 8, !dbg !105
  store double %52, double* %x, align 8, !dbg !105
  %53 = load double* %x, align 8, !dbg !106
  %54 = load double* %x, align 8, !dbg !106
  %55 = fmul double %53, %54, !dbg !106
  store double %55, double* %u, align 8, !dbg !106
  %56 = load double* %w, align 8, !dbg !107
  %57 = fsub double -0.000000e+00, %56, !dbg !107
  %58 = load double* %w, align 8, !dbg !107
  %59 = load double* %x, align 8, !dbg !107
  %60 = load double* %w, align 8, !dbg !107
  %61 = fadd double %59, %60, !dbg !107
  %62 = fdiv double %58, %61, !dbg !107
  %63 = fsub double %57, %62, !dbg !107
  %64 = load double* %x, align 8, !dbg !107
  %65 = load double* %u, align 8, !dbg !107
  %66 = load double* %w, align 8, !dbg !107
  %67 = fadd double %65, %66, !dbg !107
  %68 = fdiv double %64, %67, !dbg !107
  %69 = fsub double %63, %68, !dbg !107
  %70 = load double* %u, align 8, !dbg !107
  %71 = load double* %x, align 8, !dbg !107
  %72 = load double* %u, align 8, !dbg !107
  %73 = fmul double %71, %72, !dbg !107
  %74 = load double* %w, align 8, !dbg !107
  %75 = fadd double %73, %74, !dbg !107
  %76 = fdiv double %70, %75, !dbg !107
  %77 = fsub double %69, %76, !dbg !107
  store double %77, double* @sa, align 8, !dbg !107
  %78 = load double* %v, align 8, !dbg !108
  %79 = fmul double 1.800000e+01, %78, !dbg !108
  %80 = load double* @sa, align 8, !dbg !108
  %81 = load double* @two, align 8, !dbg !108
  %82 = load double* %s, align 8, !dbg !108
  %83 = fmul double %81, %82, !dbg !108
  %84 = fadd double %80, %83, !dbg !108
  %85 = fmul double %79, %84, !dbg !108
  store double %85, double* @sa, align 8, !dbg !108
  %86 = load double* @sa, align 8, !dbg !109
  %87 = fptosi double %86 to i64, !dbg !109
  %88 = mul nsw i64 -2000, %87, !dbg !109
  store i64 %88, i64* %m, align 8, !dbg !109
  %89 = load i64* %m, align 8, !dbg !110
  %90 = sitofp i64 %89 to double, !dbg !110
  %91 = load double* @scale, align 8, !dbg !110
  %92 = fdiv double %90, %91, !dbg !110
  %93 = fptosi double %92 to i64, !dbg !110
  store i64 %93, i64* %m, align 8, !dbg !110
  %94 = load double* @sa, align 8, !dbg !111
  %95 = fadd double %94, 5.002000e+02, !dbg !111
  store double %95, double* @sc, align 8, !dbg !111
  %96 = load double* @sc, align 8, !dbg !112
  %97 = fmul double %96, 1.000000e-30, !dbg !112
  %98 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %97, double 0.000000e+00, double 0.000000e+00), !dbg !112
  ret i32 0, !dbg !113
}
...
!94 = metadata !{i32 242, i32 0, metadata !4, null}
!95 = metadata !{i32 243, i32 0, metadata !4, null}
!96 = metadata !{i32 244, i32 0, metadata !4, null}
!97 = metadata !{i32 245, i32 0, metadata !4, null}
!98 = metadata !{i32 247, i32 0, metadata !99, null}
!99 = metadata !{i32 786443, metadata !1, metadata !4, i32 247, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-7.c]
!100 = metadata !{i32 249, i32 0, metadata !101, null}
!101 = metadata !{i32 786443, metadata !1, metadata !99, i32 248, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-7.c]
!102 = metadata !{i32 250, i32 0, metadata !101, null}
!103 = metadata !{i32 251, i32 0, metadata !101, null}
!104 = metadata !{i32 252, i32 0, metadata !101, null}
!105 = metadata !{i32 256, i32 0, metadata !4, null}
!106 = metadata !{i32 257, i32 0, metadata !4, null}
!107 = metadata !{i32 258, i32 0, metadata !4, null}
!108 = metadata !{i32 259, i32 0, metadata !4, null}
!109 = metadata !{i32 261, i32 0, metadata !4, null}
!110 = metadata !{i32 262, i32 0, metadata !4, null}
!111 = metadata !{i32 264, i32 0, metadata !4, null}
!112 = metadata !{i32 269, i32 0, metadata !4, null}
!113 = metadata !{i32 275, i32 0, metadata !4, null}
