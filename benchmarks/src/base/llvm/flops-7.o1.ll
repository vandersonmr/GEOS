...
; <label>:17                                      ; preds = %2
  %18 = load double* @sa, align 8, !dbg !112, !tbaa !82
  tail call void @llvm.dbg.value(metadata !{double %18}, i64 0, metadata !15), !dbg !112
  %19 = fmul double %18, %18, !dbg !113
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !12), !dbg !113
  %20 = fsub double -0.000000e+00, %1, !dbg !114
  %21 = fadd double %1, %18, !dbg !114
  %22 = fdiv double %1, %21, !dbg !114
  %23 = fsub double %20, %22, !dbg !114
  %24 = fadd double %1, %19, !dbg !114
  %25 = fdiv double %18, %24, !dbg !114
  %26 = fsub double %23, %25, !dbg !114
  %27 = fmul double %18, %19, !dbg !114
  %28 = fadd double %1, %27, !dbg !114
  %29 = fdiv double %19, %28, !dbg !114
  %30 = fsub double %26, %29, !dbg !114
  %31 = load double* @two, align 8, !dbg !115, !tbaa !82
  %32 = fmul double %15, %31, !dbg !115
  %33 = fadd double %30, %32, !dbg !115
  %34 = fmul double %33, 0x3EE8B8FD9F05143A, !dbg !115
  store double %34, double* @sa, align 8, !dbg !115, !tbaa !82
  %35 = fadd double %34, 5.002000e+02, !dbg !116
  store double %35, double* @sc, align 8, !dbg !116, !tbaa !82
  %36 = fmul double %35, 1.000000e-30, !dbg !117
  %37 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %36, double 0.000000e+00, double 0.000000e+00) #3, !dbg !117
  ret i32 0, !dbg !118
}
...
!114 = metadata !{i32 258, i32 0, metadata !4, null}
!115 = metadata !{i32 259, i32 0, metadata !4, null}
!116 = metadata !{i32 264, i32 0, metadata !4, null}
!117 = metadata !{i32 269, i32 0, metadata !4, null}
!118 = metadata !{i32 275, i32 0, metadata !4, null}
