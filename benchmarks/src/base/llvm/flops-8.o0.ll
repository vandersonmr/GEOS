...
; <label>:15                                      ; preds = %86, %0
  ...
  br i1 %19, label %20, label %89, !dbg !97
...
; <label>:20                                      ; preds = %15
  ...
  %28 = load double* %w, align 8, !dbg !102
  %29 = load double* %w, align 8, !dbg !102
  %30 = load double* %w, align 8, !dbg !102
  %31 = load double* %w, align 8, !dbg !102
  %32 = load double* %w, align 8, !dbg !102
  %33 = load double* @B6, align 8, !dbg !102
  %34 = load double* %w, align 8, !dbg !102
  %35 = fmul double %33, %34, !dbg !102
  %36 = load double* @B5, align 8, !dbg !102
  %37 = fadd double %35, %36, !dbg !102
  %38 = fmul double %32, %37, !dbg !102
  %39 = load double* @B4, align 8, !dbg !102
  %40 = fadd double %38, %39, !dbg !102
  %41 = fmul double %31, %40, !dbg !102
  %42 = load double* @B3, align 8, !dbg !102
  %43 = fadd double %41, %42, !dbg !102
  %44 = fmul double %30, %43, !dbg !102
  %45 = load double* @B2, align 8, !dbg !102
  %46 = fadd double %44, %45, !dbg !102
  %47 = fmul double %29, %46, !dbg !102
  %48 = load double* @B1, align 8, !dbg !102
  %49 = fadd double %47, %48, !dbg !102
  %50 = fmul double %28, %49, !dbg !102
  %51 = load double* @one, align 8, !dbg !102
  %52 = fadd double %50, %51, !dbg !102
  store double %52, double* %v, align 8, !dbg !102
  %53 = load double* %s, align 8, !dbg !103
  %54 = load double* %v, align 8, !dbg !103
  %55 = load double* %v, align 8, !dbg !103
  %56 = fmul double %54, %55, !dbg !103
  %57 = load double* %u, align 8, !dbg !103
  %58 = fmul double %56, %57, !dbg !103
  %59 = load double* @A6, align 8, !dbg !103
  %60 = load double* %w, align 8, !dbg !103
  %61 = fmul double %59, %60, !dbg !103
  %62 = load double* @A5, align 8, !dbg !103
  %63 = fadd double %61, %62, !dbg !103
  %64 = load double* %w, align 8, !dbg !103
  %65 = fmul double %63, %64, !dbg !103
  %66 = load double* @A4, align 8, !dbg !103
  %67 = fadd double %65, %66, !dbg !103
  %68 = load double* %w, align 8, !dbg !103
  %69 = fmul double %67, %68, !dbg !103
  %70 = load double* @A3, align 8, !dbg !103
  %71 = fadd double %69, %70, !dbg !103
  %72 = load double* %w, align 8, !dbg !103
  %73 = fmul double %71, %72, !dbg !103
  %74 = load double* @A2, align 8, !dbg !103
  %75 = fadd double %73, %74, !dbg !103
  %76 = load double* %w, align 8, !dbg !103
  %77 = fmul double %75, %76, !dbg !103
  %78 = load double* @A1, align 8, !dbg !103
  %79 = fadd double %77, %78, !dbg !103
  %80 = load double* %w, align 8, !dbg !103
  %81 = fmul double %79, %80, !dbg !103
  %82 = load double* @one, align 8, !dbg !103
  %83 = fadd double %81, %82, !dbg !103
  %84 = fmul double %58, %83, !dbg !103
  %85 = fadd double %53, %84, !dbg !103
  store double %85, double* %s, align 8, !dbg !103
  br label %86, !dbg !104

; <label>:86                                      ; preds = %20
  %87 = load i64* %i, align 8, !dbg !97
  %88 = add nsw i64 %87, 1, !dbg !97
  store i64 %88, i64* %i, align 8, !dbg !97
  br label %15, !dbg !97

; <label>:89                                      ; preds = %15
  %90 = load double* @piref, align 8, !dbg !105
  %91 = load double* @three, align 8, !dbg !105
  %92 = fdiv double %90, %91, !dbg !105
  store double %92, double* %u, align 8, !dbg !105
  %93 = load double* %u, align 8, !dbg !106
  %94 = load double* %u, align 8, !dbg !106
  %95 = fmul double %93, %94, !dbg !106
  store double %95, double* %w, align 8, !dbg !106
  %96 = load double* %u, align 8, !dbg !107
  %97 = load double* @A6, align 8, !dbg !107
  %98 = load double* %w, align 8, !dbg !107
  %99 = fmul double %97, %98, !dbg !107
  %100 = load double* @A5, align 8, !dbg !107
  %101 = fadd double %99, %100, !dbg !107
  %102 = load double* %w, align 8, !dbg !107
  %103 = fmul double %101, %102, !dbg !107
  %104 = load double* @A4, align 8, !dbg !107
  %105 = fadd double %103, %104, !dbg !107
  %106 = load double* %w, align 8, !dbg !107
  %107 = fmul double %105, %106, !dbg !107
  %108 = load double* @A3, align 8, !dbg !107
  %109 = fadd double %107, %108, !dbg !107
  %110 = load double* %w, align 8, !dbg !107
  %111 = fmul double %109, %110, !dbg !107
  %112 = load double* @A2, align 8, !dbg !107
  %113 = fadd double %111, %112, !dbg !107
  %114 = load double* %w, align 8, !dbg !107
  %115 = fmul double %113, %114, !dbg !107
  %116 = load double* @A1, align 8, !dbg !107
  %117 = fadd double %115, %116, !dbg !107
  %118 = load double* %w, align 8, !dbg !107
  %119 = fmul double %117, %118, !dbg !107
  %120 = load double* @one, align 8, !dbg !107
  %121 = fadd double %119, %120, !dbg !107
  %122 = fmul double %96, %121, !dbg !107
  store double %122, double* @sa, align 8, !dbg !107
  %123 = load double* %w, align 8, !dbg !108
  %124 = load double* %w, align 8, !dbg !108
  %125 = load double* %w, align 8, !dbg !108
  %126 = load double* %w, align 8, !dbg !108
  %127 = load double* %w, align 8, !dbg !108
  %128 = load double* @B6, align 8, !dbg !108
  %129 = load double* %w, align 8, !dbg !108
  %130 = fmul double %128, %129, !dbg !108
  %131 = load double* @B5, align 8, !dbg !108
  %132 = fadd double %130, %131, !dbg !108
  %133 = fmul double %127, %132, !dbg !108
  %134 = load double* @B4, align 8, !dbg !108
  %135 = fadd double %133, %134, !dbg !108
  %136 = fmul double %126, %135, !dbg !108
  %137 = load double* @B3, align 8, !dbg !108
  %138 = fadd double %136, %137, !dbg !108
  %139 = fmul double %125, %138, !dbg !108
  %140 = load double* @B2, align 8, !dbg !108
  %141 = fadd double %139, %140, !dbg !108
  %142 = fmul double %124, %141, !dbg !108
  %143 = load double* @B1, align 8, !dbg !108
  %144 = fadd double %142, %143, !dbg !108
  %145 = fmul double %123, %144, !dbg !108
  %146 = load double* @one, align 8, !dbg !108
  %147 = fadd double %145, %146, !dbg !108
  store double %147, double* @sb, align 8, !dbg !108
  %148 = load double* @sa, align 8, !dbg !109
  %149 = load double* @sb, align 8, !dbg !109
  %150 = fmul double %148, %149, !dbg !109
  %151 = load double* @sb, align 8, !dbg !109
  %152 = fmul double %150, %151, !dbg !109
  store double %152, double* @sa, align 8, !dbg !109
  %153 = load double* %x, align 8, !dbg !110
  %154 = load double* @sa, align 8, !dbg !110
  %155 = load double* @two, align 8, !dbg !110
  %156 = load double* %s, align 8, !dbg !110
  %157 = fmul double %155, %156, !dbg !110
  %158 = fadd double %154, %157, !dbg !110
  %159 = fmul double %153, %158, !dbg !110
  %160 = load double* @two, align 8, !dbg !110
  %161 = fdiv double %159, %160, !dbg !110
  store double %161, double* @sa, align 8, !dbg !110
  store double 0x3FD2AAAAAAAAAAAB, double* @sb, align 8, !dbg !111
  %162 = load double* @sa, align 8, !dbg !112
  %163 = load double* @sb, align 8, !dbg !112
  %164 = fsub double %162, %163, !dbg !112
  store double %164, double* @sc, align 8, !dbg !112
  %165 = load double* @sc, align 8, !dbg !113
  %166 = fmul double %165, 1.000000e-30, !dbg !113
  %167 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %166, double 0.000000e+00, double 0.000000e+00), !dbg !113
  ret i32 0, !dbg !114
}
...
!94 = metadata !{i32 241, i32 0, metadata !4, null}
!95 = metadata !{i32 242, i32 0, metadata !4, null}
!96 = metadata !{i32 243, i32 0, metadata !4, null}
!97 = metadata !{i32 245, i32 0, metadata !98, null}
!98 = metadata !{i32 786443, metadata !1, metadata !4, i32 245, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-8.c]
!99 = metadata !{i32 247, i32 0, metadata !100, null}
!100 = metadata !{i32 786443, metadata !1, metadata !98, i32 246, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/flops-8.c]
!101 = metadata !{i32 248, i32 0, metadata !100, null}
!102 = metadata !{i32 249, i32 0, metadata !100, null}
!103 = metadata !{i32 250, i32 0, metadata !100, null}
!104 = metadata !{i32 251, i32 0, metadata !100, null}
!105 = metadata !{i32 253, i32 0, metadata !4, null}
!106 = metadata !{i32 254, i32 0, metadata !4, null}
!107 = metadata !{i32 255, i32 0, metadata !4, null}
!108 = metadata !{i32 256, i32 0, metadata !4, null}
!109 = metadata !{i32 257, i32 0, metadata !4, null}
!110 = metadata !{i32 259, i32 0, metadata !4, null}
!111 = metadata !{i32 260, i32 0, metadata !4, null}
!112 = metadata !{i32 261, i32 0, metadata !4, null}
!113 = metadata !{i32 266, i32 0, metadata !4, null}
!114 = metadata !{i32 271, i32 0, metadata !4, null}
