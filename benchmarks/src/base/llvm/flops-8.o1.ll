...
; <label>:51                                      ; preds = %18
  %52 = load double* @piref, align 8, !dbg !111, !tbaa !82
  %53 = load double* @three, align 8, !dbg !111, !tbaa !82
  %54 = fdiv double %52, %53, !dbg !111
  tail call void @llvm.dbg.value(metadata !{double %54}, i64 0, metadata !12), !dbg !111
  %55 = fmul double %54, %54, !dbg !112
  tail call void @llvm.dbg.value(metadata !{double %55}, i64 0, metadata !14), !dbg !112
  %56 = load double* @A6, align 8, !dbg !113, !tbaa !82
  %57 = fmul double %56, %55, !dbg !113
  %58 = load double* @A5, align 8, !dbg !113, !tbaa !82
  %59 = fadd double %57, %58, !dbg !113
  %60 = fmul double %55, %59, !dbg !113
  %61 = load double* @A4, align 8, !dbg !113, !tbaa !82
  %62 = fadd double %61, %60, !dbg !113
  %63 = fmul double %55, %62, !dbg !113
  %64 = load double* @A3, align 8, !dbg !113, !tbaa !82
  %65 = fadd double %64, %63, !dbg !113
  %66 = fmul double %55, %65, !dbg !113
  %67 = load double* @A2, align 8, !dbg !113, !tbaa !82
  %68 = fadd double %67, %66, !dbg !113
  %69 = fmul double %55, %68, !dbg !113
  %70 = load double* @A1, align 8, !dbg !113, !tbaa !82
  %71 = fadd double %70, %69, !dbg !113
  %72 = fmul double %55, %71, !dbg !113
  %73 = load double* @one, align 8, !dbg !113, !tbaa !82
  %74 = fadd double %73, %72, !dbg !113
  %75 = fmul double %54, %74, !dbg !113
  store double %75, double* @sa, align 8, !dbg !113, !tbaa !82
  %76 = load double* @B6, align 8, !dbg !114, !tbaa !82
  %77 = fmul double %55, %76, !dbg !114
  %78 = load double* @B5, align 8, !dbg !114, !tbaa !82
  %79 = fadd double %77, %78, !dbg !114
  %80 = fmul double %55, %79, !dbg !114
  %81 = load double* @B4, align 8, !dbg !114, !tbaa !82
  %82 = fadd double %81, %80, !dbg !114
  %83 = fmul double %55, %82, !dbg !114
  %84 = load double* @B3, align 8, !dbg !114, !tbaa !82
  %85 = fadd double %84, %83, !dbg !114
  %86 = fmul double %55, %85, !dbg !114
  %87 = load double* @B2, align 8, !dbg !114, !tbaa !82
  %88 = fadd double %87, %86, !dbg !114
  %89 = fmul double %55, %88, !dbg !114
  %90 = load double* @B1, align 8, !dbg !114, !tbaa !82
  %91 = fadd double %90, %89, !dbg !114
  %92 = fmul double %55, %91, !dbg !114
  %93 = load double* @one, align 8, !dbg !114, !tbaa !82
  %94 = fadd double %93, %92, !dbg !114
  %95 = load double* @sa, align 8, !dbg !115, !tbaa !82
  %96 = fmul double %95, %94, !dbg !115
  %97 = fmul double %94, %96, !dbg !115
  %98 = load double* @two, align 8, !dbg !116, !tbaa !82
  %99 = fmul double %49, %98, !dbg !116
  %100 = fadd double %99, %97, !dbg !116
  %101 = fmul double %4, %100, !dbg !116
  %102 = fdiv double %101, %98, !dbg !116
  store double %102, double* @sa, align 8, !dbg !116, !tbaa !82
  store double 0x3FD2AAAAAAAAAAAB, double* @sb, align 8, !dbg !117, !tbaa !82
  %103 = fadd double %102, 0xBFD2AAAAAAAAAAAB, !dbg !118
  store double %103, double* @sc, align 8, !dbg !118, !tbaa !82
  %104 = fmul double %103, 1.000000e-30, !dbg !119
  %105 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %104, double 0.000000e+00, double 0.000000e+00) #3, !dbg !119
  ret i32 0, !dbg !120
}
