...
define i32 @main() #0 {
  ...
  %2 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !120
  ...
  %10 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !132
...
; <label>:23                                      ; preds = %18
  ...
  %28 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !150
...
._crit_edge67:                                    ; preds = %48, %23
  ...
  %66 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !165
...
; <label>:75                                      ; preds = %._crit_edge67, %18
  ...
  %77 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !178
  ...
  %85 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !188
  ...
  %130 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %127, double %128, double %129) #4, !dbg !202
  ...
  %135 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !211
...
; <label>:148                                     ; preds = %._crit_edge58, %75
  ...
  %149 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !223
  ...
  %162 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !239
...
; <label>:183                                     ; preds = %._crit_edge47, %148
  ...
  %184 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !256
  ...
  %219 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str5, i64 0, i64 0), double %216, double %217, double %218) #4, !dbg !268
  ...
  %226 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !277
...
._crit_edge36:                                    ; preds = %243, %183
  ...
  %263 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !292
  ...
  %310 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str6, i64 0, i64 0), double %307, double %308, double %309) #4, !dbg !304
  ...
  %320 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !315
...
._crit_edge29:                                    ; preds = %335, %._crit_edge36
  ...
  %354 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !329
  ...
  %421 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str7, i64 0, i64 0), double %418, double %419, double %420) #4, !dbg !343
  ...
  %427 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !352
...
._crit_edge23:                                    ; preds = %458, %._crit_edge29
  ...
  %488 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !368
  ...
  %554 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str8, i64 0, i64 0), double %551, double %552, double %553) #4, !dbg !382
  ...
  %560 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !391
...
._crit_edge17:                                    ; preds = %591, %._crit_edge23
  ...
  %621 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !406
  ...
  %687 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str9, i64 0, i64 0), double %684, double %685, double %686) #4, !dbg !420
  ...
  %691 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !430
...
._crit_edge11:                                    ; preds = %.lr.ph10, %._crit_edge17
  ...
  %714 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !444
  ...
  %757 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str10, i64 0, i64 0), double %754, double %755, double %756) #4, !dbg !457
  ...
  %764 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !466
...
._crit_edge:                                      ; preds = %787, %._crit_edge11
  ...
  %821 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !481
  ...
  %888 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str11, i64 0, i64 0), double %885, double %886, double %887) #4, !dbg !495
  ...
  %923 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str12, i64 0, i64 0), i64 %750) #4, !dbg !506
  %924 = load double* @nulltime, align 8, !dbg !507, !tbaa !98
  %925 = fmul double %924, 1.000000e-30, !dbg !507
  %926 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str13, i64 0, i64 0), double %925) #4, !dbg !507
  ...
  %929 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str14, i64 0, i64 0), double %928) #4, !dbg !508
  ...
  %932 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str15, i64 0, i64 0), double %931) #4, !dbg !509
  ...
  %935 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str16, i64 0, i64 0), double %934) #4, !dbg !510
  ...
  %938 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([31 x i8]* @.str17, i64 0, i64 0), double %937) #4, !dbg !511
  ret i32 0, !dbg !512
}
...
define i32 @dtime(double* nocapture %p) #0 {
  ...
  %3 = tail call i32 @gettimeofday(%struct.timeval* @tnow, %struct.timezone* null) #4, !dbg !515
