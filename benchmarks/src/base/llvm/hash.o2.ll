...
; <label>:22                                      ; preds = %ht_find_new.exit, %.lr.ph22
  %i.021 = phi i32 [ 1, %.lr.ph22 ], [ %53, %ht_find_new.exit ]
...
ht_hashcode.exit.i:                               ; preds = %.lr.ph.i.i, %22
  ...
  br i1 %37, label %._crit_edge.i.thread, label %.lr.ph.i, !dbg !214

._crit_edge.i.thread:                             ; preds = %ht_hashcode.exit.i
  %38 = call %struct.ht_node* @ht_node_create(i8* %19) #5, !dbg !215
  br label %50, !dbg !218

; <label>:39                                      ; preds = %.lr.ph.i
  %40 = getelementptr inbounds %struct.ht_node* %node.04.i, i64 0, i32 2, !dbg !219
  %node.0.i = load %struct.ht_node** %40, align 8, !dbg !213
  %41 = icmp eq %struct.ht_node* %node.0.i, null, !dbg !214
  br i1 %41, label %._crit_edge.i, label %.lr.ph.i, !dbg !214

.lr.ph.i:                                         ; preds = %ht_hashcode.exit.i, %39
  %node.04.i = phi %struct.ht_node* [ %node.0.i, %39 ], [ %node.03.i, %ht_hashcode.exit.i ]
  %42 = getelementptr inbounds %struct.ht_node* %node.04.i, i64 0, i32 0, !dbg !220
  %43 = load i8** %42, align 8, !dbg !220, !tbaa !128
  %44 = call i32 @strcmp(i8* %19, i8* %43) #5, !dbg !220
  %45 = icmp eq i32 %44, 0, !dbg !220
  tail call void @llvm.dbg.value(metadata !{%struct.ht_node* %node.04.i}, i64 0, metadata !212) #5, !dbg !221
  br i1 %45, label %ht_find_new.exit, label %39, !dbg !220

._crit_edge.i:                                    ; preds = %39
  %46 = icmp eq %struct.ht_node* %node.04.i, null, !dbg !218
  %47 = call %struct.ht_node* @ht_node_create(i8* %19) #5, !dbg !215
  br i1 %46, label %50, label %48, !dbg !218

; <label>:48                                      ; preds = %._crit_edge.i
  %49 = getelementptr inbounds %struct.ht_node* %node.04.i, i64 0, i32 2, !dbg !215
  store %struct.ht_node* %47, %struct.ht_node** %49, align 8, !dbg !215, !tbaa !137
  br label %ht_find_new.exit, !dbg !215

; <label>:50                                      ; preds = %._crit_edge.i.thread, %._crit_edge.i
  %51 = phi %struct.ht_node* [ %38, %._crit_edge.i.thread ], [ %47, %._crit_edge.i ]
  store %struct.ht_node* %51, %struct.ht_node** %36, align 8, !dbg !222, !tbaa !163
  br label %ht_find_new.exit, !dbg !222

ht_find_new.exit:                                 ; preds = %.lr.ph.i, %48, %50
  %.0.i = phi %struct.ht_node* [ %47, %48 ], [ %51, %50 ], [ %node.04.i, %.lr.ph.i ]
  %52 = getelementptr inbounds %struct.ht_node* %.0.i, i64 0, i32 1, !dbg !199
  store i32 %i.021, i32* %52, align 4, !dbg !199, !tbaa !135
  %53 = add nsw i32 %i.021, 1, !dbg !190
  tail call void @llvm.dbg.value(metadata !{i32 %53}, i64 0, metadata !54), !dbg !190
  %exitcond = icmp eq i32 %i.021, %8, !dbg !190
  br i1 %exitcond, label %.preheader, label %22, !dbg !190

; <label>:54                                      ; preds = %.lr.ph, %ht_find.exit
  %i.120 = phi i32 [ %8, %.lr.ph ], [ %78, %ht_find.exit ]
  %c.019 = phi i32 [ 0, %.lr.ph ], [ %c.0., %ht_find.exit ]
  %55 = call i32 (i8*, i8*, ...)* @sprintf(i8* %21, i8* getelementptr inbounds ([3 x i8]* @.str3, i64 0, i64 0), i32 %i.120) #5, !dbg !196
  tail call void @llvm.dbg.value(metadata !{i8* %21}, i64 0, metadata !224) #5, !dbg !227
  tail call void @llvm.dbg.value(metadata !{i8* %21}, i64 0, metadata !228) #5, !dbg !230
  tail call void @llvm.dbg.value(metadata !204, i64 0, metadata !231) #5, !dbg !232
  %56 = load i8* %21, align 16, !dbg !233, !tbaa !209
  %57 = icmp eq i8 %56, 0, !dbg !233
  br i1 %57, label %ht_hashcode.exit.i7, label %.lr.ph.i.i4, !dbg !233

.lr.ph.i.i4:                                      ; preds = %54, %.lr.ph.i.i4
  %58 = phi i8 [ %63, %.lr.ph.i.i4 ], [ %56, %54 ]
  %val.02.i.i2 = phi i64 [ %61, %.lr.ph.i.i4 ], [ 0, %54 ]
  %.01.i.i3 = phi i8* [ %62, %.lr.ph.i.i4 ], [ %21, %54 ]
  %59 = mul i64 %val.02.i.i2, 5, !dbg !233
  %60 = sext i8 %58 to i64, !dbg !233
  %61 = add i64 %59, %60, !dbg !233
  tail call void @llvm.dbg.value(metadata !{i64 %61}, i64 0, metadata !231) #5, !dbg !233
  %62 = getelementptr inbounds i8* %.01.i.i3, i64 1, !dbg !233
  tail call void @llvm.dbg.value(metadata !{i8* %62}, i64 0, metadata !228) #5, !dbg !233
  %63 = load i8* %62, align 1, !dbg !233, !tbaa !209
  %64 = icmp eq i8 %63, 0, !dbg !233
  br i1 %64, label %ht_hashcode.exit.i7, label %.lr.ph.i.i4, !dbg !233

ht_hashcode.exit.i7:                              ; preds = %.lr.ph.i.i4, %54
  %val.0.lcssa.i.i5 = phi i64 [ 0, %54 ], [ %61, %.lr.ph.i.i4 ]
  %sext26 = shl i64 %12, 32, !dbg !234
  %65 = ashr exact i64 %sext26, 32, !dbg !234
  %66 = urem i64 %val.0.lcssa.i.i5, %65, !dbg !234
  %sext.i6 = shl i64 %66, 32, !dbg !235
  %67 = ashr exact i64 %sext.i6, 32, !dbg !235
  %68 = getelementptr inbounds %struct.ht_node** %17, i64 %67, !dbg !235
  %node.01.i = load %struct.ht_node** %68, align 8, !dbg !235
  %69 = icmp eq %struct.ht_node* %node.01.i, null, !dbg !236
  br i1 %69, label %ht_find.exit, label %.lr.ph.i9, !dbg !236

; <label>:70                                      ; preds = %.lr.ph.i9
  %71 = getelementptr inbounds %struct.ht_node* %node.02.i, i64 0, i32 2, !dbg !237
  %node.0.i8 = load %struct.ht_node** %71, align 8, !dbg !235
  %72 = icmp eq %struct.ht_node* %node.0.i8, null, !dbg !236
  br i1 %72, label %ht_find.exit, label %.lr.ph.i9, !dbg !236

.lr.ph.i9:                                        ; preds = %ht_hashcode.exit.i7, %70
  %node.02.i = phi %struct.ht_node* [ %node.0.i8, %70 ], [ %node.01.i, %ht_hashcode.exit.i7 ]
  %73 = getelementptr inbounds %struct.ht_node* %node.02.i, i64 0, i32 0, !dbg !238
  %74 = load i8** %73, align 8, !dbg !238, !tbaa !128
  %75 = call i32 @strcmp(i8* %21, i8* %74) #5, !dbg !238
  %76 = icmp eq i32 %75, 0, !dbg !238
  br i1 %76, label %ht_find.exit, label %70, !dbg !238

ht_find.exit:                                     ; preds = %70, %.lr.ph.i9, %ht_hashcode.exit.i7
  %.0.i10 = phi %struct.ht_node* [ null, %ht_hashcode.exit.i7 ], [ null, %70 ], [ %node.02.i, %.lr.ph.i9 ]
  %not. = icmp ne %struct.ht_node* %.0.i10, null, !dbg !225
  %77 = zext i1 %not. to i32, !dbg !225
  %c.0. = add nsw i32 %77, %c.019, !dbg !225
  %78 = add nsw i32 %i.120, -1, !dbg !194
  tail call void @llvm.dbg.value(metadata !{i32 %78}, i64 0, metadata !54), !dbg !194
  %79 = icmp sgt i32 %78, 0, !dbg !194
  br i1 %79, label %54, label %._crit_edge, !dbg !194

._crit_edge:                                      ; preds = %ht_find.exit, %ht_create.exit, %.preheader
  %c.0.lcssa = phi i32 [ 0, %.preheader ], [ 0, %ht_create.exit ], [ %c.0., %ht_find.exit ]
  tail call void @llvm.dbg.value(metadata !140, i64 0, metadata !239) #5, !dbg !241
  %80 = icmp sgt i32 %14, 0, !dbg !241
  br i1 %80, label %.lr.ph4.i, label %ht_destroy.exit, !dbg !241

.lr.ph4.i:                                        ; preds = %._crit_edge, %._crit_edge.i14
  %indvars.iv.i12 = phi i64 [ %indvars.iv.next.i15, %._crit_edge.i14 ], [ 0, %._crit_edge ]
  %81 = getelementptr inbounds %struct.ht_node** %17, i64 %indvars.iv.i12, !dbg !242
  %82 = load %struct.ht_node** %81, align 8, !dbg !242, !tbaa !163
  tail call void @llvm.dbg.value(metadata !{%struct.ht_node* %82}, i64 0, metadata !243) #5, !dbg !242
  %83 = icmp eq %struct.ht_node* %82, null, !dbg !244
  br i1 %83, label %._crit_edge.i14, label %.lr.ph.i13, !dbg !244

.lr.ph.i13:                                       ; preds = %.lr.ph4.i, %.lr.ph.i13
  %next.01.i = phi %struct.ht_node* [ %85, %.lr.ph.i13 ], [ %82, %.lr.ph4.i ]
  tail call void @llvm.dbg.value(metadata !{%struct.ht_node* %next.01.i}, i64 0, metadata !245) #5, !dbg !246
  %84 = getelementptr inbounds %struct.ht_node* %next.01.i, i64 0, i32 2, !dbg !247
  %85 = load %struct.ht_node** %84, align 8, !dbg !247, !tbaa !137
  tail call void @llvm.dbg.value(metadata !{%struct.ht_node* %85}, i64 0, metadata !243) #5, !dbg !247
  %86 = getelementptr inbounds %struct.ht_node* %next.01.i, i64 0, i32 0, !dbg !248
  %87 = load i8** %86, align 8, !dbg !248, !tbaa !128
  tail call void @free(i8* %87) #5, !dbg !248
  %88 = bitcast %struct.ht_node* %next.01.i to i8*, !dbg !249
  tail call void @free(i8* %88) #5, !dbg !249
  %89 = icmp eq %struct.ht_node* %85, null, !dbg !244
  br i1 %89, label %._crit_edge.i14, label %.lr.ph.i13, !dbg !244

._crit_edge.i14:                                  ; preds = %.lr.ph.i13, %.lr.ph4.i
  %indvars.iv.next.i15 = add nuw nsw i64 %indvars.iv.i12, 1, !dbg !241
  %90 = trunc i64 %indvars.iv.next.i15 to i32, !dbg !241
  %91 = icmp slt i32 %90, %14, !dbg !241
  br i1 %91, label %.lr.ph4.i, label %ht_destroy.exit, !dbg !241

ht_destroy.exit:                                  ; preds = %._crit_edge.i14, %._crit_edge
  tail call void @free(i8* %16) #5, !dbg !250
  %92 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %c.0.lcssa) #5, !dbg !251
  ret i32 0, !dbg !252
}
...
!215 = metadata !{i32 148, i32 0, metadata !216, metadata !199}
!216 = metadata !{i32 786443, metadata !5, metadata !217, i32 147, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!217 = metadata !{i32 786443, metadata !5, metadata !87, i32 147, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!218 = metadata !{i32 147, i32 0, metadata !217, metadata !199}
!219 = metadata !{i32 141, i32 0, metadata !97, metadata !199}
!220 = metadata !{i32 139, i32 0, metadata !95, metadata !199}
!221 = metadata !{i32 140, i32 0, metadata !97, metadata !199}
!222 = metadata !{i32 150, i32 0, metadata !223, metadata !199}
!223 = metadata !{i32 786443, metadata !5, metadata !217, i32 149, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!224 = metadata !{i32 786689, metadata !63, metadata !"key", metadata !6, i32 33554557, metadata !13, i32 0, metadata !225} ; [ DW_TAG_arg_variable ] [key] [line 125]
!225 = metadata !{i32 29, i32 0, metadata !226, null}
!226 = metadata !{i32 786443, metadata !1, metadata !197, i32 29, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/hash.c]
!227 = metadata !{i32 125, i32 0, metadata !63, metadata !225}
!228 = metadata !{i32 786689, metadata !80, metadata !"key", metadata !6, i32 33554478, metadata !13, i32 0, metadata !229} ; [ DW_TAG_arg_variable ] [key] [line 46]
!229 = metadata !{i32 126, i32 0, metadata !70, metadata !225}
!230 = metadata !{i32 46, i32 0, metadata !80, metadata !229}
!231 = metadata !{i32 786688, metadata !80, metadata !"val", metadata !6, i32 47, metadata !78, i32 0, metadata !229} ; [ DW_TAG_auto_variable ] [val] [line 47]
!232 = metadata !{i32 47, i32 0, metadata !80, metadata !229}
!233 = metadata !{i32 48, i32 0, metadata !208, metadata !229}
!234 = metadata !{i32 49, i32 0, metadata !80, metadata !229}
!235 = metadata !{i32 127, i32 0, metadata !70, metadata !225}
!236 = metadata !{i32 128, i32 0, metadata !70, metadata !225}
!237 = metadata !{i32 130, i32 0, metadata !75, metadata !225}
!238 = metadata !{i32 129, i32 0, metadata !73, metadata !225}
!239 = metadata !{i32 786688, metadata !38, metadata !"i", metadata !6, i32 86, metadata !16, i32 0, metadata !240} ; [ DW_TAG_auto_variable ] [i] [line 86]
!240 = metadata !{i32 32, i32 0, metadata !55, null}
!241 = metadata !{i32 95, i32 0, metadata !160, metadata !240}
!242 = metadata !{i32 96, i32 0, metadata !162, metadata !240}
!243 = metadata !{i32 786688, metadata !38, metadata !"next", metadata !6, i32 85, metadata !9, i32 0, metadata !240} ; [ DW_TAG_auto_variable ] [next] [line 85]
!244 = metadata !{i32 103, i32 0, metadata !162, metadata !240}
!245 = metadata !{i32 786688, metadata !38, metadata !"cur", metadata !6, i32 85, metadata !9, i32 0, metadata !240} ; [ DW_TAG_auto_variable ] [cur] [line 85]
!246 = metadata !{i32 104, i32 0, metadata !166, metadata !240}
!247 = metadata !{i32 105, i32 0, metadata !166, metadata !240}
!248 = metadata !{i32 106, i32 0, metadata !166, metadata !240}
!249 = metadata !{i32 107, i32 0, metadata !166, metadata !240}
!250 = metadata !{i32 117, i32 0, metadata !38, metadata !240}
!251 = metadata !{i32 34, i32 0, metadata !55, null}
!252 = metadata !{i32 35, i32 0, metadata !55, null}
