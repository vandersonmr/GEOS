...
define noalias %struct.ht_node* @ht_node_create(i8* nocapture readonly %key) #0 {
  ...
  %1 = tail call noalias i8* @malloc(i64 24) #5, !dbg !96
...
; <label>:4                                       ; preds = %0
  tail call void @perror(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0)) #6, !dbg !98
  tail call void @exit(i32 1) #7, !dbg !100
  unreachable, !dbg !100

; <label>:5                                       ; preds = %0
  %6 = tail call noalias i8* @strdup(i8* %key) #5, !dbg !101
...
; <label>:8                                       ; preds = %5
  tail call void @perror(i8* getelementptr inbounds ([14 x i8]* @.str1, i64 0, i64 0)) #6, !dbg !103
...
define noalias %struct.ht_ht* @ht_create(i32 %size) #0 {
  ...
  %1 = tail call noalias i8* @malloc(i64 40) #5, !dbg !121
...
; <label>:7                                       ; preds = %3
  ...
  %12 = tail call noalias i8* @calloc(i64 %11, i64 8) #5, !dbg !128
...
.lr.ph:                                           ; preds = %.lr.ph4, %.lr.ph
  ...
  tail call void @free(i8* %13) #5, !dbg !147
  %14 = bitcast %struct.ht_node* %next.01 to i8*, !dbg !148
  tail call void @free(i8* %14) #5, !dbg !148
...
._crit_edge5:                                     ; preds = %16, %0
  ...
  tail call void @free(i8* %21) #5, !dbg !149
  %22 = bitcast %struct.ht_ht* %ht to i8*, !dbg !150
  tail call void @free(i8* %22) #5, !dbg !150
  ret void, !dbg !151
}
...
.thread:                                          ; preds = %0
  ...
  %2 = tail call %struct.ht_ht* @ht_create(i32 3500000) #8, !dbg !155
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !62), !dbg !155
  tail call void @llvm.dbg.value(metadata !156, i64 0, metadata !54), !dbg !157
  br label %.lr.ph17, !dbg !157

; <label>:3                                       ; preds = %0
  %4 = getelementptr inbounds i8** %argv, i64 1, !dbg !153
  %5 = load i8** %4, align 8, !dbg !153, !tbaa !142
  %6 = tail call i32 @atoi(i8* %5) #9, !dbg !153
  tail call void @llvm.dbg.value(metadata !{i32 %10}, i64 0, metadata !57), !dbg !153
  tail call void @llvm.dbg.declare(metadata !{[32 x i8]* %buf}, metadata !58), !dbg !154
  %7 = tail call %struct.ht_ht* @ht_create(i32 %6) #8, !dbg !155
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !62), !dbg !155
  tail call void @llvm.dbg.value(metadata !156, i64 0, metadata !54), !dbg !157
  %8 = icmp slt i32 %6, 1, !dbg !157
  br i1 %8, label %._crit_edge, label %.lr.ph17, !dbg !157

.lr.ph17:                                         ; preds = %.thread, %3
  %9 = phi %struct.ht_ht* [ %2, %.thread ], [ %7, %3 ]
  %10 = phi i32 [ 3500000, %.thread ], [ %6, %3 ]
  %11 = getelementptr inbounds [32 x i8]* %buf, i64 0, i64 0, !dbg !159
  %12 = getelementptr inbounds %struct.ht_ht* %9, i64 0, i32 0, !dbg !161
  %13 = getelementptr inbounds %struct.ht_ht* %9, i64 0, i32 1, !dbg !164
  %14 = getelementptr inbounds %struct.ht_ht* %9, i64 0, i32 4, !dbg !165
  br label %19, !dbg !157

.preheader:                                       ; preds = %ht_find_new.exit
  %15 = icmp sgt i32 %10, 0, !dbg !166
  br i1 %15, label %.lr.ph, label %._crit_edge, !dbg !166

.lr.ph:                                           ; preds = %.preheader
  %16 = getelementptr inbounds [32 x i8]* %buf, i64 0, i64 0, !dbg !168
  %17 = getelementptr inbounds %struct.ht_ht* %9, i64 0, i32 0, !dbg !170
  %18 = getelementptr inbounds %struct.ht_ht* %9, i64 0, i32 1, !dbg !174
  br label %53, !dbg !166

; <label>:19                                      ; preds = %ht_find_new.exit, %.lr.ph17
  %i.015 = phi i32 [ 1, %.lr.ph17 ], [ %52, %ht_find_new.exit ]
  %20 = call i32 (i8*, i8*, ...)* @sprintf(i8* %11, i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0), i32 %i.015) #5, !dbg !159
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !175) #10, !dbg !176
  tail call void @llvm.dbg.value(metadata !{i8* %11}, i64 0, metadata !177) #10, !dbg !176
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !178) #10, !dbg !179
  tail call void @llvm.dbg.value(metadata !{i8* %11}, i64 0, metadata !180) #10, !dbg !179
  tail call void @llvm.dbg.value(metadata !181, i64 0, metadata !182) #10, !dbg !183
  %21 = load i8* %11, align 16, !dbg !184, !tbaa !186
  %22 = icmp eq i8 %21, 0, !dbg !184
  br i1 %22, label %ht_hashcode.exit.i, label %.lr.ph.i.i, !dbg !184

.lr.ph.i.i:                                       ; preds = %19, %.lr.ph.i.i
  %23 = phi i8 [ %28, %.lr.ph.i.i ], [ %21, %19 ]
  %val.02.i.i = phi i64 [ %26, %.lr.ph.i.i ], [ 0, %19 ]
  %.01.i.i = phi i8* [ %27, %.lr.ph.i.i ], [ %11, %19 ]
  %24 = mul i64 %val.02.i.i, 5, !dbg !184
  %25 = sext i8 %23 to i64, !dbg !184
  %26 = add i64 %24, %25, !dbg !184
  tail call void @llvm.dbg.value(metadata !{i64 %26}, i64 0, metadata !182) #10, !dbg !184
  %27 = getelementptr inbounds i8* %.01.i.i, i64 1, !dbg !184
  tail call void @llvm.dbg.value(metadata !{i8* %27}, i64 0, metadata !180) #10, !dbg !184
  %28 = load i8* %27, align 1, !dbg !184, !tbaa !186
  %29 = icmp eq i8 %28, 0, !dbg !184
  br i1 %29, label %ht_hashcode.exit.i, label %.lr.ph.i.i, !dbg !184

ht_hashcode.exit.i:                               ; preds = %.lr.ph.i.i, %19
  %val.0.lcssa.i.i = phi i64 [ 0, %19 ], [ %26, %.lr.ph.i.i ]
  %30 = load i32* %12, align 4, !dbg !161, !tbaa !126
  %31 = sext i32 %30 to i64, !dbg !161
  %32 = urem i64 %val.0.lcssa.i.i, %31, !dbg !161
  tail call void @llvm.dbg.value(metadata !187, i64 0, metadata !188) #10, !dbg !164
  %sext.i = shl i64 %32, 32, !dbg !164
  %33 = ashr exact i64 %sext.i, 32, !dbg !164
  %34 = load %struct.ht_node*** %13, align 8, !dbg !164, !tbaa !129
  %35 = getelementptr inbounds %struct.ht_node** %34, i64 %33, !dbg !164
  %node.03.i = load %struct.ht_node** %35, align 8, !dbg !164
  %36 = icmp eq %struct.ht_node* %node.03.i, null, !dbg !189
  br i1 %36, label %._crit_edge.i, label %.lr.ph.i, !dbg !189

; <label>:37                                      ; preds = %.lr.ph.i
  %38 = getelementptr inbounds %struct.ht_node* %node.04.i, i64 0, i32 2, !dbg !190
  %node.0.i = load %struct.ht_node** %38, align 8, !dbg !164
  %39 = icmp eq %struct.ht_node* %node.0.i, null, !dbg !189
  br i1 %39, label %._crit_edge.i, label %.lr.ph.i, !dbg !189

.lr.ph.i:                                         ; preds = %ht_hashcode.exit.i, %37
  %node.04.i = phi %struct.ht_node* [ %node.0.i, %37 ], [ %node.03.i, %ht_hashcode.exit.i ]
  %40 = getelementptr inbounds %struct.ht_node* %node.04.i, i64 0, i32 0, !dbg !192
  %41 = load i8** %40, align 8, !dbg !192, !tbaa !107
  %42 = call i32 @strcmp(i8* %11, i8* %41) #9, !dbg !192
  %43 = icmp eq i32 %42, 0, !dbg !192
  tail call void @llvm.dbg.value(metadata !{%struct.ht_node* %node.04.i}, i64 0, metadata !188) #10, !dbg !194
  br i1 %43, label %ht_find_new.exit, label %37, !dbg !192

._crit_edge.i:                                    ; preds = %37, %ht_hashcode.exit.i
  %prev.0.lcssa.i = phi %struct.ht_node* [ null, %ht_hashcode.exit.i ], [ %node.04.i, %37 ]
  %44 = load i32* %14, align 4, !dbg !165, !tbaa !135
  %45 = add nsw i32 %44, 1, !dbg !165
  store i32 %45, i32* %14, align 4, !dbg !165, !tbaa !135
  %46 = icmp eq %struct.ht_node* %prev.0.lcssa.i, null, !dbg !195
  %47 = call %struct.ht_node* @ht_node_create(i8* %11) #5, !dbg !197
  br i1 %46, label %50, label %48, !dbg !195

; <label>:48                                      ; preds = %._crit_edge.i
  %49 = getelementptr inbounds %struct.ht_node* %prev.0.lcssa.i, i64 0, i32 2, !dbg !197
  store %struct.ht_node* %47, %struct.ht_node** %49, align 8, !dbg !197, !tbaa !116
  br label %ht_find_new.exit, !dbg !197

; <label>:50                                      ; preds = %._crit_edge.i
  store %struct.ht_node* %47, %struct.ht_node** %35, align 8, !dbg !199, !tbaa !142
  br label %ht_find_new.exit, !dbg !199

ht_find_new.exit:                                 ; preds = %.lr.ph.i, %48, %50
  %.0.i = phi %struct.ht_node* [ %47, %48 ], [ %47, %50 ], [ %node.04.i, %.lr.ph.i ]
  %51 = getelementptr inbounds %struct.ht_node* %.0.i, i64 0, i32 1, !dbg !163
  store i32 %i.015, i32* %51, align 4, !dbg !163, !tbaa !114
  %52 = add nsw i32 %i.015, 1, !dbg !157
  tail call void @llvm.dbg.value(metadata !{i32 %52}, i64 0, metadata !54), !dbg !157
  %exitcond = icmp eq i32 %i.015, %10, !dbg !157
  br i1 %exitcond, label %.preheader, label %19, !dbg !157

; <label>:53                                      ; preds = %.lr.ph, %ht_find.exit
  %i.114 = phi i32 [ %10, %.lr.ph ], [ %79, %ht_find.exit ]
  %c.013 = phi i32 [ 0, %.lr.ph ], [ %c.0., %ht_find.exit ]
  %54 = call i32 (i8*, i8*, ...)* @sprintf(i8* %16, i8* getelementptr inbounds ([3 x i8]* @.str3, i64 0, i64 0), i32 %i.114) #5, !dbg !168
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !201) #10, !dbg !202
  tail call void @llvm.dbg.value(metadata !{i8* %16}, i64 0, metadata !203) #10, !dbg !202
  tail call void @llvm.dbg.value(metadata !{%struct.ht_ht* %81}, i64 0, metadata !204) #10, !dbg !205
  tail call void @llvm.dbg.value(metadata !{i8* %16}, i64 0, metadata !206) #10, !dbg !205
  tail call void @llvm.dbg.value(metadata !181, i64 0, metadata !207) #10, !dbg !208
  %55 = load i8* %16, align 16, !dbg !209, !tbaa !186
  %56 = icmp eq i8 %55, 0, !dbg !209
  br i1 %56, label %ht_hashcode.exit.i6, label %.lr.ph.i.i3, !dbg !209

.lr.ph.i.i3:                                      ; preds = %53, %.lr.ph.i.i3
  %57 = phi i8 [ %62, %.lr.ph.i.i3 ], [ %55, %53 ]
  %val.02.i.i1 = phi i64 [ %60, %.lr.ph.i.i3 ], [ 0, %53 ]
  %.01.i.i2 = phi i8* [ %61, %.lr.ph.i.i3 ], [ %16, %53 ]
  %58 = mul i64 %val.02.i.i1, 5, !dbg !209
  %59 = sext i8 %57 to i64, !dbg !209
  %60 = add i64 %58, %59, !dbg !209
  tail call void @llvm.dbg.value(metadata !{i64 %60}, i64 0, metadata !207) #10, !dbg !209
  %61 = getelementptr inbounds i8* %.01.i.i2, i64 1, !dbg !209
  tail call void @llvm.dbg.value(metadata !{i8* %61}, i64 0, metadata !206) #10, !dbg !209
  %62 = load i8* %61, align 1, !dbg !209, !tbaa !186
  %63 = icmp eq i8 %62, 0, !dbg !209
  br i1 %63, label %ht_hashcode.exit.i6, label %.lr.ph.i.i3, !dbg !209

ht_hashcode.exit.i6:                              ; preds = %.lr.ph.i.i3, %53
  %val.0.lcssa.i.i4 = phi i64 [ 0, %53 ], [ %60, %.lr.ph.i.i3 ]
  %64 = load i32* %17, align 4, !dbg !170, !tbaa !126
  %65 = sext i32 %64 to i64, !dbg !170
  %66 = urem i64 %val.0.lcssa.i.i4, %65, !dbg !170
  %sext.i5 = shl i64 %66, 32, !dbg !174
  %67 = ashr exact i64 %sext.i5, 32, !dbg !174
  %68 = load %struct.ht_node*** %18, align 8, !dbg !174, !tbaa !129
  %69 = getelementptr inbounds %struct.ht_node** %68, i64 %67, !dbg !174
  %node.01.i = load %struct.ht_node** %69, align 8, !dbg !174
  %70 = icmp eq %struct.ht_node* %node.01.i, null, !dbg !210
  br i1 %70, label %ht_find.exit, label %.lr.ph.i8, !dbg !210

; <label>:71                                      ; preds = %.lr.ph.i8
  %72 = getelementptr inbounds %struct.ht_node* %node.02.i, i64 0, i32 2, !dbg !211
  %node.0.i7 = load %struct.ht_node** %72, align 8, !dbg !174
  %73 = icmp eq %struct.ht_node* %node.0.i7, null, !dbg !210
  br i1 %73, label %ht_find.exit, label %.lr.ph.i8, !dbg !210

.lr.ph.i8:                                        ; preds = %ht_hashcode.exit.i6, %71
  %node.02.i = phi %struct.ht_node* [ %node.0.i7, %71 ], [ %node.01.i, %ht_hashcode.exit.i6 ]
  %74 = getelementptr inbounds %struct.ht_node* %node.02.i, i64 0, i32 0, !dbg !213
  %75 = load i8** %74, align 8, !dbg !213, !tbaa !107
  %76 = call i32 @strcmp(i8* %16, i8* %75) #9, !dbg !213
  %77 = icmp eq i32 %76, 0, !dbg !213
  br i1 %77, label %ht_find.exit, label %71, !dbg !213

ht_find.exit:                                     ; preds = %71, %.lr.ph.i8, %ht_hashcode.exit.i6
  %.0.i9 = phi %struct.ht_node* [ null, %ht_hashcode.exit.i6 ], [ null, %71 ], [ %node.02.i, %.lr.ph.i8 ]
  %not. = icmp ne %struct.ht_node* %.0.i9, null, !dbg !172
  %78 = zext i1 %not. to i32, !dbg !172
  %c.0. = add nsw i32 %78, %c.013, !dbg !172
  %79 = add nsw i32 %i.114, -1, !dbg !166
  tail call void @llvm.dbg.value(metadata !{i32 %79}, i64 0, metadata !54), !dbg !166
  %80 = icmp sgt i32 %79, 0, !dbg !166
  br i1 %80, label %53, label %._crit_edge, !dbg !166

._crit_edge:                                      ; preds = %ht_find.exit, %3, %.preheader
  %81 = phi %struct.ht_ht* [ %9, %.preheader ], [ %7, %3 ], [ %9, %ht_find.exit ]
  %c.0.lcssa = phi i32 [ 0, %.preheader ], [ 0, %3 ], [ %c.0., %ht_find.exit ]
  tail call void @ht_destroy(%struct.ht_ht* %81) #8, !dbg !215
  %82 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %c.0.lcssa) #5, !dbg !216
  ret i32 0, !dbg !217
}
...
!72 = metadata !{i32 786478, metadata !5, metadata !6, metadata !"ht_hashcode", metadata !"ht_hashcode", metadata !"", i32 46, metadata !73, i1 true, i1 true, i32 0, i32 0, null, i32 256, i1 true, null, null, null, metadata !75, i32 46} ; [ DW_TAG_subprogram ] [line 46] [local] [def] [ht_hashcode]
...
!161 = metadata !{i32 49, i32 0, metadata !72, metadata !162}
!162 = metadata !{i32 136, i32 0, metadata !80, metadata !163}
!163 = metadata !{i32 24, i32 0, metadata !160, null}
!164 = metadata !{i32 137, i32 0, metadata !80, metadata !163}
!165 = metadata !{i32 146, i32 0, metadata !80, metadata !163}
!166 = metadata !{i32 27, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !1, metadata !55, i32 27, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/hash.c]
!168 = metadata !{i32 28, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !167, i32 27, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/hash.c]
!170 = metadata !{i32 49, i32 0, metadata !72, metadata !171}
!171 = metadata !{i32 126, i32 0, metadata !70, metadata !172}
!172 = metadata !{i32 29, i32 0, metadata !173, null}
!173 = metadata !{i32 786443, metadata !1, metadata !169, i32 29, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/hash.c]
!174 = metadata !{i32 127, i32 0, metadata !70, metadata !172}
!175 = metadata !{i32 786689, metadata !80, metadata !"ht", metadata !6, i32 16777351, metadata !25, i32 0, metadata !163} ; [ DW_TAG_arg_variable ] [ht] [line 135]
!176 = metadata !{i32 135, i32 0, metadata !80, metadata !163}
!177 = metadata !{i32 786689, metadata !80, metadata !"key", metadata !6, i32 33554567, metadata !13, i32 0, metadata !163} ; [ DW_TAG_arg_variable ] [key] [line 135]
!178 = metadata !{i32 786689, metadata !72, metadata !"ht", metadata !6, i32 16777262, metadata !25, i32 0, metadata !162} ; [ DW_TAG_arg_variable ] [ht] [line 46]
!179 = metadata !{i32 46, i32 0, metadata !72, metadata !162}
!180 = metadata !{i32 786689, metadata !72, metadata !"key", metadata !6, i32 33554478, metadata !13, i32 0, metadata !162} ; [ DW_TAG_arg_variable ] [key] [line 46]
!181 = metadata !{i64 0}
!182 = metadata !{i32 786688, metadata !72, metadata !"val", metadata !6, i32 47, metadata !79, i32 0, metadata !162} ; [ DW_TAG_auto_variable ] [val] [line 47]
!183 = metadata !{i32 47, i32 0, metadata !72, metadata !162}
!184 = metadata !{i32 48, i32 0, metadata !185, metadata !162}
!185 = metadata !{i32 786443, metadata !5, metadata !72, i32 48, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!186 = metadata !{metadata !110, metadata !110, i64 0}
!187 = metadata !{%struct.ht_node* null}
!188 = metadata !{i32 786688, metadata !80, metadata !"prev", metadata !6, i32 137, metadata !9, i32 0, metadata !163} ; [ DW_TAG_auto_variable ] [prev] [line 137]
!189 = metadata !{i32 138, i32 0, metadata !80, metadata !163}
!190 = metadata !{i32 141, i32 0, metadata !191, metadata !163}
!191 = metadata !{i32 786443, metadata !5, metadata !80, i32 138, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!192 = metadata !{i32 139, i32 0, metadata !193, metadata !163}
!193 = metadata !{i32 786443, metadata !5, metadata !191, i32 139, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!194 = metadata !{i32 140, i32 0, metadata !191, metadata !163}
!195 = metadata !{i32 147, i32 0, metadata !196, metadata !163}
!196 = metadata !{i32 786443, metadata !5, metadata !80, i32 147, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!197 = metadata !{i32 148, i32 0, metadata !198, metadata !163}
!198 = metadata !{i32 786443, metadata !5, metadata !196, i32 147, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!199 = metadata !{i32 150, i32 0, metadata !200, metadata !163}
!200 = metadata !{i32 786443, metadata !5, metadata !196, i32 149, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!201 = metadata !{i32 786689, metadata !63, metadata !"ht", metadata !6, i32 16777341, metadata !25, i32 0, metadata !172} ; [ DW_TAG_arg_variable ] [ht] [line 125]
!202 = metadata !{i32 125, i32 0, metadata !63, metadata !172}
!203 = metadata !{i32 786689, metadata !63, metadata !"key", metadata !6, i32 33554557, metadata !13, i32 0, metadata !172} ; [ DW_TAG_arg_variable ] [key] [line 125]
!204 = metadata !{i32 786689, metadata !72, metadata !"ht", metadata !6, i32 16777262, metadata !25, i32 0, metadata !171} ; [ DW_TAG_arg_variable ] [ht] [line 46]
!205 = metadata !{i32 46, i32 0, metadata !72, metadata !171}
!206 = metadata !{i32 786689, metadata !72, metadata !"key", metadata !6, i32 33554478, metadata !13, i32 0, metadata !171} ; [ DW_TAG_arg_variable ] [key] [line 46]
!207 = metadata !{i32 786688, metadata !72, metadata !"val", metadata !6, i32 47, metadata !79, i32 0, metadata !171} ; [ DW_TAG_auto_variable ] [val] [line 47]
!208 = metadata !{i32 47, i32 0, metadata !72, metadata !171}
!209 = metadata !{i32 48, i32 0, metadata !185, metadata !171}
!210 = metadata !{i32 128, i32 0, metadata !70, metadata !172}
!211 = metadata !{i32 130, i32 0, metadata !212, metadata !172}
!212 = metadata !{i32 786443, metadata !5, metadata !70, i32 128, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!213 = metadata !{i32 129, i32 0, metadata !214, metadata !172}
!214 = metadata !{i32 786443, metadata !5, metadata !212, i32 129, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/./simple_hash.h]
!215 = metadata !{i32 32, i32 0, metadata !55, null}
!216 = metadata !{i32 34, i32 0, metadata !55, null}
!217 = metadata !{i32 35, i32 0, metadata !55, null}
