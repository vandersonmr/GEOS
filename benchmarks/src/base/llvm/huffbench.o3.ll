...
.lr.ph:                                           ; preds = %0
  ...
  %5 = icmp eq i8 %4, 45, !dbg !384
  %6 = getelementptr inbounds i8* %3, i64 1, !dbg !386
  %7 = getelementptr inbounds i8* %3, i64 2, !dbg !388
  %8 = getelementptr inbounds i8* %3, i64 3, !dbg !391
  br i1 %5, label %.lr.ph.split.us, label %.preheader

; <label>:9                                       ; preds = %24
  %10 = icmp slt i32 %25, %argc, !dbg !393
  br i1 %10, label %.lr.ph.split.us, label %.loopexit, !dbg !393

.lr.ph.split.us:                                  ; preds = %.lr.ph, %9
  %i.07.us = phi i32 [ %25, %9 ], [ 1, %.lr.ph ]
  ...
  %11 = load i8* %6, align 1, !dbg !386, !tbaa !149
  %12 = zext i8 %11 to i32, !dbg !386
  %13 = sub nsw i32 103, %12, !dbg !386
  tail call void @llvm.dbg.value(metadata !{i32 %13}, i64 0, metadata !89), !dbg !386
  %14 = icmp eq i8 %11, 103, !dbg !396
  br i1 %14, label %15, label %24, !dbg !396

; <label>:15                                      ; preds = %.lr.ph.split.us
  %16 = load i8* %7, align 1, !dbg !388, !tbaa !149
  %17 = zext i8 %16 to i32, !dbg !388
  %18 = sub nsw i32 97, %17, !dbg !388
  tail call void @llvm.dbg.value(metadata !{i32 %18}, i64 0, metadata !89), !dbg !388
  %19 = icmp eq i8 %16, 97, !dbg !391
  br i1 %19, label %20, label %24, !dbg !391

; <label>:20                                      ; preds = %15
  %21 = load i8* %8, align 1, !dbg !391, !tbaa !149
  %22 = zext i8 %21 to i32, !dbg !391
  %23 = sub nsw i32 0, %22, !dbg !391
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !89), !dbg !391
  br label %24, !dbg !391

; <label>:24                                      ; preds = %20, %15, %.lr.ph.split.us
  %__result.0.us = phi i32 [ %23, %20 ], [ %18, %15 ], [ %13, %.lr.ph.split.us ]
  %phitmp.us = icmp eq i32 %__result.0.us, 0, !dbg !383
  %25 = add nsw i32 %i.07.us, 1, !dbg !393
  tail call void @llvm.dbg.value(metadata !{i32 %25}, i64 0, metadata !74), !dbg !393
  br i1 %phitmp.us, label %.loopexit, label %9, !dbg !395

; <label>:26                                      ; preds = %.preheader
  %27 = icmp slt i32 %28, %argc, !dbg !393
  br i1 %27, label %.preheader, label %.loopexit, !dbg !393

.preheader:                                       ; preds = %.lr.ph, %26
  %i.07 = phi i32 [ %28, %26 ], [ 1, %.lr.ph ]
  tail call void @llvm.dbg.value(metadata !394, i64 0, metadata !84), !dbg !395
  tail call void @llvm.dbg.value(metadata !{i8* %3}, i64 0, metadata !85), !dbg !383
  %phitmp = icmp eq i8 %4, 45, !dbg !383
  %28 = add nsw i32 %i.07, 1, !dbg !393
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !74), !dbg !393
  br i1 %phitmp, label %.loopexit, label %26, !dbg !395

.loopexit:                                        ; preds = %26, %.preheader, %9, %24, %0
  %ga_testing.0 = phi i1 [ false, %0 ], [ false, %9 ], [ true, %24 ], [ false, %26 ], [ true, %.preheader ]
  ...
  %29 = tail call noalias i8* @malloc(i64 10000000) #3, !dbg !403
  tail call void @llvm.dbg.value(metadata !{i8* %29}, i64 0, metadata !404) #3, !dbg !403
  tail call void @llvm.dbg.value(metadata !{i8* %29}, i64 0, metadata !405) #3, !dbg !406
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.loopexit
  ...
  %ptr.01.i = phi i8* [ %44, %.lr.ph.i ], [ %29, %.loopexit ]
  %30 = load i64* @seed, align 8, !dbg !409, !tbaa !136
  %31 = xor i64 %30, 123459876, !dbg !409
  %32 = sdiv i64 %31, 127773, !dbg !411
  tail call void @llvm.dbg.value(metadata !{i64 %32}, i64 0, metadata !412) #3, !dbg !411
  %33 = mul i64 %32, -127773, !dbg !413
  %34 = add i64 %33, %31, !dbg !413
  %35 = mul nsw i64 %34, 16807, !dbg !413
  %36 = mul i64 %32, -2836, !dbg !413
  %37 = add i64 %35, %36, !dbg !413
  %38 = icmp slt i64 %37, 0, !dbg !414
  %39 = add nsw i64 %37, 2147483647, !dbg !415
  %..i.i = select i1 %38, i64 %39, i64 %37, !dbg !414
  %40 = srem i64 %..i.i, 32, !dbg !416
  tail call void @llvm.dbg.value(metadata !{i64 %40}, i64 0, metadata !417) #3, !dbg !416
  %41 = xor i64 %..i.i, 123459876, !dbg !418
  store i64 %41, i64* @seed, align 8, !dbg !418, !tbaa !136
  %42 = getelementptr inbounds [33 x i8]* @.str, i64 0, i64 %40, !dbg !410
  %43 = load i8* %42, align 1, !dbg !410, !tbaa !149
  store i8 %43, i8* %ptr.01.i, align 1, !dbg !410, !tbaa !149
  %44 = getelementptr inbounds i8* %ptr.01.i, i64 1, !dbg !419
  tail call void @llvm.dbg.value(metadata !{i8* %44}, i64 0, metadata !405) #3, !dbg !419
...
generate_test_data.exit:                          ; preds = %.lr.ph.i, %generate_test_data.exit
  %i.16 = phi i32 [ %45, %generate_test_data.exit ], [ 0, %.lr.ph.i ]
  tail call void @compdecomp(i8* %29, i64 10000000), !dbg !420
  %45 = add nsw i32 %i.16, 1, !dbg !422
  tail call void @llvm.dbg.value(metadata !{i32 %45}, i64 0, metadata !74), !dbg !422
  %exitcond = icmp eq i32 %45, 30, !dbg !422
  br i1 %exitcond, label %46, label %generate_test_data.exit, !dbg !422

; <label>:46                                      ; preds = %generate_test_data.exit
  tail call void @llvm.dbg.value(metadata !423, i64 0, metadata !91), !dbg !424
  tail call void @free(i8* %29) #3, !dbg !425
  %47 = load %struct._IO_FILE** @stdout, align 8, !dbg !426, !tbaa !277
  br i1 %ga_testing.0, label %48, label %50, !dbg !428

; <label>:48                                      ; preds = %46
  %49 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([3 x i8]* @.str5, i64 0, i64 0), double 0.000000e+00) #3, !dbg !426
  br label %52, !dbg !426

; <label>:50                                      ; preds = %46
  %51 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %47, i8* getelementptr inbounds ([35 x i8]* @.str6, i64 0, i64 0), double 0.000000e+00) #3, !dbg !429
  br label %52

; <label>:52                                      ; preds = %50, %48
  %53 = load %struct._IO_FILE** @stdout, align 8, !dbg !430, !tbaa !277
  %54 = tail call i32 @fflush(%struct._IO_FILE* %53) #3, !dbg !430
  ret i32 0, !dbg !431
}
