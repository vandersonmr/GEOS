...
define void @Innerproduct(i32* nocapture %result, [41 x i32]* nocapture readonly %a, [41 x i32]* nocapture readonly %b, i32 %row, i32 %column) #0 {
  tail call void @llvm.dbg.value(metadata !{i32* %result}, i64 0, metadata !29), !dbg !148
  tail call void @llvm.dbg.value(metadata !{[41 x i32]* %a}, i64 0, metadata !30), !dbg !148
  tail call void @llvm.dbg.value(metadata !{[41 x i32]* %b}, i64 0, metadata !31), !dbg !148
  tail call void @llvm.dbg.value(metadata !{i32 %row}, i64 0, metadata !32), !dbg !148
  tail call void @llvm.dbg.value(metadata !{i32 %column}, i64 0, metadata !33), !dbg !148
  store i32 0, i32* %result, align 4, !dbg !149, !tbaa !145
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !34), !dbg !150
...
; <label>:3                                       ; preds = %3, %0
  ...
  %4 = load i32* %result, align 4, !dbg !150, !tbaa !145
  %5 = getelementptr inbounds [41 x i32]* %a, i64 %1, i64 %indvars.iv, !dbg !150
  %6 = load i32* %5, align 4, !dbg !150, !tbaa !145
  %7 = getelementptr inbounds [41 x i32]* %b, i64 %indvars.iv, i64 %2, !dbg !150
  %8 = load i32* %7, align 4, !dbg !150, !tbaa !145
  %9 = mul nsw i32 %8, %6, !dbg !150
  %10 = add nsw i32 %9, %4, !dbg !150
  store i32 %10, i32* %result, align 4, !dbg !150, !tbaa !145
...
define void @Intmm(i32 %run) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %run}, i64 0, metadata !39), !dbg !153
  tail call void @Initrand(), !dbg !154
  tail call void @Initmatrix([41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @ima, i64 0, i64 0)), !dbg !155
  tail call void @Initmatrix([41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @imb, i64 0, i64 0)), !dbg !156
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !40), !dbg !157
...
; <label>:1                                       ; preds = %1, %.preheader
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %1 ]
  %2 = getelementptr inbounds [41 x [41 x i32]]* @imr, i64 0, i64 %indvars.iv3, i64 %indvars.iv, !dbg !161
  %3 = trunc i64 %indvars.iv to i32, !dbg !161
  %4 = trunc i64 %indvars.iv3 to i32, !dbg !161
  tail call void @Innerproduct(i32* %2, [41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @ima, i64 0, i64 0), [41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @imb, i64 0, i64 0), i32 %4, i32 %3), !dbg !161
...
; <label>:6                                       ; preds = %5
  ...
  %9 = getelementptr inbounds [41 x [41 x i32]]* @imr, i64 0, i64 %8, i64 %8, !dbg !162
  %10 = load i32* %9, align 4, !dbg !162, !tbaa !145
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %10) #3, !dbg !162
  ret void, !dbg !163
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !164, i64 0, metadata !44), !dbg !165
  br label %1, !dbg !165

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Intmm(i32 %i.01), !dbg !165
  %2 = add nsw i32 %i.01, 1, !dbg !165
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !44), !dbg !165
...
!140 = metadata !{i32 130, i32 0, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !139, i32 130, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!142 = metadata !{i32 131, i32 0, metadata !143, null}
!143 = metadata !{i32 786443, metadata !1, metadata !141, i32 130, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!144 = metadata !{i32 132, i32 0, metadata !143, null}
!145 = metadata !{metadata !146, metadata !146, i64 0}
!146 = metadata !{metadata !"int", metadata !131, i64 0}
!147 = metadata !{i32 134, i32 0, metadata !12, null}
!148 = metadata !{i32 136, i32 0, metadata !24, null}
!149 = metadata !{i32 139, i32 0, metadata !24, null}
!150 = metadata !{i32 140, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !1, metadata !24, i32 140, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!152 = metadata !{i32 141, i32 0, metadata !24, null}
!153 = metadata !{i32 143, i32 0, metadata !35, null}
!154 = metadata !{i32 145, i32 0, metadata !35, null}
!155 = metadata !{i32 146, i32 0, metadata !35, null}
!156 = metadata !{i32 147, i32 0, metadata !35, null}
!157 = metadata !{i32 148, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !1, metadata !35, i32 148, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!159 = metadata !{i32 149, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !158, i32 149, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!161 = metadata !{i32 150, i32 0, metadata !160, null}
!162 = metadata !{i32 151, i32 0, metadata !35, null}
!163 = metadata !{i32 152, i32 0, metadata !35, null}
!164 = metadata !{i32 0}
!165 = metadata !{i32 157, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !1, metadata !42, i32 157, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!167 = metadata !{i32 158, i32 0, metadata !42, null}
