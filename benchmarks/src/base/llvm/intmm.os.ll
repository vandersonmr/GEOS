...
; <label>:1                                       ; preds = %1, %0
  ...
  tail call void @Intmm(i32 %i.01) #4, !dbg !200
  %2 = add nsw i32 %i.01, 1, !dbg !200
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !44), !dbg !200
  %exitcond = icmp eq i32 %2, 10, !dbg !200
  br i1 %exitcond, label %3, label %1, !dbg !200
