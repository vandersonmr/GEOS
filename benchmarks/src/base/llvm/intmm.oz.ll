...
define void @Intmm(i32 %run) #0 {
  ...
  tail call void @Initmatrix([41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @ima, i64 0, i64 0)) #3, !dbg !158
  tail call void @Initmatrix([41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @imb, i64 0, i64 0)) #3, !dbg !159
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !40), !dbg !160
...
; <label>:1                                       ; preds = %1, %.preheader
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %1 ]
  %2 = getelementptr inbounds [41 x [41 x i32]]* @imr, i64 0, i64 %indvars.iv3, i64 %indvars.iv, !dbg !164
  %3 = trunc i64 %indvars.iv to i32, !dbg !164
  %4 = trunc i64 %indvars.iv3 to i32, !dbg !164
  tail call void @Innerproduct(i32* %2, [41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @ima, i64 0, i64 0), [41 x i32]* getelementptr inbounds ([41 x [41 x i32]]* @imb, i64 0, i64 0), i32 %4, i32 %3) #3, !dbg !164
...
; <label>:6                                       ; preds = %5
  ...
  %9 = getelementptr inbounds [41 x [41 x i32]]* @imr, i64 0, i64 %8, i64 %8, !dbg !165
  %10 = load i32* %9, align 4, !dbg !165, !tbaa !147
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %10) #4, !dbg !165
  ret void, !dbg !166
}
...
; Function Attrs: minsize nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !167, i64 0, metadata !44), !dbg !168
  br label %1, !dbg !168

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Intmm(i32 %i.01) #3, !dbg !168
  %2 = add nsw i32 %i.01, 1, !dbg !168
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !44), !dbg !168
...
!158 = metadata !{i32 146, i32 0, metadata !35, null}
!159 = metadata !{i32 147, i32 0, metadata !35, null}
!160 = metadata !{i32 148, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !35, i32 148, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!162 = metadata !{i32 149, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !1, metadata !161, i32 149, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!164 = metadata !{i32 150, i32 0, metadata !163, null}
!165 = metadata !{i32 151, i32 0, metadata !35, null}
!166 = metadata !{i32 152, i32 0, metadata !35, null}
!167 = metadata !{i32 0}
!168 = metadata !{i32 157, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !42, i32 157, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/intmm.c]
!170 = metadata !{i32 158, i32 0, metadata !42, null}
