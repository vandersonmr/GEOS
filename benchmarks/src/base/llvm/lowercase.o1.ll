...
; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i64 [ 0, %0 ], [ %2, %1 ]
  tail call fastcc void @doTest(i64 %i.01), !dbg !67
  %2 = add i64 %i.01, 1, !dbg !65
  tail call void @llvm.dbg.value(metadata !{i64 %2}, i64 0, metadata !15), !dbg !65
  %exitcond = icmp eq i64 %2, 32, !dbg !65
  br i1 %exitcond, label %3, label %1, !dbg !65
...
define internal fastcc void @doTest(i64 %numberOfIterations) #0 {
  tail call void @llvm.dbg.value(metadata !{i64 %numberOfIterations}, i64 0, metadata !23), !dbg !69
  tail call void @llvm.dbg.value(metadata !{i64 %numberOfIterations}, i64 0, metadata !24), !dbg !70
  %1 = add i64 %numberOfIterations, 15, !dbg !71
  %2 = and i64 %1, -16, !dbg !71
  tail call void @llvm.dbg.value(metadata !{i64 %2}, i64 0, metadata !26), !dbg !71
  %3 = shl i64 %2, 1, !dbg !72
  %4 = tail call noalias i8* @malloc(i64 %3) #2, !dbg !72
  %5 = bitcast i8* %4 to i16*, !dbg !72
  tail call void @llvm.dbg.value(metadata !{i16* %5}, i64 0, metadata !27), !dbg !72
  tail call void @llvm.dbg.value(metadata !64, i64 0, metadata !31), !dbg !73
  %6 = icmp eq i64 %2, 0, !dbg !73
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !73

.lr.ph:                                           ; preds = %0, %.lr.ph
  %i.02 = phi i64 [ %9, %.lr.ph ], [ 0, %0 ]
  %7 = getelementptr inbounds i16* %5, i64 %i.02, !dbg !75
  %8 = bitcast i16* %7 to i8*, !dbg !75
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* bitcast ([16 x i16]* @staticData to i8*), i64 32, i32 2, i1 false), !dbg !75
  %9 = add i64 %i.02, 16, !dbg !73
  tail call void @llvm.dbg.value(metadata !{i64 %9}, i64 0, metadata !31), !dbg !73
  %10 = icmp ult i64 %9, %2, !dbg !73
  br i1 %10, label %.lr.ph, label %._crit_edge, !dbg !73

._crit_edge:                                      ; preds = %.lr.ph, %0
  %11 = tail call noalias i8* @malloc(i64 %3) #2, !dbg !76
  %12 = bitcast i8* %11 to i16*, !dbg !76
  tail call void @llvm.dbg.value(metadata !{i16* %12}, i64 0, metadata !32), !dbg !76
  %13 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([29 x i8]* @.str, i64 0, i64 0), i64 %numberOfIterations, i64 %numberOfIterations) #2, !dbg !77
  tail call void @llvm.memset.p0i8.i64(i8* %11, i8 0, i64 %3, i32 2, i1 false), !dbg !78
  tail call void @llvm.dbg.value(metadata !64, i64 0, metadata !31), !dbg !79
  br label %14, !dbg !79

; <label>:14                                      ; preds = %14, %._crit_edge
  %i.11 = phi i64 [ 0, %._crit_edge ], [ %15, %14 ]
  tail call fastcc void @lower_StringImpl(i16* %5, i64 %numberOfIterations, i16* %12), !dbg !81
  %15 = add i64 %i.11, 1, !dbg !79
  tail call void @llvm.dbg.value(metadata !{i64 %15}, i64 0, metadata !31), !dbg !79
  %exitcond = icmp eq i64 %15, 10000000, !dbg !79
  br i1 %exitcond, label %16, label %14, !dbg !79
...
define internal fastcc void @lower_StringImpl(i16* noalias nocapture readonly %data, i64 %length, i16* noalias nocapture %output) #0 {
  tail call void @llvm.dbg.value(metadata !83, i64 0, metadata !44), !dbg !84
  tail call void @llvm.dbg.value(metadata !64, i64 0, metadata !45), !dbg !85
  %1 = icmp eq i64 %length, 0, !dbg !85
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !85

.lr.ph:                                           ; preds = %0, %.lr.ph
  %i.01 = phi i64 [ %6, %.lr.ph ], [ 0, %0 ]
  %2 = getelementptr inbounds i16* %data, i64 %i.01, !dbg !86
  %3 = load i16* %2, align 2, !dbg !86, !tbaa !87
  tail call void @llvm.dbg.value(metadata !{i16 %3}, i64 0, metadata !46), !dbg !86
  %4 = tail call fastcc zeroext i16 @toASCIILower(i16 zeroext %3), !dbg !91
  %5 = getelementptr inbounds i16* %output, i64 %i.01, !dbg !91
  store i16 %4, i16* %5, align 2, !dbg !91, !tbaa !87
  %6 = add i64 %i.01, 1, !dbg !85
  tail call void @llvm.dbg.value(metadata !{i64 %6}, i64 0, metadata !45), !dbg !85
  %exitcond = icmp eq i64 %6, %length, !dbg !85
  br i1 %exitcond, label %._crit_edge, label %.lr.ph, !dbg !85
...
define internal fastcc zeroext i16 @toASCIILower(i16 zeroext %c) #3 {
  tail call void @llvm.dbg.value(metadata !{i16 %c}, i64 0, metadata !53), !dbg !92
  %c.off = add i16 %c, -65, !dbg !92
  %1 = icmp ult i16 %c.off, 26, !dbg !92
  %2 = zext i1 %1 to i16
...
!19 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"doTest", metadata !"doTest", metadata !"", i32 30, metadata !20, i1 true, i1 true, i32 0, i32 0, null, i32 256, i1 true, void (i64)* @doTest, null, null, metadata !22, i32 31} ; [ DW_TAG_subprogram ] [line 30] [local] [def] [scope 31] [doTest]
...
!33 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"lower_StringImpl", metadata !"lower_StringImpl", metadata !"", i32 11, metadata !34, i1 true, i1 true, i32 0, i32 0, null, i32 256, i1 true, void (i16*, i64, i16*)* @lower_StringImpl, null, null, metadata !40, i32 12} ; [ DW_TAG_subprogram ] [line 11] [local] [def] [scope 12] [lower_StringImpl]
...
!49 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"toASCIILower", metadata !"toASCIILower", metadata !"", i32 8, metadata !50, i1 true, i1 true, i32 0, i32 0, null, i32 256, i1 true, i16 (i16)* @toASCIILower, null, null, metadata !52, i32 8} ; [ DW_TAG_subprogram ] [line 8] [local] [def] [toASCIILower]
...
!56 = metadata !{i32 786484, i32 0, null, metadata !"staticData", metadata !"staticData", metadata !"", metadata !5, i32 27, metadata !57, i32 1, i32 1, [16 x i16]* @staticData, null} ; [ DW_TAG_variable ] [staticData] [line 27] [local] [def]
...
!67 = metadata !{i32 55, i32 0, metadata !66, null}
!68 = metadata !{i32 57, i32 0, metadata !4, null}
!69 = metadata !{i32 30, i32 0, metadata !19, null}
!70 = metadata !{i32 32, i32 0, metadata !19, null}
!71 = metadata !{i32 33, i32 0, metadata !19, null}
!72 = metadata !{i32 34, i32 0, metadata !19, null}
!73 = metadata !{i32 36, i32 0, metadata !74, null}
!74 = metadata !{i32 786443, metadata !1, metadata !19, i32 36, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lowercase.c]
!75 = metadata !{i32 37, i32 0, metadata !74, null}
!76 = metadata !{i32 39, i32 0, metadata !19, null}
!77 = metadata !{i32 40, i32 0, metadata !19, null}
!78 = metadata !{i32 42, i32 0, metadata !19, null}
!79 = metadata !{i32 46, i32 0, metadata !80, null}
!80 = metadata !{i32 786443, metadata !1, metadata !19, i32 46, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lowercase.c]
!81 = metadata !{i32 48, i32 0, metadata !80, null}
!82 = metadata !{i32 49, i32 0, metadata !19, null}
!83 = metadata !{i16 0}
!84 = metadata !{i32 14, i32 0, metadata !33, null}
!85 = metadata !{i32 16, i32 0, metadata !48, null}
!86 = metadata !{i32 17, i32 0, metadata !47, null}
!87 = metadata !{metadata !88, metadata !88, i64 0}
!88 = metadata !{metadata !"short", metadata !89, i64 0}
!89 = metadata !{metadata !"omnipotent char", metadata !90, i64 0}
!90 = metadata !{metadata !"Simple C/C++ TBAA"}
!91 = metadata !{i32 19, i32 17, metadata !47, null}
!92 = metadata !{i32 8, i32 0, metadata !49, null} ; [ DW_TAG_imported_declaration ]
