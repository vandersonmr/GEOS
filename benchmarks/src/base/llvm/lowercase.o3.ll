...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  br label %doTest.exit, !dbg !65

doTest.exit:                                      ; preds = %doTest.exit, %0
  %i.01 = phi i64 [ 0, %0 ], [ %2, %doTest.exit ]
  ...
  %1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([29 x i8]* @.str, i64 0, i64 0), i64 %i.01, i64 %i.01) #3, !dbg !80
  ...
  br i1 %exitcond, label %3, label %doTest.exit, !dbg !65

; <label>:3                                       ; preds = %doTest.exit
  ret i32 0, !dbg !83
}
