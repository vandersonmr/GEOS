...
; <label>:1                                       ; preds = %.backedge, %0
  ...
  %2 = getelementptr inbounds double** %a, i64 %indvars.iv5, !dbg !242
  %3 = load double** %2, align 8, !dbg !242, !tbaa !165
  tail call void @llvm.dbg.value(metadata !{double* %3}, i64 0, metadata !74), !dbg !242
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !241
  %4 = add nsw i32 %k.02, 1, !dbg !243
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !77), !dbg !243
  %5 = sub nsw i32 2000, %k.02, !dbg !244
  %6 = trunc i64 %indvars.iv5 to i32, !dbg !244
  ...
  %9 = getelementptr inbounds i32* %ipvt, i64 %indvars.iv5, !dbg !245
...
.backedge:                                        ; preds = %31, %1
  ...
  %exitcond7 = icmp eq i64 %indvars.iv.next6, 1999, !dbg !241
  br i1 %exitcond7, label %32, label %1, !dbg !241

; <label>:14                                      ; preds = %1
  %15 = icmp ne i32 %7, 0, !dbg !249
  %16 = getelementptr inbounds double* %3, i64 %indvars.iv5, !dbg !251
  %17 = load double* %16, align 8, !dbg !251, !tbaa !167
  br i1 %15, label %18, label %.lr.ph, !dbg !249
...
.lr.ph:                                           ; preds = %14, %18
  ...
  %21 = sub i64 1999, %indvars.iv5, !dbg !257
  %22 = trunc i64 %21 to i32, !dbg !257
  tail call void @dscal(i32 %22, double %20, double* %3, i32 %4, i32 1) #8, !dbg !257
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !73), !dbg !258
  br label %23, !dbg !258

; <label>:23                                      ; preds = %31, %.lr.ph
  %indvars.iv3 = phi i64 [ %indvars.iv, %.lr.ph ], [ %indvars.iv.next4, %31 ]
  %24 = getelementptr inbounds double** %a, i64 %indvars.iv3, !dbg !259
  %25 = load double** %24, align 8, !dbg !259, !tbaa !165
  tail call void @llvm.dbg.value(metadata !{double* %25}, i64 0, metadata !79), !dbg !259
  %26 = getelementptr inbounds double* %25, i64 %10, !dbg !260
  %27 = load double* %26, align 8, !dbg !260, !tbaa !167
  tail call void @llvm.dbg.value(metadata !{double %27}, i64 0, metadata !71), !dbg !260
  br i1 %15, label %28, label %31, !dbg !261

; <label>:28                                      ; preds = %23
  %29 = getelementptr inbounds double* %25, i64 %indvars.iv5, !dbg !263
  %30 = load double* %29, align 8, !dbg !263, !tbaa !167
  store double %30, double* %26, align 8, !dbg !263, !tbaa !167
  store double %27, double* %29, align 8, !dbg !265, !tbaa !167
  br label %31, !dbg !266

; <label>:31                                      ; preds = %28, %23
  tail call void @daxpy(i32 %22, double %27, double* %3, i32 %4, i32 1, double* %25, i32 %4, i32 1) #8, !dbg !267
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1, !dbg !258
  %lftr.wideiv = trunc i64 %indvars.iv.next4 to i32, !dbg !258
  %exitcond = icmp eq i32 %lftr.wideiv, 2000, !dbg !258
  br i1 %exitcond, label %.backedge, label %23, !dbg !258

; <label>:32                                      ; preds = %.backedge
  %33 = getelementptr inbounds i32* %ipvt, i64 1999, !dbg !268
  store i32 1999, i32* %33, align 4, !dbg !268, !tbaa !246
  ret void, !dbg !269
}

; Function Attrs: minsize nounwind optsize uwtable
define void @dgesl(double** nocapture readonly %a, i32* nocapture readonly %ipvt, double* nocapture %b) #0 {
  tail call void @llvm.dbg.value(metadata !{double** %a}, i64 0, metadata !88), !dbg !270
  tail call void @llvm.dbg.value(metadata !{i32* %ipvt}, i64 0, metadata !89), !dbg !270
  tail call void @llvm.dbg.value(metadata !{double* %b}, i64 0, metadata !90), !dbg !270
  tail call void @llvm.dbg.value(metadata !141, i64 0, metadata !92), !dbg !271
  br label %1, !dbg !271

; <label>:1                                       ; preds = %12, %0
  %indvars.iv3 = phi i64 [ 0, %0 ], [ %indvars.iv.next4, %12 ]
  %k.02 = phi i32 [ 0, %0 ], [ %13, %12 ]
  %2 = getelementptr inbounds i32* %ipvt, i64 %indvars.iv3, !dbg !272
  %3 = load i32* %2, align 4, !dbg !272, !tbaa !246
  tail call void @llvm.dbg.value(metadata !{i32 %3}, i64 0, metadata !94), !dbg !272
  %4 = sext i32 %3 to i64, !dbg !273
  %5 = getelementptr inbounds double* %b, i64 %4, !dbg !273
  %6 = load double* %5, align 8, !dbg !273, !tbaa !167
  tail call void @llvm.dbg.value(metadata !{double %6}, i64 0, metadata !91), !dbg !273
  %7 = trunc i64 %indvars.iv3 to i32, !dbg !274
  %8 = icmp eq i32 %3, %7, !dbg !274
  br i1 %8, label %12, label %9, !dbg !274

; <label>:9                                       ; preds = %1
  %10 = getelementptr inbounds double* %b, i64 %indvars.iv3, !dbg !276
  %11 = load double* %10, align 8, !dbg !276, !tbaa !167
  store double %11, double* %5, align 8, !dbg !276, !tbaa !167
  store double %6, double* %10, align 8, !dbg !278, !tbaa !167
  br label %12, !dbg !279

; <label>:12                                      ; preds = %1, %9
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1, !dbg !271
  %13 = add nsw i32 %k.02, 1, !dbg !280
  tail call void @llvm.dbg.value(metadata !{i32 %13}, i64 0, metadata !97), !dbg !280
  %14 = sub i64 1999, %indvars.iv3, !dbg !281
  %15 = getelementptr inbounds double** %a, i64 %indvars.iv3, !dbg !281
  %16 = load double** %15, align 8, !dbg !281, !tbaa !165
  %17 = trunc i64 %14 to i32, !dbg !281
  tail call void @daxpy(i32 %17, double %6, double* %16, i32 %13, i32 1, double* %b, i32 %13, i32 1) #8, !dbg !281
  tail call void @llvm.dbg.value(metadata !{i32 %13}, i64 0, metadata !92), !dbg !271
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 1999, !dbg !271
  br i1 %exitcond5, label %.preheader, label %1, !dbg !271

.preheader:                                       ; preds = %12, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %.preheader ], [ 0, %12 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !282
  %18 = sub i64 1999, %indvars.iv, !dbg !284
  %19 = getelementptr inbounds double** %a, i64 %18, !dbg !286
  %20 = load double** %19, align 8, !dbg !286, !tbaa !165
  %21 = getelementptr inbounds double* %20, i64 %18, !dbg !286
  %22 = load double* %21, align 8, !dbg !286, !tbaa !167
  %23 = getelementptr inbounds double* %b, i64 %18, !dbg !286
  %24 = load double* %23, align 8, !dbg !286, !tbaa !167
  %25 = fdiv double %24, %22, !dbg !286
  store double %25, double* %23, align 8, !dbg !286, !tbaa !167
  %26 = fsub double -0.000000e+00, %25, !dbg !287
  tail call void @llvm.dbg.value(metadata !{double %26}, i64 0, metadata !91), !dbg !287
  %27 = trunc i64 %18 to i32, !dbg !288
  tail call void @daxpy(i32 %27, double %26, double* %20, i32 0, i32 1, double* %b, i32 0, i32 1) #8, !dbg !288
  %exitcond = icmp eq i64 %indvars.iv.next, 2000, !dbg !282
  br i1 %exitcond, label %28, label %.preheader, !dbg !282
...
define i32 @main(i32 %argc, i8** nocapture readonly %argv) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %argc}, i64 0, metadata !105), !dbg !290
  tail call void @llvm.dbg.value(metadata !{i8** %argv}, i64 0, metadata !106), !dbg !290
  tail call void @llvm.dbg.value(metadata !291, i64 0, metadata !108), !dbg !292
  %1 = icmp sgt i32 %argc, 1, !dbg !293
  br i1 %1, label %.lr.ph, label %.loopexit, !dbg !293

.lr.ph:                                           ; preds = %0
  %2 = getelementptr inbounds i8** %argv, i64 1, !dbg !295
  %3 = load i8** %2, align 8, !dbg !295, !tbaa !165
  %4 = tail call i32 @strcmp(i8* %3, i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0)) #9, !dbg !295
  %5 = icmp eq i32 %4, 0, !dbg !295
  br label %8, !dbg !300

; <label>:6                                       ; preds = %8
  %7 = icmp slt i32 %9, %argc, !dbg !300
  br i1 %7, label %8, label %.loopexit, !dbg !300

; <label>:8                                       ; preds = %.lr.ph, %6
  %i.03 = phi i32 [ 1, %.lr.ph ], [ %9, %6 ]
  %9 = add nsw i32 %i.03, 1, !dbg !300
  tail call void @llvm.dbg.value(metadata !{i32 %9}, i64 0, metadata !107), !dbg !300
  br i1 %5, label %.loopexit, label %6, !dbg !295

.loopexit:                                        ; preds = %6, %8, %0
  %ga_testing.0 = phi i1 [ false, %0 ], [ false, %6 ], [ true, %8 ]
  %10 = tail call noalias i8* @malloc(i64 16000) #10, !dbg !301
  %11 = bitcast i8* %10 to double**, !dbg !301
  tail call void @llvm.dbg.value(metadata !{double** %11}, i64 0, metadata !110), !dbg !301
  tail call void @llvm.dbg.value(metadata !141, i64 0, metadata !107), !dbg !302
  br label %12, !dbg !302

; <label>:12                                      ; preds = %12, %.loopexit
  %indvars.iv6 = phi i64 [ 0, %.loopexit ], [ %indvars.iv.next7, %12 ]
  %13 = tail call noalias i8* @malloc(i64 16008) #10, !dbg !304
  %14 = bitcast i8* %13 to double*, !dbg !304
  %15 = getelementptr inbounds double** %11, i64 %indvars.iv6, !dbg !304
  store double* %14, double** %15, align 8, !dbg !304, !tbaa !165
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1, !dbg !302
  %exitcond8 = icmp eq i64 %indvars.iv.next7, 2000, !dbg !302
  br i1 %exitcond8, label %16, label %12, !dbg !302

; <label>:16                                      ; preds = %12
  %17 = tail call noalias i8* @malloc(i64 16000) #10, !dbg !305
  %18 = bitcast i8* %17 to double*, !dbg !305
  tail call void @llvm.dbg.value(metadata !{double* %18}, i64 0, metadata !111), !dbg !305
  tail call void @llvm.dbg.value(metadata !306, i64 0, metadata !112), !dbg !307
  %19 = tail call noalias i8* @malloc(i64 8000) #10, !dbg !308
  %20 = bitcast i8* %19 to i32*, !dbg !308
  tail call void @llvm.dbg.value(metadata !{i32* %20}, i64 0, metadata !113), !dbg !308
  tail call void @llvm.dbg.value(metadata !309, i64 0, metadata !114), !dbg !310
  tail call void @matgen(double** %11, double* %18) #8, !dbg !311
  tail call void @dgefa(double** %11, i32* %20) #8, !dbg !312
  tail call void @dgesl(double** %11, i32* %20, double* %18) #8, !dbg !313
  tail call void @llvm.dbg.value(metadata !314, i64 0, metadata !115), !dbg !315
  tail call void @free(i8* %19) #10, !dbg !316
  tail call void @free(i8* %17) #10, !dbg !317
  tail call void @llvm.dbg.value(metadata !141, i64 0, metadata !107), !dbg !318
  br label %21, !dbg !318

; <label>:21                                      ; preds = %21, %16
  %indvars.iv = phi i64 [ 0, %16 ], [ %indvars.iv.next, %21 ]
  %22 = getelementptr inbounds double** %11, i64 %indvars.iv, !dbg !320
  %23 = load double** %22, align 8, !dbg !320, !tbaa !165
  %24 = bitcast double* %23 to i8*, !dbg !320
  tail call void @free(i8* %24) #10, !dbg !320
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !318
  %exitcond = icmp eq i64 %indvars.iv.next, 2000, !dbg !318
  br i1 %exitcond, label %25, label %21, !dbg !318

; <label>:25                                      ; preds = %21
  tail call void @free(i8* %10) #10, !dbg !321
  %26 = load %struct._IO_FILE** @stdout, align 8, !dbg !322, !tbaa !165
  br i1 %ga_testing.0, label %27, label %29, !dbg !324

; <label>:27                                      ; preds = %25
  %28 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %26, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0), double 0.000000e+00) #10, !dbg !322
  br label %31, !dbg !322

; <label>:29                                      ; preds = %25
  %30 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %26, i8* getelementptr inbounds ([33 x i8]* @.str2, i64 0, i64 0), double 0.000000e+00) #10, !dbg !325
  br label %31

; <label>:31                                      ; preds = %29, %27
  %32 = load %struct._IO_FILE** @stdout, align 8, !dbg !326, !tbaa !165
  %33 = tail call i32 @fflush(%struct._IO_FILE* %32) #10, !dbg !326
  ret i32 0, !dbg !327
}
...
!257 = metadata !{i32 293, i32 0, metadata !82, null}
!258 = metadata !{i32 296, i32 0, metadata !81, null}
!259 = metadata !{i32 298, i32 0, metadata !80, null}
!260 = metadata !{i32 299, i32 0, metadata !80, null}
!261 = metadata !{i32 301, i32 0, metadata !262, null}
!262 = metadata !{i32 786443, metadata !1, metadata !80, i32 301, i32 0, i32 45} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!263 = metadata !{i32 303, i32 0, metadata !264, null}
!264 = metadata !{i32 786443, metadata !1, metadata !262, i32 302, i32 0, i32 46} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!265 = metadata !{i32 304, i32 0, metadata !264, null}
!266 = metadata !{i32 305, i32 0, metadata !264, null}
!267 = metadata !{i32 307, i32 0, metadata !80, null}
!268 = metadata !{i32 312, i32 0, metadata !64, null}
!269 = metadata !{i32 313, i32 0, metadata !64, null}
!270 = metadata !{i32 317, i32 0, metadata !84, null}
!271 = metadata !{i32 323, i32 0, metadata !96, null}
!272 = metadata !{i32 325, i32 0, metadata !95, null}
!273 = metadata !{i32 326, i32 0, metadata !95, null}
!274 = metadata !{i32 328, i32 0, metadata !275, null}
!275 = metadata !{i32 786443, metadata !1, metadata !95, i32 328, i32 0, i32 49} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!276 = metadata !{i32 330, i32 0, metadata !277, null}
!277 = metadata !{i32 786443, metadata !1, metadata !275, i32 329, i32 0, i32 50} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!278 = metadata !{i32 331, i32 0, metadata !277, null}
!279 = metadata !{i32 332, i32 0, metadata !277, null}
!280 = metadata !{i32 334, i32 0, metadata !95, null}
!281 = metadata !{i32 335, i32 0, metadata !95, null}
!282 = metadata !{i32 339, i32 0, metadata !283, null}
!283 = metadata !{i32 786443, metadata !1, metadata !84, i32 339, i32 0, i32 51} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!284 = metadata !{i32 341, i32 0, metadata !285, null}
!285 = metadata !{i32 786443, metadata !1, metadata !283, i32 340, i32 0, i32 52} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!286 = metadata !{i32 342, i32 0, metadata !285, null}
!287 = metadata !{i32 343, i32 0, metadata !285, null}
!288 = metadata !{i32 344, i32 0, metadata !285, null}
!289 = metadata !{i32 346, i32 0, metadata !84, null}
!290 = metadata !{i32 348, i32 0, metadata !98, null}
!291 = metadata !{i8 0}
!292 = metadata !{i32 353, i32 0, metadata !98, null}
!293 = metadata !{i32 355, i32 0, metadata !294, null}
!294 = metadata !{i32 786443, metadata !1, metadata !98, i32 355, i32 0, i32 53} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!295 = metadata !{i32 359, i32 0, metadata !296, null}
!296 = metadata !{i32 786443, metadata !1, metadata !297, i32 359, i32 0, i32 57} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!297 = metadata !{i32 786443, metadata !1, metadata !298, i32 358, i32 0, i32 56} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!298 = metadata !{i32 786443, metadata !1, metadata !299, i32 357, i32 0, i32 55} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!299 = metadata !{i32 786443, metadata !1, metadata !294, i32 356, i32 0, i32 54} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!300 = metadata !{i32 357, i32 0, metadata !298, null}
!301 = metadata !{i32 367, i32 0, metadata !98, null}
!302 = metadata !{i32 369, i32 0, metadata !303, null}
!303 = metadata !{i32 786443, metadata !1, metadata !98, i32 369, i32 0, i32 59} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!304 = metadata !{i32 370, i32 0, metadata !303, null}
!305 = metadata !{i32 372, i32 0, metadata !98, null}
!306 = metadata !{double* undef}
!307 = metadata !{i32 373, i32 0, metadata !98, null}
!308 = metadata !{i32 374, i32 0, metadata !98, null}
!309 = metadata !{double 0x41F3E5E475555555}
!310 = metadata !{i32 377, i32 0, metadata !98, null}
!311 = metadata !{i32 380, i32 0, metadata !98, null}
!312 = metadata !{i32 387, i32 0, metadata !98, null}
!313 = metadata !{i32 388, i32 0, metadata !98, null}
!314 = metadata !{double 0.000000e+00}
!315 = metadata !{i32 392, i32 0, metadata !98, null}
!316 = metadata !{i32 395, i32 0, metadata !98, null}
!317 = metadata !{i32 397, i32 0, metadata !98, null}
!318 = metadata !{i32 399, i32 0, metadata !319, null}
!319 = metadata !{i32 786443, metadata !1, metadata !98, i32 399, i32 0, i32 60} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!320 = metadata !{i32 400, i32 0, metadata !319, null}
!321 = metadata !{i32 402, i32 0, metadata !98, null}
!322 = metadata !{i32 406, i32 0, metadata !323, null}
!323 = metadata !{i32 786443, metadata !1, metadata !98, i32 405, i32 0, i32 61} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/lpbench.c]
!324 = metadata !{i32 405, i32 0, metadata !323, null}
!325 = metadata !{i32 408, i32 0, metadata !323, null}
!326 = metadata !{i32 410, i32 0, metadata !98, null}
!327 = metadata !{i32 413, i32 0, metadata !98, null}
