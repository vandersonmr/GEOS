...
; <label>:4                                       ; preds = %loop.exit, %.preheader
  ...
  tail call void @llvm.dbg.declare(metadata !37, metadata !22), !dbg !62
  tail call void @llvm.dbg.declare(metadata !37, metadata !23), !dbg !63
  tail call void @llvm.dbg.value(metadata !43, i64 0, metadata !64), !dbg !65
  tail call void @llvm.dbg.declare(metadata !37, metadata !16), !dbg !66
  tail call void @llvm.dbg.value(metadata !{double %9}, i64 0, metadata !68), !dbg !69
  %10 = fmul double %9, %9, !dbg !69
  tail call void @llvm.dbg.value(metadata !{double %8}, i64 0, metadata !68), !dbg !69
  %11 = fmul double %8, %8, !dbg !69
  %12 = fadd double %11, %10, !dbg !66
  %13 = fcmp ugt double %12, 4.000000e+00, !dbg !67
  %.pre = load i32* @max_i, align 4, !dbg !58, !tbaa !49
  br i1 %13, label %loop.exit, label %.lr.ph.i, !dbg !67

.lr.ph.i:                                         ; preds = %4, %18
  %14 = phi double [ %25, %18 ], [ %11, %4 ]
  %15 = phi double [ %24, %18 ], [ %10, %4 ]
  %z.sroa.5.03.i = phi double [ %23, %18 ], [ %8, %4 ]
  %z.sroa.0.02.i = phi double [ %22, %18 ], [ %9, %4 ]
  %i.01.i = phi i32 [ %16, %18 ], [ 1, %4 ]
  %16 = add nsw i32 %i.01.i, 1, !dbg !67
  tail call void @llvm.dbg.value(metadata !{i32 %16}, i64 0, metadata !64), !dbg !67
  %17 = icmp slt i32 %i.01.i, %.pre, !dbg !67
  br i1 %17, label %18, label %loop.exit

; <label>:18                                      ; preds = %.lr.ph.i
  %19 = fsub double %15, %14, !dbg !70
  %20 = fmul double %z.sroa.5.03.i, %z.sroa.0.02.i, !dbg !70
  %21 = fadd double %20, %20, !dbg !70
  %22 = fadd double %9, %19, !dbg !70
  %23 = fadd double %8, %21, !dbg !70
  tail call void @llvm.dbg.declare(metadata !37, metadata !16), !dbg !66
  tail call void @llvm.dbg.value(metadata !{double %z.sroa.0.02.i}, i64 0, metadata !68), !dbg !69
  %24 = fmul double %22, %22, !dbg !69
  tail call void @llvm.dbg.value(metadata !{double %z.sroa.5.03.i}, i64 0, metadata !68), !dbg !69
  %25 = fmul double %23, %23, !dbg !69
  %26 = fadd double %24, %25, !dbg !66
  %27 = fcmp ugt double %26, 4.000000e+00, !dbg !67
  br i1 %27, label %loop.exit, label %.lr.ph.i, !dbg !67

loop.exit:                                        ; preds = %.lr.ph.i, %18, %4
  %i.1.i = phi i32 [ 1, %4 ], [ %16, %18 ], [ %16, %.lr.ph.i ]
  %28 = icmp sgt i32 %i.1.i, %.pre, !dbg !58
  %29 = select i1 %28, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0), !dbg !58
  %30 = tail call i32 (i8*, ...)* @printf(i8* %29) #5, !dbg !58
  %31 = add nsw i32 %i.01, 1, !dbg !61
  tail call void @llvm.dbg.value(metadata !{i32 %31}, i64 0, metadata !29), !dbg !61
  %exitcond = icmp eq i32 %31, 39, !dbg !61
  br i1 %exitcond, label %32, label %4, !dbg !61

; <label>:32                                      ; preds = %loop.exit
  %putchar = tail call i32 @putchar(i32 10) #5, !dbg !71
  %33 = add nsw i32 %j.02, 1, !dbg !56
  tail call void @llvm.dbg.value(metadata !{i32 %33}, i64 0, metadata !30), !dbg !56
  %exitcond3 = icmp eq i32 %33, 39, !dbg !56
  br i1 %exitcond3, label %34, label %.preheader, !dbg !56
...
!62 = metadata !{i32 11, i32 0, metadata !17, metadata !58}
!63 = metadata !{i32 12, i32 0, metadata !17, metadata !58}
!64 = metadata !{i32 786688, metadata !17, metadata !"i", metadata !5, i32 13, metadata !20, i32 0, metadata !58} ; [ DW_TAG_auto_variable ] [i] [line 13]
!65 = metadata !{i32 13, i32 0, metadata !17, metadata !58}
!66 = metadata !{i32 9, i32 0, metadata !11, metadata !67}
!67 = metadata !{i32 14, i32 0, metadata !17, metadata !58}
!68 = metadata !{i32 786689, metadata !4, metadata !"x", metadata !5, i32 16777223, metadata !8, i32 0, metadata !66} ; [ DW_TAG_arg_variable ] [x] [line 7]
!69 = metadata !{i32 7, i32 0, metadata !4, metadata !66}
!70 = metadata !{i32 15, i32 0, metadata !17, metadata !58}
!71 = metadata !{i32 24, i32 0, metadata !60, null}
!72 = metadata !{i32 26, i32 0, metadata !25, null}
