...
; <label>:5                                       ; preds = %25, %.preheader
  %y.04 = phi i32 [ 0, %.preheader ], [ %26, %25 ]
...
; <label>:25                                      ; preds = %13
  tail call void @emit(double %19, double %20), !dbg !63
  %26 = add nsw i32 %y.04, 1, !dbg !50
  tail call void @llvm.dbg.value(metadata !{i32 %26}, i64 0, metadata !17), !dbg !50
  %exitcond = icmp eq i32 %26, 5000, !dbg !50
  br i1 %exitcond, label %27, label %5, !dbg !50

; <label>:27                                      ; preds = %25
  %28 = add nsw i32 %x.05, 1, !dbg !48
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !15), !dbg !48
  %exitcond7 = icmp eq i32 %28, 5000, !dbg !48
  br i1 %exitcond7, label %29, label %.preheader, !dbg !48
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @mandel(), !dbg !65
  %1 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !66
  %2 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !66
  %3 = fptosi double %1 to i32, !dbg !66
  %4 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %3) #3, !dbg !66
  ret i32 0, !dbg !67
}
...
!63 = metadata !{i32 41, i32 0, metadata !20, null}
!64 = metadata !{i32 44, i32 0, metadata !11, null}
!65 = metadata !{i32 47, i32 0, metadata !25, null}
!66 = metadata !{i32 48, i32 0, metadata !25, null}
!67 = metadata !{i32 49, i32 0, metadata !25, null}
