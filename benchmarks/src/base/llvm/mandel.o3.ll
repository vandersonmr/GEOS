...
; <label>:13                                      ; preds = %13, %5
  ...
  %21 = tail call double @hypot(double %19, double %20) #3, !dbg !61
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !47, i64 0, metadata !67) #3, !dbg !69
  br label %.preheader.i, !dbg !69

.preheader.i:                                     ; preds = %31, %0
  %x.05.i = phi i32 [ 0, %0 ], [ %32, %31 ]
  %1 = sitofp i32 %x.05.i to double, !dbg !70
  %2 = fmul double %1, 4.000000e+00, !dbg !70
  %3 = fdiv double %2, 5.000000e+03, !dbg !70
  %4 = fadd double %3, -2.000000e+00, !dbg !70
  br label %5, !dbg !71

; <label>:5                                       ; preds = %25, %.preheader.i
  %y.04.i = phi i32 [ 0, %.preheader.i ], [ %30, %25 ]
  tail call void @llvm.dbg.declare(metadata !43, metadata !19) #3, !dbg !70
  %6 = sitofp i32 %y.04.i to double, !dbg !70
  %7 = fmul double %6, 4.000000e+00, !dbg !70
  %8 = fdiv double %7, 5.000000e+03, !dbg !70
  %9 = fsub double -2.000000e+00, %8, !dbg !70
  %10 = fmul double %9, 0.000000e+00, !dbg !70
  %11 = fadd double %9, 0.000000e+00, !dbg !70
  %12 = fadd double %4, %10, !dbg !70
  tail call void @llvm.dbg.declare(metadata !43, metadata !24) #3, !dbg !72
  tail call void @llvm.dbg.value(metadata !47, i64 0, metadata !73) #3, !dbg !74
  br label %13, !dbg !74

; <label>:13                                      ; preds = %13, %5
  %z.sroa.0.03.i = phi double [ 0.000000e+00, %5 ], [ %19, %13 ]
  %z.sroa.6.02.i = phi double [ 0.000000e+00, %5 ], [ %20, %13 ]
  %n.01.i = phi i32 [ 0, %5 ], [ %23, %13 ]
  %14 = fmul double %z.sroa.0.03.i, %z.sroa.0.03.i, !dbg !75
  %15 = fmul double %z.sroa.6.02.i, %z.sroa.6.02.i, !dbg !75
  %16 = fsub double %14, %15, !dbg !75
  %17 = fmul double %z.sroa.0.03.i, %z.sroa.6.02.i, !dbg !75
  %18 = fadd double %17, %17, !dbg !75
  %19 = fadd double %12, %16, !dbg !75
  %20 = fadd double %11, %18, !dbg !75
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !76) #3, !dbg !78
  tail call void @llvm.dbg.value(metadata !{double %20}, i64 0, metadata !79) #3, !dbg !78
  %21 = tail call double @hypot(double %19, double %20) #3, !dbg !80
  %22 = fcmp ult double %21, 2.000000e+00, !dbg !77
  %23 = add nsw i32 %n.01.i, 1, !dbg !74
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !73) #3, !dbg !74
  %24 = icmp slt i32 %23, 10, !dbg !74
  %or.cond.i = and i1 %22, %24, !dbg !77
  br i1 %or.cond.i, label %13, label %25, !dbg !77

; <label>:25                                      ; preds = %13
  tail call void @llvm.dbg.declare(metadata !43, metadata !10) #3, !dbg !81
  %26 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !83
  %27 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !83
  %28 = fadd double %19, %26, !dbg !83
  %29 = fadd double %20, %27, !dbg !83
  store volatile double %28, double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !83
  store volatile double %29, double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !83
  %30 = add nsw i32 %y.04.i, 1, !dbg !71
  tail call void @llvm.dbg.value(metadata !{i32 %30}, i64 0, metadata !84) #3, !dbg !71
  %exitcond.i = icmp eq i32 %30, 5000, !dbg !71
  br i1 %exitcond.i, label %31, label %5, !dbg !71

; <label>:31                                      ; preds = %25
  %32 = add nsw i32 %x.05.i, 1, !dbg !69
  tail call void @llvm.dbg.value(metadata !{i32 %32}, i64 0, metadata !67) #3, !dbg !69
  %exitcond7.i = icmp eq i32 %32, 5000, !dbg !69
  br i1 %exitcond7.i, label %mandel.exit, label %.preheader.i, !dbg !69

mandel.exit:                                      ; preds = %31
  %33 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !85
  %34 = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !85
  %35 = fptosi double %33 to i32, !dbg !85
  %36 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %35) #3, !dbg !85
  ret i32 0, !dbg !86
}
...
!67 = metadata !{i32 786688, metadata !11, metadata !"x", metadata !5, i32 30, metadata !16, i32 0, metadata !68} ; [ DW_TAG_auto_variable ] [x] [line 30]
!68 = metadata !{i32 47, i32 0, metadata !25, null}
!69 = metadata !{i32 31, i32 0, metadata !23, metadata !68}
!70 = metadata !{i32 33, i32 0, metadata !20, metadata !68}
!71 = metadata !{i32 32, i32 0, metadata !21, metadata !68}
!72 = metadata !{i32 34, i32 0, metadata !20, metadata !68}
!73 = metadata !{i32 786688, metadata !11, metadata !"n", metadata !5, i32 30, metadata !16, i32 0, metadata !68} ; [ DW_TAG_auto_variable ] [n] [line 30]
!74 = metadata !{i32 36, i32 0, metadata !53, metadata !68}
!75 = metadata !{i32 37, i32 0, metadata !55, metadata !68}
!76 = metadata !{i32 786689, metadata !28, metadata !"__x", metadata !30, i32 16778049, metadata !33, i32 0, metadata !77} ; [ DW_TAG_arg_variable ] [__x] [line 833]
!77 = metadata !{i32 38, i32 0, metadata !58, metadata !68}
!78 = metadata !{i32 833, i32 0, metadata !28, metadata !77}
!79 = metadata !{i32 786689, metadata !28, metadata !"__y", metadata !30, i32 33555265, metadata !33, i32 0, metadata !77} ; [ DW_TAG_arg_variable ] [__y] [line 833]
!80 = metadata !{i32 833, i32 0, metadata !62, metadata !77}
!81 = metadata !{i32 25, i32 0, metadata !4, metadata !82}
!82 = metadata !{i32 41, i32 0, metadata !20, metadata !68}
!83 = metadata !{i32 26, i32 0, metadata !4, metadata !82}
!84 = metadata !{i32 786688, metadata !11, metadata !"y", metadata !5, i32 30, metadata !16, i32 0, metadata !68} ; [ DW_TAG_auto_variable ] [y] [line 30]
!85 = metadata !{i32 48, i32 0, metadata !25, null}
!86 = metadata !{i32 49, i32 0, metadata !25, null}
