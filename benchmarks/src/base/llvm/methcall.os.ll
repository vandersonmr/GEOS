...
define i32 @main(i32 %argc, i8** nocapture readonly %argv) #1 {
  ...
  br i1 %1, label %2, label %6, !dbg !152

; <label>:2                                       ; preds = %0
  %3 = getelementptr inbounds i8** %argv, i64 1, !dbg !152
  %4 = load i8** %3, align 8, !dbg !152, !tbaa !153
  %5 = tail call i32 @atoi(i8* %4) #6, !dbg !152
  br label %6, !dbg !152

; <label>:6                                       ; preds = %0, %2
  %7 = phi i32 [ %5, %2 ], [ 500000000, %0 ], !dbg !152
  tail call void @llvm.dbg.value(metadata !{i32 %7}, i64 0, metadata !84), !dbg !152
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !87), !dbg !155
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !156) #7, !dbg !158
  %8 = tail call noalias i8* @malloc(i64 24) #5, !dbg !159
  %9 = bitcast i8* %8 to %struct.Toggle*, !dbg !159
  tail call void @llvm.dbg.value(metadata !{%struct.Toggle* %9}, i64 0, metadata !160) #7, !dbg !159
  tail call void @llvm.dbg.value(metadata !{%struct.Toggle* %9}, i64 0, metadata !161) #7, !dbg !163
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !164) #7, !dbg !163
  store i8 1, i8* %8, align 1, !dbg !165, !tbaa !93
  %10 = getelementptr inbounds i8* %8, i64 8, !dbg !166
  %11 = bitcast i8* %10 to {}**, !dbg !166
  store {}* bitcast (i8 (%struct.Toggle*)* @toggle_value to {}*), {}** %11, align 8, !dbg !166, !tbaa !104
  %12 = getelementptr inbounds i8* %8, i64 16, !dbg !167
  %13 = bitcast i8* %12 to %struct.Toggle* (%struct.Toggle*)**, !dbg !167
  store %struct.Toggle* (%struct.Toggle*)* @toggle_activate, %struct.Toggle* (%struct.Toggle*)** %13, align 8, !dbg !167, !tbaa !106
  tail call void @llvm.dbg.value(metadata !{%struct.Toggle* %9}, i64 0, metadata !85), !dbg !157
  tail call void @llvm.dbg.value(metadata !168, i64 0, metadata !83), !dbg !169
  %14 = icmp sgt i32 %7, 0, !dbg !169
  br i1 %14, label %.lr.ph5, label %21, !dbg !169

.lr.ph5:                                          ; preds = %6, %._crit_edge14
  %15 = phi %struct.Toggle* (%struct.Toggle*)* [ %.pre15, %._crit_edge14 ], [ @toggle_activate, %6 ]
  %i.03 = phi i32 [ %phitmp17, %._crit_edge14 ], [ 1, %6 ]
  %16 = tail call %struct.Toggle* %15(%struct.Toggle* %9) #5, !dbg !171
  %17 = getelementptr inbounds %struct.Toggle* %16, i64 0, i32 1, !dbg !171
  %18 = load {}** %17, align 8, !dbg !171
  %19 = bitcast {}* %18 to i8 (%struct.Toggle*)*, !dbg !171
  %20 = tail call signext i8 %19(%struct.Toggle* %9) #5, !dbg !171
  tail call void @llvm.dbg.value(metadata !{i8 %20}, i64 0, metadata !87), !dbg !171
  tail call void @llvm.dbg.value(metadata !{i32 %i.03}, i64 0, metadata !83), !dbg !169
  %exitcond12 = icmp eq i32 %i.03, %7, !dbg !169
  br i1 %exitcond12, label %._crit_edge6, label %._crit_edge14, !dbg !169

._crit_edge14:                                    ; preds = %.lr.ph5
  %.pre15 = load %struct.Toggle* (%struct.Toggle*)** %13, align 8, !dbg !171, !tbaa !106
  %phitmp17 = add i32 %i.03, 1, !dbg !169
  br label %.lr.ph5, !dbg !169

._crit_edge6:                                     ; preds = %.lr.ph5
  %phitmp = icmp ne i8 %20, 0, !dbg !169
  %phitmp8 = select i1 %phitmp, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), !dbg !169
  br label %21, !dbg !169

; <label>:21                                      ; preds = %._crit_edge6, %6
  %val.0.lcssa = phi i8* [ %phitmp8, %._crit_edge6 ], [ getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), %6 ]
  %22 = tail call i32 @puts(i8* %val.0.lcssa) #5, !dbg !173
  tail call void @free(i8* %8) #5, !dbg !174
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !87), !dbg !175
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !176) #7, !dbg !178
  tail call void @llvm.dbg.value(metadata !179, i64 0, metadata !180) #7, !dbg !178
  %23 = tail call noalias i8* @malloc(i64 32) #5, !dbg !181
  tail call void @llvm.dbg.value(metadata !154, i64 0, metadata !182) #7, !dbg !184
  store i8 1, i8* %23, align 1, !dbg !185, !tbaa !93
  %24 = getelementptr inbounds i8* %23, i64 8, !dbg !186
  %25 = bitcast i8* %24 to {}**, !dbg !186
  store {}* bitcast (i8 (%struct.Toggle*)* @toggle_value to {}*), {}** %25, align 8, !dbg !186, !tbaa !104
  %26 = getelementptr inbounds i8* %23, i64 16, !dbg !187
  %27 = bitcast i8* %26 to %struct.Toggle* (%struct.Toggle*)**, !dbg !187
  tail call void @llvm.dbg.value(metadata !179, i64 0, metadata !188) #7, !dbg !190
  %28 = getelementptr inbounds i8* %23, i64 24, !dbg !191
  %29 = bitcast i8* %28 to i32*, !dbg !191
  store i32 3, i32* %29, align 4, !dbg !191, !tbaa !123
  %30 = getelementptr inbounds i8* %23, i64 28, !dbg !192
  %31 = bitcast i8* %30 to i32*, !dbg !192
  store i32 0, i32* %31, align 4, !dbg !192, !tbaa !120
  store %struct.Toggle* (%struct.Toggle*)* bitcast (%struct.NthToggle* (%struct.NthToggle*)* @nth_toggle_activate to %struct.Toggle* (%struct.Toggle*)*), %struct.Toggle* (%struct.Toggle*)** %27, align 8, !dbg !193, !tbaa !134
  tail call void @llvm.dbg.value(metadata !168, i64 0, metadata !83), !dbg !194
  br i1 %14, label %.lr.ph, label %40, !dbg !194

.lr.ph:                                           ; preds = %21
  %32 = bitcast i8* %23 to %struct.Toggle*, !dbg !196
  br label %33, !dbg !194

; <label>:33                                      ; preds = %._crit_edge13, %.lr.ph
  %34 = phi %struct.Toggle* (%struct.Toggle*)* [ bitcast (%struct.NthToggle* (%struct.NthToggle*)* @nth_toggle_activate to %struct.Toggle* (%struct.Toggle*)*), %.lr.ph ], [ %.pre, %._crit_edge13 ]
  %i.12 = phi i32 [ 1, %.lr.ph ], [ %phitmp16, %._crit_edge13 ]
  %35 = tail call %struct.Toggle* %34(%struct.Toggle* %32) #5, !dbg !196
  %36 = getelementptr inbounds %struct.Toggle* %35, i64 0, i32 1, !dbg !196
  %37 = load {}** %36, align 8, !dbg !196
  %38 = bitcast {}* %37 to i8 (%struct.Toggle*)*, !dbg !196
  %39 = tail call signext i8 %38(%struct.Toggle* %32) #5, !dbg !196
  tail call void @llvm.dbg.value(metadata !{i8 %39}, i64 0, metadata !87), !dbg !196
  tail call void @llvm.dbg.value(metadata !{i32 %i.12}, i64 0, metadata !83), !dbg !194
  %exitcond = icmp eq i32 %i.12, %7, !dbg !194
  br i1 %exitcond, label %._crit_edge, label %._crit_edge13, !dbg !194

._crit_edge13:                                    ; preds = %33
  %.pre = load %struct.Toggle* (%struct.Toggle*)** %27, align 8, !dbg !196, !tbaa !134
  %phitmp16 = add i32 %i.12, 1, !dbg !194
  br label %33, !dbg !194

._crit_edge:                                      ; preds = %33
  %phitmp9 = icmp ne i8 %39, 0, !dbg !194
  %phitmp10 = select i1 %phitmp9, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8]* @.str1, i64 0, i64 0), !dbg !194
  br label %40, !dbg !194

; <label>:40                                      ; preds = %._crit_edge, %21
  %val.1.lcssa = phi i8* [ %phitmp10, %._crit_edge ], [ getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), %21 ]
  %41 = tail call i32 @puts(i8* %val.1.lcssa) #5, !dbg !198
  tail call void @free(i8* %23) #5, !dbg !199
  ret i32 0, !dbg !200
}
...
!153 = metadata !{metadata !97, metadata !97, i64 0}
!154 = metadata !{i8 1}
!155 = metadata !{i32 77, i32 0, metadata !75, null}
!156 = metadata !{i32 786689, metadata !41, metadata !"start_state", metadata !10, i32 16777252, metadata !13, i32 0, metadata !157} ; [ DW_TAG_arg_variable ] [start_state] [line 36]
!157 = metadata !{i32 79, i32 0, metadata !75, null}
!158 = metadata !{i32 36, i32 0, metadata !41, metadata !157}
!159 = metadata !{i32 37, i32 0, metadata !41, metadata !157}
!160 = metadata !{i32 786688, metadata !41, metadata !"this", metadata !10, i32 37, metadata !14, i32 0, metadata !157} ; [ DW_TAG_auto_variable ] [this] [line 37]
!161 = metadata !{i32 786689, metadata !35, metadata !"this", metadata !10, i32 16777246, metadata !14, i32 0, metadata !162} ; [ DW_TAG_arg_variable ] [this] [line 30]
!162 = metadata !{i32 38, i32 0, metadata !41, metadata !157}
!163 = metadata !{i32 30, i32 0, metadata !35, metadata !162}
!164 = metadata !{i32 786689, metadata !35, metadata !"start_state", metadata !10, i32 33554462, metadata !13, i32 0, metadata !162} ; [ DW_TAG_arg_variable ] [start_state] [line 30]
!165 = metadata !{i32 31, i32 0, metadata !35, metadata !162}
!166 = metadata !{i32 32, i32 0, metadata !35, metadata !162}
!167 = metadata !{i32 33, i32 0, metadata !35, metadata !162}
!168 = metadata !{i32 0}
!169 = metadata !{i32 80, i32 0, metadata !170, null}
!170 = metadata !{i32 786443, metadata !1, metadata !75, i32 80, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/methcall.c]
!171 = metadata !{i32 81, i32 0, metadata !172, null}
!172 = metadata !{i32 786443, metadata !1, metadata !170, i32 80, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/methcall.c]
!173 = metadata !{i32 83, i32 0, metadata !75, null}
!174 = metadata !{i32 84, i32 0, metadata !75, null}
!175 = metadata !{i32 86, i32 0, metadata !75, null}
!176 = metadata !{i32 786689, metadata !68, metadata !"start_state", metadata !10, i32 16777277, metadata !13, i32 0, metadata !177} ; [ DW_TAG_arg_variable ] [start_state] [line 61]
!177 = metadata !{i32 87, i32 0, metadata !75, null}
!178 = metadata !{i32 61, i32 0, metadata !68, metadata !177}
!179 = metadata !{i32 3}
!180 = metadata !{i32 786689, metadata !68, metadata !"max_count", metadata !10, i32 33554493, metadata !58, i32 0, metadata !177} ; [ DW_TAG_arg_variable ] [max_count] [line 61]
!181 = metadata !{i32 62, i32 0, metadata !68, metadata !177}
...
!183 = metadata !{i32 63, i32 0, metadata !68, metadata !177}
...
!188 = metadata !{i32 786689, metadata !62, metadata !"max_count", metadata !10, i32 33554487, metadata !58, i32 0, metadata !189} ; [ DW_TAG_arg_variable ] [max_count] [line 55]
!189 = metadata !{i32 64, i32 0, metadata !68, metadata !177}
!190 = metadata !{i32 55, i32 0, metadata !62, metadata !189}
!191 = metadata !{i32 56, i32 0, metadata !62, metadata !189}
!192 = metadata !{i32 57, i32 0, metadata !62, metadata !189}
!193 = metadata !{i32 58, i32 0, metadata !62, metadata !189} ; [ DW_TAG_imported_module ]
!194 = metadata !{i32 88, i32 0, metadata !195, null}
!195 = metadata !{i32 786443, metadata !1, metadata !75, i32 88, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/methcall.c]
!196 = metadata !{i32 89, i32 0, metadata !197, null}
!197 = metadata !{i32 786443, metadata !1, metadata !195, i32 88, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/methcall.c]
!198 = metadata !{i32 91, i32 0, metadata !75, null}
!199 = metadata !{i32 92, i32 0, metadata !75, null}
!200 = metadata !{i32 93, i32 0, metadata !75, null}
