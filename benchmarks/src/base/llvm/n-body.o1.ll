...
.loopexit:                                        ; preds = %12, %.lr.ph8
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1, !dbg !90
  %lftr.wideiv17 = trunc i64 %indvars.iv.next16 to i32, !dbg !90
  %exitcond18 = icmp eq i32 %lftr.wideiv17, %nbodies, !dbg !90
  br i1 %exitcond18, label %.preheader, label %.lr.ph8, !dbg !90

.preheader:                                       ; preds = %.loopexit
  %2 = icmp sgt i32 %nbodies, 0, !dbg !91
  br i1 %2, label %.lr.ph, label %._crit_edge, !dbg !91
...
.lr.ph8:                                          ; preds = %0, %.loopexit
  ...
  %3 = trunc i64 %indvars.iv.next16 to i32, !dbg !92
  %4 = icmp slt i32 %3, %nbodies, !dbg !92
  br i1 %4, label %.lr.ph5, label %.loopexit, !dbg !92

.lr.ph5:                                          ; preds = %.lr.ph8
  %5 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 0, !dbg !93
  %6 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 1, !dbg !94
  %7 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 2, !dbg !95
  %8 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 3, !dbg !96
  %9 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 4, !dbg !97
  %10 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 5, !dbg !98
  %11 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv15, i32 6, !dbg !99
  br label %12, !dbg !92

; <label>:12                                      ; preds = %12, %.lr.ph5
  %indvars.iv11 = phi i64 [ %indvars.iv9, %.lr.ph5 ], [ %indvars.iv.next12, %12 ]
  %13 = load double* %5, align 8, !dbg !93, !tbaa !100
  %14 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 0, !dbg !93
  %15 = load double* %14, align 8, !dbg !93, !tbaa !100
  %16 = fsub double %13, %15, !dbg !93
  tail call void @llvm.dbg.value(metadata !{double %16}, i64 0, metadata !32), !dbg !93
  %17 = load double* %6, align 8, !dbg !94, !tbaa !105
  %18 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 1, !dbg !94
  %19 = load double* %18, align 8, !dbg !94, !tbaa !105
  %20 = fsub double %17, %19, !dbg !94
  tail call void @llvm.dbg.value(metadata !{double %20}, i64 0, metadata !33), !dbg !94
  %21 = load double* %7, align 8, !dbg !95, !tbaa !106
  %22 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 2, !dbg !95
  %23 = load double* %22, align 8, !dbg !95, !tbaa !106
  %24 = fsub double %21, %23, !dbg !95
  tail call void @llvm.dbg.value(metadata !{double %24}, i64 0, metadata !34), !dbg !95
  %25 = fmul double %16, %16, !dbg !107
  %26 = fmul double %20, %20, !dbg !107
  %27 = fadd double %25, %26, !dbg !107
  %28 = fmul double %24, %24, !dbg !107
  %29 = fadd double %27, %28, !dbg !107
  %30 = tail call double @sqrt(double %29) #3, !dbg !107
  tail call void @llvm.dbg.value(metadata !{double %30}, i64 0, metadata !35), !dbg !107
  %31 = fmul double %30, %30, !dbg !108
  %32 = fmul double %30, %31, !dbg !108
  %33 = fdiv double %dt, %32, !dbg !108
  tail call void @llvm.dbg.value(metadata !{double %33}, i64 0, metadata !36), !dbg !108
  %34 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 6, !dbg !96
  %35 = load double* %34, align 8, !dbg !96, !tbaa !109
  %36 = fmul double %16, %35, !dbg !96
  %37 = fmul double %33, %36, !dbg !96
  %38 = load double* %8, align 8, !dbg !96, !tbaa !110
  %39 = fsub double %38, %37, !dbg !96
  store double %39, double* %8, align 8, !dbg !96, !tbaa !110
  %40 = load double* %34, align 8, !dbg !97, !tbaa !109
  %41 = fmul double %20, %40, !dbg !97
  %42 = fmul double %33, %41, !dbg !97
  %43 = load double* %9, align 8, !dbg !97, !tbaa !111
  %44 = fsub double %43, %42, !dbg !97
  store double %44, double* %9, align 8, !dbg !97, !tbaa !111
  %45 = load double* %34, align 8, !dbg !98, !tbaa !109
  %46 = fmul double %24, %45, !dbg !98
  %47 = fmul double %33, %46, !dbg !98
  %48 = load double* %10, align 8, !dbg !98, !tbaa !112
  %49 = fsub double %48, %47, !dbg !98
  store double %49, double* %10, align 8, !dbg !98, !tbaa !112
  %50 = load double* %11, align 8, !dbg !99, !tbaa !109
  %51 = fmul double %16, %50, !dbg !99
  %52 = fmul double %33, %51, !dbg !99
  %53 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 3, !dbg !99
  %54 = load double* %53, align 8, !dbg !99, !tbaa !110
  %55 = fadd double %54, %52, !dbg !99
  store double %55, double* %53, align 8, !dbg !99, !tbaa !110
  %56 = load double* %11, align 8, !dbg !113, !tbaa !109
  %57 = fmul double %20, %56, !dbg !113
  %58 = fmul double %33, %57, !dbg !113
  %59 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 4, !dbg !113
  %60 = load double* %59, align 8, !dbg !113, !tbaa !111
  %61 = fadd double %60, %58, !dbg !113
  store double %61, double* %59, align 8, !dbg !113, !tbaa !111
  %62 = load double* %11, align 8, !dbg !114, !tbaa !109
  %63 = fmul double %24, %62, !dbg !114
  %64 = fmul double %33, %63, !dbg !114
  %65 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv11, i32 5, !dbg !114
  %66 = load double* %65, align 8, !dbg !114, !tbaa !112
  %67 = fadd double %66, %64, !dbg !114
  store double %67, double* %65, align 8, !dbg !114, !tbaa !112
  ...
  br i1 %exitcond14, label %.loopexit, label %12, !dbg !92

.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %.preheader ]
  %68 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv, i32 3, !dbg !115
  %69 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv, i32 0, !dbg !115
  %70 = bitcast double* %68 to <2 x double>*, !dbg !115
  %71 = load <2 x double>* %70, align 8, !dbg !115, !tbaa !116
  %72 = insertelement <2 x double> undef, double %dt, i32 0, !dbg !115
  %73 = insertelement <2 x double> %72, double %dt, i32 1, !dbg !115
  %74 = fmul <2 x double> %73, %71, !dbg !115
  %75 = bitcast double* %69 to <2 x double>*, !dbg !115
  %76 = load <2 x double>* %75, align 8, !dbg !115, !tbaa !116
  %77 = fadd <2 x double> %76, %74, !dbg !115
  %78 = bitcast double* %69 to <2 x double>*, !dbg !115
  store <2 x double> %77, <2 x double>* %78, align 8, !dbg !115, !tbaa !116
  %79 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv, i32 5, !dbg !117
  %80 = load double* %79, align 8, !dbg !117, !tbaa !112
  %81 = fmul double %80, %dt, !dbg !117
  %82 = getelementptr inbounds %struct.planet* %bodies, i64 %indvars.iv, i32 2, !dbg !117
  %83 = load double* %82, align 8, !dbg !117, !tbaa !106
  %84 = fadd double %83, %81, !dbg !117
  store double %84, double* %82, align 8, !dbg !117, !tbaa !106
...
.loopexit:                                        ; preds = %23, %.lr.ph5
  ...
  %lftr.wideiv11 = trunc i64 %indvars.iv.next10 to i32, !dbg !122
  %exitcond12 = icmp eq i32 %lftr.wideiv11, %nbodies, !dbg !122
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  tail call void @offset_momentum(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)), !dbg !146
  %1 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)), !dbg !147
...
; <label>:3                                       ; preds = %3, %0
  ...
  tail call void @advance(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0), double 1.000000e-02), !dbg !151
...
; <label>:5                                       ; preds = %3
  %6 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)), !dbg !152
