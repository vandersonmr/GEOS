...
.lr.ph.i:
  ...
  %49 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)), !dbg !163
  %50 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %49) #3, !dbg !163
  tail call void @llvm.dbg.value(metadata !164, i64 0, metadata !79), !dbg !165
  br label %51, !dbg !165

; <label>:51                                      ; preds = %51, %.lr.ph.i
  %i.02 = phi i32 [ 1, %.lr.ph.i ], [ %52, %51 ]
  tail call void @advance(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0), double 1.000000e-02), !dbg !167
  %52 = add nsw i32 %i.02, 1, !dbg !165
  tail call void @llvm.dbg.value(metadata !{i32 %52}, i64 0, metadata !79), !dbg !165
  %exitcond = icmp eq i32 %52, 5000001, !dbg !165
  br i1 %exitcond, label %53, label %51, !dbg !165

; <label>:53                                      ; preds = %51
  %54 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)), !dbg !168
  %55 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %54) #3, !dbg !168
  ret i32 0, !dbg !169
}
