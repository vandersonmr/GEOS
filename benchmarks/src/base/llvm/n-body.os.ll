...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %0
  ...
  %pz.03.i = phi double [ %14, %.lr.ph.i ], [ 0.000000e+00, %0 ]
  %1 = phi <2 x double> [ %10, %.lr.ph.i ], [ zeroinitializer, %0 ]
  %2 = getelementptr inbounds [5 x %struct.planet]* @bodies, i64 0, i64 %indvars.iv.i, i32 3, !dbg !158
  %3 = getelementptr inbounds [5 x %struct.planet]* @bodies, i64 0, i64 %indvars.iv.i, i32 6, !dbg !158
  %4 = load double* %3, align 8, !dbg !158, !tbaa !109
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !152), !dbg !158
  %5 = bitcast double* %2 to <2 x double>*, !dbg !158
  %6 = load <2 x double>* %5, align 8, !dbg !158, !tbaa !116
  %7 = insertelement <2 x double> undef, double %4, i32 0, !dbg !158
  %8 = insertelement <2 x double> %7, double %4, i32 1, !dbg !158
  %9 = fmul <2 x double> %6, %8, !dbg !158
  %10 = fadd <2 x double> %1, %9, !dbg !158
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !154), !dbg !159
  %11 = getelementptr inbounds [5 x %struct.planet]* @bodies, i64 0, i64 %indvars.iv.i, i32 5, !dbg !160
  %12 = load double* %11, align 8, !dbg !160, !tbaa !112
  %13 = fmul double %4, %12, !dbg !160
  %14 = fadd double %pz.03.i, %13, !dbg !160
  tail call void @llvm.dbg.value(metadata !{double %14}, i64 0, metadata !155), !dbg !160
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !157
  %exitcond4 = icmp eq i64 %indvars.iv.next.i, 5, !dbg !157
  br i1 %exitcond4, label %offset_momentum.exit, label %.lr.ph.i, !dbg !157

offset_momentum.exit:                             ; preds = %.lr.ph.i
  %15 = fsub <2 x double> <double -0.000000e+00, double -0.000000e+00>, %10, !dbg !161
  %16 = fdiv <2 x double> %15, <double 0x4043BD3CC9BE45DE, double 0x4043BD3CC9BE45DE>, !dbg !161
  store <2 x double> %16, <2 x double>* bitcast (double* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0, i32 3) to <2 x double>*), align 8, !dbg !161, !tbaa !116
  %17 = fsub double -0.000000e+00, %14, !dbg !162
  %18 = fdiv double %17, 0x4043BD3CC9BE45DE, !dbg !162
  store double %18, double* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0, i32 5), align 8, !dbg !162, !tbaa !112
  %19 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)) #4, !dbg !163
  %20 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %19) #3, !dbg !163
  tail call void @llvm.dbg.value(metadata !164, i64 0, metadata !79), !dbg !165
  br label %21, !dbg !165

; <label>:21                                      ; preds = %21, %offset_momentum.exit
  %i.02 = phi i32 [ 1, %offset_momentum.exit ], [ %22, %21 ]
  tail call void @advance(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0), double 1.000000e-02) #4, !dbg !167
  %22 = add nsw i32 %i.02, 1, !dbg !165
  tail call void @llvm.dbg.value(metadata !{i32 %22}, i64 0, metadata !79), !dbg !165
  %exitcond = icmp eq i32 %22, 5000001, !dbg !165
  br i1 %exitcond, label %23, label %21, !dbg !165

; <label>:23                                      ; preds = %21
  %24 = tail call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i64 0, i64 0)) #4, !dbg !168
  %25 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %24) #3, !dbg !168
  ret i32 0, !dbg !169
}
...
!163 = metadata !{i32 136, i32 0, metadata !69, null}
!164 = metadata !{i32 1}
!165 = metadata !{i32 137, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !1, metadata !69, i32 137, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/n-body.c]
!167 = metadata !{i32 138, i32 0, metadata !166, null}
!168 = metadata !{i32 139, i32 0, metadata !69, null}
!169 = metadata !{i32 140, i32 0, metadata !69, null}
