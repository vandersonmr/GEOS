...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  ...
  %1 = tail call noalias i8* @malloc(i64 5120004) #4, !dbg !33
...
._crit_edge:                                      ; preds = %.loopexit, %.preheader
  ...
  %34 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 %4, i32 %count.0.lcssa) #4, !dbg !54
...
; <label>:36                                      ; preds = %._crit_edge
  tail call void @free(i8* %1) #4, !dbg !56
  br label %37, !dbg !57
