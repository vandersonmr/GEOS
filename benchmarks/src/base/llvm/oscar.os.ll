...
; Function Attrs: nounwind optsize uwtable
define void @Oscar() #0 {
  tail call void @Exptab(i32 256, %struct.complex* getelementptr inbounds ([130 x %struct.complex]* @e, i64 0, i64 0)) #6, !dbg !313
...
; <label>:20                                      ; preds = %20, %.preheader
  ...
  tail call void @Fft(i32 256, %struct.complex* getelementptr inbounds ([257 x %struct.complex]* @z, i64 0, i64 0), %struct.complex* getelementptr inbounds ([257 x %struct.complex]* @w, i64 0, i64 0), %struct.complex* getelementptr inbounds ([130 x %struct.complex]* @e, i64 0, i64 0), float 6.250000e-02) #6, !dbg !337
...
; <label>:22                                      ; preds = %20
  tail call void @Printcomplex(%struct.complex* getelementptr inbounds ([257 x %struct.complex]* @z, i64 0, i64 0), i32 1, i32 256, i32 17) #6, !dbg !339
  ret void, !dbg !340
}

; Function Attrs: nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !285, i64 0, metadata !90), !dbg !341
  br label %1, !dbg !341

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Oscar() #6, !dbg !343
  %2 = add nsw i32 %i.01, 1, !dbg !341
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !90), !dbg !341
  %exitcond = icmp eq i32 %2, 10, !dbg !341
  br i1 %exitcond, label %3, label %1, !dbg !341
...
!339 = metadata !{i32 313, i32 0, metadata !82, null}
!340 = metadata !{i32 314, i32 0, metadata !82, null}
!341 = metadata !{i32 320, i32 0, metadata !342, null}
!342 = metadata !{i32 786443, metadata !1, metadata !88, i32 320, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/oscar.c]
!343 = metadata !{i32 321, i32 0, metadata !342, null}
!344 = metadata !{i32 322, i32 0, metadata !88, null}
