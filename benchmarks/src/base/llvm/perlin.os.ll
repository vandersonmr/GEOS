...
.lr.ph:                                           ; preds = %.preheader
  %9 = tail call double @floor(double %x.07) #4, !dbg !85
...
; <label>:28                                      ; preds = %.lr.ph, %noise.exit
  ...
  tail call void @llvm.dbg.value(metadata !96, i64 0, metadata !97) #5, !dbg !98
  tail call void @llvm.dbg.value(metadata !{i32 %11}, i64 0, metadata !99) #5, !dbg !85
  %29 = tail call double @floor(double %y.12) #4, !dbg !100
  %30 = fptosi double %29 to i32, !dbg !100
  %31 = and i32 %30, 255, !dbg !100
  tail call void @llvm.dbg.value(metadata !{i32 %31}, i64 0, metadata !101) #5, !dbg !100
  tail call void @llvm.dbg.value(metadata !102, i64 0, metadata !103) #5, !dbg !104
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !105) #5, !dbg !87
  %32 = fsub double %y.12, %29, !dbg !106
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !107) #5, !dbg !106
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !97) #5, !dbg !109
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !110) #5, !dbg !88
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !111) #5, !dbg !89
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !112) #5, !dbg !114
  ...
  tail call void @llvm.dbg.value(metadata !{double %39}, i64 0, metadata !115) #5, !dbg !113
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !116) #5, !dbg !118
  tail call void @llvm.dbg.value(metadata !119, i64 0, metadata !120) #5, !dbg !117
  %40 = add nsw i32 %31, %22, !dbg !90
  tail call void @llvm.dbg.value(metadata !{i32 %40}, i64 0, metadata !121) #5, !dbg !90
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %44}, i64 0, metadata !122) #5, !dbg !90
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %49}, i64 0, metadata !123) #5, !dbg !90
  %50 = add nsw i32 %26, %31, !dbg !90
  tail call void @llvm.dbg.value(metadata !{i32 %50}, i64 0, metadata !124) #5, !dbg !90
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %54}, i64 0, metadata !125) #5, !dbg !90
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %59}, i64 0, metadata !126) #5, !dbg !90
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %62}, i64 0, metadata !128) #5, !dbg !129
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !130) #5, !dbg !129
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !131) #5, !dbg !129
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !132) #5, !dbg !129
  %63 = and i32 %62, 15, !dbg !133
  tail call void @llvm.dbg.value(metadata !{i32 %63}, i64 0, metadata !134) #5, !dbg !133
  %64 = icmp ult i32 %63, 8, !dbg !135
  %65 = select i1 %64, double %12, double %32, !dbg !135
  tail call void @llvm.dbg.value(metadata !{double %65}, i64 0, metadata !136) #5, !dbg !135
...
; <label>:71                                      ; preds = %67, %28
  ...
  tail call void @llvm.dbg.value(metadata !{double %72}, i64 0, metadata !137) #5, !dbg !135
...
grad.exit7.i:                                     ; preds = %81, %77
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %87}, i64 0, metadata !139) #5, !dbg !140
  tail call void @llvm.dbg.value(metadata !{double %27}, i64 0, metadata !141) #5, !dbg !140
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !142) #5, !dbg !140
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !143) #5, !dbg !140
  %88 = and i32 %87, 15, !dbg !144
  tail call void @llvm.dbg.value(metadata !{i32 %88}, i64 0, metadata !145) #5, !dbg !144
  %89 = icmp ult i32 %88, 8, !dbg !146
  %90 = select i1 %89, double %27, double %32, !dbg !146
  tail call void @llvm.dbg.value(metadata !{double %90}, i64 0, metadata !147) #5, !dbg !146
...
; <label>:96                                      ; preds = %92, %grad.exit7.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %97}, i64 0, metadata !148) #5, !dbg !146
...
grad.exit6.i:                                     ; preds = %106, %102
  ...
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !150) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %84}, i64 0, metadata !152) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %109}, i64 0, metadata !153) #5, !dbg !151
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %115}, i64 0, metadata !155) #5, !dbg !156
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !157) #5, !dbg !156
  tail call void @llvm.dbg.value(metadata !{double %116}, i64 0, metadata !158) #5, !dbg !156
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !159) #5, !dbg !156
  %117 = and i32 %115, 15, !dbg !160
  tail call void @llvm.dbg.value(metadata !{i32 %117}, i64 0, metadata !161) #5, !dbg !160
  %118 = icmp ult i32 %117, 8, !dbg !162
  %119 = select i1 %118, double %12, double %116, !dbg !162
  tail call void @llvm.dbg.value(metadata !{double %119}, i64 0, metadata !163) #5, !dbg !162
...
; <label>:125                                     ; preds = %121, %grad.exit6.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %126}, i64 0, metadata !164) #5, !dbg !162
...
grad.exit5.i:                                     ; preds = %135, %131
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %141}, i64 0, metadata !167) #5, !dbg !168
  tail call void @llvm.dbg.value(metadata !{double %27}, i64 0, metadata !169) #5, !dbg !168
  tail call void @llvm.dbg.value(metadata !{double %116}, i64 0, metadata !170) #5, !dbg !168
  tail call void @llvm.dbg.value(metadata !108, i64 0, metadata !171) #5, !dbg !168
  %142 = and i32 %141, 15, !dbg !172
  tail call void @llvm.dbg.value(metadata !{i32 %142}, i64 0, metadata !173) #5, !dbg !172
  %143 = icmp ult i32 %142, 8, !dbg !174
  %144 = select i1 %143, double %27, double %116, !dbg !174
  tail call void @llvm.dbg.value(metadata !{double %144}, i64 0, metadata !175) #5, !dbg !174
...
; <label>:150                                     ; preds = %146, %grad.exit5.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %151}, i64 0, metadata !176) #5, !dbg !174
...
grad.exit4.i:                                     ; preds = %160, %156
  ...
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !178) #5, !dbg !179
  tail call void @llvm.dbg.value(metadata !{double %138}, i64 0, metadata !180) #5, !dbg !179
  tail call void @llvm.dbg.value(metadata !{double %163}, i64 0, metadata !181) #5, !dbg !179
  %164 = fsub double %163, %138, !dbg !179
  %165 = fmul double %19, %164, !dbg !179
  %166 = fadd double %138, %165, !dbg !179
  tail call void @llvm.dbg.value(metadata !{double %39}, i64 0, metadata !150) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %112}, i64 0, metadata !152) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %166}, i64 0, metadata !153) #5, !dbg !151
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %173}, i64 0, metadata !183) #5, !dbg !184
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !185) #5, !dbg !184
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !186) #5, !dbg !184
  tail call void @llvm.dbg.value(metadata !187, i64 0, metadata !188) #5, !dbg !184
  %174 = and i32 %173, 15, !dbg !189
  tail call void @llvm.dbg.value(metadata !{i32 %174}, i64 0, metadata !190) #5, !dbg !189
  %175 = icmp ult i32 %174, 8, !dbg !191
  %176 = select i1 %175, double %12, double %32, !dbg !191
  tail call void @llvm.dbg.value(metadata !{double %176}, i64 0, metadata !192) #5, !dbg !191
...
; <label>:182                                     ; preds = %178, %grad.exit4.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %183}, i64 0, metadata !193) #5, !dbg !191
...
grad.exit3.i:                                     ; preds = %192, %188
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %199}, i64 0, metadata !196) #5, !dbg !197
  tail call void @llvm.dbg.value(metadata !{double %27}, i64 0, metadata !198) #5, !dbg !197
  tail call void @llvm.dbg.value(metadata !{double %32}, i64 0, metadata !199) #5, !dbg !197
  tail call void @llvm.dbg.value(metadata !187, i64 0, metadata !200) #5, !dbg !197
  %200 = and i32 %199, 15, !dbg !201
  tail call void @llvm.dbg.value(metadata !{i32 %200}, i64 0, metadata !202) #5, !dbg !201
  %201 = icmp ult i32 %200, 8, !dbg !203
  %202 = select i1 %201, double %27, double %32, !dbg !203
  tail call void @llvm.dbg.value(metadata !{double %202}, i64 0, metadata !204) #5, !dbg !203
...
; <label>:208                                     ; preds = %204, %grad.exit3.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %209}, i64 0, metadata !205) #5, !dbg !203
...
grad.exit2.i:                                     ; preds = %218, %214
  ...
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !207) #5, !dbg !208
  tail call void @llvm.dbg.value(metadata !{double %195}, i64 0, metadata !209) #5, !dbg !208
  tail call void @llvm.dbg.value(metadata !{double %221}, i64 0, metadata !210) #5, !dbg !208
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %228}, i64 0, metadata !212) #5, !dbg !213
  tail call void @llvm.dbg.value(metadata !{double %12}, i64 0, metadata !214) #5, !dbg !213
  tail call void @llvm.dbg.value(metadata !{double %116}, i64 0, metadata !215) #5, !dbg !213
  tail call void @llvm.dbg.value(metadata !187, i64 0, metadata !216) #5, !dbg !213
  %229 = and i32 %228, 15, !dbg !217
  tail call void @llvm.dbg.value(metadata !{i32 %229}, i64 0, metadata !218) #5, !dbg !217
  %230 = icmp ult i32 %229, 8, !dbg !219
  %231 = select i1 %230, double %12, double %116, !dbg !219
  tail call void @llvm.dbg.value(metadata !{double %231}, i64 0, metadata !220) #5, !dbg !219
...
; <label>:237                                     ; preds = %233, %grad.exit2.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %238}, i64 0, metadata !221) #5, !dbg !219
...
grad.exit1.i:                                     ; preds = %247, %243
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %254}, i64 0, metadata !224) #5, !dbg !225
  tail call void @llvm.dbg.value(metadata !{double %27}, i64 0, metadata !226) #5, !dbg !225
  tail call void @llvm.dbg.value(metadata !{double %116}, i64 0, metadata !227) #5, !dbg !225
  tail call void @llvm.dbg.value(metadata !187, i64 0, metadata !228) #5, !dbg !225
  %255 = and i32 %254, 15, !dbg !229
  tail call void @llvm.dbg.value(metadata !{i32 %255}, i64 0, metadata !230) #5, !dbg !229
  %256 = icmp ult i32 %255, 8, !dbg !231
  %257 = select i1 %256, double %27, double %116, !dbg !231
  tail call void @llvm.dbg.value(metadata !{double %257}, i64 0, metadata !232) #5, !dbg !231
...
; <label>:263                                     ; preds = %259, %grad.exit1.i
  ...
  tail call void @llvm.dbg.value(metadata !{double %264}, i64 0, metadata !233) #5, !dbg !231
...
noise.exit:                                       ; preds = %269, %273
  ...
  tail call void @llvm.dbg.value(metadata !{double %19}, i64 0, metadata !235) #5, !dbg !236
  tail call void @llvm.dbg.value(metadata !{double %250}, i64 0, metadata !237) #5, !dbg !236
  tail call void @llvm.dbg.value(metadata !{double %276}, i64 0, metadata !238) #5, !dbg !236
  %277 = fsub double %276, %250, !dbg !236
  %278 = fmul double %19, %277, !dbg !236
  %279 = fadd double %250, %278, !dbg !236
  tail call void @llvm.dbg.value(metadata !{double %39}, i64 0, metadata !207) #5, !dbg !208
  tail call void @llvm.dbg.value(metadata !{double %224}, i64 0, metadata !209) #5, !dbg !208
  tail call void @llvm.dbg.value(metadata !{double %279}, i64 0, metadata !210) #5, !dbg !208
  %280 = fsub double %279, %224, !dbg !208
  %281 = fmul double %39, %280, !dbg !208
  %282 = fadd double %224, %281, !dbg !208
  tail call void @llvm.dbg.value(metadata !119, i64 0, metadata !150) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %169}, i64 0, metadata !152) #5, !dbg !151
  tail call void @llvm.dbg.value(metadata !{double %282}, i64 0, metadata !153) #5, !dbg !151
...
; <label>:293                                     ; preds = %init.exit
  %294 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), double %sum.2.lcssa) #6, !dbg !240
  ret i32 0, !dbg !241
}
