...
define void @Initialize() #0 {
  ...
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !135, !tbaa !129
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !135, !tbaa !129
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !135, !tbaa !129
  store i32 3, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 4), align 16, !dbg !135, !tbaa !129
  store i32 4, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 5), align 4, !dbg !135, !tbaa !129
  store i32 5, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 6), align 8, !dbg !135, !tbaa !129
  store i32 6, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 7), align 4, !dbg !135, !tbaa !129
  ret void, !dbg !137
}
...
; <label>:10                                      ; preds = %.lr.ph, %10
  ...
  tail call void @Permute(i32 %5), !dbg !153
...
define void @Perm() #0 {
  ...
  tail call void @llvm.dbg.value(metadata !132, i64 0, metadata !164), !dbg !167
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !168, !tbaa !129
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !168, !tbaa !129
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !168, !tbaa !129
  store i32 3, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 4), align 16, !dbg !168, !tbaa !129
  store i32 4, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 5), align 4, !dbg !168, !tbaa !129
  store i32 5, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 6), align 8, !dbg !168, !tbaa !129
  store i32 6, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 7), align 4, !dbg !168, !tbaa !129
  tail call void @Permute(i32 7), !dbg !169
  tail call void @llvm.dbg.value(metadata !170, i64 0, metadata !31), !dbg !162
  tail call void @llvm.dbg.value(metadata !132, i64 0, metadata !164), !dbg !167
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !168, !tbaa !129
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !168, !tbaa !129
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !168, !tbaa !129
  ...
  tail call void @Permute(i32 7), !dbg !169
  tail call void @llvm.dbg.value(metadata !170, i64 0, metadata !31), !dbg !162
  %1 = load i32* @pctr, align 4, !dbg !171, !tbaa !129
  %2 = icmp eq i32 %1, 43300, !dbg !171
  br i1 %2, label %4, label %3, !dbg !171

; <label>:3                                       ; preds = %0
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @str, i64 0, i64 0)), !dbg !173
  %.pre = load i32* @pctr, align 4, !dbg !174, !tbaa !129
  br label %4, !dbg !173

; <label>:4                                       ; preds = %0, %3
  %5 = phi i32 [ 43300, %0 ], [ %.pre, %3 ]
  %6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %5) #3, !dbg !174
  ret void, !dbg !175
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !176, i64 0, metadata !34), !dbg !177
  br label %1, !dbg !177

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Perm(), !dbg !177
  %2 = add nsw i32 %i.01, 1, !dbg !177
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !34), !dbg !177
  %exitcond = icmp eq i32 %2, 100, !dbg !177
  br i1 %exitcond, label %3, label %1, !dbg !177
...
!164 = metadata !{i32 786688, metadata !20, metadata !"i", metadata !5, i32 132, metadata !11, i32 0, metadata !165} ; [ DW_TAG_auto_variable ] [i] [line 132]
...
!168 = metadata !{i32 134, i32 0, metadata !136, metadata !165}
!169 = metadata !{i32 156, i32 0, metadata !166, null}
!170 = metadata !{i32 2}
!171 = metadata !{i32 158, i32 0, metadata !172, null}
!172 = metadata !{i32 786443, metadata !1, metadata !29, i32 158, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/perm.c]
!173 = metadata !{i32 159, i32 0, metadata !172, null}
!174 = metadata !{i32 160, i32 0, metadata !29, null}
!175 = metadata !{i32 161, i32 0, metadata !29, null}
!176 = metadata !{i32 0}
!177 = metadata !{i32 166, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !1, metadata !32, i32 166, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/perm.c]
!179 = metadata !{i32 167, i32 0, metadata !32, null}
