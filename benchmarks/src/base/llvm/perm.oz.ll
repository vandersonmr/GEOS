...
; <label>:1                                       ; preds = %1, %0
  ...
  tail call void @Initialize() #4, !dbg !164
  tail call void @Permute(i32 7) #4, !dbg !166
  %2 = add nsw i32 %i.01, 1, !dbg !162
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !31), !dbg !162
  %exitcond = icmp eq i32 %2, 6, !dbg !162
  br i1 %exitcond, label %3, label %1, !dbg !162

; <label>:3                                       ; preds = %1
  %4 = load i32* @pctr, align 4, !dbg !167, !tbaa !129
  %5 = icmp eq i32 %4, 43300, !dbg !167
  br i1 %5, label %7, label %6, !dbg !167

; <label>:6                                       ; preds = %3
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @str, i64 0, i64 0)), !dbg !169
  %.pre = load i32* @pctr, align 4, !dbg !170, !tbaa !129
  br label %7, !dbg !169

; <label>:7                                       ; preds = %3, %6
  %8 = phi i32 [ 43300, %3 ], [ %.pre, %6 ]
  %9 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %8) #5, !dbg !170
  ret void, !dbg !171
}
...
; Function Attrs: minsize nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !172, i64 0, metadata !34), !dbg !173
  br label %1, !dbg !173

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Perm() #4, !dbg !173
  %2 = add nsw i32 %i.01, 1, !dbg !173
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !34), !dbg !173
  %exitcond = icmp eq i32 %2, 100, !dbg !173
  br i1 %exitcond, label %3, label %1, !dbg !173
...
!165 = metadata !{i32 786443, metadata !1, metadata !163, i32 154, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/perm.c]
!166 = metadata !{i32 156, i32 0, metadata !165, null}
!167 = metadata !{i32 158, i32 0, metadata !168, null}
!168 = metadata !{i32 786443, metadata !1, metadata !29, i32 158, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/perm.c]
!169 = metadata !{i32 159, i32 0, metadata !168, null}
!170 = metadata !{i32 160, i32 0, metadata !29, null}
!171 = metadata !{i32 161, i32 0, metadata !29, null}
!172 = metadata !{i32 0}
!173 = metadata !{i32 166, i32 0, metadata !174, null}
!174 = metadata !{i32 786443, metadata !1, metadata !32, i32 166, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/perm.c]
!175 = metadata !{i32 167, i32 0, metadata !32, null}
