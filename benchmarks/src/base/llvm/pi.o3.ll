...
; <label>:19                                      ; preds = %1
  ...
  %23 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([45 x i8]* @.str1, i64 0, i64 0), double %phitmp.le, double %phitmp1.le, i32 %22, i32 40000001) #3, !dbg !83
  ...
  %32 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([37 x i8]* @.str2, i64 0, i64 0), double %29, double %31, i32 40000000) #3, !dbg !57
  ret i32 0, !dbg !85
}
