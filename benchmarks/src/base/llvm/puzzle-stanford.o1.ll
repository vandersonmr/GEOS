...
; <label>:15                                      ; preds = %10, %6
  ...
  %16 = load i32* %2, align 4, !dbg !141, !tbaa !143
  %17 = trunc i64 %indvars.iv to i32, !dbg !141
  %18 = icmp slt i32 %17, %16, !dbg !141
  br i1 %18, label %6, label %._crit_edge, !dbg !141
...
.lr.ph6:                                          ; preds = %0
  %5 = load i32* %2, align 4, !dbg !151, !tbaa !143
  %6 = sext i32 %j to i64, !dbg !151
  br label %7, !dbg !151

; <label>:7                                       ; preds = %14, %.lr.ph6
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %14 ], [ 0, %.lr.ph6 ]
  %8 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %1, i64 %indvars.iv10, !dbg !153
  %9 = load i32* %8, align 4, !dbg !153, !tbaa !143
  %10 = icmp eq i32 %9, 0, !dbg !153
  br i1 %10, label %14, label %11, !dbg !153

; <label>:11                                      ; preds = %7
  %12 = add nsw i64 %indvars.iv10, %6, !dbg !153
  %13 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %12, !dbg !153
  store i32 1, i32* %13, align 4, !dbg !153, !tbaa !143
  br label %14, !dbg !153

; <label>:14                                      ; preds = %7, %11
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1, !dbg !151
  %15 = trunc i64 %indvars.iv10 to i32, !dbg !151
  %16 = icmp slt i32 %15, %5, !dbg !151
  br i1 %16, label %7, label %._crit_edge7, !dbg !151

._crit_edge7:                                     ; preds = %14, %0
  %17 = getelementptr inbounds [13 x i32]* @class, i64 0, i64 %1, !dbg !155
  %18 = load i32* %17, align 4, !dbg !155, !tbaa !143
  %19 = sext i32 %18 to i64, !dbg !155
  %20 = getelementptr inbounds [4 x i32]* @piececount, i64 0, i64 %19, !dbg !155
  %21 = load i32* %20, align 4, !dbg !155, !tbaa !143
  %22 = add nsw i32 %21, -1, !dbg !155
  store i32 %22, i32* %20, align 4, !dbg !155, !tbaa !143
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !23), !dbg !156
  %23 = icmp slt i32 %j, 512, !dbg !156
  br i1 %23, label %.lr.ph, label %._crit_edge, !dbg !156

.lr.ph:                                           ; preds = %._crit_edge7
  %24 = sext i32 %j to i64
  br label %28, !dbg !156

; <label>:25                                      ; preds = %28
  %26 = trunc i64 %indvars.iv.next to i32, !dbg !156
  %27 = icmp slt i32 %26, 512, !dbg !156
  br i1 %27, label %28, label %._crit_edge, !dbg !156

; <label>:28                                      ; preds = %.lr.ph, %25
  %indvars.iv = phi i64 [ %24, %.lr.ph ], [ %indvars.iv.next, %25 ]
  %29 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %indvars.iv, !dbg !158
  %30 = load i32* %29, align 4, !dbg !158, !tbaa !143
  %31 = icmp eq i32 %30, 0, !dbg !158
  %indvars.iv.next = add nsw i64 %indvars.iv, 1, !dbg !156
  br i1 %31, label %._crit_edge2, label %25, !dbg !158

._crit_edge2:                                     ; preds = %28
  %32 = trunc i64 %indvars.iv to i32, !dbg !158
  br label %._crit_edge, !dbg !158

._crit_edge:                                      ; preds = %25, %._crit_edge2, %._crit_edge7
  %.0 = phi i32 [ %32, %._crit_edge2 ], [ 0, %._crit_edge7 ], [ 0, %25 ]
  ret i32 %.0, !dbg !160
}
...
.lr.ph:                                           ; preds = %0
  %5 = load i32* %2, align 4, !dbg !162, !tbaa !143
  %6 = sext i32 %j to i64, !dbg !162
  br label %7, !dbg !162

; <label>:7                                       ; preds = %14, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %14 ], [ 0, %.lr.ph ]
  %8 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %1, i64 %indvars.iv, !dbg !164
  %9 = load i32* %8, align 4, !dbg !164, !tbaa !143
  %10 = icmp eq i32 %9, 0, !dbg !164
  br i1 %10, label %14, label %11, !dbg !164

; <label>:11                                      ; preds = %7
  %12 = add nsw i64 %indvars.iv, %6, !dbg !164
  %13 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %12, !dbg !164
  store i32 0, i32* %13, align 4, !dbg !164, !tbaa !143
  br label %14, !dbg !164

; <label>:14                                      ; preds = %7, %11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !162
  %15 = trunc i64 %indvars.iv to i32, !dbg !162
  %16 = icmp slt i32 %15, %5, !dbg !162
  br i1 %16, label %7, label %._crit_edge, !dbg !162

._crit_edge:                                      ; preds = %14, %0
  %17 = getelementptr inbounds [13 x i32]* @class, i64 0, i64 %1, !dbg !166
  %18 = load i32* %17, align 4, !dbg !166, !tbaa !143
  %19 = sext i32 %18 to i64, !dbg !166
  %20 = getelementptr inbounds [4 x i32]* @piececount, i64 0, i64 %19, !dbg !166
  %21 = load i32* %20, align 4, !dbg !166, !tbaa !143
  %22 = add nsw i32 %21, 1, !dbg !166
  store i32 %22, i32* %20, align 4, !dbg !166, !tbaa !143
  ret void, !dbg !167
}
...
; <label>:3                                       ; preds = %0, %22
  ...
  br i1 %9, label %22, label %10, !dbg !172

; <label>:10                                      ; preds = %3
  %11 = trunc i64 %indvars.iv to i32, !dbg !174
  %12 = tail call i32 @Fit(i32 %11, i32 %j), !dbg !174
  %13 = icmp eq i32 %12, 0, !dbg !174
  br i1 %13, label %22, label %14, !dbg !174

; <label>:14                                      ; preds = %10
  %15 = trunc i64 %indvars.iv to i32, !dbg !176
  %16 = tail call i32 @Place(i32 %15, i32 %j), !dbg !176
  tail call void @llvm.dbg.value(metadata !{i32 %16}, i64 0, metadata !37), !dbg !176
  %17 = tail call i32 @Trial(i32 %16), !dbg !178
  %18 = icmp ne i32 %17, 0, !dbg !178
  %19 = icmp eq i32 %16, 0, !dbg !178
  %or.cond = or i1 %18, %19, !dbg !178
  br i1 %or.cond, label %25, label %20, !dbg !178

; <label>:20                                      ; preds = %14
  %21 = trunc i64 %indvars.iv to i32, !dbg !180
  tail call void @Remove(i32 %21, i32 %j), !dbg !180
  br label %22, !dbg !181

; <label>:22                                      ; preds = %10, %3, %20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !170
  %23 = trunc i64 %indvars.iv.next to i32, !dbg !170
  %24 = icmp slt i32 %23, 13, !dbg !170
  br i1 %24, label %3, label %25, !dbg !170
...
; <label>:3                                       ; preds = %3, %.preheader31
  ...
  %4 = shl i64 %indvars.iv183, 3, !dbg !188
  %5 = add nsw i64 %4, %indvars.iv186, !dbg !188
  %6 = shl i64 %5, 3, !dbg !188
  %7 = add nsw i64 %6, %indvars.iv189, !dbg !188
  %8 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %7, !dbg !188
  store i32 0, i32* %8, align 4, !dbg !188, !tbaa !143
  %indvars.iv.next184 = add nuw nsw i64 %indvars.iv183, 1, !dbg !188
  %exitcond185 = icmp eq i64 %indvars.iv.next184, 6, !dbg !188
  br i1 %exitcond185, label %9, label %3, !dbg !188
...
; <label>:10                                      ; preds = %9
  %indvars.iv.next190 = add nuw nsw i64 %indvars.iv189, 1, !dbg !190
  %exitcond191 = icmp eq i64 %indvars.iv.next190, 6, !dbg !190
  br i1 %exitcond191, label %.preheader28, label %.preheader32, !dbg !190
...
.preheader28:                                     ; preds = %10
  ...
  br label %.preheader27, !dbg !194

.preheader27:                                     ; preds = %15, %.preheader28
  %indvars.iv175 = phi i64 [ 0, %.preheader28 ], [ %indvars.iv.next176, %15 ]
  br label %11, !dbg !196

; <label>:11                                      ; preds = %11, %.preheader27
...
; <label>:15                                      ; preds = %11
  %indvars.iv.next176 = add nuw nsw i64 %indvars.iv175, 1, !dbg !194
  %exitcond177 = icmp eq i64 %indvars.iv.next176, 4, !dbg !194
  br i1 %exitcond177, label %16, label %.preheader27, !dbg !194
...
; <label>:83                                      ; preds = %82
  ...
  %84 = tail call i32 @Fit(i32 0, i32 73), !dbg !303
  %85 = icmp eq i32 %84, 0, !dbg !303
  br i1 %85, label %88, label %86, !dbg !303

; <label>:86                                      ; preds = %83
  %87 = tail call i32 @Place(i32 0, i32 73), !dbg !303
...
; <label>:89                                      ; preds = %88, %86
  %90 = load i32* @n, align 4, !dbg !306, !tbaa !143
  %91 = tail call i32 @Trial(i32 %90), !dbg !306
...
; <label>:98                                      ; preds = %94, %97, %93
  ...
  %100 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0), i32 %99) #4, !dbg !310
  %101 = load i32* @kount, align 4, !dbg !311, !tbaa !143
  %102 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str3, i64 0, i64 0), i32 %101) #4, !dbg !311
  ret void, !dbg !312
}
...
!189 = metadata !{i32 786443, metadata !1, metadata !186, i32 165, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle-stanford.c]
!190 = metadata !{i32 165, i32 0, metadata !187, null}
...
!197 = metadata !{i32 786443, metadata !1, metadata !195, i32 167, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle-stanford.c]
