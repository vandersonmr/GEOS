...
.split.us:                                        ; preds = %0, %Fit.exit.thread9.us
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %Fit.exit.thread9.us ], [ 0, %0 ]
  %5 = getelementptr inbounds [13 x i32]* @class, i64 0, i64 %indvars.iv17, !dbg !177
  %6 = load i32* %5, align 4, !dbg !177, !tbaa !143
  %7 = sext i32 %6 to i64, !dbg !177
  %8 = getelementptr inbounds [4 x i32]* @piececount, i64 0, i64 %7, !dbg !177
  %9 = load i32* %8, align 4, !dbg !177, !tbaa !143
  %10 = icmp eq i32 %9, 0, !dbg !177
  br i1 %10, label %Fit.exit.thread9.us, label %11, !dbg !177

; <label>:11                                      ; preds = %.split.us
  ...
  %12 = getelementptr inbounds [13 x i32]* @piecemax, i64 0, i64 %indvars.iv17, !dbg !184
  %13 = load i32* %12, align 4, !dbg !184, !tbaa !143
  %14 = icmp slt i32 %13, 0, !dbg !184
  br i1 %14, label %.lr.ph.i2.us, label %.lr.ph.i.us, !dbg !184

.lr.ph.i.us:                                      ; preds = %11, %23
  %indvars.iv.i.us = phi i64 [ %indvars.iv.next.i.us, %23 ], [ 0, %11 ]
  %15 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %indvars.iv17, i64 %indvars.iv.i.us, !dbg !185
  %16 = load i32* %15, align 4, !dbg !185, !tbaa !143
  %17 = icmp eq i32 %16, 0, !dbg !185
  br i1 %17, label %23, label %18, !dbg !185

; <label>:18                                      ; preds = %.lr.ph.i.us
  %19 = add nsw i64 %indvars.iv.i.us, %4, !dbg !186
  %20 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %19, !dbg !186
  %21 = load i32* %20, align 4, !dbg !186, !tbaa !143
  %22 = icmp eq i32 %21, 0, !dbg !186
  br i1 %22, label %23, label %Fit.exit.thread9.us, !dbg !186

; <label>:23                                      ; preds = %18, %.lr.ph.i.us
  %indvars.iv.next.i.us = add nuw nsw i64 %indvars.iv.i.us, 1, !dbg !184
  %24 = trunc i64 %indvars.iv.i.us to i32, !dbg !184
  %25 = icmp slt i32 %24, %13, !dbg !184
  br i1 %25, label %.lr.ph.i.us, label %.lr.ph6.i.us, !dbg !184

.lr.ph6.i.us:                                     ; preds = %23
  ...
  %26 = add i32 %13, 1, !dbg !191
  br label %27, !dbg !191

; <label>:27                                      ; preds = %34, %.lr.ph6.i.us
  %indvars.iv10.i.us = phi i64 [ %indvars.iv.next11.i.us, %34 ], [ 0, %.lr.ph6.i.us ]
  %28 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %indvars.iv17, i64 %indvars.iv10.i.us, !dbg !192
  %29 = load i32* %28, align 4, !dbg !192, !tbaa !143
  %30 = icmp eq i32 %29, 0, !dbg !192
  br i1 %30, label %34, label %31, !dbg !192

; <label>:31                                      ; preds = %27
  %32 = add nsw i64 %indvars.iv10.i.us, %4, !dbg !192
  %33 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %32, !dbg !192
  store i32 1, i32* %33, align 4, !dbg !192, !tbaa !143
  br label %34, !dbg !192

; <label>:34                                      ; preds = %31, %27
  %indvars.iv.next11.i.us = add nuw nsw i64 %indvars.iv10.i.us, 1, !dbg !191
  %lftr.wideiv13 = trunc i64 %indvars.iv.next11.i.us to i32, !dbg !191
  %exitcond14 = icmp eq i32 %lftr.wideiv13, %26, !dbg !191
  br i1 %exitcond14, label %.lr.ph.i2.us, label %27, !dbg !191

.lr.ph.i2.us:                                     ; preds = %34, %11
  %35 = add nsw i32 %9, -1, !dbg !193
  store i32 %35, i32* %8, align 4, !dbg !193, !tbaa !143
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !190), !dbg !172
  br label %36, !dbg !172

; <label>:36                                      ; preds = %40, %.lr.ph.i2.us
  %indvars.iv.i3.us = phi i64 [ %4, %.lr.ph.i2.us ], [ %indvars.iv.next.i4.us, %40 ]
  %37 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %indvars.iv.i3.us, !dbg !194
  %38 = load i32* %37, align 4, !dbg !194, !tbaa !143
  %39 = icmp eq i32 %38, 0, !dbg !194
  %indvars.iv.next.i4.us = add nsw i64 %indvars.iv.i3.us, 1, !dbg !172
  br i1 %39, label %._crit_edge2.i.us, label %40, !dbg !194

; <label>:40                                      ; preds = %36
  %41 = trunc i64 %indvars.iv.next.i4.us to i32, !dbg !172
  %42 = icmp slt i32 %41, 512, !dbg !172
  br i1 %42, label %36, label %Place.exit.us, !dbg !172

._crit_edge2.i.us:                                ; preds = %36
  %43 = trunc i64 %indvars.iv.i3.us to i32, !dbg !194
  br label %Place.exit.us, !dbg !194

Place.exit.us:                                    ; preds = %40, %._crit_edge2.i.us
  %.0.i5.us = phi i32 [ %43, %._crit_edge2.i.us ], [ 0, %40 ]
  tail call void @llvm.dbg.value(metadata !{i32 %.0.i5.us}, i64 0, metadata !37), !dbg !173
  %44 = tail call i32 @Trial(i32 %.0.i5.us), !dbg !195
  %45 = icmp ne i32 %44, 0, !dbg !195
  %46 = icmp eq i32 %.0.i5.us, 0, !dbg !195
  %or.cond.us = or i1 %45, %46, !dbg !195
  br i1 %or.cond.us, label %.us-lcssa.us, label %47, !dbg !195

; <label>:47                                      ; preds = %Place.exit.us
  ...
  %48 = load i32* %12, align 4, !dbg !202, !tbaa !143
  %49 = icmp slt i32 %48, 0, !dbg !202
  br i1 %49, label %Remove.exit.us, label %.lr.ph.i6.us, !dbg !202

.lr.ph.i6.us:                                     ; preds = %47
  %50 = add i32 %48, 1, !dbg !202
  br label %51, !dbg !202

; <label>:51                                      ; preds = %58, %.lr.ph.i6.us
  %indvars.iv.i7.us = phi i64 [ %indvars.iv.next.i8.us, %58 ], [ 0, %.lr.ph.i6.us ]
  %52 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %indvars.iv17, i64 %indvars.iv.i7.us, !dbg !203
  %53 = load i32* %52, align 4, !dbg !203, !tbaa !143
  %54 = icmp eq i32 %53, 0, !dbg !203
  br i1 %54, label %58, label %55, !dbg !203

; <label>:55                                      ; preds = %51
  %56 = add nsw i64 %indvars.iv.i7.us, %4, !dbg !203
...
; <label>:58                                      ; preds = %55, %51
  %indvars.iv.next.i8.us = add nuw nsw i64 %indvars.iv.i7.us, 1, !dbg !202
  %lftr.wideiv15 = trunc i64 %indvars.iv.next.i8.us to i32, !dbg !202
  %exitcond16 = icmp eq i32 %lftr.wideiv15, %50, !dbg !202
  br i1 %exitcond16, label %Remove.exit.us, label %51, !dbg !202

Remove.exit.us:                                   ; preds = %58, %47
  %59 = load i32* %5, align 4, !dbg !204, !tbaa !143
  ...
  br label %Fit.exit.thread9.us, !dbg !205

Fit.exit.thread9.us:                              ; preds = %18, %Remove.exit.us, %.split.us
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1, !dbg !170
  %64 = trunc i64 %indvars.iv.next18 to i32, !dbg !170
  %65 = icmp slt i32 %64, 13, !dbg !170
  br i1 %65, label %.split.us, label %.us-lcssa.us, !dbg !170

..split_crit_edge:                                ; preds = %0, %Fit.exit.thread9
  %indvars.iv = phi i64 [ %indvars.iv.next, %Fit.exit.thread9 ], [ 0, %0 ]
  %66 = getelementptr inbounds [13 x i32]* @class, i64 0, i64 %indvars.iv, !dbg !177
  %67 = load i32* %66, align 4, !dbg !177, !tbaa !143
  %68 = sext i32 %67 to i64, !dbg !177
  %69 = getelementptr inbounds [4 x i32]* @piececount, i64 0, i64 %68, !dbg !177
  %70 = load i32* %69, align 4, !dbg !177, !tbaa !143
  %71 = icmp eq i32 %70, 0, !dbg !177
  br i1 %71, label %Fit.exit.thread9, label %72, !dbg !177

; <label>:72                                      ; preds = %..split_crit_edge
  tail call void @llvm.dbg.value(metadata !178, i64 0, metadata !179), !dbg !181
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !182), !dbg !181
  tail call void @llvm.dbg.value(metadata !140, i64 0, metadata !183), !dbg !184
  %73 = getelementptr inbounds [13 x i32]* @piecemax, i64 0, i64 %indvars.iv, !dbg !184
  %74 = load i32* %73, align 4, !dbg !184, !tbaa !143
  %75 = icmp slt i32 %74, 0, !dbg !184
  br i1 %75, label %Place.exit, label %.lr.ph.i, !dbg !184

.lr.ph.i:                                         ; preds = %72, %84
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %84 ], [ 0, %72 ]
  %76 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %indvars.iv, i64 %indvars.iv.i, !dbg !185
  %77 = load i32* %76, align 4, !dbg !185, !tbaa !143
  %78 = icmp eq i32 %77, 0, !dbg !185
  br i1 %78, label %84, label %79, !dbg !185

; <label>:79                                      ; preds = %.lr.ph.i
  %80 = add nsw i64 %indvars.iv.i, %4, !dbg !186
  %81 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %80, !dbg !186
  %82 = load i32* %81, align 4, !dbg !186, !tbaa !143
  %83 = icmp eq i32 %82, 0, !dbg !186
  br i1 %83, label %84, label %Fit.exit.thread9, !dbg !186

; <label>:84                                      ; preds = %79, %.lr.ph.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !184
  %85 = trunc i64 %indvars.iv.i to i32, !dbg !184
  %86 = icmp slt i32 %85, %74, !dbg !184
  br i1 %86, label %.lr.ph.i, label %.lr.ph6.i, !dbg !184

.lr.ph6.i:                                        ; preds = %84
  tail call void @llvm.dbg.value(metadata !178, i64 0, metadata !187), !dbg !188
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !189), !dbg !188
  tail call void @llvm.dbg.value(metadata !140, i64 0, metadata !190), !dbg !191
  %87 = add i32 %74, 1, !dbg !191
  br label %88, !dbg !191

; <label>:88                                      ; preds = %95, %.lr.ph6.i
  %indvars.iv10.i = phi i64 [ %indvars.iv.next11.i, %95 ], [ 0, %.lr.ph6.i ]
  %89 = getelementptr inbounds [13 x [512 x i32]]* @p, i64 0, i64 %indvars.iv, i64 %indvars.iv10.i, !dbg !192
  %90 = load i32* %89, align 4, !dbg !192, !tbaa !143
  %91 = icmp eq i32 %90, 0, !dbg !192
  br i1 %91, label %95, label %92, !dbg !192

; <label>:92                                      ; preds = %88
  %93 = add nsw i64 %indvars.iv10.i, %4, !dbg !192
  %94 = getelementptr inbounds [512 x i32]* @puzzl, i64 0, i64 %93, !dbg !192
  store i32 1, i32* %94, align 4, !dbg !192, !tbaa !143
  br label %95, !dbg !192
...
; <label>:95                                      ; preds = %92, %88
  ...
  %exitcond = icmp eq i32 %lftr.wideiv, %87, !dbg !191
  br i1 %exitcond, label %Place.exit, label %88, !dbg !191

Place.exit:                                       ; preds = %72, %95
  %96 = add nsw i32 %70, -1, !dbg !193
  store i32 %96, i32* %69, align 4, !dbg !193, !tbaa !143
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !190), !dbg !172
  tail call void @llvm.dbg.value(metadata !140, i64 0, metadata !37), !dbg !173
  %97 = tail call i32 @Trial(i32 0), !dbg !195
  br label %.us-lcssa.us, !dbg !195

Fit.exit.thread9:                                 ; preds = %79, %..split_crit_edge
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !170
  %98 = trunc i64 %indvars.iv.next to i32, !dbg !170
  %99 = icmp slt i32 %98, 13, !dbg !170
  br i1 %99, label %..split_crit_edge, label %.us-lcssa.us, !dbg !170

.us-lcssa.us:                                     ; preds = %Fit.exit.thread9, %Place.exit.us, %Fit.exit.thread9.us, %Place.exit
  %.0 = phi i32 [ 1, %Place.exit ], [ 1, %Place.exit.us ], [ 0, %Fit.exit.thread9.us ], [ 0, %Fit.exit.thread9 ]
  ret i32 %.0, !dbg !206
}
