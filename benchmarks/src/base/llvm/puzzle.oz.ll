...
._crit_edge:                                      ; preds = %.lr.ph, %0
  %11 = tail call i32 @randInt(i32 1, i32 %size) #5, !dbg !101
  store i32 %11, i32* %5, align 4, !dbg !101, !tbaa !89
  tail call void @shuffle(i32* %5, i32 %1) #5, !dbg !102
  ret i32* %5, !dbg !103
}
...
define i32 @findDuplicate(i32* nocapture readonly %data, i32 %len) #2 {
  tail call void @llvm.dbg.value(metadata !{i32* %data}, i64 0, metadata !49), !dbg !104
  tail call void @llvm.dbg.value(metadata !{i32 %len}, i64 0, metadata !50), !dbg !104
  tail call void @llvm.dbg.value(metadata !97, i64 0, metadata !52), !dbg !105
  tail call void @llvm.dbg.value(metadata !97, i64 0, metadata !51), !dbg !106
  %1 = icmp sgt i32 %len, 0, !dbg !106
...
.lr.ph:                                           ; preds = %0, %.lr.ph
  ...
  %2 = trunc i64 %indvars.iv.next to i32, !dbg !108
  %3 = xor i32 %result.02, %2, !dbg !108
  %4 = getelementptr inbounds i32* %data, i64 %indvars.iv, !dbg !108
  %5 = load i32* %4, align 4, !dbg !108, !tbaa !89
  %6 = xor i32 %3, %5, !dbg !108
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !52), !dbg !108
  %exitcond = icmp eq i32 %2, %len, !dbg !106
  br i1 %exitcond, label %._crit_edge, label %.lr.ph, !dbg !106

._crit_edge:                                      ; preds = %.lr.ph, %0
  %result.0.lcssa = phi i32 [ 0, %0 ], [ %6, %.lr.ph ]
  %7 = xor i32 %result.0.lcssa, %len, !dbg !109
  tail call void @llvm.dbg.value(metadata !{i32 %7}, i64 0, metadata !52), !dbg !109
  ret i32 %7, !dbg !110
}

; Function Attrs: minsize nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !111, i64 0, metadata !112), !dbg !114
  store i64 1, i64* @next, align 8, !dbg !115, !tbaa !66
  tail call void @llvm.dbg.value(metadata !97, i64 0, metadata !55), !dbg !116
  br label %1, !dbg !116

; <label>:1                                       ; preds = %1, %0
  %i.02 = phi i32 [ 0, %0 ], [ %6, %1 ]
  %2 = tail call i32* @createRandomArray(i32 500000) #5, !dbg !118
  tail call void @llvm.dbg.value(metadata !{i32* %2}, i64 0, metadata !58), !dbg !118
  tail call void @llvm.dbg.value(metadata !97, i64 0, metadata !56), !dbg !120
  %3 = tail call i32 @findDuplicate(i32* %2, i32 500001) #5, !dbg !122
  %4 = bitcast i32* %2 to i8*, !dbg !123
  tail call void @free(i8* %4) #4, !dbg !123
  %5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @.str, i64 0, i64 0), i32 %3) #4, !dbg !124
  %6 = add nsw i32 %i.02, 1, !dbg !116
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !55), !dbg !116
  %exitcond = icmp eq i32 %6, 5, !dbg !116
  br i1 %exitcond, label %7, label %1, !dbg !116
...
!101 = metadata !{i32 54, i32 0, metadata !37, null}
!102 = metadata !{i32 55, i32 0, metadata !37, null}
!103 = metadata !{i32 56, i32 0, metadata !37, null}
!104 = metadata !{i32 59, i32 0, metadata !45, null}
!105 = metadata !{i32 61, i32 0, metadata !45, null}
!106 = metadata !{i32 63, i32 0, metadata !107, null}
!107 = metadata !{i32 786443, metadata !1, metadata !45, i32 63, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle.c]
!108 = metadata !{i32 64, i32 0, metadata !107, null}
!109 = metadata !{i32 65, i32 0, metadata !45, null}
!110 = metadata !{i32 66, i32 0, metadata !45, null}
!111 = metadata !{i32 1}
!112 = metadata !{i32 786689, metadata !9, metadata !"seed", metadata !5, i32 16777236, metadata !12, i32 0, metadata !113} ; [ DW_TAG_arg_variable ] [seed] [line 20]
!113 = metadata !{i32 73, i32 0, metadata !53, null}
!114 = metadata !{i32 20, i32 0, metadata !9, metadata !113}
!115 = metadata !{i32 21, i32 0, metadata !9, metadata !113}
!116 = metadata !{i32 75, i32 0, metadata !117, null}
!117 = metadata !{i32 786443, metadata !1, metadata !53, i32 75, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle.c]
!118 = metadata !{i32 76, i32 0, metadata !119, null}
!119 = metadata !{i32 786443, metadata !1, metadata !117, i32 75, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle.c]
!120 = metadata !{i32 77, i32 0, metadata !121, null}
!121 = metadata !{i32 786443, metadata !1, metadata !119, i32 77, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/puzzle.c]
!122 = metadata !{i32 78, i32 0, metadata !121, null}
!123 = metadata !{i32 79, i32 0, metadata !119, null}
!124 = metadata !{i32 80, i32 0, metadata !119, null}
!125 = metadata !{i32 83, i32 0, metadata !53, null}
