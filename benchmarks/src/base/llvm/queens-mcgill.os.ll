...
vector.body:                                      ; preds = %vector.body, %._crit_edge.thread
  %index = phi i64 [ 0, %._crit_edge.thread ], [ %index.next, %vector.body ], !dbg !116
  %63 = getelementptr inbounds [100 x i32]* @file, i64 0, i64 %index, !dbg !116
  %64 = bitcast i32* %63 to <4 x i32>*, !dbg !116
  store <4 x i32> <i32 101, i32 101, i32 101, i32 101>, <4 x i32>* %64, align 16, !dbg !116
  %index.next = add i64 %index, 4, !dbg !116
  %65 = icmp eq i64 %index.next, 100, !dbg !116
  br i1 %65, label %vector.body32, label %vector.body, !dbg !116, !llvm.loop !118

vector.body32:                                    ; preds = %vector.body, %vector.body32
  %index35 = phi i64 [ %index.next39, %vector.body32 ], [ 0, %vector.body ], !dbg !121
  %66 = getelementptr inbounds [199 x i32]* @bakdiag, i64 0, i64 %index35, !dbg !121
  %67 = bitcast i32* %66 to <2 x i32>*, !dbg !121
  store <2 x i32> <i32 101, i32 101>, <2 x i32>* %67, align 8, !dbg !121
  %68 = getelementptr inbounds [199 x i32]* @fordiag, i64 0, i64 %index35, !dbg !121
  %69 = bitcast i32* %68 to <2 x i32>*, !dbg !121
  store <2 x i32> <i32 101, i32 101>, <2 x i32>* %69, align 8, !dbg !121
  %index.next39 = add i64 %index35, 2, !dbg !121
  %70 = icmp eq i64 %index.next39, 198, !dbg !121
  br i1 %70, label %.preheader, label %vector.body32, !dbg !121, !llvm.loop !123

.preheader:                                       ; preds = %vector.body32, %.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next, %.preheader ], [ 198, %vector.body32 ]
  %71 = getelementptr inbounds [199 x i32]* @bakdiag, i64 0, i64 %indvars.iv, !dbg !121
  store i32 101, i32* %71, align 4, !dbg !121, !tbaa !65
  %72 = getelementptr inbounds [199 x i32]* @fordiag, i64 0, i64 %indvars.iv, !dbg !121
  store i32 101, i32* %72, align 4, !dbg !121, !tbaa !65
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !121
  %exitcond = icmp eq i64 %indvars.iv.next, 199, !dbg !121
  br i1 %exitcond, label %73, label %.preheader, !dbg !121, !llvm.loop !124

; <label>:73                                      ; preds = %.preheader
  tail call void @find(i32 0) #9, !dbg !125
  %74 = load i32* @printing, align 4, !dbg !126, !tbaa !65
  %75 = icmp ne i32 %74, 0, !dbg !126
  %76 = load i64* @solutions, align 8
  %77 = icmp ne i64 %76, 0, !dbg !126
  %or.cond = and i1 %75, %77, !dbg !126
  br i1 %or.cond, label %78, label %80, !dbg !126

; <label>:78                                      ; preds = %73
  %79 = tail call i32 @putchar(i32 10) #8, !dbg !126
  %.pr = load i64* @solutions, align 8, !dbg !128
  br label %80, !dbg !126

; <label>:80                                      ; preds = %78, %73
  %81 = phi i64 [ %.pr, %78 ], [ %76, %73 ], !dbg !128
  %82 = icmp eq i64 %81, 1, !dbg !128
  br i1 %82, label %83, label %84, !dbg !128

; <label>:83                                      ; preds = %80
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([23 x i8]* @str, i64 0, i64 0)), !dbg !128
  br label %86, !dbg !128

; <label>:84                                      ; preds = %80
  %85 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([28 x i8]* @.str11, i64 0, i64 0), i64 %81) #8, !dbg !130
  br label %86

; <label>:86                                      ; preds = %84, %83
  tail call void @exit(i32 0) #7, !dbg !131
  unreachable, !dbg !131
}
...
define void @find(i32 %level) #3 {
  tail call void @llvm.dbg.value(metadata !{i32 %level}, i64 0, metadata !28), !dbg !132
  %1 = load i32* @queens, align 4, !dbg !133, !tbaa !65
  %2 = icmp eq i32 %1, %level, !dbg !133
  br i1 %2, label %3, label %13, !dbg !133

; <label>:3                                       ; preds = %0
  %4 = load i64* @solutions, align 8, !dbg !135, !tbaa !113
  %5 = add i64 %4, 1, !dbg !135
  store i64 %5, i64* @solutions, align 8, !dbg !135, !tbaa !113
  %6 = load i32* @printing, align 4, !dbg !137, !tbaa !65
  %7 = icmp eq i32 %6, 0, !dbg !137
  br i1 %7, label %9, label %8, !dbg !137

; <label>:8                                       ; preds = %3
  tail call void @pboard() #9, !dbg !137
  br label %9, !dbg !137

; <label>:9                                       ; preds = %3, %8
  %10 = load i32* @findall, align 4, !dbg !139, !tbaa !65
  %11 = icmp eq i32 %10, 0, !dbg !139
  br i1 %11, label %12, label %.loopexit, !dbg !139

; <label>:12                                      ; preds = %9
  tail call void @exit(i32 0) #7, !dbg !139
  unreachable, !dbg !139

; <label>:13                                      ; preds = %0
  tail call void @llvm.dbg.value(metadata !115, i64 0, metadata !29), !dbg !141
  tail call void @llvm.dbg.value(metadata !144, i64 0, metadata !30), !dbg !141
  %14 = sext i32 %level to i64, !dbg !141
  tail call void @llvm.dbg.value(metadata !{i32* %21}, i64 0, metadata !32), !dbg !141
  %15 = load i32* @files, align 4, !dbg !141, !tbaa !65
  tail call void @llvm.dbg.value(metadata !{i32* %20}, i64 0, metadata !33), !dbg !141
  %16 = icmp sgt i32 %15, 0, !dbg !141
  br i1 %16, label %.lr.ph, label %.loopexit, !dbg !141

.lr.ph:                                           ; preds = %13
  %17 = add i32 %level, -1, !dbg !141
  %18 = add i32 %17, %15, !dbg !141
  %19 = sext i32 %18 to i64, !dbg !141
  %20 = getelementptr inbounds [199 x i32]* @bakdiag, i64 0, i64 %19, !dbg !141
  %21 = getelementptr inbounds [199 x i32]* @fordiag, i64 0, i64 %14, !dbg !141
  %22 = getelementptr inbounds [100 x i32]* @queen, i64 0, i64 %14, !dbg !145
  %23 = add nsw i32 %level, 1, !dbg !149
  br label %24, !dbg !141
...
; <label>:24                                      ; preds = %.lr.ph, %35
  ...
  %26 = load i32* %fp.02, align 4, !dbg !150, !tbaa !65
  %27 = icmp slt i32 %26, %level, !dbg !150
  br i1 %27, label %35, label %28, !dbg !150

; <label>:28                                      ; preds = %24
  %29 = load i32* %fdp.03, align 4, !dbg !150, !tbaa !65
  %30 = icmp slt i32 %29, %level, !dbg !150
  br i1 %30, label %35, label %31, !dbg !150

; <label>:31                                      ; preds = %28
  %32 = load i32* %bdp.04, align 4, !dbg !150, !tbaa !65
  %33 = icmp slt i32 %32, %level, !dbg !150
  br i1 %33, label %35, label %34, !dbg !150

; <label>:34                                      ; preds = %31
  store i32 %f.01, i32* %22, align 4, !dbg !145, !tbaa !65
  store i32 %level, i32* %bdp.04, align 4, !dbg !151, !tbaa !65
  store i32 %level, i32* %fdp.03, align 4, !dbg !151, !tbaa !65
  store i32 %level, i32* %fp.02, align 4, !dbg !151, !tbaa !65
  tail call void @find(i32 %23) #9, !dbg !149
  store i32 101, i32* %bdp.04, align 4, !dbg !152, !tbaa !65
  store i32 101, i32* %fdp.03, align 4, !dbg !152, !tbaa !65
  store i32 101, i32* %fp.02, align 4, !dbg !152, !tbaa !65
  %.pre = load i32* @files, align 4, !dbg !141, !tbaa !65
  br label %35, !dbg !153

; <label>:35                                      ; preds = %31, %28, %24, %34
  %36 = phi i32 [ %25, %31 ], [ %25, %28 ], [ %25, %24 ], [ %.pre, %34 ], !dbg !154
  %37 = add nsw i32 %f.01, 1, !dbg !154
  tail call void @llvm.dbg.value(metadata !{i32 %37}, i64 0, metadata !29), !dbg !154
  %38 = getelementptr inbounds i32* %fp.02, i64 1, !dbg !154
  tail call void @llvm.dbg.value(metadata !{i32* %38}, i64 0, metadata !30), !dbg !154
  %39 = getelementptr inbounds i32* %fdp.03, i64 1, !dbg !154
  tail call void @llvm.dbg.value(metadata !{i32* %39}, i64 0, metadata !32), !dbg !154
  %40 = getelementptr inbounds i32* %bdp.04, i64 -1, !dbg !154
  tail call void @llvm.dbg.value(metadata !{i32* %40}, i64 0, metadata !33), !dbg !154
  %41 = icmp slt i32 %37, %36, !dbg !141
  br i1 %41, label %24, label %.loopexit, !dbg !141
...
define void @pboard() #3 {
  %1 = load i32* @findall, align 4, !dbg !156, !tbaa !65
  %2 = icmp eq i32 %1, 0, !dbg !156
  br i1 %2, label %.preheader1, label %3, !dbg !156

; <label>:3                                       ; preds = %0
  %4 = load i64* @solutions, align 8, !dbg !158, !tbaa !113
  %5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str12, i64 0, i64 0), i64 %4) #8, !dbg !158
  br label %.preheader1, !dbg !158

.preheader1:                                      ; preds = %0, %3
  %6 = load i32* @ranks, align 4, !dbg !159, !tbaa !65
  %7 = icmp sgt i32 %6, 0, !dbg !159
  br i1 %7, label %.preheader, label %._crit_edge4, !dbg !159

.preheader:                                       ; preds = %.preheader1, %._crit_edge
  %indvars.iv = phi i64 [ %indvars.iv.next, %._crit_edge ], [ 0, %.preheader1 ]
  %8 = load i32* @files, align 4, !dbg !161, !tbaa !65
  %9 = icmp sgt i32 %8, 0, !dbg !161
  br i1 %9, label %.lr.ph, label %._crit_edge, !dbg !161

.lr.ph:                                           ; preds = %.preheader
  %10 = getelementptr inbounds [100 x i32]* @queen, i64 0, i64 %indvars.iv, !dbg !164
  br label %11, !dbg !161

; <label>:11                                      ; preds = %.lr.ph, %19
  %j.02 = phi i32 [ 0, %.lr.ph ], [ %20, %19 ]
  %12 = tail call i32 @putchar(i32 32) #8, !dbg !167
  %13 = load i32* %10, align 4, !dbg !164, !tbaa !65
  %14 = icmp eq i32 %j.02, %13, !dbg !164
  br i1 %14, label %15, label %17, !dbg !164

; <label>:15                                      ; preds = %11
  %16 = tail call i32 @putchar(i32 81) #8, !dbg !164
  br label %19, !dbg !164

; <label>:17                                      ; preds = %11
  %18 = tail call i32 @putchar(i32 45) #8, !dbg !168
  br label %19

; <label>:19                                      ; preds = %15, %17
  %20 = add nsw i32 %j.02, 1, !dbg !161
  tail call void @llvm.dbg.value(metadata !{i32 %20}, i64 0, metadata !23), !dbg !161
  %21 = load i32* @files, align 4, !dbg !161, !tbaa !65
  %22 = icmp slt i32 %20, %21, !dbg !161
  br i1 %22, label %11, label %._crit_edge, !dbg !161

._crit_edge:                                      ; preds = %19, %.preheader
  %23 = tail call i32 @putchar(i32 10) #8, !dbg !169
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !159
  %24 = load i32* @ranks, align 4, !dbg !159, !tbaa !65
  %25 = trunc i64 %indvars.iv.next to i32, !dbg !159
  %26 = icmp slt i32 %25, %24, !dbg !159
  br i1 %26, label %.preheader, label %._crit_edge4, !dbg !159

._crit_edge4:                                     ; preds = %._crit_edge, %.preheader1
  %27 = load %struct._IO_FILE** @stdout, align 8, !dbg !170, !tbaa !60
  %28 = tail call i32 @fflush(%struct._IO_FILE* %27) #8, !dbg !170
  ret void, !dbg !171
}
...
attributes #0 = { noreturn nounwind optsize uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #2 = { noreturn nounwind optsize "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!118 = metadata !{metadata !118, metadata !119, metadata !120}
!119 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!120 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!121 = metadata !{i32 277, i32 0, metadata !122, null}
!122 = metadata !{i32 786443, metadata !1, metadata !4, i32 277, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!123 = metadata !{metadata !123, metadata !119, metadata !120}
!124 = metadata !{metadata !124, metadata !119, metadata !120}
!125 = metadata !{i32 280, i32 0, metadata !4, null}
!126 = metadata !{i32 281, i32 0, metadata !127, null}
!127 = metadata !{i32 786443, metadata !1, metadata !4, i32 281, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!128 = metadata !{i32 284, i32 0, metadata !129, null}
!129 = metadata !{i32 786443, metadata !1, metadata !4, i32 284, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!130 = metadata !{i32 285, i32 0, metadata !129, null}
!131 = metadata !{i32 287, i32 0, metadata !4, null}
!132 = metadata !{i32 328, i32 0, metadata !24, null}
!133 = metadata !{i32 338, i32 0, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !24, i32 338, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!135 = metadata !{i32 339, i32 0, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !134, i32 338, i32 0, i32 26} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!137 = metadata !{i32 340, i32 0, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !136, i32 340, i32 0, i32 27} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!139 = metadata !{i32 341, i32 0, metadata !140, null}
!140 = metadata !{i32 786443, metadata !1, metadata !136, i32 341, i32 0, i32 28} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!141 = metadata !{i32 348, i32 0, metadata !142, null}
!142 = metadata !{i32 786443, metadata !1, metadata !143, i32 347, i32 0, i32 30} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!143 = metadata !{i32 786443, metadata !1, metadata !134, i32 346, i32 0, i32 29} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!144 = metadata !{null}
!145 = metadata !{i32 361, i32 0, metadata !146, null}
!146 = metadata !{i32 786443, metadata !1, metadata !147, i32 360, i32 0, i32 33} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!147 = metadata !{i32 786443, metadata !1, metadata !148, i32 358, i32 0, i32 32} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!148 = metadata !{i32 786443, metadata !1, metadata !142, i32 357, i32 0, i32 31} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!149 = metadata !{i32 363, i32 0, metadata !146, null}
!150 = metadata !{i32 358, i32 0, metadata !147, null}
!151 = metadata !{i32 362, i32 0, metadata !146, null}
!152 = metadata !{i32 364, i32 0, metadata !146, null}
!153 = metadata !{i32 365, i32 0, metadata !146, null}
!154 = metadata !{i32 355, i32 0, metadata !142, null}
!155 = metadata !{i32 368, i32 0, metadata !24, null}
!156 = metadata !{i32 303, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !1, metadata !18, i32 303, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!158 = metadata !{i32 304, i32 0, metadata !157, null}
!159 = metadata !{i32 306, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !18, i32 306, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!161 = metadata !{i32 307, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !1, metadata !163, i32 307, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!163 = metadata !{i32 786443, metadata !1, metadata !160, i32 306, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!164 = metadata !{i32 309, i32 0, metadata !165, null}
!165 = metadata !{i32 786443, metadata !1, metadata !166, i32 309, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!166 = metadata !{i32 786443, metadata !1, metadata !162, i32 307, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens-mcgill.c]
!167 = metadata !{i32 308, i32 0, metadata !166, null}
!168 = metadata !{i32 310, i32 0, metadata !165, null}
!169 = metadata !{i32 312, i32 0, metadata !163, null}
!170 = metadata !{i32 314, i32 0, metadata !18, null}
!171 = metadata !{i32 315, i32 0, metadata !18, null}
