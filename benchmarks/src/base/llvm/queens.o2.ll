...
; <label>:5                                       ; preds = %.lr.ph, %.backedge
  ...
  %6 = getelementptr inbounds i32* %b, i64 %indvars.iv.next, !dbg !148
  %7 = load i32* %6, align 4, !dbg !148, !tbaa !146
  %8 = icmp eq i32 %7, 0, !dbg !148
  br i1 %8, label %.backedge, label %9, !dbg !148

; <label>:9                                       ; preds = %5
  %10 = add nsw i64 %indvars.iv.next, %1, !dbg !148
  %11 = getelementptr inbounds i32* %a, i64 %10, !dbg !148
  %12 = load i32* %11, align 4, !dbg !148, !tbaa !146
  %13 = icmp eq i32 %12, 0, !dbg !148
  br i1 %13, label %.backedge, label %14, !dbg !148

; <label>:14                                      ; preds = %9
  %15 = xor i64 %indvars.iv, 4294967295
  %16 = trunc i64 %15 to i32, !dbg !148
  %17 = add i32 %0, %16, !dbg !148
  %18 = sext i32 %17 to i64, !dbg !148
  %19 = getelementptr inbounds i32* %c, i64 %18, !dbg !148
  %20 = load i32* %19, align 4, !dbg !148, !tbaa !146
  %21 = icmp eq i32 %20, 0, !dbg !148
  br i1 %21, label %.backedge, label %22, !dbg !148

; <label>:22                                      ; preds = %14
  %23 = trunc i64 %indvars.iv.next to i32, !dbg !151
  store i32 %23, i32* %2, align 4, !dbg !151, !tbaa !146
  store i32 0, i32* %6, align 4, !dbg !159, !tbaa !146
  store i32 0, i32* %11, align 4, !dbg !160, !tbaa !146
  store i32 0, i32* %19, align 4, !dbg !161, !tbaa !146
  br i1 %3, label %24, label %28, !dbg !153

; <label>:24                                      ; preds = %22
  tail call void @Try(i32 %4, i32* %q, i32* %a, i32* %b, i32* %c, i32* %x), !dbg !155
  %25 = load i32* %q, align 4, !dbg !162, !tbaa !146
  %26 = icmp eq i32 %25, 0, !dbg !162
  br i1 %26, label %27, label %.critedge, !dbg !162

; <label>:27                                      ; preds = %24
  store i32 1, i32* %6, align 4, !dbg !164, !tbaa !146
  store i32 1, i32* %11, align 4, !dbg !166, !tbaa !146
  store i32 1, i32* %19, align 4, !dbg !167, !tbaa !146
  %.pre = load i32* %q, align 4, !dbg !157, !tbaa !146
  %phitmp = icmp eq i32 %.pre, 0, !dbg !168
...
.backedge:                                        ; preds = %27, %5, %9, %14
  %29 = phi i1 [ %phitmp, %27 ], [ true, %5 ], [ true, %9 ], [ true, %14 ]
  %30 = trunc i64 %indvars.iv.next to i32, !dbg !157
  %31 = icmp ne i32 %30, 8, !dbg !157
  %or.cond = and i1 %29, %31, !dbg !157
  br i1 %or.cond, label %5, label %.critedge, !dbg !157

.critedge:                                        ; preds = %24, %.backedge, %28
  ret void, !dbg !170
}
