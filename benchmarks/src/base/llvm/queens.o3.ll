...
.lr.ph:
  ...
  br i1 %3, label %.lr.ph.split.us, label %.lr.ph..lr.ph.split_crit_edge

.lr.ph.split.us:                                  ; preds = %.lr.ph, %.backedge.us
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %.backedge.us ], [ 0, %.lr.ph ]
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1, !dbg !157
  store i32 0, i32* %q, align 4, !dbg !158, !tbaa !146
  %5 = getelementptr inbounds i32* %b, i64 %indvars.iv.next5, !dbg !148
  %6 = load i32* %5, align 4, !dbg !148, !tbaa !146
  %7 = icmp eq i32 %6, 0, !dbg !148
  br i1 %7, label %.backedge.us, label %8, !dbg !148

; <label>:8                                       ; preds = %.lr.ph.split.us
  %9 = add nsw i64 %indvars.iv.next5, %1, !dbg !148
  %10 = getelementptr inbounds i32* %a, i64 %9, !dbg !148
  %11 = load i32* %10, align 4, !dbg !148, !tbaa !146
  %12 = icmp eq i32 %11, 0, !dbg !148
  br i1 %12, label %.backedge.us, label %13, !dbg !148

; <label>:13                                      ; preds = %8
  %14 = xor i64 %indvars.iv4, 4294967295
  %15 = trunc i64 %14 to i32, !dbg !148
  %16 = add i32 %0, %15, !dbg !148
  %17 = sext i32 %16 to i64, !dbg !148
  %18 = getelementptr inbounds i32* %c, i64 %17, !dbg !148
  %19 = load i32* %18, align 4, !dbg !148, !tbaa !146
  %20 = icmp eq i32 %19, 0, !dbg !148
  br i1 %20, label %.backedge.us, label %21, !dbg !148

; <label>:21                                      ; preds = %13
  %22 = trunc i64 %indvars.iv.next5 to i32, !dbg !151
  store i32 %22, i32* %2, align 4, !dbg !151, !tbaa !146
  store i32 0, i32* %5, align 4, !dbg !159, !tbaa !146
  store i32 0, i32* %10, align 4, !dbg !160, !tbaa !146
  store i32 0, i32* %18, align 4, !dbg !161, !tbaa !146
  tail call void @Try(i32 %4, i32* %q, i32* %a, i32* %b, i32* %c, i32* %x), !dbg !155
  %23 = load i32* %q, align 4, !dbg !162, !tbaa !146
  %24 = icmp eq i32 %23, 0, !dbg !162
  br i1 %24, label %25, label %.backedge.us, !dbg !162

; <label>:25                                      ; preds = %21
  store i32 1, i32* %5, align 4, !dbg !164, !tbaa !146
  store i32 1, i32* %10, align 4, !dbg !166, !tbaa !146
  store i32 1, i32* %18, align 4, !dbg !167, !tbaa !146
  br label %.backedge.us, !dbg !168

.backedge.us:                                     ; preds = %25, %21, %13, %8, %.lr.ph.split.us
  %26 = load i32* %q, align 4, !dbg !157, !tbaa !146
  %27 = icmp eq i32 %26, 0, !dbg !157
  %28 = trunc i64 %indvars.iv.next5 to i32, !dbg !157
  %29 = icmp ne i32 %28, 8, !dbg !157
  %or.cond.us = and i1 %27, %29, !dbg !157
  br i1 %or.cond.us, label %.lr.ph.split.us, label %.critedge, !dbg !157

.lr.ph..lr.ph.split_crit_edge:                    ; preds = %.lr.ph, %.backedge
  %indvars.iv = phi i64 [ %indvars.iv.next, %.backedge ], [ 0, %.lr.ph ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !157
  store i32 0, i32* %q, align 4, !dbg !158, !tbaa !146
  %30 = getelementptr inbounds i32* %b, i64 %indvars.iv.next, !dbg !148
  %31 = load i32* %30, align 4, !dbg !148, !tbaa !146
  %32 = icmp eq i32 %31, 0, !dbg !148
  br i1 %32, label %.backedge, label %33, !dbg !148

; <label>:33                                      ; preds = %.lr.ph..lr.ph.split_crit_edge
  %34 = add nsw i64 %indvars.iv.next, %1, !dbg !148
  %35 = getelementptr inbounds i32* %a, i64 %34, !dbg !148
  %36 = load i32* %35, align 4, !dbg !148, !tbaa !146
  %37 = icmp eq i32 %36, 0, !dbg !148
  br i1 %37, label %.backedge, label %38, !dbg !148

; <label>:38                                      ; preds = %33
  %39 = xor i64 %indvars.iv, 4294967295
  %40 = trunc i64 %39 to i32, !dbg !148
  %41 = add i32 %0, %40, !dbg !148
  %42 = sext i32 %41 to i64, !dbg !148
  %43 = getelementptr inbounds i32* %c, i64 %42, !dbg !148
  %44 = load i32* %43, align 4, !dbg !148, !tbaa !146
  %45 = icmp eq i32 %44, 0, !dbg !148
  br i1 %45, label %.backedge, label %46, !dbg !148

; <label>:46                                      ; preds = %38
  %47 = trunc i64 %indvars.iv.next to i32, !dbg !151
  store i32 %47, i32* %2, align 4, !dbg !151, !tbaa !146
  store i32 0, i32* %30, align 4, !dbg !159, !tbaa !146
  store i32 0, i32* %35, align 4, !dbg !160, !tbaa !146
  store i32 0, i32* %43, align 4, !dbg !161, !tbaa !146
  store i32 1, i32* %q, align 4, !dbg !169, !tbaa !146
  br label %.backedge

.backedge:                                        ; preds = %46, %.lr.ph..lr.ph.split_crit_edge, %33, %38
  %48 = load i32* %q, align 4, !dbg !157, !tbaa !146
  %49 = icmp eq i32 %48, 0, !dbg !157
  %50 = trunc i64 %indvars.iv.next to i32, !dbg !157
  %51 = icmp ne i32 %50, 8, !dbg !157
  %or.cond = and i1 %49, %51, !dbg !157
  br i1 %or.cond, label %.lr.ph..lr.ph.split_crit_edge, label %.critedge, !dbg !157

.critedge:                                        ; preds = %.backedge, %.backedge.us
  ret void, !dbg !170
}
...
; <label>:5                                       ; preds = %19, %0
  %indvars.iv = phi i64 [ -7, %0 ], [ %indvars.iv.next, %19 ]
...
; <label>:14                                      ; preds = %11
  ...
  %16 = icmp slt i32 %12, 8, !dbg !181
  br i1 %16, label %.thread, label %19, !dbg !181

.thread:                                          ; preds = %11, %14
  %17 = add nsw i64 %indvars.iv, 7, !dbg !181
  %18 = getelementptr inbounds [15 x i32]* %c, i64 0, i64 %17, !dbg !181
  store i32 1, i32* %18, align 4, !dbg !181, !tbaa !146
  br label %19, !dbg !181

; <label>:19                                      ; preds = %.thread, %14
  %indvars.iv.next = add nsw i64 %indvars.iv, 1, !dbg !175
  %exitcond = icmp eq i64 %indvars.iv.next, 17, !dbg !175
  br i1 %exitcond, label %20, label %5, !dbg !175

; <label>:20                                      ; preds = %19
  %21 = getelementptr inbounds [17 x i32]* %b, i64 0, i64 0, !dbg !183
  %22 = getelementptr inbounds [9 x i32]* %a, i64 0, i64 0, !dbg !183
  %23 = getelementptr inbounds [15 x i32]* %c, i64 0, i64 0, !dbg !183
  %24 = getelementptr inbounds [9 x i32]* %x, i64 0, i64 0, !dbg !183
  call void @Try(i32 1, i32* %q, i32* %21, i32* %22, i32* %23, i32* %24), !dbg !183
  tail call void @llvm.dbg.value(metadata !{i32* %q}, i64 0, metadata !27), !dbg !184
  %25 = load i32* %q, align 4, !dbg !184, !tbaa !146
  %26 = icmp eq i32 %25, 0, !dbg !184
  br i1 %26, label %27, label %28, !dbg !184
...
define void @Queens(i32 %run) #0 {
  ...
  %1 = bitcast i32* %q.i to i8*, !dbg !191
  %2 = bitcast [9 x i32]* %a.i to i8*, !dbg !192
  %3 = bitcast [17 x i32]* %b.i to i8*, !dbg !192
  %4 = bitcast [15 x i32]* %c.i to i8*, !dbg !192
  %5 = bitcast [9 x i32]* %x.i to i8*, !dbg !192
  %6 = getelementptr inbounds [17 x i32]* %b.i, i64 0, i64 0, !dbg !193
  %7 = getelementptr inbounds [9 x i32]* %a.i, i64 0, i64 0, !dbg !193
  %8 = getelementptr inbounds [15 x i32]* %c.i, i64 0, i64 0, !dbg !193
  %9 = getelementptr inbounds [9 x i32]* %x.i, i64 0, i64 0, !dbg !193
  br label %10, !dbg !189

; <label>:10                                      ; preds = %Doit.exit, %0
  %i.01 = phi i32 [ 1, %0 ], [ %30, %Doit.exit ]
  call void @llvm.lifetime.start(i64 4, i8* %1) #2, !dbg !191
  tail call void @llvm.dbg.declare(metadata !{i32* %q.i}, metadata !27) #2, !dbg !191
  call void @llvm.lifetime.start(i64 36, i8* %2) #2, !dbg !192
  tail call void @llvm.dbg.declare(metadata !{[9 x i32]* %a.i}, metadata !28) #2, !dbg !192
  call void @llvm.lifetime.start(i64 68, i8* %3) #2, !dbg !192
  tail call void @llvm.dbg.declare(metadata !{[17 x i32]* %b.i}, metadata !32) #2, !dbg !192
  call void @llvm.lifetime.start(i64 60, i8* %4) #2, !dbg !192
  tail call void @llvm.dbg.declare(metadata !{[15 x i32]* %c.i}, metadata !36) #2, !dbg !192
  call void @llvm.lifetime.start(i64 36, i8* %5) #2, !dbg !192
  tail call void @llvm.dbg.declare(metadata !{[9 x i32]* %x.i}, metadata !40) #2, !dbg !192
  tail call void @llvm.dbg.value(metadata !173, i64 0, metadata !194) #2, !dbg !195
  br label %11, !dbg !196

; <label>:11                                      ; preds = %25, %10
  %indvars.iv.i = phi i64 [ -7, %10 ], [ %indvars.iv.next.i, %25 ]
  %12 = add i64 %indvars.iv.i, 4294967295, !dbg !197
  %13 = trunc i64 %12 to i32, !dbg !197
  %14 = icmp ult i32 %13, 8, !dbg !197
  br i1 %14, label %15, label %17, !dbg !197

; <label>:15                                      ; preds = %11
  %16 = getelementptr inbounds [9 x i32]* %a.i, i64 0, i64 %indvars.iv.i, !dbg !197
  store i32 1, i32* %16, align 4, !dbg !197, !tbaa !146
  br label %17, !dbg !197

; <label>:17                                      ; preds = %15, %11
  %18 = trunc i64 %indvars.iv.i to i32, !dbg !198
  %19 = icmp sgt i32 %18, 1, !dbg !198
  br i1 %19, label %20, label %.thread.i, !dbg !198

; <label>:20                                      ; preds = %17
  %21 = getelementptr inbounds [17 x i32]* %b.i, i64 0, i64 %indvars.iv.i, !dbg !198
  store i32 1, i32* %21, align 4, !dbg !198, !tbaa !146
  %22 = icmp slt i32 %18, 8, !dbg !199
  br i1 %22, label %.thread.i, label %25, !dbg !199

.thread.i:                                        ; preds = %20, %17
  %23 = add nsw i64 %indvars.iv.i, 7, !dbg !199
  %24 = getelementptr inbounds [15 x i32]* %c.i, i64 0, i64 %23, !dbg !199
  store i32 1, i32* %24, align 4, !dbg !199, !tbaa !146
  br label %25, !dbg !199

; <label>:25                                      ; preds = %.thread.i, %20
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1, !dbg !196
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 17, !dbg !196
  br i1 %exitcond.i, label %26, label %11, !dbg !196

; <label>:26                                      ; preds = %25
  call void @Try(i32 1, i32* %q.i, i32* %6, i32* %7, i32* %8, i32* %9) #2, !dbg !193
  tail call void @llvm.dbg.value(metadata !{i32* %q.i}, i64 0, metadata !200) #2, !dbg !201
  tail call void @llvm.dbg.value(metadata !{i32* %q.i}, i64 0, metadata !27), !dbg !201
  %27 = load i32* %q.i, align 4, !dbg !201, !tbaa !146
  %28 = icmp eq i32 %27, 0, !dbg !201
  br i1 %28, label %29, label %Doit.exit, !dbg !201

; <label>:29                                      ; preds = %26
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)) #2, !dbg !201
  br label %Doit.exit, !dbg !201

Doit.exit:                                        ; preds = %26, %29
  call void @llvm.lifetime.end(i64 36, i8* %5) #2, !dbg !202
  call void @llvm.lifetime.end(i64 60, i8* %4) #2, !dbg !202
  call void @llvm.lifetime.end(i64 68, i8* %3) #2, !dbg !202
  call void @llvm.lifetime.end(i64 36, i8* %2) #2, !dbg !202
  call void @llvm.lifetime.end(i64 4, i8* %1) #2, !dbg !202
  %30 = add nsw i32 %i.01, 1, !dbg !189
  tail call void @llvm.dbg.value(metadata !{i32 %30}, i64 0, metadata !46), !dbg !189
  %exitcond = icmp eq i32 %30, 51, !dbg !189
  br i1 %exitcond, label %31, label %10, !dbg !189

; <label>:31                                      ; preds = %Doit.exit
  %32 = add nsw i32 %run, 1, !dbg !203
  %33 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %32) #2, !dbg !203
  ret void, !dbg !204
}

; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !143, i64 0, metadata !49), !dbg !205
  br label %1, !dbg !205

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Queens(i32 %i.01), !dbg !205
  %2 = add nsw i32 %i.01, 1, !dbg !205
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !49), !dbg !205
  %exitcond = icmp eq i32 %2, 100, !dbg !205
  br i1 %exitcond, label %3, label %1, !dbg !205
...
!191 = metadata !{i32 163, i32 0, metadata !24, metadata !189}
!192 = metadata !{i32 164, i32 0, metadata !24, metadata !189}
!193 = metadata !{i32 173, i32 0, metadata !24, metadata !189}
!194 = metadata !{i32 786688, metadata !24, metadata !"i", metadata !5, i32 163, metadata !11, i32 0, metadata !189} ; [ DW_TAG_auto_variable ] [i] [line 163]
!195 = metadata !{i32 165, i32 0, metadata !24, metadata !189}
!196 = metadata !{i32 166, i32 0, metadata !24, metadata !189}
!197 = metadata !{i32 167, i32 0, metadata !177, metadata !189}
!198 = metadata !{i32 168, i32 0, metadata !180, metadata !189}
!199 = metadata !{i32 169, i32 0, metadata !182, metadata !189}
!200 = metadata !{i32 786688, metadata !24, metadata !"q", metadata !5, i32 163, metadata !11, i32 0, metadata !189} ; [ DW_TAG_auto_variable ] [q] [line 163]
!201 = metadata !{i32 174, i32 0, metadata !185, metadata !189}
!202 = metadata !{i32 175, i32 0, metadata !24, metadata !189}
!203 = metadata !{i32 180, i32 0, metadata !41, null}
!204 = metadata !{i32 181, i32 0, metadata !41, null}
!205 = metadata !{i32 186, i32 0, metadata !206, null}
!206 = metadata !{i32 786443, metadata !1, metadata !47, i32 186, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/queens.c]
!207 = metadata !{i32 187, i32 0, metadata !47, null}
