...
; <label>:24                                      ; preds = %22
  tail call void @Try(i32 %4, i32* %q, i32* %a, i32* %b, i32* %c, i32* %x) #4, !dbg !155
...
; <label>:20                                      ; preds = %19
  ...
  call void @Try(i32 1, i32* %q, i32* %21, i32* %22, i32* %23, i32* %24) #4, !dbg !183
...
; <label>:3                                       ; preds = %1
  ...
  %5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %4) #5, !dbg !191
  ret void, !dbg !192
}
...
; <label>:1                                       ; preds = %1, %0
  ...
  tail call void @Queens(i32 %i.01) #4, !dbg !193
