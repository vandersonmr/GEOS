...
define void @Initarr() #0 {
  tail call void @Initrand(), !dbg !128
  store i32 0, i32* @biggest, align 4, !dbg !129, !tbaa !130
  store i32 0, i32* @littlest, align 4, !dbg !129, !tbaa !130
  tail call void @llvm.dbg.value(metadata !132, i64 0, metadata !14), !dbg !133
  br label %1, !dbg !133

; <label>:1                                       ; preds = %15, %0
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %15 ]
  %2 = tail call i32 @Rand(), !dbg !135
  %3 = sext i32 %2 to i64, !dbg !135
  tail call void @llvm.dbg.value(metadata !{i64 %3}, i64 0, metadata !15), !dbg !135
  %4 = srem i64 %3, 100000, !dbg !137
  %5 = add nsw i64 %4, 4294917296, !dbg !137
  %6 = trunc i64 %5 to i32, !dbg !137
  %7 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv, !dbg !137
  store i32 %6, i32* %7, align 4, !dbg !137, !tbaa !130
  %8 = load i32* @biggest, align 4, !dbg !138, !tbaa !130
  %9 = icmp sgt i32 %6, %8, !dbg !138
  br i1 %9, label %10, label %11, !dbg !138

; <label>:10                                      ; preds = %1
  store i32 %6, i32* @biggest, align 4, !dbg !138, !tbaa !130
  br label %15, !dbg !138

; <label>:11                                      ; preds = %1
  %12 = load i32* @littlest, align 4, !dbg !140, !tbaa !130
  %13 = icmp slt i32 %6, %12, !dbg !140
  br i1 %13, label %14, label %15, !dbg !140

; <label>:14                                      ; preds = %11
  store i32 %6, i32* @littlest, align 4, !dbg !140, !tbaa !130
  br label %15, !dbg !140

; <label>:15                                      ; preds = %10, %14, %11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !133
  %exitcond = icmp eq i64 %indvars.iv.next, 5001, !dbg !133
  br i1 %exitcond, label %16, label %1, !dbg !133
...
tailrecurse:                                      ; preds = %29, %0
  %l.tr = phi i32 [ %l, %0 ], [ %i.1, %29 ]
  tail call void @llvm.dbg.value(metadata !{i32* %a}, i64 0, metadata !22), !dbg !143
  tail call void @llvm.dbg.value(metadata !{i32 %l.tr}, i64 0, metadata !23), !dbg !143
  tail call void @llvm.dbg.value(metadata !{i32 %r}, i64 0, metadata !24), !dbg !143
  tail call void @llvm.dbg.value(metadata !{i32 %l.tr}, i64 0, metadata !25), !dbg !144
  tail call void @llvm.dbg.value(metadata !{i32 %r}, i64 0, metadata !26), !dbg !144
  %1 = add nsw i32 %l.tr, %r, !dbg !145
  %2 = sdiv i32 %1, 2, !dbg !145
  %3 = sext i32 %2 to i64, !dbg !145
  %4 = getelementptr inbounds i32* %a, i64 %3, !dbg !145
  %5 = load i32* %4, align 4, !dbg !145, !tbaa !130
  tail call void @llvm.dbg.value(metadata !{i32 %5}, i64 0, metadata !27), !dbg !145
  br label %.outer, !dbg !146

.outer:                                           ; preds = %24, %tailrecurse
  %j.0.ph = phi i32 [ %r, %tailrecurse ], [ %j.2, %24 ]
  %i.0.ph = phi i32 [ %l.tr, %tailrecurse ], [ %i.1, %24 ]
  %6 = sext i32 %i.0.ph to i64
  br label %7

; <label>:7                                       ; preds = %7, %.outer
  %indvars.iv = phi i64 [ %indvars.iv.next, %7 ], [ %6, %.outer ]
  %8 = getelementptr inbounds i32* %a, i64 %indvars.iv, !dbg !147
  %9 = load i32* %8, align 4, !dbg !147, !tbaa !130
  %10 = icmp slt i32 %9, %5, !dbg !147
  %indvars.iv.next = add nsw i64 %indvars.iv, 1, !dbg !147
  br i1 %10, label %7, label %.preheader, !dbg !147
...
; <label>:12                                      ; preds = %12, %.preheader
  ...
  %13 = getelementptr inbounds i32* %a, i64 %indvars.iv5, !dbg !149
  %14 = load i32* %13, align 4, !dbg !149, !tbaa !130
  %15 = icmp slt i32 %5, %14, !dbg !149
  %indvars.iv.next6 = add nsw i64 %indvars.iv5, -1, !dbg !149
  br i1 %15, label %12, label %16, !dbg !149

; <label>:16                                      ; preds = %12
  %17 = trunc i64 %indvars.iv to i32, !dbg !149
  %18 = trunc i64 %indvars.iv5 to i32, !dbg !150
  %19 = icmp sgt i32 %17, %18, !dbg !150
  br i1 %19, label %24, label %20, !dbg !150

; <label>:20                                      ; preds = %16
  %21 = load i32* %8, align 4, !dbg !152, !tbaa !130
  tail call void @llvm.dbg.value(metadata !{i32 %21}, i64 0, metadata !28), !dbg !152
  store i32 %14, i32* %8, align 4, !dbg !154, !tbaa !130
  store i32 %21, i32* %13, align 4, !dbg !155, !tbaa !130
  %22 = add nsw i32 %17, 1, !dbg !156
  tail call void @llvm.dbg.value(metadata !{i32 %22}, i64 0, metadata !25), !dbg !156
  %23 = add nsw i32 %18, -1, !dbg !156
  tail call void @llvm.dbg.value(metadata !{i32 %23}, i64 0, metadata !26), !dbg !156
  br label %24, !dbg !157

; <label>:24                                      ; preds = %16, %20
  %j.2 = phi i32 [ %23, %20 ], [ %18, %16 ]
  %i.1 = phi i32 [ %22, %20 ], [ %17, %16 ]
  %25 = icmp sgt i32 %i.1, %j.2, !dbg !158
  br i1 %25, label %26, label %.outer, !dbg !158

; <label>:26                                      ; preds = %24
  %27 = icmp sgt i32 %j.2, %l.tr, !dbg !159
  br i1 %27, label %28, label %29, !dbg !159

; <label>:28                                      ; preds = %26
  tail call void @Quicksort(i32* %a, i32 %l.tr, i32 %j.2), !dbg !159
  br label %29, !dbg !159

; <label>:29                                      ; preds = %28, %26
  %30 = icmp slt i32 %i.1, %r, !dbg !161
  br i1 %30, label %tailrecurse, label %31, !dbg !161
...
define void @Quick(i32 %run) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %run}, i64 0, metadata !33), !dbg !164
  tail call void @Initarr(), !dbg !165
  tail call void @Quicksort(i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 0), i32 1, i32 5000), !dbg !166
  %1 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !167, !tbaa !130
  %2 = load i32* @littlest, align 4, !dbg !167, !tbaa !130
  %3 = icmp eq i32 %1, %2, !dbg !167
  br i1 %3, label %4, label %8, !dbg !167

; <label>:4                                       ; preds = %0
  %5 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 5000), align 16, !dbg !167, !tbaa !130
  %6 = load i32* @biggest, align 4, !dbg !167, !tbaa !130
  %7 = icmp eq i32 %5, %6, !dbg !167
  br i1 %7, label %9, label %8, !dbg !167

; <label>:8                                       ; preds = %4, %0
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([17 x i8]* @str, i64 0, i64 0)), !dbg !167
  br label %9, !dbg !167

; <label>:9                                       ; preds = %4, %8
  %10 = add nsw i32 %run, 1, !dbg !169
  %11 = sext i32 %10 to i64, !dbg !169
  %12 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %11, !dbg !169
  %13 = load i32* %12, align 4, !dbg !169, !tbaa !130
  %14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %13) #3, !dbg !169
  ret void, !dbg !170
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !171, i64 0, metadata !36), !dbg !172
  br label %1, !dbg !172

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Quick(i32 %i.01), !dbg !172
  %2 = add nsw i32 %i.01, 1, !dbg !172
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !36), !dbg !172
  %exitcond = icmp eq i32 %2, 100, !dbg !172
  br i1 %exitcond, label %3, label %1, !dbg !172
...
!128 = metadata !{i32 129, i32 0, metadata !12, null}
!129 = metadata !{i32 130, i32 0, metadata !12, null}
!130 = metadata !{metadata !131, metadata !131, i64 0}
!131 = metadata !{metadata !"int", metadata !123, i64 0}
!132 = metadata !{i32 1}
!133 = metadata !{i32 131, i32 0, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !12, i32 131, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!135 = metadata !{i32 132, i32 0, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !134, i32 131, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!137 = metadata !{i32 134, i32 0, metadata !136, null}
!138 = metadata !{i32 135, i32 0, metadata !139, null}
!139 = metadata !{i32 786443, metadata !1, metadata !136, i32 135, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!140 = metadata !{i32 136, i32 0, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !139, i32 136, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!142 = metadata !{i32 138, i32 0, metadata !12, null}
!143 = metadata !{i32 140, i32 0, metadata !17, null}
!144 = metadata !{i32 144, i32 0, metadata !17, null}
!145 = metadata !{i32 145, i32 0, metadata !17, null}
!146 = metadata !{i32 146, i32 0, metadata !17, null}
!147 = metadata !{i32 147, i32 0, metadata !148, null}
!148 = metadata !{i32 786443, metadata !1, metadata !17, i32 146, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!149 = metadata !{i32 148, i32 0, metadata !148, null}
!150 = metadata !{i32 149, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !1, metadata !148, i32 149, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!152 = metadata !{i32 150, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !1, metadata !151, i32 149, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!154 = metadata !{i32 151, i32 0, metadata !153, null}
!155 = metadata !{i32 152, i32 0, metadata !153, null}
!156 = metadata !{i32 153, i32 0, metadata !153, null}
!157 = metadata !{i32 154, i32 0, metadata !153, null}
!158 = metadata !{i32 155, i32 0, metadata !148, null}
!159 = metadata !{i32 156, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !17, i32 156, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!161 = metadata !{i32 157, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !1, metadata !17, i32 157, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!163 = metadata !{i32 158, i32 0, metadata !17, null}
!164 = metadata !{i32 161, i32 0, metadata !29, null}
!165 = metadata !{i32 162, i32 0, metadata !29, null}
!166 = metadata !{i32 163, i32 0, metadata !29, null}
!167 = metadata !{i32 164, i32 0, metadata !168, null}
!168 = metadata !{i32 786443, metadata !1, metadata !29, i32 164, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!169 = metadata !{i32 165, i32 0, metadata !29, null}
!170 = metadata !{i32 166, i32 0, metadata !29, null}
!171 = metadata !{i32 0}
!172 = metadata !{i32 171, i32 0, metadata !173, null}
!173 = metadata !{i32 786443, metadata !1, metadata !34, i32 171, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!174 = metadata !{i32 172, i32 0, metadata !34, null}
