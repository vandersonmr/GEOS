...
; <label>:27                                      ; preds = %25
  tail call void @Quicksort(i32* %a, i32 %l.tr, i32 %j.2), !dbg !161
  br label %28, !dbg !161
...
define void @Quick(i32 %run) #0 {
  ...
  store i64 74755, i64* @seed, align 8, !dbg !167, !tbaa !121
  store i32 0, i32* @biggest, align 4, !dbg !170, !tbaa !131
  store i32 0, i32* @littlest, align 4, !dbg !170, !tbaa !131
  tail call void @llvm.dbg.value(metadata !133, i64 0, metadata !171), !dbg !172
  br label %1, !dbg !172

; <label>:1                                       ; preds = %17, %0
  %2 = phi i32 [ 0, %0 ], [ %18, %17 ]
  %3 = phi i32 [ 0, %0 ], [ %19, %17 ], !dbg !173
  %indvars.iv.i = phi i64 [ 1, %0 ], [ %indvars.iv.next.i, %17 ]
  %4 = phi i64 [ 74755, %0 ], [ %7, %17 ], !dbg !173
  %5 = mul nsw i64 %4, 1309, !dbg !173
  %6 = add nsw i64 %5, 13849, !dbg !173
  %7 = and i64 %6, 65535, !dbg !173
  tail call void @llvm.dbg.value(metadata !{i64 %7}, i64 0, metadata !175), !dbg !174
  %8 = urem i64 %7, 100000, !dbg !176
  %9 = add nsw i64 %8, 4294917296, !dbg !176
  %10 = trunc i64 %9 to i32, !dbg !176
  %11 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv.i, !dbg !176
  store i32 %10, i32* %11, align 4, !dbg !176, !tbaa !131
  %12 = icmp sgt i32 %10, %3, !dbg !177
  br i1 %12, label %13, label %14, !dbg !177

; <label>:13                                      ; preds = %1
  store i32 %10, i32* @biggest, align 4, !dbg !177, !tbaa !131
  br label %17, !dbg !177

; <label>:14                                      ; preds = %1
  %15 = icmp slt i32 %10, %2, !dbg !178
  br i1 %15, label %16, label %17, !dbg !178

; <label>:16                                      ; preds = %14
  store i32 %10, i32* @littlest, align 4, !dbg !178, !tbaa !131
  br label %17, !dbg !178

; <label>:17                                      ; preds = %16, %14, %13
  %18 = phi i32 [ %2, %13 ], [ %10, %16 ], [ %2, %14 ]
  %19 = phi i32 [ %10, %13 ], [ %3, %16 ], [ %3, %14 ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !172
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 5001, !dbg !172
  br i1 %exitcond.i, label %Initarr.exit, label %1, !dbg !172

Initarr.exit:                                     ; preds = %17
  store i64 %7, i64* @seed, align 8, !dbg !173, !tbaa !121
  tail call void @Quicksort(i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 0), i32 1, i32 5000), !dbg !179
  %20 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !180, !tbaa !131
  %21 = load i32* @littlest, align 4, !dbg !180, !tbaa !131
  %22 = icmp eq i32 %20, %21, !dbg !180
  br i1 %22, label %23, label %27, !dbg !180

; <label>:23                                      ; preds = %Initarr.exit
  %24 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 5000), align 16, !dbg !180, !tbaa !131
  %25 = load i32* @biggest, align 4, !dbg !180, !tbaa !131
  %26 = icmp eq i32 %24, %25, !dbg !180
  br i1 %26, label %28, label %27, !dbg !180

; <label>:27                                      ; preds = %23, %Initarr.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([17 x i8]* @str, i64 0, i64 0)), !dbg !180
  br label %28, !dbg !180

; <label>:28                                      ; preds = %23, %27
  %29 = add nsw i32 %run, 1, !dbg !182
  %30 = sext i32 %29 to i64, !dbg !182
  %31 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %30, !dbg !182
  %32 = load i32* %31, align 4, !dbg !182, !tbaa !131
  %33 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %32) #3, !dbg !182
  ret void, !dbg !183
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !184, i64 0, metadata !36), !dbg !185
  br label %1, !dbg !185

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Quick(i32 %i.01), !dbg !185
  %2 = add nsw i32 %i.01, 1, !dbg !185
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !36), !dbg !185
  %exitcond = icmp eq i32 %2, 100, !dbg !185
  br i1 %exitcond, label %3, label %1, !dbg !185
...
!167 = metadata !{i32 116, i32 0, metadata !4, metadata !168}
!168 = metadata !{i32 129, i32 0, metadata !12, metadata !169}
!169 = metadata !{i32 162, i32 0, metadata !29, null}
!170 = metadata !{i32 130, i32 0, metadata !12, metadata !169}
!171 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 127, metadata !11, i32 0, metadata !169} ; [ DW_TAG_auto_variable ] [i] [line 127]
!172 = metadata !{i32 131, i32 0, metadata !135, metadata !169}
!173 = metadata !{i32 120, i32 0, metadata !8, metadata !174}
!174 = metadata !{i32 132, i32 0, metadata !138, metadata !169}
!175 = metadata !{i32 786688, metadata !12, metadata !"temp", metadata !5, i32 128, metadata !16, i32 0, metadata !169} ; [ DW_TAG_auto_variable ] [temp] [line 128]
!176 = metadata !{i32 134, i32 0, metadata !138, metadata !169}
!177 = metadata !{i32 135, i32 0, metadata !141, metadata !169}
!178 = metadata !{i32 136, i32 0, metadata !143, metadata !169}
!179 = metadata !{i32 163, i32 0, metadata !29, null}
!180 = metadata !{i32 164, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !1, metadata !29, i32 164, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!182 = metadata !{i32 165, i32 0, metadata !29, null}
!183 = metadata !{i32 166, i32 0, metadata !29, null}
!184 = metadata !{i32 0}
!185 = metadata !{i32 171, i32 0, metadata !186, null}
!186 = metadata !{i32 786443, metadata !1, metadata !34, i32 171, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/quicksort.c]
!187 = metadata !{i32 172, i32 0, metadata !34, null}
