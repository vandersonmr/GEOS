...
.preheader:                                       ; preds = %12, %0
  %indvars.iv5 = phi i64 [ 1, %0 ], [ %indvars.iv.next6, %12 ]
  %.lcssa4 = phi i64 [ %seed.promoted3, %0 ], [ %5, %12 ]
  br label %1, !dbg !144
...
; <label>:1                                       ; preds = %1, %.preheader
  ...
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !22), !dbg !141
  %7 = urem i32 %6, 120, !dbg !146
  %8 = add nsw i32 %7, -60, !dbg !146
  %9 = sitofp i32 %8 to double, !dbg !146
  %10 = fdiv double %9, 3.000000e+00, !dbg !146
  %11 = getelementptr inbounds [41 x double]* %m, i64 %indvars.iv5, i64 %indvars.iv, !dbg !146
  store double %10, double* %11, align 8, !dbg !146, !tbaa !147
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !144
  %exitcond = icmp eq i64 %indvars.iv.next, 41, !dbg !144
  br i1 %exitcond, label %12, label %1, !dbg !144

; <label>:12                                      ; preds = %1
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !138
  %exitcond7 = icmp eq i64 %indvars.iv.next6, 41, !dbg !138
  br i1 %exitcond7, label %13, label %.preheader, !dbg !138
...
define void @rInnerproduct(double* nocapture %result, [41 x double]* nocapture readonly %a, [41 x double]* nocapture readonly %b, i32 %row, i32 %column) #0 {
  tail call void @llvm.dbg.value(metadata !{double* %result}, i64 0, metadata !30), !dbg !150
  tail call void @llvm.dbg.value(metadata !{[41 x double]* %a}, i64 0, metadata !31), !dbg !150
  tail call void @llvm.dbg.value(metadata !{[41 x double]* %b}, i64 0, metadata !32), !dbg !150
  tail call void @llvm.dbg.value(metadata !{i32 %row}, i64 0, metadata !33), !dbg !150
  tail call void @llvm.dbg.value(metadata !{i32 %column}, i64 0, metadata !34), !dbg !150
  store double 0.000000e+00, double* %result, align 8, !dbg !151, !tbaa !147
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !35), !dbg !152
  %1 = sext i32 %row to i64, !dbg !152
  %2 = sext i32 %column to i64, !dbg !152
  br label %3, !dbg !152

; <label>:3                                       ; preds = %3, %0
  %4 = phi double [ 0.000000e+00, %0 ], [ %10, %3 ], !dbg !152
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %3 ]
  %5 = getelementptr inbounds [41 x double]* %a, i64 %1, i64 %indvars.iv, !dbg !152
  %6 = load double* %5, align 8, !dbg !152, !tbaa !147
  %7 = getelementptr inbounds [41 x double]* %b, i64 %indvars.iv, i64 %2, !dbg !152
  %8 = load double* %7, align 8, !dbg !152, !tbaa !147
  %9 = fmul double %6, %8, !dbg !152
  %10 = fadd double %4, %9, !dbg !152
  store double %10, double* %result, align 8, !dbg !152, !tbaa !147
...
define void @Mm(i32 %run) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %run}, i64 0, metadata !40), !dbg !155
...
.preheader.i7:                                    ; preds = %12, %0
  %indvars.iv5.i5 = phi i64 [ 1, %0 ], [ %indvars.iv.next6.i11, %12 ]
  %.lcssa4.i6 = phi i64 [ 74755, %0 ], [ %5, %12 ]
  br label %1, !dbg !164
...
; <label>:1                                       ; preds = %1, %.preheader.i7
  ...
  %9 = sitofp i32 %8 to double, !dbg !169
  %10 = fdiv double %9, 3.000000e+00, !dbg !169
  %11 = getelementptr inbounds [41 x [41 x double]]* @rma, i64 0, i64 %indvars.iv5.i5, i64 %indvars.iv.i8, !dbg !169
  store double %10, double* %11, align 8, !dbg !169, !tbaa !147
  %indvars.iv.next.i9 = add nuw nsw i64 %indvars.iv.i8, 1, !dbg !164
  %exitcond.i10 = icmp eq i64 %indvars.iv.next.i9, 41, !dbg !164
  br i1 %exitcond.i10, label %12, label %1, !dbg !164

; <label>:12                                      ; preds = %1
  %indvars.iv.next6.i11 = add nuw nsw i64 %indvars.iv5.i5, 1, !dbg !163
  %exitcond7.i12 = icmp eq i64 %indvars.iv.next6.i11, 41, !dbg !163
  br i1 %exitcond7.i12, label %rInitmatrix.exit13, label %.preheader.i7, !dbg !163

rInitmatrix.exit13:                               ; preds = %12
...
.preheader.i:                                     ; preds = %24, %rInitmatrix.exit13
  %indvars.iv5.i = phi i64 [ 1, %rInitmatrix.exit13 ], [ %indvars.iv.next6.i, %24 ]
  %.lcssa4.i = phi i64 [ %5, %rInitmatrix.exit13 ], [ %17, %24 ]
  br label %13, !dbg !176

; <label>:13                                      ; preds = %13, %.preheader.i
  %indvars.iv.i1 = phi i64 [ 1, %.preheader.i ], [ %indvars.iv.next.i2, %13 ]
  %14 = phi i64 [ %.lcssa4.i, %.preheader.i ], [ %17, %13 ], !dbg !177
  %15 = mul nsw i64 %14, 1309, !dbg !177
  %16 = add nsw i64 %15, 13849, !dbg !177
  %17 = and i64 %16, 65535, !dbg !177
  %18 = trunc i64 %17 to i32, !dbg !179
  tail call void @llvm.dbg.value(metadata !{i32 %18}, i64 0, metadata !180), !dbg !178
  %19 = urem i32 %18, 120, !dbg !181
  %20 = add nsw i32 %19, -60, !dbg !181
  %21 = sitofp i32 %20 to double, !dbg !181
  %22 = fdiv double %21, 3.000000e+00, !dbg !181
  %23 = getelementptr inbounds [41 x [41 x double]]* @rmb, i64 0, i64 %indvars.iv5.i, i64 %indvars.iv.i1, !dbg !181
  store double %22, double* %23, align 8, !dbg !181, !tbaa !147
  %indvars.iv.next.i2 = add nuw nsw i64 %indvars.iv.i1, 1, !dbg !176
  %exitcond.i3 = icmp eq i64 %indvars.iv.next.i2, 41, !dbg !176
  br i1 %exitcond.i3, label %24, label %13, !dbg !176

; <label>:24                                      ; preds = %13
  %indvars.iv.next6.i = add nuw nsw i64 %indvars.iv5.i, 1, !dbg !175
  %exitcond7.i = icmp eq i64 %indvars.iv.next6.i, 41, !dbg !175
  br i1 %exitcond7.i, label %rInitmatrix.exit, label %.preheader.i, !dbg !175

rInitmatrix.exit:                                 ; preds = %24
  store i64 %17, i64* @seed, align 8, !dbg !177, !tbaa !129
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !41), !dbg !182
  br label %.preheader, !dbg !182

.preheader:                                       ; preds = %35, %rInitmatrix.exit
  %indvars.iv21 = phi i64 [ 1, %rInitmatrix.exit ], [ %indvars.iv.next22, %35 ]
  br label %25, !dbg !184

; <label>:25                                      ; preds = %rInnerproduct.exit, %.preheader
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %rInnerproduct.exit ]
  %26 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %indvars.iv21, i64 %indvars.iv, !dbg !186
  tail call void @llvm.dbg.value(metadata !{double* %26}, i64 0, metadata !187), !dbg !188
  ...
  store double 0.000000e+00, double* %26, align 8, !dbg !194, !tbaa !147
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !195), !dbg !196
  br label %27, !dbg !196

; <label>:27                                      ; preds = %27, %25
  %28 = phi double [ 0.000000e+00, %25 ], [ %34, %27 ], !dbg !196
  %indvars.iv.i = phi i64 [ 1, %25 ], [ %indvars.iv.next.i, %27 ]
  %29 = getelementptr inbounds [41 x [41 x double]]* @rma, i64 0, i64 %indvars.iv21, i64 %indvars.iv.i, !dbg !196
  %30 = load double* %29, align 8, !dbg !196, !tbaa !147
  %31 = getelementptr inbounds [41 x [41 x double]]* @rmb, i64 0, i64 %indvars.iv.i, i64 %indvars.iv, !dbg !196
  %32 = load double* %31, align 8, !dbg !196, !tbaa !147
  %33 = fmul double %30, %32, !dbg !196
  %34 = fadd double %28, %33, !dbg !196
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !196
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 41, !dbg !196
  br i1 %exitcond.i, label %rInnerproduct.exit, label %27, !dbg !196

rInnerproduct.exit:                               ; preds = %27
  store double %34, double* %26, align 8, !dbg !196, !tbaa !147
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !184
  %exitcond = icmp eq i64 %indvars.iv.next, 41, !dbg !184
  br i1 %exitcond, label %35, label %25, !dbg !184

; <label>:35                                      ; preds = %rInnerproduct.exit
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1, !dbg !182
  %exitcond23 = icmp eq i64 %indvars.iv.next22, 41, !dbg !182
  br i1 %exitcond23, label %36, label %.preheader, !dbg !182

; <label>:36                                      ; preds = %35
  %37 = add nsw i32 %run, 1, !dbg !197
  %38 = sext i32 %37 to i64, !dbg !197
  %39 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %38, i64 %38, !dbg !197
  %40 = load double* %39, align 8, !dbg !197, !tbaa !147
  %41 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), double %40) #3, !dbg !197
  ret void, !dbg !198
}
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !199, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 0), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 1), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 2), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 3), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 4), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 5), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 6), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 7), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 8), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  tail call void @Mm(i32 9), !dbg !200
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !45), !dbg !200
  ret i32 0, !dbg !202
}
...
!140 = metadata !{i32 122, i32 0, metadata !8, metadata !141}
!141 = metadata !{i32 133, i32 0, metadata !142, null}
!142 = metadata !{i32 786443, metadata !1, metadata !143, i32 132, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!143 = metadata !{i32 786443, metadata !1, metadata !139, i32 132, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!144 = metadata !{i32 132, i32 0, metadata !143, null}
!145 = metadata !{i32 123, i32 0, metadata !8, metadata !141}
!146 = metadata !{i32 134, i32 0, metadata !142, null}
!147 = metadata !{metadata !148, metadata !148, i64 0}
!148 = metadata !{metadata !"double", metadata !131, i64 0}
!149 = metadata !{i32 136, i32 0, metadata !12, null}
!150 = metadata !{i32 138, i32 0, metadata !25, null}
!151 = metadata !{i32 141, i32 0, metadata !25, null}
!152 = metadata !{i32 142, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !1, metadata !25, i32 142, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!154 = metadata !{i32 143, i32 0, metadata !25, null}
!155 = metadata !{i32 145, i32 0, metadata !36, null}
!156 = metadata !{i32 118, i32 0, metadata !4, metadata !157}
!157 = metadata !{i32 147, i32 0, metadata !36, null}
!158 = metadata !{null}
!159 = metadata !{i32 786689, metadata !12, metadata !"m", metadata !5, i32 16777345, metadata !15, i32 0, metadata !160} ; [ DW_TAG_arg_variable ] [m] [line 129]
!160 = metadata !{i32 148, i32 0, metadata !36, null}
!161 = metadata !{i32 129, i32 0, metadata !12, metadata !160}
!162 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 130, metadata !11, i32 0, metadata !160} ; [ DW_TAG_auto_variable ] [i] [line 130]
!163 = metadata !{i32 131, i32 0, metadata !139, metadata !160}
!164 = metadata !{i32 132, i32 0, metadata !143, metadata !160}
!165 = metadata !{i32 122, i32 0, metadata !8, metadata !166}
!166 = metadata !{i32 133, i32 0, metadata !142, metadata !160}
!167 = metadata !{i32 123, i32 0, metadata !8, metadata !166}
!168 = metadata !{i32 786688, metadata !12, metadata !"temp", metadata !5, i32 130, metadata !11, i32 0, metadata !160} ; [ DW_TAG_auto_variable ] [temp] [line 130]
!169 = metadata !{i32 134, i32 0, metadata !142, metadata !160}
!170 = metadata !{null}
!171 = metadata !{i32 786689, metadata !12, metadata !"m", metadata !5, i32 16777345, metadata !15, i32 0, metadata !172} ; [ DW_TAG_arg_variable ] [m] [line 129]
!172 = metadata !{i32 149, i32 0, metadata !36, null}
!173 = metadata !{i32 129, i32 0, metadata !12, metadata !172}
!174 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 130, metadata !11, i32 0, metadata !172} ; [ DW_TAG_auto_variable ] [i] [line 130]
!175 = metadata !{i32 131, i32 0, metadata !139, metadata !172}
!176 = metadata !{i32 132, i32 0, metadata !143, metadata !172}
!177 = metadata !{i32 122, i32 0, metadata !8, metadata !178}
!178 = metadata !{i32 133, i32 0, metadata !142, metadata !172}
!179 = metadata !{i32 123, i32 0, metadata !8, metadata !178}
!180 = metadata !{i32 786688, metadata !12, metadata !"temp", metadata !5, i32 130, metadata !11, i32 0, metadata !172} ; [ DW_TAG_auto_variable ] [temp] [line 130]
!181 = metadata !{i32 134, i32 0, metadata !142, metadata !172}
!182 = metadata !{i32 150, i32 0, metadata !183, null}
!183 = metadata !{i32 786443, metadata !1, metadata !36, i32 150, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!184 = metadata !{i32 151, i32 0, metadata !185, null}
!185 = metadata !{i32 786443, metadata !1, metadata !183, i32 151, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!186 = metadata !{i32 152, i32 0, metadata !185, null}
!187 = metadata !{i32 786689, metadata !25, metadata !"result", metadata !5, i32 16777354, metadata !28, i32 0, metadata !186} ; [ DW_TAG_arg_variable ] [result] [line 138]
!188 = metadata !{i32 138, i32 0, metadata !25, metadata !186}
!189 = metadata !{i32 786689, metadata !25, metadata !"a", metadata !5, i32 33554570, metadata !15, i32 0, metadata !186} ; [ DW_TAG_arg_variable ] [a] [line 138]
!190 = metadata !{i32 786689, metadata !25, metadata !"b", metadata !5, i32 50331786, metadata !15, i32 0, metadata !186} ; [ DW_TAG_arg_variable ] [b] [line 138]
!191 = metadata !{i32 undef}
!192 = metadata !{i32 786689, metadata !25, metadata !"row", metadata !5, i32 67109002, metadata !11, i32 0, metadata !186} ; [ DW_TAG_arg_variable ] [row] [line 138]
!193 = metadata !{i32 786689, metadata !25, metadata !"column", metadata !5, i32 83886218, metadata !11, i32 0, metadata !186} ; [ DW_TAG_arg_variable ] [column] [line 138]
!194 = metadata !{i32 141, i32 0, metadata !25, metadata !186}
!195 = metadata !{i32 786688, metadata !25, metadata !"i", metadata !5, i32 140, metadata !11, i32 0, metadata !186} ; [ DW_TAG_auto_variable ] [i] [line 140]
!196 = metadata !{i32 142, i32 0, metadata !153, metadata !186}
!197 = metadata !{i32 153, i32 0, metadata !36, null}
!198 = metadata !{i32 154, i32 0, metadata !36, null}
!199 = metadata !{i32 0}
!200 = metadata !{i32 159, i32 0, metadata !201, null}
!201 = metadata !{i32 786443, metadata !1, metadata !43, i32 159, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!202 = metadata !{i32 160, i32 0, metadata !43, null}
