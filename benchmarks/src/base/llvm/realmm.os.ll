...
define void @Mm(i32 %run) #0 {
  ...
  tail call void @rInitmatrix([41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rma, i64 0, i64 0)) #3, !dbg !158
  tail call void @rInitmatrix([41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rmb, i64 0, i64 0)) #3, !dbg !159
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !41), !dbg !160
  br label %.preheader, !dbg !160

.preheader:                                       ; preds = %11, %0
  %indvars.iv4 = phi i64 [ 1, %0 ], [ %indvars.iv.next5, %11 ]
  br label %1, !dbg !162

; <label>:1                                       ; preds = %rInnerproduct.exit, %.preheader
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %rInnerproduct.exit ]
  %2 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %indvars.iv4, i64 %indvars.iv, !dbg !164
  tail call void @llvm.dbg.value(metadata !{double* %2}, i64 0, metadata !165), !dbg !166
  tail call void @llvm.dbg.value(metadata !167, i64 0, metadata !168), !dbg !166
  tail call void @llvm.dbg.value(metadata !169, i64 0, metadata !170), !dbg !166
  tail call void @llvm.dbg.value(metadata !171, i64 0, metadata !172), !dbg !166
  tail call void @llvm.dbg.value(metadata !171, i64 0, metadata !173), !dbg !166
  store double 0.000000e+00, double* %2, align 8, !dbg !174, !tbaa !147
  tail call void @llvm.dbg.value(metadata !137, i64 0, metadata !175), !dbg !176
  br label %3, !dbg !176

; <label>:3                                       ; preds = %3, %1
  %4 = phi double [ 0.000000e+00, %1 ], [ %10, %3 ], !dbg !176
  %indvars.iv.i = phi i64 [ 1, %1 ], [ %indvars.iv.next.i, %3 ]
  %5 = getelementptr inbounds [41 x [41 x double]]* @rma, i64 0, i64 %indvars.iv4, i64 %indvars.iv.i, !dbg !176
  %6 = load double* %5, align 8, !dbg !176, !tbaa !147
  %7 = getelementptr inbounds [41 x [41 x double]]* @rmb, i64 0, i64 %indvars.iv.i, i64 %indvars.iv, !dbg !176
  %8 = load double* %7, align 8, !dbg !176, !tbaa !147
  %9 = fmul double %6, %8, !dbg !176
  %10 = fadd double %4, %9, !dbg !176
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !176
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 41, !dbg !176
  br i1 %exitcond.i, label %rInnerproduct.exit, label %3, !dbg !176

rInnerproduct.exit:                               ; preds = %3
  store double %10, double* %2, align 8, !dbg !176, !tbaa !147
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !162
  %exitcond = icmp eq i64 %indvars.iv.next, 41, !dbg !162
  br i1 %exitcond, label %11, label %1, !dbg !162

; <label>:11                                      ; preds = %rInnerproduct.exit
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1, !dbg !160
  %exitcond6 = icmp eq i64 %indvars.iv.next5, 41, !dbg !160
  br i1 %exitcond6, label %12, label %.preheader, !dbg !160

; <label>:12                                      ; preds = %11
  %13 = add nsw i32 %run, 1, !dbg !177
  %14 = sext i32 %13 to i64, !dbg !177
  %15 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %14, i64 %14, !dbg !177
  %16 = load double* %15, align 8, !dbg !177, !tbaa !147
  %17 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), double %16) #4, !dbg !177
  ret void, !dbg !178
}
...
; Function Attrs: nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !179, i64 0, metadata !45), !dbg !180
  br label %1, !dbg !180

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Mm(i32 %i.01) #3, !dbg !180
  %2 = add nsw i32 %i.01, 1, !dbg !180
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !45), !dbg !180
  %exitcond = icmp eq i32 %2, 10, !dbg !180
  br i1 %exitcond, label %3, label %1, !dbg !180
...
!158 = metadata !{i32 148, i32 0, metadata !36, null}
!159 = metadata !{i32 149, i32 0, metadata !36, null}
!160 = metadata !{i32 150, i32 0, metadata !161, null}
!161 = metadata !{i32 786443, metadata !1, metadata !36, i32 150, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!162 = metadata !{i32 151, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !1, metadata !161, i32 151, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!164 = metadata !{i32 152, i32 0, metadata !163, null}
!165 = metadata !{i32 786689, metadata !25, metadata !"result", metadata !5, i32 16777354, metadata !28, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [result] [line 138]
!166 = metadata !{i32 138, i32 0, metadata !25, metadata !164}
!167 = metadata !{[41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rma, i64 0, i64 0)}
!168 = metadata !{i32 786689, metadata !25, metadata !"a", metadata !5, i32 33554570, metadata !15, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [a] [line 138]
!169 = metadata !{[41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rmb, i64 0, i64 0)}
!170 = metadata !{i32 786689, metadata !25, metadata !"b", metadata !5, i32 50331786, metadata !15, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [b] [line 138]
!171 = metadata !{i32 undef}
!172 = metadata !{i32 786689, metadata !25, metadata !"row", metadata !5, i32 67109002, metadata !11, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [row] [line 138]
!173 = metadata !{i32 786689, metadata !25, metadata !"column", metadata !5, i32 83886218, metadata !11, i32 0, metadata !164} ; [ DW_TAG_arg_variable ] [column] [line 138]
!174 = metadata !{i32 141, i32 0, metadata !25, metadata !164}
!175 = metadata !{i32 786688, metadata !25, metadata !"i", metadata !5, i32 140, metadata !11, i32 0, metadata !164} ; [ DW_TAG_auto_variable ] [i] [line 140]
!176 = metadata !{i32 142, i32 0, metadata !153, metadata !164}
!177 = metadata !{i32 153, i32 0, metadata !36, null}
!178 = metadata !{i32 154, i32 0, metadata !36, null}
!179 = metadata !{i32 0}
!180 = metadata !{i32 159, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !1, metadata !43, i32 159, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!182 = metadata !{i32 160, i32 0, metadata !43, null}
