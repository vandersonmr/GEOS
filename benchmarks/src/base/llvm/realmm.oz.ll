...
; <label>:1                                       ; preds = %1, %.preheader
  %indvars.iv = phi i64 [ 1, %.preheader ], [ %indvars.iv.next, %1 ]
  %2 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %indvars.iv3, i64 %indvars.iv, !dbg !164
  %3 = trunc i64 %indvars.iv to i32, !dbg !164
  %4 = trunc i64 %indvars.iv3 to i32, !dbg !164
  tail call void @rInnerproduct(double* %2, [41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rma, i64 0, i64 0), [41 x double]* getelementptr inbounds ([41 x [41 x double]]* @rmb, i64 0, i64 0), i32 %4, i32 %3) #3, !dbg !164
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !162
  %exitcond = icmp eq i64 %indvars.iv.next, 41, !dbg !162
  br i1 %exitcond, label %5, label %1, !dbg !162

; <label>:5                                       ; preds = %1
  %indvars.iv.next4 = add nuw nsw i64 %indvars.iv3, 1, !dbg !160
  %exitcond5 = icmp eq i64 %indvars.iv.next4, 41, !dbg !160
  br i1 %exitcond5, label %6, label %.preheader, !dbg !160

; <label>:6                                       ; preds = %5
  %7 = add nsw i32 %run, 1, !dbg !165
  %8 = sext i32 %7 to i64, !dbg !165
  %9 = getelementptr inbounds [41 x [41 x double]]* @rmr, i64 0, i64 %8, i64 %8, !dbg !165
  %10 = load double* %9, align 8, !dbg !165, !tbaa !147
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), double %10) #4, !dbg !165
  ret void, !dbg !166
}
...
; Function Attrs: minsize nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !167, i64 0, metadata !45), !dbg !168
  br label %1, !dbg !168

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Mm(i32 %i.01) #3, !dbg !168
  %2 = add nsw i32 %i.01, 1, !dbg !168
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !45), !dbg !168
  %exitcond = icmp eq i32 %2, 10, !dbg !168
  br i1 %exitcond, label %3, label %1, !dbg !168
...
!165 = metadata !{i32 153, i32 0, metadata !36, null}
!166 = metadata !{i32 154, i32 0, metadata !36, null}
!167 = metadata !{i32 0}
!168 = metadata !{i32 159, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !43, i32 159, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/realmm.c]
!170 = metadata !{i32 160, i32 0, metadata !43, null}
