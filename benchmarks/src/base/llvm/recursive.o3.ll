...
; <label>:6                                       ; preds = %.lr.ph
  ...
  %8 = tail call i32 @ack(i32 %x.tr1, i32 %7), !dbg !56
...
tailrecurse:                                      ; preds = %0, %tailrecurse
  ...
  %3 = tail call i32 @fib(i32 %2), !dbg !60
...
; <label>:2                                       ; preds = %0
  ...
  %4 = tail call double @fibFP(double %3), !dbg !65
  %5 = fadd double %n, -1.000000e+00, !dbg !65
  %6 = tail call double @fibFP(double %5), !dbg !65
...
tailrecurse:                                      ; preds = %0, %tailrecurse
  ...
  %3 = tail call i32 @tak(i32 %2, i32 %y.tr2, i32 %z.tr3), !dbg !70
  %4 = add nsw i32 %y.tr2, -1, !dbg !70
  %5 = tail call i32 @tak(i32 %4, i32 %z.tr3, i32 %x.tr1), !dbg !70
  %6 = add nsw i32 %z.tr3, -1, !dbg !70
  %7 = tail call i32 @tak(i32 %6, i32 %x.tr1, i32 %y.tr2), !dbg !70
...
tailrecurse:                                      ; preds = %0, %tailrecurse
  ...
  %3 = tail call double @takFP(double %2, double %y.tr2, double %z.tr3), !dbg !76
  %4 = fadd double %y.tr2, -1.000000e+00, !dbg !76
  %5 = tail call double @takFP(double %4, double %z.tr3, double %x.tr1), !dbg !76
  %6 = fadd double %z.tr3, -1.000000e+00, !dbg !76
  %7 = tail call double @takFP(double %6, double %x.tr1, double %y.tr2), !dbg !76
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #1 {
  ...
  %1 = tail call i32 @ack(i32 3, i32 11), !dbg !81
  %2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 11, i32 %1) #4, !dbg !81
  %3 = tail call double @fibFP(double 3.800000e+01), !dbg !82
  %4 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str1, i64 0, i64 0), double 3.800000e+01, double %3) #4, !dbg !82
  %5 = tail call i32 @tak(i32 30, i32 20, i32 10), !dbg !83
  %6 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str2, i64 0, i64 0), i32 30, i32 20, i32 10, i32 %5) #4, !dbg !83
  %7 = tail call i32 @fib(i32 3), !dbg !84
  %8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i32 %7) #4, !dbg !84
  %9 = tail call double @takFP(double 3.000000e+00, double 2.000000e+00, double 1.000000e+00), !dbg !85
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str4, i64 0, i64 0), double %9) #4, !dbg !85
  ret i32 0, !dbg !86
}
