...
; <label>:15                                      ; preds = %.lr.ph, %.lr.ph, %5
  ...
  %16 = load %struct.task** @tcb, align 8, !dbg !207, !tbaa !148
  ...
  %22 = load %struct.task** @tcb, align 8, !dbg !210, !tbaa !148
  %23 = getelementptr inbounds %struct.task* %22, i64 0, i32 7, !dbg !210
  %24 = load i64* %23, align 8, !dbg !210, !tbaa !170
  store i64 %24, i64* @v2, align 8, !dbg !210, !tbaa !208
  %25 = load i32* @tracing, align 4, !dbg !211, !tbaa !192
  %26 = icmp eq i32 %25, 1, !dbg !211
  br i1 %26, label %27, label %31, !dbg !211

; <label>:27                                      ; preds = %15
  %28 = load i64* @taskid, align 8, !dbg !211, !tbaa !208
  %29 = add nsw i64 %28, 48, !dbg !211
  %30 = trunc i64 %29 to i8, !dbg !211
  tail call void @trace(i8 signext %30), !dbg !211
  br label %31, !dbg !211

; <label>:31                                      ; preds = %27, %15
  %32 = load %struct.task** @tcb, align 8, !dbg !213, !tbaa !148
  %33 = getelementptr inbounds %struct.task* %32, i64 0, i32 5, !dbg !213
  %34 = load %struct.task* (%struct.packet*)** %33, align 8, !dbg !213, !tbaa !166
  %35 = tail call %struct.task* %34(%struct.packet* %pkt.0) #3, !dbg !213
  tail call void @llvm.dbg.value(metadata !{%struct.task* %35}, i64 0, metadata !65), !dbg !213
  %36 = load i64* @v1, align 8, !dbg !214, !tbaa !208
  %37 = load %struct.task** @tcb, align 8, !dbg !214, !tbaa !148
  %38 = getelementptr inbounds %struct.task* %37, i64 0, i32 6, !dbg !214
  store i64 %36, i64* %38, align 8, !dbg !214, !tbaa !168
  %39 = load i64* @v2, align 8, !dbg !215, !tbaa !208
  %40 = load %struct.task** @tcb, align 8, !dbg !215, !tbaa !148
  %41 = getelementptr inbounds %struct.task* %40, i64 0, i32 7, !dbg !215
  store i64 %39, i64* %41, align 8, !dbg !215, !tbaa !170
  br label %.backedge, !dbg !216

; <label>:42                                      ; preds = %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph
  %43 = load %struct.task** @tcb, align 8, !dbg !217, !tbaa !148
  %44 = getelementptr inbounds %struct.task* %43, i64 0, i32 0, !dbg !217
  %45 = load %struct.task** %44, align 8, !dbg !217, !tbaa !153
  br label %.backedge, !dbg !218

.backedge:                                        ; preds = %42, %31
  %storemerge = phi %struct.task* [ %45, %42 ], [ %35, %31 ]
...
define %struct.task* @Wait() #0 {
  ...
  %5 = load %struct.task** @tcb, align 8, !dbg !222, !tbaa !148
  ret %struct.task* %5, !dbg !222
}
...
define %struct.task* @holdself() #0 {
  ...
  %7 = load %struct.task** @tcb, align 8, !dbg !225, !tbaa !148
  %8 = getelementptr inbounds %struct.task* %7, i64 0, i32 0, !dbg !225
  %9 = load %struct.task** %8, align 8, !dbg !225, !tbaa !153
  ret %struct.task* %9, !dbg !225
}
...
.thread:                                          ; preds = %0, %2
  %7 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([17 x i8]* @.str2, i64 0, i64 0), i32 %id) #3, !dbg !232
  br label %8, !dbg !232
...
define %struct.task* @release(i32 %id) #0 {
  ...
  %1 = tail call %struct.task* @findtcb(i32 %id), !dbg !236
...
; <label>:14                                      ; preds = %5
  ...
  br i1 %23, label %28, label %26, !dbg !255

; <label>:24                                      ; preds = %5
  %25 = bitcast %struct.packet** %11 to %struct.packet*, !dbg !257
  tail call void @append(%struct.packet* %pkt, %struct.packet* %25), !dbg !257
  br label %26

; <label>:26                                      ; preds = %14, %24
  %27 = load %struct.task** @tcb, align 8, !dbg !259, !tbaa !148
  br label %28, !dbg !259

; <label>:28                                      ; preds = %14, %0, %26
  %.0 = phi %struct.task* [ %27, %26 ], [ null, %0 ], [ %3, %14 ]
  ret %struct.task* %.0, !dbg !260
}

; Function Attrs: nounwind uwtable
define void @append(%struct.packet* %pkt, %struct.packet* nocapture %ptr) #0 {
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %pkt}, i64 0, metadata !110), !dbg !261
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %ptr}, i64 0, metadata !111), !dbg !261
  %1 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 0, !dbg !262
  store %struct.packet* null, %struct.packet** %1, align 8, !dbg !262, !tbaa !180
  br label %2, !dbg !263

; <label>:2                                       ; preds = %2, %0
  %.0 = phi %struct.packet* [ %ptr, %0 ], [ %4, %2 ]
  %3 = getelementptr inbounds %struct.packet* %.0, i64 0, i32 0, !dbg !263
  %4 = load %struct.packet** %3, align 8, !dbg !263, !tbaa !180
  %5 = icmp eq %struct.packet* %4, null, !dbg !263
  br i1 %5, label %6, label %2, !dbg !263

; <label>:6                                       ; preds = %2
  store %struct.packet* %pkt, %struct.packet** %3, align 8, !dbg !264, !tbaa !180
  ret void, !dbg !265
}

; Function Attrs: nounwind uwtable
define %struct.task* @idlefn(%struct.packet* nocapture readnone %pkt) #0 {
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %pkt}, i64 0, metadata !86), !dbg !266
  %1 = load i64* @v2, align 8, !dbg !267, !tbaa !208
  %2 = add nsw i64 %1, -1, !dbg !267
  store i64 %2, i64* @v2, align 8, !dbg !267, !tbaa !208
  %3 = icmp eq i64 %2, 0, !dbg !268
  br i1 %3, label %4, label %6, !dbg !268

; <label>:4                                       ; preds = %0
  %5 = tail call %struct.task* @holdself(), !dbg !268
  br label %17, !dbg !268

; <label>:6                                       ; preds = %0
  %7 = load i64* @v1, align 8, !dbg !270, !tbaa !208
  %8 = and i64 %7, 1, !dbg !270
  %9 = icmp eq i64 %8, 0, !dbg !270
  %10 = lshr i64 %7, 1, !dbg !272
  %11 = and i64 %10, 32767, !dbg !272
  br i1 %9, label %12, label %14, !dbg !270

; <label>:12                                      ; preds = %6
  store i64 %11, i64* @v1, align 8, !dbg !272, !tbaa !208
  %13 = tail call %struct.task* @release(i32 5), !dbg !274
  br label %17, !dbg !274

; <label>:14                                      ; preds = %6
  %15 = xor i64 %11, 53256, !dbg !275
  store i64 %15, i64* @v1, align 8, !dbg !275, !tbaa !208
  %16 = tail call %struct.task* @release(i32 6), !dbg !277
  br label %17, !dbg !277

; <label>:17                                      ; preds = %14, %12, %4
  %.0 = phi %struct.task* [ %5, %4 ], [ %13, %12 ], [ %16, %14 ]
  ret %struct.task* %.0, !dbg !278
}

; Function Attrs: nounwind uwtable
define %struct.task* @workfn(%struct.packet* %pkt) #0 {
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %pkt}, i64 0, metadata !89), !dbg !279
  %1 = icmp eq %struct.packet* %pkt, null, !dbg !280
  br i1 %1, label %2, label %4, !dbg !280

; <label>:2                                       ; preds = %0
  %3 = tail call %struct.task* @Wait(), !dbg !280
  br label %19, !dbg !280

; <label>:4                                       ; preds = %0
  %5 = load i64* @v1, align 8, !dbg !281, !tbaa !208
  %6 = sub nsw i64 7, %5, !dbg !281
  store i64 %6, i64* @v1, align 8, !dbg !281, !tbaa !208
  %7 = trunc i64 %6 to i32, !dbg !282
  %8 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 1, !dbg !282
  store i32 %7, i32* %8, align 4, !dbg !282, !tbaa !183
  %9 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 3, !dbg !283
  store i32 0, i32* %9, align 4, !dbg !283, !tbaa !187
  tail call void @llvm.dbg.value(metadata !175, i64 0, metadata !90), !dbg !284
  br label %10, !dbg !284

; <label>:10                                      ; preds = %10, %4
  %indvars.iv = phi i64 [ 0, %4 ], [ %indvars.iv.next, %10 ]
  %11 = load i64* @v2, align 8, !dbg !286, !tbaa !208
  %12 = add nsw i64 %11, 1, !dbg !286
  %13 = icmp sgt i64 %11, 25, !dbg !288
  %. = select i1 %13, i64 1, i64 %12, !dbg !288
  store i64 %., i64* @v2, align 8, !dbg !288, !tbaa !208
  %14 = getelementptr inbounds [28 x i8]* @alphabet, i64 0, i64 %., !dbg !290
  %15 = load i8* %14, align 1, !dbg !290, !tbaa !291
  %16 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 4, i64 %indvars.iv, !dbg !290
  store i8 %15, i8* %16, align 1, !dbg !290, !tbaa !291
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !284
  %exitcond = icmp eq i64 %indvars.iv.next, 4, !dbg !284
  br i1 %exitcond, label %17, label %10, !dbg !284

; <label>:17                                      ; preds = %10
  %18 = tail call %struct.task* @qpkt(%struct.packet* %pkt), !dbg !292
  br label %19, !dbg !292

; <label>:19                                      ; preds = %17, %2
  %.0 = phi %struct.task* [ %3, %2 ], [ %18, %17 ]
  ret %struct.task* %.0, !dbg !293
}

; Function Attrs: nounwind uwtable
define %struct.task* @handlerfn(%struct.packet* %pkt) #0 {
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %pkt}, i64 0, metadata !95), !dbg !294
  %1 = icmp eq %struct.packet* %pkt, null, !dbg !295
  br i1 %1, label %7, label %2, !dbg !295

; <label>:2                                       ; preds = %0
  %3 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 2, !dbg !295
  %4 = load i32* %3, align 4, !dbg !295, !tbaa !185
  %5 = icmp eq i32 %4, 1001, !dbg !295
  %6 = select i1 %5, %struct.packet* bitcast (i64* @v1 to %struct.packet*), %struct.packet* bitcast (i64* @v2 to %struct.packet*), !dbg !295
  tail call void @append(%struct.packet* %pkt, %struct.packet* %6), !dbg !295
  br label %7, !dbg !295

; <label>:7                                       ; preds = %0, %2
  %8 = load i64* @v1, align 8, !dbg !297, !tbaa !208
  %9 = icmp eq i64 %8, 0, !dbg !297
  br i1 %9, label %35, label %10, !dbg !297

; <label>:10                                      ; preds = %7
  %11 = inttoptr i64 %8 to %struct.packet*, !dbg !298
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %11}, i64 0, metadata !99), !dbg !298
  %12 = getelementptr inbounds %struct.packet* %11, i64 0, i32 3, !dbg !299
  %13 = load i32* %12, align 4, !dbg !299, !tbaa !187
  tail call void @llvm.dbg.value(metadata !{i32 %13}, i64 0, metadata !96), !dbg !299
  %14 = icmp sgt i32 %13, 3, !dbg !300
  br i1 %14, label %15, label %20, !dbg !300

; <label>:15                                      ; preds = %10
  %16 = getelementptr inbounds %struct.packet* %11, i64 0, i32 0, !dbg !302
  %17 = load %struct.packet** %16, align 8, !dbg !302, !tbaa !180
  %18 = ptrtoint %struct.packet* %17 to i64, !dbg !302
  store i64 %18, i64* @v1, align 8, !dbg !302, !tbaa !208
  %19 = tail call %struct.task* @qpkt(%struct.packet* %11), !dbg !304
  br label %37, !dbg !304

; <label>:20                                      ; preds = %10
  %21 = load i64* @v2, align 8, !dbg !305, !tbaa !208
  %22 = icmp eq i64 %21, 0, !dbg !305
  br i1 %22, label %35, label %23, !dbg !305

; <label>:23                                      ; preds = %20
  %24 = inttoptr i64 %21 to %struct.packet*, !dbg !306
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %24}, i64 0, metadata !100), !dbg !306
  %25 = getelementptr inbounds %struct.packet* %24, i64 0, i32 0, !dbg !307
  %26 = load %struct.packet** %25, align 8, !dbg !307, !tbaa !180
  %27 = ptrtoint %struct.packet* %26 to i64, !dbg !307
  store i64 %27, i64* @v2, align 8, !dbg !307, !tbaa !208
  %28 = sext i32 %13 to i64, !dbg !308
  %29 = getelementptr inbounds %struct.packet* %11, i64 0, i32 4, i64 %28, !dbg !308
  %30 = load i8* %29, align 1, !dbg !308, !tbaa !291
  %31 = sext i8 %30 to i32, !dbg !308
  %32 = getelementptr inbounds %struct.packet* %24, i64 0, i32 3, !dbg !308
  store i32 %31, i32* %32, align 4, !dbg !308, !tbaa !187
  %33 = add nsw i32 %13, 1, !dbg !309
  store i32 %33, i32* %12, align 4, !dbg !309, !tbaa !187
  %34 = tail call %struct.task* @qpkt(%struct.packet* %24), !dbg !310
  br label %37, !dbg !310

; <label>:35                                      ; preds = %20, %7
  %36 = tail call %struct.task* @Wait(), !dbg !311
  br label %37, !dbg !311

; <label>:37                                      ; preds = %35, %23, %15
  %.0 = phi %struct.task* [ %19, %15 ], [ %34, %23 ], [ %36, %35 ]
  ret %struct.task* %.0, !dbg !312
}

; Function Attrs: nounwind uwtable
define %struct.task* @devfn(%struct.packet* %pkt) #0 {
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %pkt}, i64 0, metadata !105), !dbg !313
  %1 = icmp eq %struct.packet* %pkt, null, !dbg !314
  br i1 %1, label %2, label %10, !dbg !314

; <label>:2                                       ; preds = %0
  %3 = load i64* @v1, align 8, !dbg !316, !tbaa !208
  %4 = icmp eq i64 %3, 0, !dbg !316
  br i1 %4, label %5, label %7, !dbg !316

; <label>:5                                       ; preds = %2
  %6 = tail call %struct.task* @Wait(), !dbg !316
  br label %20, !dbg !316

; <label>:7                                       ; preds = %2
  %8 = inttoptr i64 %3 to %struct.packet*, !dbg !319
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %8}, i64 0, metadata !105), !dbg !319
  store i64 0, i64* @v1, align 8, !dbg !320, !tbaa !208
  %9 = tail call %struct.task* @qpkt(%struct.packet* %8), !dbg !321
  br label %20, !dbg !321

; <label>:10                                      ; preds = %0
  %11 = ptrtoint %struct.packet* %pkt to i64, !dbg !322
  store i64 %11, i64* @v1, align 8, !dbg !322, !tbaa !208
  %12 = load i32* @tracing, align 4, !dbg !324, !tbaa !192
  %13 = icmp eq i32 %12, 1, !dbg !324
  br i1 %13, label %14, label %18, !dbg !324

; <label>:14                                      ; preds = %10
  %15 = getelementptr inbounds %struct.packet* %pkt, i64 0, i32 3, !dbg !324
  %16 = load i32* %15, align 4, !dbg !324, !tbaa !187
  %17 = trunc i32 %16 to i8, !dbg !324
  tail call void @trace(i8 signext %17), !dbg !324
  br label %18, !dbg !324

; <label>:18                                      ; preds = %14, %10
  %19 = tail call %struct.task* @holdself(), !dbg !326
  br label %20, !dbg !326

; <label>:20                                      ; preds = %18, %7, %5
  %.0 = phi %struct.task* [ %6, %5 ], [ %9, %7 ], [ %19, %18 ]
  ret %struct.task* %.0, !dbg !327
}

; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !200, i64 0, metadata !116), !dbg !328
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([20 x i8]* @str, i64 0, i64 0)), !dbg !329
  tail call void @createtask(i32 1, i32 0, %struct.packet* null, i32 0, %struct.task* (%struct.packet*)* @idlefn, i64 1, i64 10000000), !dbg !330
  %1 = tail call %struct.packet* @pkt(%struct.packet* null, i32 0, i32 1001), !dbg !331
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %1}, i64 0, metadata !116), !dbg !331
  %2 = tail call %struct.packet* @pkt(%struct.packet* %1, i32 0, i32 1001), !dbg !332
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %2}, i64 0, metadata !116), !dbg !332
  tail call void @createtask(i32 2, i32 1000, %struct.packet* %2, i32 3, %struct.task* (%struct.packet*)* @workfn, i64 3, i64 0), !dbg !333
  %3 = tail call %struct.packet* @pkt(%struct.packet* null, i32 5, i32 1000), !dbg !334
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %3}, i64 0, metadata !116), !dbg !334
  %4 = tail call %struct.packet* @pkt(%struct.packet* %3, i32 5, i32 1000), !dbg !335
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %4}, i64 0, metadata !116), !dbg !335
  %5 = tail call %struct.packet* @pkt(%struct.packet* %4, i32 5, i32 1000), !dbg !336
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %5}, i64 0, metadata !116), !dbg !336
  tail call void @createtask(i32 3, i32 2000, %struct.packet* %5, i32 3, %struct.task* (%struct.packet*)* @handlerfn, i64 0, i64 0), !dbg !337
  %6 = tail call %struct.packet* @pkt(%struct.packet* null, i32 6, i32 1000), !dbg !338
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %6}, i64 0, metadata !116), !dbg !338
  %7 = tail call %struct.packet* @pkt(%struct.packet* %6, i32 6, i32 1000), !dbg !339
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %7}, i64 0, metadata !116), !dbg !339
  %8 = tail call %struct.packet* @pkt(%struct.packet* %7, i32 6, i32 1000), !dbg !340
  tail call void @llvm.dbg.value(metadata !{%struct.packet* %8}, i64 0, metadata !116), !dbg !340
  tail call void @createtask(i32 4, i32 3000, %struct.packet* %8, i32 3, %struct.task* (%struct.packet*)* @handlerfn, i64 0, i64 0), !dbg !341
  tail call void @llvm.dbg.value(metadata !200, i64 0, metadata !116), !dbg !342
  tail call void @createtask(i32 5, i32 4000, %struct.packet* null, i32 2, %struct.task* (%struct.packet*)* @devfn, i64 0, i64 0), !dbg !343
  tail call void @createtask(i32 6, i32 5000, %struct.packet* null, i32 2, %struct.task* (%struct.packet*)* @devfn, i64 0, i64 0), !dbg !344
  %9 = load %struct.task** @tasklist, align 8, !dbg !345, !tbaa !148
  store %struct.task* %9, %struct.task** @tcb, align 8, !dbg !345, !tbaa !148
  store i32 0, i32* @holdcount, align 4, !dbg !346, !tbaa !192
  store i32 0, i32* @qpktcount, align 4, !dbg !346, !tbaa !192
  %puts2 = tail call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @str11, i64 0, i64 0)), !dbg !347
  store i32 0, i32* @tracing, align 4, !dbg !348, !tbaa !192
  store i32 0, i32* @layout, align 4, !dbg !349, !tbaa !192
  tail call void @schedule(), !dbg !350
  %puts3 = tail call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @str12, i64 0, i64 0)), !dbg !351
  %10 = load i32* @qpktcount, align 4, !dbg !352, !tbaa !192
  %11 = load i32* @holdcount, align 4, !dbg !352, !tbaa !192
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([33 x i8]* @.str6, i64 0, i64 0), i32 %10, i32 %11) #3, !dbg !352
  %13 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str7, i64 0, i64 0)) #3, !dbg !353
  %14 = load i32* @qpktcount, align 4, !dbg !354, !tbaa !192
  %15 = icmp eq i32 %14, 23263894, !dbg !354
  %16 = load i32* @holdcount, align 4
  %17 = icmp eq i32 %16, 9305557, !dbg !354
  %or.cond = and i1 %15, %17, !dbg !354
  br i1 %or.cond, label %18, label %20, !dbg !354

; <label>:18                                      ; preds = %0
  %19 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) #3, !dbg !356
  tail call void @llvm.dbg.value(metadata !175, i64 0, metadata !117), !dbg !358
  br label %22, !dbg !359

; <label>:20                                      ; preds = %0
  %21 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str9, i64 0, i64 0)) #3, !dbg !360
  tail call void @llvm.dbg.value(metadata !362, i64 0, metadata !117), !dbg !363
  br label %22

; <label>:22                                      ; preds = %20, %18
  %retval.0 = phi i32 [ 0, %18 ], [ 1, %20 ]
  %puts4 = tail call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @str13, i64 0, i64 0)), !dbg !364
...
!259 = metadata !{i32 252, i32 0, metadata !80, null}
!260 = metadata !{i32 253, i32 0, metadata !80, null}
!261 = metadata !{i32 341, i32 0, metadata !106, null}
!262 = metadata !{i32 343, i32 0, metadata !106, null}
!263 = metadata !{i32 345, i32 0, metadata !106, null}
!264 = metadata !{i32 347, i32 0, metadata !106, null}
!265 = metadata !{i32 348, i32 0, metadata !106, null}
!266 = metadata !{i32 255, i32 0, metadata !84, null}
!267 = metadata !{i32 257, i32 0, metadata !84, null}
!268 = metadata !{i32 258, i32 0, metadata !269, null}
!269 = metadata !{i32 786443, metadata !1, metadata !84, i32 258, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!270 = metadata !{i32 260, i32 0, metadata !271, null}
!271 = metadata !{i32 786443, metadata !1, metadata !84, i32 260, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!272 = metadata !{i32 262, i32 0, metadata !273, null}
!273 = metadata !{i32 786443, metadata !1, metadata !271, i32 261, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!274 = metadata !{i32 263, i32 0, metadata !273, null}
!275 = metadata !{i32 267, i32 0, metadata !276, null}
!276 = metadata !{i32 786443, metadata !1, metadata !271, i32 266, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!277 = metadata !{i32 268, i32 0, metadata !276, null}
!278 = metadata !{i32 270, i32 0, metadata !84, null}
!279 = metadata !{i32 272, i32 0, metadata !87, null}
!280 = metadata !{i32 274, i32 0, metadata !92, null}
!281 = metadata !{i32 279, i32 0, metadata !91, null}
!282 = metadata !{i32 280, i32 0, metadata !91, null}
!283 = metadata !{i32 282, i32 0, metadata !91, null}
!284 = metadata !{i32 283, i32 0, metadata !285, null}
!285 = metadata !{i32 786443, metadata !1, metadata !91, i32 283, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!286 = metadata !{i32 285, i32 0, metadata !287, null}
!287 = metadata !{i32 786443, metadata !1, metadata !285, i32 284, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!288 = metadata !{i32 286, i32 0, metadata !289, null}
!289 = metadata !{i32 786443, metadata !1, metadata !287, i32 286, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!290 = metadata !{i32 287, i32 0, metadata !287, null}
!291 = metadata !{metadata !150, metadata !150, i64 0}
!292 = metadata !{i32 289, i32 0, metadata !91, null}
!293 = metadata !{i32 291, i32 0, metadata !87, null}
!294 = metadata !{i32 293, i32 0, metadata !93, null}
!295 = metadata !{i32 295, i32 0, metadata !296, null}
!296 = metadata !{i32 786443, metadata !1, metadata !93, i32 295, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!297 = metadata !{i32 298, i32 0, metadata !98, null}
!298 = metadata !{i32 301, i32 0, metadata !97, null}
!299 = metadata !{i32 302, i32 0, metadata !97, null}
!300 = metadata !{i32 304, i32 0, metadata !301, null}
!301 = metadata !{i32 786443, metadata !1, metadata !97, i32 304, i32 0, i32 27} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!302 = metadata !{i32 306, i32 0, metadata !303, null}
!303 = metadata !{i32 786443, metadata !1, metadata !301, i32 305, i32 0, i32 28} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!304 = metadata !{i32 307, i32 0, metadata !303, null}
!305 = metadata !{i32 310, i32 0, metadata !102, null}
!306 = metadata !{i32 314, i32 0, metadata !101, null}
!307 = metadata !{i32 315, i32 0, metadata !101, null}
!308 = metadata !{i32 316, i32 0, metadata !101, null}
!309 = metadata !{i32 317, i32 0, metadata !101, null}
!310 = metadata !{i32 318, i32 0, metadata !101, null}
!311 = metadata !{i32 321, i32 0, metadata !93, null}
!312 = metadata !{i32 322, i32 0, metadata !93, null}
!313 = metadata !{i32 324, i32 0, metadata !103, null}
!314 = metadata !{i32 326, i32 0, metadata !315, null}
!315 = metadata !{i32 786443, metadata !1, metadata !103, i32 326, i32 0, i32 31} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!316 = metadata !{i32 328, i32 0, metadata !317, null}
!317 = metadata !{i32 786443, metadata !1, metadata !318, i32 328, i32 0, i32 33} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!318 = metadata !{i32 786443, metadata !1, metadata !315, i32 327, i32 0, i32 32} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!319 = metadata !{i32 329, i32 0, metadata !318, null}
!320 = metadata !{i32 330, i32 0, metadata !318, null}
!321 = metadata !{i32 331, i32 0, metadata !318, null}
!322 = metadata !{i32 335, i32 0, metadata !323, null}
!323 = metadata !{i32 786443, metadata !1, metadata !315, i32 334, i32 0, i32 34} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!324 = metadata !{i32 336, i32 0, metadata !325, null}
!325 = metadata !{i32 786443, metadata !1, metadata !323, i32 336, i32 0, i32 35} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!326 = metadata !{i32 337, i32 0, metadata !323, null}
!327 = metadata !{i32 339, i32 0, metadata !103, null}
!328 = metadata !{i32 352, i32 0, metadata !112, null}
!329 = metadata !{i32 355, i32 0, metadata !112, null}
!330 = metadata !{i32 357, i32 0, metadata !112, null}
!331 = metadata !{i32 359, i32 0, metadata !112, null}
!332 = metadata !{i32 360, i32 0, metadata !112, null}
!333 = metadata !{i32 362, i32 0, metadata !112, null}
!334 = metadata !{i32 364, i32 0, metadata !112, null}
!335 = metadata !{i32 365, i32 0, metadata !112, null}
!336 = metadata !{i32 366, i32 0, metadata !112, null}
!337 = metadata !{i32 368, i32 0, metadata !112, null}
!338 = metadata !{i32 370, i32 0, metadata !112, null}
!339 = metadata !{i32 371, i32 0, metadata !112, null}
!340 = metadata !{i32 372, i32 0, metadata !112, null}
!341 = metadata !{i32 374, i32 0, metadata !112, null}
!342 = metadata !{i32 376, i32 0, metadata !112, null}
!343 = metadata !{i32 377, i32 0, metadata !112, null}
!344 = metadata !{i32 378, i32 0, metadata !112, null}
!345 = metadata !{i32 380, i32 0, metadata !112, null}
!346 = metadata !{i32 382, i32 0, metadata !112, null}
!347 = metadata !{i32 384, i32 0, metadata !112, null}
!348 = metadata !{i32 386, i32 0, metadata !112, null}
!349 = metadata !{i32 387, i32 0, metadata !112, null}
!350 = metadata !{i32 389, i32 0, metadata !112, null}
!351 = metadata !{i32 391, i32 0, metadata !112, null}
!352 = metadata !{i32 393, i32 0, metadata !112, null}
!353 = metadata !{i32 396, i32 0, metadata !112, null}
!354 = metadata !{i32 397, i32 0, metadata !355, null}
!355 = metadata !{i32 786443, metadata !1, metadata !112, i32 397, i32 0, i32 36} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!356 = metadata !{i32 398, i32 0, metadata !357, null}
!357 = metadata !{i32 786443, metadata !1, metadata !355, i32 397, i32 0, i32 37} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!358 = metadata !{i32 399, i32 0, metadata !357, null}
!359 = metadata !{i32 400, i32 0, metadata !357, null}
!360 = metadata !{i32 401, i32 0, metadata !361, null}
!361 = metadata !{i32 786443, metadata !1, metadata !355, i32 400, i32 0, i32 38} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/richards_benchmark.c]
!362 = metadata !{i32 1}
!363 = metadata !{i32 402, i32 0, metadata !361, null}
!364 = metadata !{i32 405, i32 0, metadata !112, null}
!365 = metadata !{i32 406, i32 0, metadata !112, null}
