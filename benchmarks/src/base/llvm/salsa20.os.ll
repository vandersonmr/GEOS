...
; <label>:3                                       ; preds = %0
  tail call void @salsa20(i32* getelementptr inbounds ([16 x i32]* @outbuf, i64 0, i64 0), i32* getelementptr inbounds ([16 x i32]* @STATE, i64 0, i64 0)) #4, !dbg !73
...
.preheader:                                       ; preds = %vector.body, %.preheader
  %i.1 = phi i32 [ %9, %.preheader ], [ 0, %vector.body ]
  %8 = tail call i32 @salsa() #4, !dbg !88
  %9 = add i32 %i.1, 1, !dbg !90
  tail call void @llvm.dbg.value(metadata !{i32 %9}, i64 0, metadata !29), !dbg !90
  %exitcond = icmp eq i32 %9, 537919489, !dbg !90
  br i1 %exitcond, label %10, label %.preheader, !dbg !90

; <label>:10                                      ; preds = %.preheader
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !28), !dbg !91
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !28), !dbg !92
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %8) #5, !dbg !93
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i32 -162172867) #5, !dbg !94
  %13 = icmp ne i32 %8, -162172867, !dbg !95
...
!89 = metadata !{i32 786443, metadata !1, metadata !23, i32 65, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/salsa20.c]
!90 = metadata !{i32 65, i32 0, metadata !89, null}
!91 = metadata !{i32 68, i32 0, metadata !23, null}
!92 = metadata !{i32 69, i32 0, metadata !23, null}
!93 = metadata !{i32 71, i32 0, metadata !23, null}
!94 = metadata !{i32 72, i32 0, metadata !23, null}
!95 = metadata !{i32 73, i32 0, metadata !23, null}
