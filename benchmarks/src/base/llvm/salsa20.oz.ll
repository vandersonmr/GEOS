...
; <label>:1                                       ; preds = %1, %0
  ...
  store i32 %5, i32* %6, align 4, !dbg !84, !tbaa !56
...
.preheader:                                       ; preds = %1, %.preheader
  ...
  %8 = tail call i32 @salsa() #4, !dbg !85
...
; <label>:10                                      ; preds = %.preheader
  ...
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %8) #5, !dbg !90
  %12 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i32 -162172867) #5, !dbg !91
