...
define void @Error(i8* %emsg) #0 {
  ...
  %1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8* %emsg) #4, !dbg !158
  ret void, !dbg !159
}
...
; <label>:7                                       ; preds = %0
  ...
  %8 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([16 x i8]* @.str1, i64 0, i64 0)) #4, !dbg !179
  br label %9
...
.critedge:                                        ; preds = %5
  ...
  %10 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([16 x i8]* @.str2, i64 0, i64 0)) #4, !dbg !195
  br label %17

; <label>:11                                      ; preds = %0, %5
  %12 = tail call i32 @Getelement() #5, !dbg !196
  tail call void @llvm.dbg.value(metadata !{i32 %12}, i64 0, metadata !34), !dbg !196
  %13 = load i32* %2, align 4, !dbg !199, !tbaa !162
  %14 = sext i32 %12 to i64, !dbg !199
  %15 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %14, i32 1, !dbg !199
  store i32 %13, i32* %15, align 4, !dbg !199, !tbaa !172
  store i32 %12, i32* %2, align 4, !dbg !200, !tbaa !162
  %16 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %14, i32 0, !dbg !201
  store i32 %i, i32* %16, align 8, !dbg !201, !tbaa !187
  br label %17, !dbg !202

; <label>:17                                      ; preds = %.critedge, %11
  ret void, !dbg !203
}

; Function Attrs: nounwind optsize uwtable
define void @Init(i32 %s, i32 %n) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %s}, i64 0, metadata !37), !dbg !204
  tail call void @llvm.dbg.value(metadata !{i32 %n}, i64 0, metadata !38), !dbg !204
  tail call void @llvm.dbg.value(metadata !{i32 %s}, i64 0, metadata !205), !dbg !207
  %1 = sext i32 %s to i64, !dbg !208
  %2 = getelementptr inbounds [4 x i32]* @stack, i64 0, i64 %1, !dbg !208
  store i32 0, i32* %2, align 4, !dbg !208, !tbaa !162
  tail call void @llvm.dbg.value(metadata !{i32 %n}, i64 0, metadata !39), !dbg !209
  %3 = icmp sgt i32 %n, 0, !dbg !209
  br i1 %3, label %.lr.ph, label %._crit_edge, !dbg !209

.lr.ph:                                           ; preds = %0, %.lr.ph
  %discctr.01 = phi i32 [ %4, %.lr.ph ], [ %n, %0 ]
  tail call void @Push(i32 %discctr.01, i32 %s) #5, !dbg !211
  %4 = add nsw i32 %discctr.01, -1, !dbg !209
  tail call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !39), !dbg !209
  %5 = icmp sgt i32 %4, 0, !dbg !209
  br i1 %5, label %.lr.ph, label %._crit_edge, !dbg !209
...
define i32 @Pop(i32 %s) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %s}, i64 0, metadata !44), !dbg !213
  %1 = sext i32 %s to i64, !dbg !214
  %2 = getelementptr inbounds [4 x i32]* @stack, i64 0, i64 %1, !dbg !214
  %3 = load i32* %2, align 4, !dbg !214, !tbaa !162
  %4 = icmp sgt i32 %3, 0, !dbg !214
  br i1 %4, label %5, label %12, !dbg !214

; <label>:5                                       ; preds = %0
  %6 = sext i32 %3 to i64, !dbg !216
  %7 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %6, i32 0, !dbg !216
  %8 = load i32* %7, align 8, !dbg !216, !tbaa !187
  tail call void @llvm.dbg.value(metadata !{i32 %8}, i64 0, metadata !46), !dbg !216
  %9 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %6, i32 1, !dbg !218
  %10 = load i32* %9, align 4, !dbg !218, !tbaa !172
  tail call void @llvm.dbg.value(metadata !{i32 %10}, i64 0, metadata !45), !dbg !218
  %11 = load i32* @freelist, align 4, !dbg !219, !tbaa !162
  store i32 %11, i32* %9, align 4, !dbg !219, !tbaa !172
  store i32 %3, i32* @freelist, align 4, !dbg !220, !tbaa !162
  store i32 %10, i32* %2, align 4, !dbg !221, !tbaa !162
  br label %14, !dbg !222

; <label>:12                                      ; preds = %0
  tail call void @llvm.dbg.value(metadata !223, i64 0, metadata !224) #3, !dbg !226
  %13 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([16 x i8]* @.str3, i64 0, i64 0)) #4, !dbg !227
  br label %14, !dbg !228
...
define void @Move(i32 %s1, i32 %s2) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %s1}, i64 0, metadata !49), !dbg !230
  tail call void @llvm.dbg.value(metadata !{i32 %s2}, i64 0, metadata !50), !dbg !230
  %1 = tail call i32 @Pop(i32 %s1) #5, !dbg !231
  tail call void @Push(i32 %1, i32 %s2) #5, !dbg !231
  %2 = load i32* @movesdone, align 4, !dbg !232, !tbaa !162
  %3 = add nsw i32 %2, 1, !dbg !232
  store i32 %3, i32* @movesdone, align 4, !dbg !232, !tbaa !162
  ret void, !dbg !233
}

; Function Attrs: nounwind optsize uwtable
define void @tower(i32 %i, i32 %j, i32 %k) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %i.tr.lcssa}, i64 0, metadata !55), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !56), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !57), !dbg !234
  %1 = icmp eq i32 %k, 1, !dbg !235
  br i1 %1, label %tailrecurse._crit_edge, label %tailrecurse, !dbg !235

tailrecurse._crit_edge:                           ; preds = %tailrecurse, %0
  %i.tr.lcssa = phi i32 [ %i, %0 ], [ %6, %tailrecurse ]
  tail call void @llvm.dbg.value(metadata !{i32 %i.tr.lcssa}, i64 0, metadata !237) #3, !dbg !238
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !239) #3, !dbg !238
  %2 = tail call i32 @Pop(i32 %i.tr.lcssa) #4, !dbg !240
  tail call void @Push(i32 %2, i32 %j) #4, !dbg !240
  %3 = load i32* @movesdone, align 4, !dbg !241, !tbaa !162
  %4 = add nsw i32 %3, 1, !dbg !241
  store i32 %4, i32* @movesdone, align 4, !dbg !241, !tbaa !162
  ret void, !dbg !242

tailrecurse:                                      ; preds = %0, %tailrecurse
  %k.tr2 = phi i32 [ %7, %tailrecurse ], [ %k, %0 ]
  %i.tr1 = phi i32 [ %6, %tailrecurse ], [ %i, %0 ]
  %5 = sub nsw i32 6, %i.tr1, !dbg !243
  %6 = sub i32 %5, %j, !dbg !243
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !58), !dbg !243
  %7 = add nsw i32 %k.tr2, -1, !dbg !245
  tail call void @tower(i32 %i.tr1, i32 %6, i32 %7) #5, !dbg !245
  tail call void @llvm.dbg.value(metadata !{i32 %i.tr.lcssa}, i64 0, metadata !246) #3, !dbg !248
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !249) #3, !dbg !248
  %8 = tail call i32 @Pop(i32 %i.tr1) #4, !dbg !250
  tail call void @Push(i32 %8, i32 %j) #4, !dbg !250
  %9 = load i32* @movesdone, align 4, !dbg !251, !tbaa !162
  %10 = add nsw i32 %9, 1, !dbg !251
  store i32 %10, i32* @movesdone, align 4, !dbg !251, !tbaa !162
  tail call void @llvm.dbg.value(metadata !{i32 %i.tr.lcssa}, i64 0, metadata !55), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !56), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %k.tr2}, i64 0, metadata !57), !dbg !234
  %11 = icmp eq i32 %7, 1, !dbg !235
  br i1 %11, label %tailrecurse._crit_edge, label %tailrecurse, !dbg !235
}

; Function Attrs: nounwind optsize uwtable
define void @Towers() #0 {
  tail call void @llvm.dbg.value(metadata !188, i64 0, metadata !61), !dbg !252
  br label %1, !dbg !252

; <label>:1                                       ; preds = %1, %0
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %1 ]
  %2 = add nsw i64 %indvars.iv, 4294967295, !dbg !252
  %3 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %indvars.iv, i32 1, !dbg !252
  %4 = trunc i64 %2 to i32, !dbg !252
  store i32 %4, i32* %3, align 4, !dbg !252, !tbaa !172
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !252
  %exitcond = icmp eq i64 %indvars.iv.next, 19, !dbg !252
  br i1 %exitcond, label %5, label %1, !dbg !252

; <label>:5                                       ; preds = %1
  store i32 18, i32* @freelist, align 4, !dbg !254, !tbaa !162
  tail call void @llvm.dbg.value(metadata !188, i64 0, metadata !255) #3, !dbg !257
  tail call void @llvm.dbg.value(metadata !258, i64 0, metadata !259) #3, !dbg !257
  tail call void @llvm.dbg.value(metadata !188, i64 0, metadata !260) #3, !dbg !262
  store i32 0, i32* getelementptr inbounds ([4 x i32]* @stack, i64 0, i64 1), align 4, !dbg !263, !tbaa !162
  tail call void @llvm.dbg.value(metadata !258, i64 0, metadata !264) #3, !dbg !265
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i, %5
  %discctr.01.i = phi i32 [ %6, %.lr.ph.i ], [ 14, %5 ]
  tail call void @Push(i32 %discctr.01.i, i32 1) #4, !dbg !266
  %6 = add nsw i32 %discctr.01.i, -1, !dbg !265
  tail call void @llvm.dbg.value(metadata !{i32 %6}, i64 0, metadata !264) #3, !dbg !265
  %7 = icmp sgt i32 %6, 0, !dbg !265
  br i1 %7, label %.lr.ph.i, label %Init.exit, !dbg !265

Init.exit:                                        ; preds = %.lr.ph.i
  tail call void @llvm.dbg.value(metadata !267, i64 0, metadata !268), !dbg !270
  store i32 0, i32* getelementptr inbounds ([4 x i32]* @stack, i64 0, i64 2), align 8, !dbg !271, !tbaa !162
  tail call void @llvm.dbg.value(metadata !272, i64 0, metadata !273), !dbg !275
  store i32 0, i32* getelementptr inbounds ([4 x i32]* @stack, i64 0, i64 3), align 4, !dbg !276, !tbaa !162
  store i32 0, i32* @movesdone, align 4, !dbg !277, !tbaa !162
  tail call void @tower(i32 1, i32 2, i32 14) #5, !dbg !278
  %8 = load i32* @movesdone, align 4, !dbg !279, !tbaa !162
  %9 = icmp eq i32 %8, 16383, !dbg !279
  br i1 %9, label %11, label %10, !dbg !279

; <label>:10                                      ; preds = %Init.exit
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)), !dbg !279
  %.pre = load i32* @movesdone, align 4, !dbg !281, !tbaa !162
  br label %11, !dbg !279

; <label>:11                                      ; preds = %Init.exit, %10
  %12 = phi i32 [ 16383, %Init.exit ], [ %.pre, %10 ]
  %13 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0), i32 %12) #4, !dbg !281
  ret void, !dbg !282
}

; Function Attrs: nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !165, i64 0, metadata !64), !dbg !283
  br label %1, !dbg !283

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Towers() #5, !dbg !283
  %2 = add nsw i32 %i.01, 1, !dbg !283
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !64), !dbg !283
  %exitcond = icmp eq i32 %2, 100, !dbg !283
  br i1 %exitcond, label %3, label %1, !dbg !283
...
!196 = metadata !{i32 155, i32 0, metadata !197, null}
!197 = metadata !{i32 786443, metadata !1, metadata !198, i32 154, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!198 = metadata !{i32 786443, metadata !1, metadata !27, i32 154, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!199 = metadata !{i32 156, i32 0, metadata !197, null}
!200 = metadata !{i32 157, i32 0, metadata !197, null}
!201 = metadata !{i32 158, i32 0, metadata !197, null}
!202 = metadata !{i32 159, i32 0, metadata !197, null}
!203 = metadata !{i32 160, i32 0, metadata !27, null}
!204 = metadata !{i32 162, i32 0, metadata !35, null}
!205 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !206} ; [ DW_TAG_arg_variable ] [s] [line 131]
!206 = metadata !{i32 164, i32 0, metadata !35, null}
!207 = metadata !{i32 131, i32 0, metadata !19, metadata !206}
!208 = metadata !{i32 132, i32 0, metadata !19, metadata !206}
!209 = metadata !{i32 165, i32 0, metadata !210, null}
!210 = metadata !{i32 786443, metadata !1, metadata !35, i32 165, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!211 = metadata !{i32 166, i32 0, metadata !210, null}
!212 = metadata !{i32 167, i32 0, metadata !35, null}
!213 = metadata !{i32 169, i32 0, metadata !40, null}
!214 = metadata !{i32 171, i32 0, metadata !215, null}
!215 = metadata !{i32 786443, metadata !1, metadata !40, i32 171, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!216 = metadata !{i32 172, i32 0, metadata !217, null}
!217 = metadata !{i32 786443, metadata !1, metadata !215, i32 171, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!218 = metadata !{i32 173, i32 0, metadata !217, null}
!219 = metadata !{i32 174, i32 0, metadata !217, null}
!220 = metadata !{i32 175, i32 0, metadata !217, null}
!221 = metadata !{i32 176, i32 0, metadata !217, null}
!222 = metadata !{i32 177, i32 0, metadata !217, null}
!223 = metadata !{i8* getelementptr inbounds ([16 x i8]* @.str3, i64 0, i64 0)}
!224 = metadata !{i32 786689, metadata !12, metadata !"emsg", metadata !5, i32 16777343, metadata !15, i32 0, metadata !225} ; [ DW_TAG_arg_variable ] [emsg] [line 127]
!225 = metadata !{i32 180, i32 0, metadata !215, null}
!226 = metadata !{i32 127, i32 0, metadata !12, metadata !225}
!227 = metadata !{i32 128, i32 0, metadata !12, metadata !225}
!228 = metadata !{i32 181, i32 0, metadata !40, null}
!229 = metadata !{i32 182, i32 0, metadata !40, null}
!230 = metadata !{i32 184, i32 0, metadata !47, null}
!231 = metadata !{i32 185, i32 0, metadata !47, null}
!232 = metadata !{i32 186, i32 0, metadata !47, null}
!233 = metadata !{i32 187, i32 0, metadata !47, null}
!234 = metadata !{i32 189, i32 0, metadata !51, null}
!235 = metadata !{i32 191, i32 0, metadata !236, null}
!236 = metadata !{i32 786443, metadata !1, metadata !51, i32 191, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!237 = metadata !{i32 786689, metadata !47, metadata !"s1", metadata !5, i32 16777400, metadata !11, i32 0, metadata !235} ; [ DW_TAG_arg_variable ] [s1] [line 184]
!238 = metadata !{i32 184, i32 0, metadata !47, metadata !235}
!239 = metadata !{i32 786689, metadata !47, metadata !"s2", metadata !5, i32 33554616, metadata !11, i32 0, metadata !235} ; [ DW_TAG_arg_variable ] [s2] [line 184]
!240 = metadata !{i32 185, i32 0, metadata !47, metadata !235}
!241 = metadata !{i32 186, i32 0, metadata !47, metadata !235}
!242 = metadata !{i32 198, i32 0, metadata !51, null}
!243 = metadata !{i32 193, i32 0, metadata !244, null}
!244 = metadata !{i32 786443, metadata !1, metadata !236, i32 192, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!245 = metadata !{i32 194, i32 0, metadata !244, null}
!246 = metadata !{i32 786689, metadata !47, metadata !"s1", metadata !5, i32 16777400, metadata !11, i32 0, metadata !247} ; [ DW_TAG_arg_variable ] [s1] [line 184]
!247 = metadata !{i32 195, i32 0, metadata !244, null}
!248 = metadata !{i32 184, i32 0, metadata !47, metadata !247}
!249 = metadata !{i32 786689, metadata !47, metadata !"s2", metadata !5, i32 33554616, metadata !11, i32 0, metadata !247} ; [ DW_TAG_arg_variable ] [s2] [line 184]
!250 = metadata !{i32 185, i32 0, metadata !47, metadata !247}
!251 = metadata !{i32 186, i32 0, metadata !47, metadata !247}
!252 = metadata !{i32 202, i32 0, metadata !253, null}
!253 = metadata !{i32 786443, metadata !1, metadata !59, i32 202, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!254 = metadata !{i32 203, i32 0, metadata !59, null}
!255 = metadata !{i32 786689, metadata !35, metadata !"s", metadata !5, i32 16777378, metadata !11, i32 0, metadata !256} ; [ DW_TAG_arg_variable ] [s] [line 162]
!256 = metadata !{i32 204, i32 0, metadata !59, null}
!257 = metadata !{i32 162, i32 0, metadata !35, metadata !256}
!258 = metadata !{i32 14}
!259 = metadata !{i32 786689, metadata !35, metadata !"n", metadata !5, i32 33554594, metadata !11, i32 0, metadata !256} ; [ DW_TAG_arg_variable ] [n] [line 162]
!260 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !261} ; [ DW_TAG_arg_variable ] [s] [line 131]
!261 = metadata !{i32 164, i32 0, metadata !35, metadata !256}
!262 = metadata !{i32 131, i32 0, metadata !19, metadata !261}
!263 = metadata !{i32 132, i32 0, metadata !19, metadata !261}
!264 = metadata !{i32 786688, metadata !35, metadata !"discctr", metadata !5, i32 163, metadata !11, i32 0, metadata !256} ; [ DW_TAG_auto_variable ] [discctr] [line 163]
!265 = metadata !{i32 165, i32 0, metadata !210, metadata !256}
!266 = metadata !{i32 166, i32 0, metadata !210, metadata !256}
!267 = metadata !{i32 2}
!268 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !269} ; [ DW_TAG_arg_variable ] [s] [line 131]
!269 = metadata !{i32 205, i32 0, metadata !59, null}
!270 = metadata !{i32 131, i32 0, metadata !19, metadata !269}
!271 = metadata !{i32 132, i32 0, metadata !19, metadata !269}
!272 = metadata !{i32 3}
!273 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !274} ; [ DW_TAG_arg_variable ] [s] [line 131]
!274 = metadata !{i32 206, i32 0, metadata !59, null}
!275 = metadata !{i32 131, i32 0, metadata !19, metadata !274}
!276 = metadata !{i32 132, i32 0, metadata !19, metadata !274}
!277 = metadata !{i32 207, i32 0, metadata !59, null}
!278 = metadata !{i32 208, i32 0, metadata !59, null}
!279 = metadata !{i32 209, i32 0, metadata !280, null}
!280 = metadata !{i32 786443, metadata !1, metadata !59, i32 209, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!281 = metadata !{i32 210, i32 0, metadata !59, null}
!282 = metadata !{i32 211, i32 0, metadata !59, null}
!283 = metadata !{i32 216, i32 0, metadata !284, null}
!284 = metadata !{i32 786443, metadata !1, metadata !62, i32 216, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!285 = metadata !{i32 217, i32 0, metadata !62, null}
