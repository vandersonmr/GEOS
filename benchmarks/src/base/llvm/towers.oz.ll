...
tailrecurse._crit_edge:                           ; preds = %tailrecurse, %0
  ...
  tail call void @Move(i32 %i.tr.lcssa, i32 %j) #5, !dbg !235
  ret void, !dbg !237

tailrecurse:                                      ; preds = %0, %tailrecurse
  %k.tr2 = phi i32 [ %4, %tailrecurse ], [ %k, %0 ]
  %i.tr1 = phi i32 [ %3, %tailrecurse ], [ %i, %0 ]
  %2 = sub nsw i32 6, %i.tr1, !dbg !238
  %3 = sub i32 %2, %j, !dbg !238
  tail call void @llvm.dbg.value(metadata !{i32 %3}, i64 0, metadata !58), !dbg !238
  %4 = add nsw i32 %k.tr2, -1, !dbg !240
  tail call void @tower(i32 %i.tr1, i32 %3, i32 %4) #5, !dbg !240
  tail call void @Move(i32 %i.tr1, i32 %j) #5, !dbg !241
  tail call void @llvm.dbg.value(metadata !{i32 %i.tr.lcssa}, i64 0, metadata !55), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !56), !dbg !234
  tail call void @llvm.dbg.value(metadata !{i32 %k.tr2}, i64 0, metadata !57), !dbg !234
  %5 = icmp eq i32 %4, 1, !dbg !235
  br i1 %5, label %tailrecurse._crit_edge, label %tailrecurse, !dbg !235
}

; Function Attrs: minsize nounwind optsize uwtable
define void @Towers() #0 {
  tail call void @llvm.dbg.value(metadata !188, i64 0, metadata !61), !dbg !242
  br label %1, !dbg !242

; <label>:1                                       ; preds = %1, %0
  %indvars.iv = phi i64 [ 1, %0 ], [ %indvars.iv.next, %1 ]
  %2 = add nsw i64 %indvars.iv, 4294967295, !dbg !242
  %3 = getelementptr inbounds [19 x %struct.element]* @cellspace, i64 0, i64 %indvars.iv, i32 1, !dbg !242
  %4 = trunc i64 %2 to i32, !dbg !242
  store i32 %4, i32* %3, align 4, !dbg !242, !tbaa !172
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !242
  %exitcond = icmp eq i64 %indvars.iv.next, 19, !dbg !242
  br i1 %exitcond, label %5, label %1, !dbg !242

; <label>:5                                       ; preds = %1
  store i32 18, i32* @freelist, align 4, !dbg !244, !tbaa !162
  tail call void @Init(i32 1, i32 14) #5, !dbg !245
  tail call void @llvm.dbg.value(metadata !246, i64 0, metadata !247), !dbg !249
  store i32 0, i32* getelementptr inbounds ([4 x i32]* @stack, i64 0, i64 2), align 8, !dbg !250, !tbaa !162
  tail call void @llvm.dbg.value(metadata !251, i64 0, metadata !252), !dbg !254
  store i32 0, i32* getelementptr inbounds ([4 x i32]* @stack, i64 0, i64 3), align 4, !dbg !255, !tbaa !162
  store i32 0, i32* @movesdone, align 4, !dbg !256, !tbaa !162
  tail call void @tower(i32 1, i32 2, i32 14) #5, !dbg !257
  %6 = load i32* @movesdone, align 4, !dbg !258, !tbaa !162
  %7 = icmp eq i32 %6, 16383, !dbg !258
  br i1 %7, label %9, label %8, !dbg !258

; <label>:8                                       ; preds = %5
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)), !dbg !258
  %.pre = load i32* @movesdone, align 4, !dbg !260, !tbaa !162
  br label %9, !dbg !258

; <label>:9                                       ; preds = %5, %8
  %10 = phi i32 [ 16383, %5 ], [ %.pre, %8 ]
  %11 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0), i32 %10) #4, !dbg !260
  ret void, !dbg !261
}

; Function Attrs: minsize nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !165, i64 0, metadata !64), !dbg !262
  br label %1, !dbg !262

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Towers() #5, !dbg !262
  %2 = add nsw i32 %i.01, 1, !dbg !262
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !64), !dbg !262
  %exitcond = icmp eq i32 %2, 100, !dbg !262
  br i1 %exitcond, label %3, label %1, !dbg !262
...
!237 = metadata !{i32 198, i32 0, metadata !51, null}
!238 = metadata !{i32 193, i32 0, metadata !239, null}
!239 = metadata !{i32 786443, metadata !1, metadata !236, i32 192, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!240 = metadata !{i32 194, i32 0, metadata !239, null}
!241 = metadata !{i32 195, i32 0, metadata !239, null}
!242 = metadata !{i32 202, i32 0, metadata !243, null}
!243 = metadata !{i32 786443, metadata !1, metadata !59, i32 202, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!244 = metadata !{i32 203, i32 0, metadata !59, null}
!245 = metadata !{i32 204, i32 0, metadata !59, null}
!246 = metadata !{i32 2}
!247 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !248} ; [ DW_TAG_arg_variable ] [s] [line 131]
!248 = metadata !{i32 205, i32 0, metadata !59, null}
!249 = metadata !{i32 131, i32 0, metadata !19, metadata !248}
!250 = metadata !{i32 132, i32 0, metadata !19, metadata !248}
!251 = metadata !{i32 3}
!252 = metadata !{i32 786689, metadata !19, metadata !"s", metadata !5, i32 16777347, metadata !11, i32 0, metadata !253} ; [ DW_TAG_arg_variable ] [s] [line 131]
!253 = metadata !{i32 206, i32 0, metadata !59, null}
!254 = metadata !{i32 131, i32 0, metadata !19, metadata !253}
!255 = metadata !{i32 132, i32 0, metadata !19, metadata !253}
!256 = metadata !{i32 207, i32 0, metadata !59, null}
!257 = metadata !{i32 208, i32 0, metadata !59, null}
!258 = metadata !{i32 209, i32 0, metadata !259, null}
!259 = metadata !{i32 786443, metadata !1, metadata !59, i32 209, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!260 = metadata !{i32 210, i32 0, metadata !59, null}
!261 = metadata !{i32 211, i32 0, metadata !59, null}
!262 = metadata !{i32 216, i32 0, metadata !263, null}
!263 = metadata !{i32 786443, metadata !1, metadata !62, i32 216, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/towers.c]
!264 = metadata !{i32 217, i32 0, metadata !62, null}
