...
define void @CreateNode(%struct.node** nocapture %t, i32 %n) #0 {
  ...
  %1 = tail call noalias i8* @malloc(i64 24) #4, !dbg !154
...
tailrecurse:                                      ; preds = %15, %4, %0
  %t.tr = phi %struct.node* [ %t, %0 ], [ %6, %4 ], [ %17, %15 ]
  ...
  br i1 %3, label %4, label %13, !dbg !163
...
; <label>:8                                       ; preds = %4
  tail call void @llvm.dbg.value(metadata !{%struct.node** %5}, i64 0, metadata !168) #4, !dbg !169
  tail call void @llvm.dbg.value(metadata !{i32 %n}, i64 0, metadata !170) #4, !dbg !169
  %9 = tail call noalias i8* @malloc(i64 24) #4, !dbg !171
  %10 = bitcast i8* %9 to %struct.node*, !dbg !171
  store %struct.node* %10, %struct.node** %5, align 8, !dbg !171, !tbaa !155
  %11 = getelementptr inbounds i8* %9, i64 16, !dbg !172
  %12 = bitcast i8* %11 to i32*, !dbg !172
  tail call void @llvm.memset.p0i8.i64(i8* %9, i8 0, i64 16, i32 8, i1 false) #4, !dbg !173
  store i32 %n, i32* %12, align 4, !dbg !172, !tbaa !159
  br label %.loopexit, !dbg !165

; <label>:13                                      ; preds = %tailrecurse
  %14 = icmp sgt i32 %2, %n, !dbg !174
  br i1 %14, label %15, label %.loopexit, !dbg !174

; <label>:15                                      ; preds = %13
  %16 = getelementptr inbounds %struct.node* %t.tr, i64 0, i32 1, !dbg !176
  %17 = load %struct.node** %16, align 8, !dbg !176, !tbaa !178
  %18 = icmp eq %struct.node* %17, null, !dbg !176
  br i1 %18, label %19, label %tailrecurse, !dbg !176

; <label>:19                                      ; preds = %15
  tail call void @llvm.dbg.value(metadata !{%struct.node** %16}, i64 0, metadata !179) #4, !dbg !180
  tail call void @llvm.dbg.value(metadata !{i32 %n}, i64 0, metadata !181) #4, !dbg !180
  %20 = tail call noalias i8* @malloc(i64 24) #4, !dbg !182
  %21 = bitcast i8* %20 to %struct.node*, !dbg !182
  store %struct.node* %21, %struct.node** %16, align 8, !dbg !182, !tbaa !155
  %22 = getelementptr inbounds i8* %20, i64 16, !dbg !183
  %23 = bitcast i8* %22 to i32*, !dbg !183
  tail call void @llvm.memset.p0i8.i64(i8* %20, i8 0, i64 16, i32 8, i1 false) #4, !dbg !184
  store i32 %n, i32* %23, align 4, !dbg !183, !tbaa !159
  br label %.loopexit, !dbg !176

.loopexit:                                        ; preds = %13, %19, %8
  ret void, !dbg !185
}

; Function Attrs: nounwind readonly uwtable
define i32 @Checktree(%struct.node* nocapture readonly %p) #2 {
  tail call void @llvm.dbg.value(metadata !{%struct.node* %p}, i64 0, metadata !40), !dbg !186
  tail call void @llvm.dbg.value(metadata !141, i64 0, metadata !41), !dbg !187
  %1 = getelementptr inbounds %struct.node* %p, i64 0, i32 0, !dbg !188
  %2 = load %struct.node** %1, align 8, !dbg !188, !tbaa !167
  %3 = icmp eq %struct.node* %2, null, !dbg !188
  br i1 %3, label %12, label %4, !dbg !188

; <label>:4                                       ; preds = %0
  %5 = getelementptr inbounds %struct.node* %2, i64 0, i32 2, !dbg !190
  %6 = load i32* %5, align 4, !dbg !190, !tbaa !159
  %7 = getelementptr inbounds %struct.node* %p, i64 0, i32 2, !dbg !190
  %8 = load i32* %7, align 4, !dbg !190, !tbaa !159
  %9 = icmp sgt i32 %6, %8, !dbg !190
  br i1 %9, label %10, label %12, !dbg !190

; <label>:10                                      ; preds = %4
  %11 = tail call i32 @Checktree(%struct.node* %2), !dbg !192
  %not.2 = icmp ne i32 %11, 0, !dbg !192
  %. = zext i1 %not.2 to i32, !dbg !192
  tail call void @llvm.dbg.value(metadata !{i32 %.}, i64 0, metadata !41), !dbg !193
  br label %12

; <label>:12                                      ; preds = %4, %0, %10
  %result.0 = phi i32 [ %., %10 ], [ 1, %0 ], [ 0, %4 ]
  %13 = getelementptr inbounds %struct.node* %p, i64 0, i32 1, !dbg !194
  %14 = load %struct.node** %13, align 8, !dbg !194, !tbaa !178
  %15 = icmp eq %struct.node* %14, null, !dbg !194
  br i1 %15, label %26, label %16, !dbg !194

; <label>:16                                      ; preds = %12
  %17 = getelementptr inbounds %struct.node* %14, i64 0, i32 2, !dbg !196
  %18 = load i32* %17, align 4, !dbg !196, !tbaa !159
  %19 = getelementptr inbounds %struct.node* %p, i64 0, i32 2, !dbg !196
  %20 = load i32* %19, align 4, !dbg !196, !tbaa !159
  %21 = icmp slt i32 %18, %20, !dbg !196
  br i1 %21, label %22, label %26, !dbg !196

; <label>:22                                      ; preds = %16
  %23 = tail call i32 @Checktree(%struct.node* %14), !dbg !198
  %24 = icmp ne i32 %result.0, 0, !dbg !198
  %not. = icmp ne i32 %23, 0, !dbg !198
  %.1 = and i1 %24, %not., !dbg !198
  %25 = zext i1 %.1 to i32
  tail call void @llvm.dbg.value(metadata !{i32 %25}, i64 0, metadata !41), !dbg !193
  ret i32 %25, !dbg !199

; <label>:26                                      ; preds = %16, %12
  %result.1 = phi i32 [ %result.0, %12 ], [ 0, %16 ]
  ret i32 %result.1, !dbg !199
}

; Function Attrs: nounwind uwtable
define void @Trees(i32 %run) #0 {
  tail call void @llvm.dbg.value(metadata !{i32 %run}, i64 0, metadata !46), !dbg !200
  store i64 74755, i64* @seed, align 8, !dbg !201, !tbaa !129
  store i32 0, i32* @biggest, align 4, !dbg !204, !tbaa !139
  store i32 0, i32* @littlest, align 4, !dbg !204, !tbaa !139
  tail call void @llvm.dbg.value(metadata !141, i64 0, metadata !205), !dbg !206
  br label %1, !dbg !206

; <label>:1                                       ; preds = %17, %0
  %2 = phi i32 [ 0, %0 ], [ %18, %17 ]
  %3 = phi i32 [ 0, %0 ], [ %19, %17 ], !dbg !207
  %indvars.iv.i = phi i64 [ 1, %0 ], [ %indvars.iv.next.i, %17 ]
  %4 = phi i64 [ 74755, %0 ], [ %7, %17 ], !dbg !207
  %5 = mul nsw i64 %4, 1309, !dbg !207
  %6 = add nsw i64 %5, 13849, !dbg !207
  %7 = and i64 %6, 65535, !dbg !207
  tail call void @llvm.dbg.value(metadata !{i64 %7}, i64 0, metadata !209), !dbg !208
  %8 = urem i64 %7, 100000, !dbg !210
  %9 = add nsw i64 %8, 4294917296, !dbg !210
  %10 = trunc i64 %9 to i32, !dbg !210
  %11 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv.i, !dbg !210
  store i32 %10, i32* %11, align 4, !dbg !210, !tbaa !139
  %12 = icmp sgt i32 %10, %3, !dbg !211
  br i1 %12, label %13, label %14, !dbg !211

; <label>:13                                      ; preds = %1
  store i32 %10, i32* @biggest, align 4, !dbg !211, !tbaa !139
  br label %17, !dbg !211

; <label>:14                                      ; preds = %1
  %15 = icmp slt i32 %10, %2, !dbg !212
  br i1 %15, label %16, label %17, !dbg !212

; <label>:16                                      ; preds = %14
  store i32 %10, i32* @littlest, align 4, !dbg !212, !tbaa !139
  br label %17, !dbg !212
...
; <label>:17                                      ; preds = %16, %14, %13
  ...
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 5001, !dbg !206
  br i1 %exitcond.i, label %tInitarr.exit, label %1, !dbg !206

tInitarr.exit:                                    ; preds = %17
  store i64 %7, i64* @seed, align 8, !dbg !207, !tbaa !129
  %20 = tail call noalias i8* @malloc(i64 24) #4, !dbg !213
  %21 = bitcast i8* %20 to %struct.node*, !dbg !213
  store %struct.node* %21, %struct.node** @tree, align 8, !dbg !213, !tbaa !155
  call void @llvm.memset.p0i8.i64(i8* %20, i8 0, i64 16, i32 8, i1 false), !dbg !214
  %22 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !214, !tbaa !139
  %23 = getelementptr inbounds i8* %20, i64 16, !dbg !214
  %24 = bitcast i8* %23 to i32*, !dbg !214
  store i32 %22, i32* %24, align 4, !dbg !214, !tbaa !159
  tail call void @llvm.dbg.value(metadata !215, i64 0, metadata !47), !dbg !216
  br label %25, !dbg !216

; <label>:25                                      ; preds = %Insert.exit._crit_edge, %tInitarr.exit
  %26 = phi %struct.node* [ %21, %tInitarr.exit ], [ %.pre, %Insert.exit._crit_edge ], !dbg !218
  %indvars.iv = phi i64 [ 2, %tInitarr.exit ], [ %indvars.iv.next, %Insert.exit._crit_edge ]
  %27 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv, !dbg !218
  %28 = load i32* %27, align 4, !dbg !218, !tbaa !139
  br label %tailrecurse.i

tailrecurse.i:                                    ; preds = %43, %32, %25
  %t.tr.i = phi %struct.node* [ %26, %25 ], [ %34, %32 ], [ %45, %43 ]
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !219) #4, !dbg !220
  tail call void @llvm.dbg.value(metadata !{%struct.node* %t.tr.i}, i64 0, metadata !221) #4, !dbg !220
  %29 = getelementptr inbounds %struct.node* %t.tr.i, i64 0, i32 2, !dbg !222
  %30 = load i32* %29, align 4, !dbg !222, !tbaa !159
  %31 = icmp slt i32 %30, %28, !dbg !222
  br i1 %31, label %32, label %41, !dbg !222

; <label>:32                                      ; preds = %tailrecurse.i
  %33 = getelementptr inbounds %struct.node* %t.tr.i, i64 0, i32 0, !dbg !223
  %34 = load %struct.node** %33, align 8, !dbg !223, !tbaa !167
  %35 = icmp eq %struct.node* %34, null, !dbg !223
  br i1 %35, label %36, label %tailrecurse.i, !dbg !223

; <label>:36                                      ; preds = %32
  tail call void @llvm.dbg.value(metadata !{%struct.node** %33}, i64 0, metadata !224) #4, !dbg !225
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !226) #4, !dbg !225
  %37 = tail call noalias i8* @malloc(i64 24) #4, !dbg !227
  %38 = bitcast i8* %37 to %struct.node*, !dbg !227
  store %struct.node* %38, %struct.node** %33, align 8, !dbg !227, !tbaa !155
  %39 = getelementptr inbounds i8* %37, i64 16, !dbg !228
  %40 = bitcast i8* %39 to i32*, !dbg !228
  tail call void @llvm.memset.p0i8.i64(i8* %37, i8 0, i64 16, i32 8, i1 false) #4, !dbg !229
  store i32 %28, i32* %40, align 4, !dbg !228, !tbaa !159
  br label %Insert.exit, !dbg !223

; <label>:41                                      ; preds = %tailrecurse.i
  %42 = icmp sgt i32 %30, %28, !dbg !230
  br i1 %42, label %43, label %Insert.exit, !dbg !230

; <label>:43                                      ; preds = %41
  %44 = getelementptr inbounds %struct.node* %t.tr.i, i64 0, i32 1, !dbg !231
  %45 = load %struct.node** %44, align 8, !dbg !231, !tbaa !178
  %46 = icmp eq %struct.node* %45, null, !dbg !231
  br i1 %46, label %47, label %tailrecurse.i, !dbg !231

; <label>:47                                      ; preds = %43
  tail call void @llvm.dbg.value(metadata !{%struct.node** %44}, i64 0, metadata !232) #4, !dbg !233
  tail call void @llvm.dbg.value(metadata !{i32 %28}, i64 0, metadata !234) #4, !dbg !233
  %48 = tail call noalias i8* @malloc(i64 24) #4, !dbg !235
  %49 = bitcast i8* %48 to %struct.node*, !dbg !235
  store %struct.node* %49, %struct.node** %44, align 8, !dbg !235, !tbaa !155
  %50 = getelementptr inbounds i8* %48, i64 16, !dbg !236
  %51 = bitcast i8* %50 to i32*, !dbg !236
  tail call void @llvm.memset.p0i8.i64(i8* %48, i8 0, i64 16, i32 8, i1 false) #4, !dbg !237
  store i32 %28, i32* %51, align 4, !dbg !236, !tbaa !159
  br label %Insert.exit, !dbg !231

Insert.exit:                                      ; preds = %41, %36, %47
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !216
  %exitcond = icmp eq i64 %indvars.iv.next, 5001, !dbg !216
  br i1 %exitcond, label %52, label %Insert.exit._crit_edge, !dbg !216

Insert.exit._crit_edge:                           ; preds = %Insert.exit
  %.pre = load %struct.node** @tree, align 8, !dbg !218, !tbaa !155
  br label %25, !dbg !216

; <label>:52                                      ; preds = %Insert.exit
  %53 = add nsw i32 %run, 2, !dbg !238
  %54 = sext i32 %53 to i64, !dbg !238
  %55 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %54, !dbg !238
  %56 = load i32* %55, align 4, !dbg !238, !tbaa !139
  %57 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %56) #4, !dbg !238
  %58 = load %struct.node** @tree, align 8, !dbg !239, !tbaa !155
  %59 = tail call i32 @Checktree(%struct.node* %58), !dbg !239
  %60 = icmp eq i32 %59, 0, !dbg !239
  br i1 %60, label %61, label %62, !dbg !239

; <label>:61                                      ; preds = %52
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @str, i64 0, i64 0)), !dbg !239
  br label %62, !dbg !239
...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !242, i64 0, metadata !50), !dbg !243
  br label %1, !dbg !243

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Trees(i32 %i.01), !dbg !243
  %2 = add nsw i32 %i.01, 1, !dbg !243
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !50), !dbg !243
  %exitcond = icmp eq i32 %2, 100, !dbg !243
  br i1 %exitcond, label %3, label %1, !dbg !243
...
!168 = metadata !{i32 786689, metadata !17, metadata !"t", metadata !5, i32 16777358, metadata !20, i32 0, metadata !165} ; [ DW_TAG_arg_variable ] [t] [line 142]
!169 = metadata !{i32 142, i32 0, metadata !17, metadata !165}
!170 = metadata !{i32 786689, metadata !17, metadata !"n", metadata !5, i32 33554574, metadata !11, i32 0, metadata !165} ; [ DW_TAG_arg_variable ] [n] [line 142]
!171 = metadata !{i32 143, i32 0, metadata !17, metadata !165}
!172 = metadata !{i32 145, i32 0, metadata !17, metadata !165}
!173 = metadata !{i32 144, i32 0, metadata !17, metadata !165}
!174 = metadata !{i32 153, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !1, metadata !164, i32 153, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!176 = metadata !{i32 154, i32 0, metadata !177, null}
!177 = metadata !{i32 786443, metadata !1, metadata !175, i32 154, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!178 = metadata !{metadata !160, metadata !156, i64 8}
!179 = metadata !{i32 786689, metadata !17, metadata !"t", metadata !5, i32 16777358, metadata !20, i32 0, metadata !176} ; [ DW_TAG_arg_variable ] [t] [line 142]
!180 = metadata !{i32 142, i32 0, metadata !17, metadata !176}
!181 = metadata !{i32 786689, metadata !17, metadata !"n", metadata !5, i32 33554574, metadata !11, i32 0, metadata !176} ; [ DW_TAG_arg_variable ] [n] [line 142]
!182 = metadata !{i32 143, i32 0, metadata !17, metadata !176}
!183 = metadata !{i32 145, i32 0, metadata !17, metadata !176}
!184 = metadata !{i32 144, i32 0, metadata !17, metadata !176}
!185 = metadata !{i32 156, i32 0, metadata !30, null}
!186 = metadata !{i32 158, i32 0, metadata !36, null}
!187 = metadata !{i32 161, i32 0, metadata !36, null}
!188 = metadata !{i32 162, i32 0, metadata !189, null}
!189 = metadata !{i32 786443, metadata !1, metadata !36, i32 162, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!190 = metadata !{i32 163, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !1, metadata !189, i32 163, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!192 = metadata !{i32 164, i32 0, metadata !191, null}
!193 = metadata !{i32 160, i32 0, metadata !36, null}
!194 = metadata !{i32 165, i32 0, metadata !195, null}
!195 = metadata !{i32 786443, metadata !1, metadata !36, i32 165, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!196 = metadata !{i32 166, i32 0, metadata !197, null}
!197 = metadata !{i32 786443, metadata !1, metadata !195, i32 166, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!198 = metadata !{i32 167, i32 0, metadata !197, null}
!199 = metadata !{i32 168, i32 0, metadata !36, null}
!200 = metadata !{i32 171, i32 0, metadata !42, null}
!201 = metadata !{i32 116, i32 0, metadata !4, metadata !202}
!202 = metadata !{i32 131, i32 0, metadata !12, metadata !203}
!203 = metadata !{i32 173, i32 0, metadata !42, null}
!204 = metadata !{i32 132, i32 0, metadata !12, metadata !203}
!205 = metadata !{i32 786688, metadata !12, metadata !"i", metadata !5, i32 129, metadata !11, i32 0, metadata !203} ; [ DW_TAG_auto_variable ] [i] [line 129]
!206 = metadata !{i32 133, i32 0, metadata !143, metadata !203}
!207 = metadata !{i32 120, i32 0, metadata !8, metadata !208}
!208 = metadata !{i32 134, i32 0, metadata !146, metadata !203}
!209 = metadata !{i32 786688, metadata !12, metadata !"temp", metadata !5, i32 130, metadata !16, i32 0, metadata !203} ; [ DW_TAG_auto_variable ] [temp] [line 130]
!210 = metadata !{i32 136, i32 0, metadata !146, metadata !203}
!211 = metadata !{i32 137, i32 0, metadata !149, metadata !203}
!212 = metadata !{i32 138, i32 0, metadata !151, metadata !203}
!213 = metadata !{i32 174, i32 0, metadata !42, null}
!214 = metadata !{i32 175, i32 0, metadata !42, null}
!215 = metadata !{i32 2}
!216 = metadata !{i32 176, i32 0, metadata !217, null}
!217 = metadata !{i32 786443, metadata !1, metadata !42, i32 176, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!218 = metadata !{i32 177, i32 0, metadata !217, null}
!219 = metadata !{i32 786689, metadata !30, metadata !"n", metadata !5, i32 16777364, metadata !11, i32 0, metadata !218} ; [ DW_TAG_arg_variable ] [n] [line 148]
!220 = metadata !{i32 148, i32 0, metadata !30, metadata !218}
!221 = metadata !{i32 786689, metadata !30, metadata !"t", metadata !5, i32 33554580, metadata !21, i32 0, metadata !218} ; [ DW_TAG_arg_variable ] [t] [line 148]
!222 = metadata !{i32 150, i32 0, metadata !164, metadata !218}
!223 = metadata !{i32 151, i32 0, metadata !166, metadata !218}
!224 = metadata !{i32 786689, metadata !17, metadata !"t", metadata !5, i32 16777358, metadata !20, i32 0, metadata !223} ; [ DW_TAG_arg_variable ] [t] [line 142]
!225 = metadata !{i32 142, i32 0, metadata !17, metadata !223}
!226 = metadata !{i32 786689, metadata !17, metadata !"n", metadata !5, i32 33554574, metadata !11, i32 0, metadata !223} ; [ DW_TAG_arg_variable ] [n] [line 142]
!227 = metadata !{i32 143, i32 0, metadata !17, metadata !223}
!228 = metadata !{i32 145, i32 0, metadata !17, metadata !223}
!229 = metadata !{i32 144, i32 0, metadata !17, metadata !223}
!230 = metadata !{i32 153, i32 0, metadata !175, metadata !218}
!231 = metadata !{i32 154, i32 0, metadata !177, metadata !218}
!232 = metadata !{i32 786689, metadata !17, metadata !"t", metadata !5, i32 16777358, metadata !20, i32 0, metadata !231} ; [ DW_TAG_arg_variable ] [t] [line 142]
!233 = metadata !{i32 142, i32 0, metadata !17, metadata !231}
!234 = metadata !{i32 786689, metadata !17, metadata !"n", metadata !5, i32 33554574, metadata !11, i32 0, metadata !231} ; [ DW_TAG_arg_variable ] [n] [line 142]
!235 = metadata !{i32 143, i32 0, metadata !17, metadata !231}
!236 = metadata !{i32 145, i32 0, metadata !17, metadata !231}
!237 = metadata !{i32 144, i32 0, metadata !17, metadata !231}
!238 = metadata !{i32 178, i32 0, metadata !42, null}
!239 = metadata !{i32 179, i32 0, metadata !240, null}
!240 = metadata !{i32 786443, metadata !1, metadata !42, i32 179, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!241 = metadata !{i32 180, i32 0, metadata !42, null}
!242 = metadata !{i32 0}
!243 = metadata !{i32 185, i32 0, metadata !244, null}
!244 = metadata !{i32 786443, metadata !1, metadata !48, i32 185, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!245 = metadata !{i32 186, i32 0, metadata !48, null}
