...
; <label>:8                                       ; preds = %4
  ...
  %9 = tail call noalias i8* @malloc(i64 24) #5, !dbg !171
...
; <label>:19                                      ; preds = %15
  ...
  %20 = tail call noalias i8* @malloc(i64 24) #5, !dbg !182
...
; <label>:10                                      ; preds = %4
  %11 = tail call i32 @Checktree(%struct.node* %2) #6, !dbg !192
...
; <label>:22                                      ; preds = %16
  %23 = tail call i32 @Checktree(%struct.node* %14) #6, !dbg !198
...
define void @Trees(i32 %run) #0 {
  ...
  tail call void @tInitarr() #6, !dbg !201
  %1 = tail call noalias i8* @malloc(i64 24) #5, !dbg !202
  %2 = bitcast i8* %1 to %struct.node*, !dbg !202
  store %struct.node* %2, %struct.node** @tree, align 8, !dbg !202, !tbaa !155
  call void @llvm.memset.p0i8.i64(i8* %1, i8 0, i64 16, i32 8, i1 false), !dbg !203
  %3 = load i32* getelementptr inbounds ([5001 x i32]* @sortlist, i64 0, i64 1), align 4, !dbg !203, !tbaa !139
  %4 = getelementptr inbounds i8* %1, i64 16, !dbg !203
  %5 = bitcast i8* %4 to i32*, !dbg !203
  store i32 %3, i32* %5, align 4, !dbg !203, !tbaa !159
  tail call void @llvm.dbg.value(metadata !204, i64 0, metadata !47), !dbg !205
  br label %6, !dbg !205

; <label>:6                                       ; preds = %._crit_edge, %0
  %7 = phi %struct.node* [ %2, %0 ], [ %.pre, %._crit_edge ]
  %indvars.iv = phi i64 [ 2, %0 ], [ %indvars.iv.next, %._crit_edge ]
  %8 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %indvars.iv, !dbg !207
  %9 = load i32* %8, align 4, !dbg !207, !tbaa !139
  tail call void @Insert(i32 %9, %struct.node* %7) #6, !dbg !207
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !205
  %exitcond = icmp eq i64 %indvars.iv.next, 5001, !dbg !205
  br i1 %exitcond, label %10, label %._crit_edge, !dbg !205

._crit_edge:                                      ; preds = %6
  %.pre = load %struct.node** @tree, align 8, !dbg !207, !tbaa !155
  br label %6, !dbg !205

; <label>:10                                      ; preds = %6
  %11 = add nsw i32 %run, 2, !dbg !208
  %12 = sext i32 %11 to i64, !dbg !208
  %13 = getelementptr inbounds [5001 x i32]* @sortlist, i64 0, i64 %12, !dbg !208
  %14 = load i32* %13, align 4, !dbg !208, !tbaa !139
  %15 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %14) #5, !dbg !208
  %16 = load %struct.node** @tree, align 8, !dbg !209, !tbaa !155
  %17 = tail call i32 @Checktree(%struct.node* %16) #6, !dbg !209
  %18 = icmp eq i32 %17, 0, !dbg !209
  br i1 %18, label %19, label %20, !dbg !209

; <label>:19                                      ; preds = %10
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @str, i64 0, i64 0)), !dbg !209
  br label %20, !dbg !209
...
; Function Attrs: nounwind optsize uwtable
define i32 @main() #0 {
  tail call void @llvm.dbg.value(metadata !212, i64 0, metadata !50), !dbg !213
  br label %1, !dbg !213

; <label>:1                                       ; preds = %1, %0
  %i.01 = phi i32 [ 0, %0 ], [ %2, %1 ]
  tail call void @Trees(i32 %i.01) #6, !dbg !213
  %2 = add nsw i32 %i.01, 1, !dbg !213
  tail call void @llvm.dbg.value(metadata !{i32 %2}, i64 0, metadata !50), !dbg !213
  %exitcond = icmp eq i32 %2, 100, !dbg !213
  br i1 %exitcond, label %3, label %1, !dbg !213
...
!201 = metadata !{i32 173, i32 0, metadata !42, null}
!202 = metadata !{i32 174, i32 0, metadata !42, null}
!203 = metadata !{i32 175, i32 0, metadata !42, null}
!204 = metadata !{i32 2}
!205 = metadata !{i32 176, i32 0, metadata !206, null}
!206 = metadata !{i32 786443, metadata !1, metadata !42, i32 176, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!207 = metadata !{i32 177, i32 0, metadata !206, null}
!208 = metadata !{i32 178, i32 0, metadata !42, null}
!209 = metadata !{i32 179, i32 0, metadata !210, null}
!210 = metadata !{i32 786443, metadata !1, metadata !42, i32 179, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!211 = metadata !{i32 180, i32 0, metadata !42, null}
!212 = metadata !{i32 0}
!213 = metadata !{i32 185, i32 0, metadata !214, null}
!214 = metadata !{i32 786443, metadata !1, metadata !48, i32 185, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/treesort.c]
!215 = metadata !{i32 186, i32 0, metadata !48, null}
