...
._crit_edge22:                                    ; preds = %.lr.ph21, %.thread
  ...
  br i1 %10, label %.critedge89, label %.lr.ph25, !dbg !189
...
; <label>:79                                      ; preds = %.critedge89, %._crit_edge31
  ...
  br i1 %10, label %.critedge90, label %.lr.ph40, !dbg !228
...
; <label>:139                                     ; preds = %.critedge90, %.lr.ph46, %._crit_edge41
  %.lcssa7 = phi double [ %133, %.lr.ph46 ], [ 1.000000e+00, %._crit_edge41 ], [ 1.000000e+00, %.critedge90 ]
...
.lr.ph60:                                         ; preds = %139, %.lr.ph60
  %.pre87 = phi double [ %.pre88, %.lr.ph60 ], [ 3.000000e+00, %139 ], !dbg !274
  %.pre88 = phi double [ %.pre87, %.lr.ph60 ], [ 2.000000e+00, %139 ], !dbg !274
  %I.758 = phi i64 [ %145, %.lr.ph60 ], [ 1, %139 ]
  store double %.pre88, double* getelementptr inbounds ([5 x double]* @E1, i64 0, i64 1), align 8, !dbg !274, !tbaa !122
  store double %.pre87, double* getelementptr inbounds ([5 x double]* @E1, i64 0, i64 2), align 16, !dbg !276, !tbaa !122
  store double %.pre88, double* getelementptr inbounds ([5 x double]* @E1, i64 0, i64 3), align 8, !dbg !277, !tbaa !122
...
._crit_edge61:                                    ; preds = %.lr.ph60
  %147 = load double* getelementptr inbounds ([5 x double]* @E1, i64 0, i64 4), align 16, !dbg !278, !tbaa !122
  tail call void @llvm.dbg.value(metadata !{i64 %8}, i64 0, metadata !280) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !282) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !218, i64 0, metadata !283) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %.pre88}, i64 0, metadata !284) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %.pre87}, i64 0, metadata !285) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %.pre88}, i64 0, metadata !286) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %147}, i64 0, metadata !287) #4, !dbg !281
  %148 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 %8, i64 1, i64 2, double %.pre88, double %.pre87, double %.pre88, double %147) #7, !dbg !288
  store i32 2, i32* @J, align 4, !dbg !289, !tbaa !187
  store i32 3, i32* @K, align 4, !dbg !290, !tbaa !187
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !15), !dbg !291
  tail call void @llvm.dbg.value(metadata !129, i64 0, metadata !293) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !218, i64 0, metadata !297) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !298, i64 0, metadata !299) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !132, i64 0, metadata !300) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !134, i64 0, metadata !301) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !134, i64 0, metadata !302) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !134, i64 0, metadata !303) #4, !dbg !296
  %149 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 0, i64 2, i64 3, double 1.000000e+00, double -1.000000e+00, double -1.000000e+00, double -1.000000e+00) #7, !dbg !304
  tail call void @llvm.dbg.value(metadata !305, i64 0, metadata !32), !dbg !306
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !15), !dbg !307
  br i1 %10, label %._crit_edge66, label %.lr.ph65, !dbg !307
...
.lr.ph65:                                         ; preds = %._crit_edge61, %.lr.ph65
  ...
  %150 = tail call double @log(double %X.162) #7, !dbg !309
  %151 = load double* @T1, align 8, !dbg !309, !tbaa !122
  %152 = fdiv double %150, %151, !dbg !309
  %153 = tail call double @exp(double %152) #7, !dbg !309
  %154 = tail call double @sqrt(double %153) #7, !dbg !309
  tail call void @llvm.dbg.value(metadata !{double %154}, i64 0, metadata !32), !dbg !309
  %155 = add nsw i64 %I.963, 1, !dbg !307
  tail call void @llvm.dbg.value(metadata !{i64 %155}, i64 0, metadata !15), !dbg !307
  %156 = icmp slt i64 %I.963, %9, !dbg !307
  br i1 %156, label %.lr.ph65, label %._crit_edge66, !dbg !307

._crit_edge66.critedge:                           ; preds = %139
  %157 = load double* getelementptr inbounds ([5 x double]* @E1, i64 0, i64 4), align 16, !dbg !278, !tbaa !122
  tail call void @llvm.dbg.value(metadata !{i64 %8}, i64 0, metadata !280) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !282) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !218, i64 0, metadata !283) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %.pre88}, i64 0, metadata !284) #4, !dbg !281
  ...
  tail call void @llvm.dbg.value(metadata !{double %.pre88}, i64 0, metadata !286) #4, !dbg !281
  tail call void @llvm.dbg.value(metadata !{double %147}, i64 0, metadata !287) #4, !dbg !281
  %158 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 %8, i64 1, i64 2, double 1.000000e+00, double 2.000000e+00, double 3.000000e+00, double %157) #7, !dbg !288
  store i32 2, i32* @J, align 4, !dbg !289, !tbaa !187
  store i32 3, i32* @K, align 4, !dbg !290, !tbaa !187
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !15), !dbg !291
  tail call void @llvm.dbg.value(metadata !129, i64 0, metadata !293) #4, !dbg !296
  ...
  tail call void @llvm.dbg.value(metadata !134, i64 0, metadata !302) #4, !dbg !296
  tail call void @llvm.dbg.value(metadata !134, i64 0, metadata !303) #4, !dbg !296
  %159 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 0, i64 2, i64 3, double 1.000000e+00, double -1.000000e+00, double -1.000000e+00, double -1.000000e+00) #7, !dbg !304
  tail call void @llvm.dbg.value(metadata !305, i64 0, metadata !32), !dbg !306
  tail call void @llvm.dbg.value(metadata !138, i64 0, metadata !15), !dbg !307
...
._crit_edge66:                                    ; preds = %.lr.ph65, %._crit_edge66.critedge, %._crit_edge61
  ...
  %160 = load i32* @J, align 4, !dbg !310, !tbaa !187
  %161 = sext i32 %160 to i64, !dbg !310
  %162 = load i32* @K, align 4, !dbg !310, !tbaa !187
  %163 = sext i32 %162 to i64, !dbg !310
  tail call void @llvm.dbg.value(metadata !{i64 %9}, i64 0, metadata !312) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{i64 %161}, i64 0, metadata !314) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{i64 %163}, i64 0, metadata !315) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{double %X.1.lcssa}, i64 0, metadata !316) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{double %X.1.lcssa}, i64 0, metadata !317) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{double %X.1.lcssa}, i64 0, metadata !318) #4, !dbg !313
  tail call void @llvm.dbg.value(metadata !{double %X.1.lcssa}, i64 0, metadata !319) #4, !dbg !313
  %164 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 %9, i64 %161, i64 %163, double %X.1.lcssa, double %X.1.lcssa, double %X.1.lcssa, double %X.1.lcssa) #7, !dbg !320
  tail call void @llvm.dbg.value(metadata !321, i64 0, metadata !37), !dbg !322
  %165 = tail call i64 @time(i64* null) #7, !dbg !324
  tail call void @llvm.dbg.value(metadata !{i64 %165}, i64 0, metadata !40), !dbg !324
  %putchar = tail call i32 @putchar(i32 10) #4, !dbg !325
...
define void @POUT(i64 %N, i64 %J, i64 %K, double %X1, double %X2, double %X3, double %X4) #0 {
  tail call void @llvm.dbg.value(metadata !{i64 %N}, i64 0, metadata !66), !dbg !327
  tail call void @llvm.dbg.value(metadata !{i64 %J}, i64 0, metadata !67), !dbg !327
  tail call void @llvm.dbg.value(metadata !{i64 %K}, i64 0, metadata !68), !dbg !327
  tail call void @llvm.dbg.value(metadata !{double %X1}, i64 0, metadata !69), !dbg !327
  tail call void @llvm.dbg.value(metadata !{double %X2}, i64 0, metadata !70), !dbg !327
  tail call void @llvm.dbg.value(metadata !{double %X3}, i64 0, metadata !71), !dbg !327
  tail call void @llvm.dbg.value(metadata !{double %X4}, i64 0, metadata !72), !dbg !327
  %1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0), i64 %N, i64 %J, i64 %K, double %X1, double %X2, double %X3, double %X4) #7, !dbg !328
  ret void, !dbg !329
}

; Function Attrs: nounwind optsize uwtable
define void @PA(double* nocapture %E) #0 {
  tail call void @llvm.dbg.value(metadata !{double* %E}, i64 0, metadata !49), !dbg !330
  store i32 0, i32* @J, align 4, !dbg !331, !tbaa !187
  %1 = getelementptr inbounds double* %E, i64 1, !dbg !332
  %2 = getelementptr inbounds double* %E, i64 2, !dbg !332
  %3 = getelementptr inbounds double* %E, i64 3, !dbg !332
  %4 = getelementptr inbounds double* %E, i64 4, !dbg !332
  %.pre = load double* %1, align 8, !dbg !332, !tbaa !122
  %.pre1 = load double* %2, align 8, !dbg !332, !tbaa !122
  %.pre2 = load double* %3, align 8, !dbg !332, !tbaa !122
  %.pre3 = load double* %4, align 8, !dbg !332, !tbaa !122
  br label %5, !dbg !331

; <label>:5                                       ; preds = %5, %0
  %6 = phi double [ %30, %5 ], [ %.pre3, %0 ], !dbg !332
  %7 = phi double [ %25, %5 ], [ %.pre2, %0 ], !dbg !332
  %8 = phi double [ %20, %5 ], [ %.pre1, %0 ], !dbg !332
  %9 = phi double [ %15, %5 ], [ %.pre, %0 ], !dbg !332
  %10 = phi i32 [ %31, %5 ], [ 0, %0 ], !dbg !332
  %11 = fadd double %9, %8, !dbg !332
  %12 = fadd double %11, %7, !dbg !332
  %13 = fsub double %12, %6, !dbg !332
  %14 = load double* @T, align 8, !dbg !332, !tbaa !122
  %15 = fmul double %13, %14, !dbg !332
  store double %15, double* %1, align 8, !dbg !332, !tbaa !122
  %16 = fadd double %15, %8, !dbg !333
  %17 = fsub double %16, %7, !dbg !333
  %18 = fadd double %17, %6, !dbg !333
  %19 = load double* @T, align 8, !dbg !333, !tbaa !122
  %20 = fmul double %18, %19, !dbg !333
  store double %20, double* %2, align 8, !dbg !333, !tbaa !122
  %21 = fsub double %15, %20, !dbg !334
  %22 = fadd double %21, %7, !dbg !334
  %23 = fadd double %22, %6, !dbg !334
  %24 = load double* @T, align 8, !dbg !334, !tbaa !122
  %25 = fmul double %23, %24, !dbg !334
  store double %25, double* %3, align 8, !dbg !334, !tbaa !122
  %26 = fsub double %20, %15, !dbg !335
  %27 = fadd double %25, %26, !dbg !335
  %28 = fadd double %6, %27, !dbg !335
  %29 = load double* @T2, align 8, !dbg !335, !tbaa !122
  %30 = fdiv double %28, %29, !dbg !335
  store double %30, double* %4, align 8, !dbg !335, !tbaa !122
  %31 = add nsw i32 %10, 1, !dbg !336
  %exitcond = icmp eq i32 %31, 6, !dbg !337
  br i1 %exitcond, label %32, label %5, !dbg !337

; <label>:32                                      ; preds = %5
  store i32 6, i32* @J, align 4, !dbg !336, !tbaa !187
  ret void, !dbg !339
}
...
define void @P3(double %X, double %Y, double* nocapture %Z) #0 {
  tail call void @llvm.dbg.value(metadata !{double %X}, i64 0, metadata !57), !dbg !340
  tail call void @llvm.dbg.value(metadata !{double %Y}, i64 0, metadata !58), !dbg !340
  tail call void @llvm.dbg.value(metadata !{double* %Z}, i64 0, metadata !59), !dbg !340
  tail call void @llvm.dbg.value(metadata !{double %X}, i64 0, metadata !60), !dbg !341
  tail call void @llvm.dbg.value(metadata !{double %Y}, i64 0, metadata !61), !dbg !342
  %1 = load double* @T, align 8, !dbg !343, !tbaa !122
  %2 = fadd double %X, %Y, !dbg !343
  %3 = fmul double %2, %1, !dbg !343
  tail call void @llvm.dbg.value(metadata !{double %3}, i64 0, metadata !60), !dbg !343
  %4 = fadd double %3, %Y, !dbg !344
  %5 = fmul double %1, %4, !dbg !344
  tail call void @llvm.dbg.value(metadata !{double %5}, i64 0, metadata !61), !dbg !344
  %6 = fadd double %3, %5, !dbg !345
  %7 = load double* @T2, align 8, !dbg !345, !tbaa !122
  %8 = fdiv double %6, %7, !dbg !345
  store double %8, double* %Z, align 8, !dbg !345, !tbaa !122
  ret void, !dbg !346
}

; Function Attrs: nounwind optsize uwtable
define void @P0() #0 {
  %1 = load i32* @K, align 4, !dbg !347, !tbaa !187
  %2 = sext i32 %1 to i64, !dbg !347
  %3 = getelementptr inbounds [5 x double]* @E1, i64 0, i64 %2, !dbg !347
  %4 = load double* %3, align 8, !dbg !347, !tbaa !122
  %5 = load i32* @J, align 4, !dbg !347, !tbaa !187
  %6 = sext i32 %5 to i64, !dbg !347
  %7 = getelementptr inbounds [5 x double]* @E1, i64 0, i64 %6, !dbg !347
  store double %4, double* %7, align 8, !dbg !347, !tbaa !122
  %8 = load i32* @L, align 4, !dbg !348, !tbaa !187
  %9 = sext i32 %8 to i64, !dbg !348
  %10 = getelementptr inbounds [5 x double]* @E1, i64 0, i64 %9, !dbg !348
  %11 = load double* %10, align 8, !dbg !348, !tbaa !122
  store double %11, double* %3, align 8, !dbg !348, !tbaa !122
  %12 = load double* %7, align 8, !dbg !349, !tbaa !122
  store double %12, double* %10, align 8, !dbg !349, !tbaa !122
  ret void, !dbg !350
}
...
!274 = metadata !{i32 415, i32 0, metadata !50, metadata !275}
!275 = metadata !{i32 311, i32 0, metadata !273, null}
!276 = metadata !{i32 416, i32 0, metadata !50, metadata !275}
!277 = metadata !{i32 417, i32 0, metadata !50, metadata !275}
!278 = metadata !{i32 314, i32 0, metadata !279, null}
!279 = metadata !{i32 786443, metadata !1, metadata !4, i32 314, i32 0, i32 29} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!280 = metadata !{i32 786689, metadata !62, metadata !"N", metadata !5, i32 16777650, metadata !16, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [N] [line 434]
!281 = metadata !{i32 434, i32 0, metadata !62, metadata !278}
!282 = metadata !{i32 786689, metadata !62, metadata !"J", metadata !5, i32 33554866, metadata !16, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [J] [line 434]
!283 = metadata !{i32 786689, metadata !62, metadata !"K", metadata !5, i32 50332082, metadata !16, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [K] [line 434]
!284 = metadata !{i32 786689, metadata !62, metadata !"X1", metadata !5, i32 67109298, metadata !28, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [X1] [line 434]
!285 = metadata !{i32 786689, metadata !62, metadata !"X2", metadata !5, i32 83886514, metadata !28, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [X2] [line 434]
!286 = metadata !{i32 786689, metadata !62, metadata !"X3", metadata !5, i32 100663730, metadata !28, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [X3] [line 434]
!287 = metadata !{i32 786689, metadata !62, metadata !"X4", metadata !5, i32 117440946, metadata !28, i32 0, metadata !278} ; [ DW_TAG_arg_variable ] [X4] [line 434]
!288 = metadata !{i32 436, i32 0, metadata !62, metadata !278}
!289 = metadata !{i32 322, i32 0, metadata !4, null}
!290 = metadata !{i32 323, i32 0, metadata !4, null}
!291 = metadata !{i32 325, i32 0, metadata !292, null}
!292 = metadata !{i32 786443, metadata !1, metadata !4, i32 325, i32 0, i32 30} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!293 = metadata !{i32 786689, metadata !62, metadata !"N", metadata !5, i32 16777650, metadata !16, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [N] [line 434]
!294 = metadata !{i32 333, i32 0, metadata !295, null}
!295 = metadata !{i32 786443, metadata !1, metadata !4, i32 333, i32 0, i32 32} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!296 = metadata !{i32 434, i32 0, metadata !62, metadata !294}
!297 = metadata !{i32 786689, metadata !62, metadata !"J", metadata !5, i32 33554866, metadata !16, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [J] [line 434]
!298 = metadata !{i64 3}
!299 = metadata !{i32 786689, metadata !62, metadata !"K", metadata !5, i32 50332082, metadata !16, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [K] [line 434]
!300 = metadata !{i32 786689, metadata !62, metadata !"X1", metadata !5, i32 67109298, metadata !28, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [X1] [line 434]
!301 = metadata !{i32 786689, metadata !62, metadata !"X2", metadata !5, i32 83886514, metadata !28, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [X2] [line 434]
!302 = metadata !{i32 786689, metadata !62, metadata !"X3", metadata !5, i32 100663730, metadata !28, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [X3] [line 434]
!303 = metadata !{i32 786689, metadata !62, metadata !"X4", metadata !5, i32 117440946, metadata !28, i32 0, metadata !294} ; [ DW_TAG_arg_variable ] [X4] [line 434]
!304 = metadata !{i32 436, i32 0, metadata !62, metadata !294}
!305 = metadata !{double 7.500000e-01}
!306 = metadata !{i32 341, i32 0, metadata !4, null}
!307 = metadata !{i32 343, i32 0, metadata !308, null}
!308 = metadata !{i32 786443, metadata !1, metadata !4, i32 343, i32 0, i32 33} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!309 = metadata !{i32 344, i32 0, metadata !308, null}
!310 = metadata !{i32 347, i32 0, metadata !311, null}
!311 = metadata !{i32 786443, metadata !1, metadata !4, i32 347, i32 0, i32 34} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!312 = metadata !{i32 786689, metadata !62, metadata !"N", metadata !5, i32 16777650, metadata !16, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [N] [line 434]
!313 = metadata !{i32 434, i32 0, metadata !62, metadata !310}
!314 = metadata !{i32 786689, metadata !62, metadata !"J", metadata !5, i32 33554866, metadata !16, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [J] [line 434]
!315 = metadata !{i32 786689, metadata !62, metadata !"K", metadata !5, i32 50332082, metadata !16, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [K] [line 434]
!316 = metadata !{i32 786689, metadata !62, metadata !"X1", metadata !5, i32 67109298, metadata !28, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [X1] [line 434]
!317 = metadata !{i32 786689, metadata !62, metadata !"X2", metadata !5, i32 83886514, metadata !28, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [X2] [line 434]
!318 = metadata !{i32 786689, metadata !62, metadata !"X3", metadata !5, i32 100663730, metadata !28, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [X3] [line 434]
!319 = metadata !{i32 786689, metadata !62, metadata !"X4", metadata !5, i32 117440946, metadata !28, i32 0, metadata !310} ; [ DW_TAG_arg_variable ] [X4] [line 434]
!320 = metadata !{i32 436, i32 0, metadata !62, metadata !310}
!321 = metadata !{i32 2}
!322 = metadata !{i32 355, i32 0, metadata !323, null}
!323 = metadata !{i32 786443, metadata !1, metadata !4, i32 355, i32 0, i32 35} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!324 = metadata !{i32 363, i32 0, metadata !4, null}
!325 = metadata !{i32 374, i32 0, metadata !4, null}
!326 = metadata !{i32 394, i32 0, metadata !4, null}
!327 = metadata !{i32 434, i32 0, metadata !62, null}
!328 = metadata !{i32 436, i32 0, metadata !62, null}
!329 = metadata !{i32 438, i32 0, metadata !62, null}
!330 = metadata !{i32 397, i32 0, metadata !44, null}
!331 = metadata !{i32 399, i32 0, metadata !44, null}
!332 = metadata !{i32 402, i32 0, metadata !44, null}
!333 = metadata !{i32 403, i32 0, metadata !44, null}
!334 = metadata !{i32 404, i32 0, metadata !44, null}
!335 = metadata !{i32 405, i32 0, metadata !44, null}
!336 = metadata !{i32 406, i32 0, metadata !44, null}
!337 = metadata !{i32 408, i32 0, metadata !338, null}
!338 = metadata !{i32 786443, metadata !1, metadata !44, i32 408, i32 0, i32 37} ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/llvm/projects/llvm-project/benchmarks/src/base/whetstone.c]
!339 = metadata !{i32 410, i32 0, metadata !44, null}
!340 = metadata !{i32 421, i32 0, metadata !53, null}
!341 = metadata !{i32 425, i32 0, metadata !53, null}
!342 = metadata !{i32 426, i32 0, metadata !53, null}
!343 = metadata !{i32 427, i32 0, metadata !53, null}
!344 = metadata !{i32 428, i32 0, metadata !53, null}
!345 = metadata !{i32 429, i32 0, metadata !53, null}
!346 = metadata !{i32 430, i32 0, metadata !53, null}
!347 = metadata !{i32 415, i32 0, metadata !50, null}
!348 = metadata !{i32 416, i32 0, metadata !50, null}
!349 = metadata !{i32 417, i32 0, metadata !50, null}
!350 = metadata !{i32 418, i32 0, metadata !50, null}
