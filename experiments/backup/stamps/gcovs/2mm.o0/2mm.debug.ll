...
entry:
  ...
  %5 = load i32* %ni, align 4
  %6 = load i32* %nj, align 4
  %7 = load i32* %nk, align 4
  %8 = load i32* %nl, align 4
  %9 = load [1024 x [1024 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [1024 x [1024 x double]]* %9, i32 0, i32 0
  %10 = load [1024 x [1024 x double]]** %B, align 8
  %arraydecay9 = getelementptr inbounds [1024 x [1024 x double]]* %10, i32 0, i32 0
  %11 = load [1024 x [1024 x double]]** %C, align 8
  %arraydecay10 = getelementptr inbounds [1024 x [1024 x double]]* %11, i32 0, i32 0
  %12 = load [1024 x [1024 x double]]** %D, align 8
  %arraydecay11 = getelementptr inbounds [1024 x [1024 x double]]* %12, i32 0, i32 0
  ...
  %13 = load i32* %ni, align 4
  %14 = load i32* %nj, align 4
  %15 = load i32* %nk, align 4
  %16 = load i32* %nl, align 4
  %17 = load double* %alpha, align 8
  %18 = load double* %beta, align 8
  %19 = load [1024 x [1024 x double]]** %tmp, align 8
  %arraydecay12 = getelementptr inbounds [1024 x [1024 x double]]* %19, i32 0, i32 0
  %20 = load [1024 x [1024 x double]]** %A, align 8
  %arraydecay13 = getelementptr inbounds [1024 x [1024 x double]]* %20, i32 0, i32 0
  %21 = load [1024 x [1024 x double]]** %B, align 8
  %arraydecay14 = getelementptr inbounds [1024 x [1024 x double]]* %21, i32 0, i32 0
  %22 = load [1024 x [1024 x double]]** %C, align 8
  %arraydecay15 = getelementptr inbounds [1024 x [1024 x double]]* %22, i32 0, i32 0
  %23 = load [1024 x [1024 x double]]** %D, align 8
  %arraydecay16 = getelementptr inbounds [1024 x [1024 x double]]* %23, i32 0, i32 0
...
land.lhs.true:                                    ; preds = %entry
  ...
  %26 = load i8** %arrayidx, align 8
  %call17 = call i32 @strcmp(i8* %26, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) #5
  %tobool = icmp ne i32 %call17, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %27 = load i32* %ni, align 4
  %28 = load i32* %nl, align 4
  %29 = load [1024 x [1024 x double]]** %D, align 8
  %arraydecay18 = getelementptr inbounds [1024 x [1024 x double]]* %29, i32 0, i32 0
  call void @print_array(i32 %27, i32 %28, [1024 x double]* %arraydecay18)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %30 = load [1024 x [1024 x double]]** %tmp, align 8
  %31 = bitcast [1024 x [1024 x double]]* %30 to i8*
  call void @free(i8* %31) #6
  %32 = load [1024 x [1024 x double]]** %A, align 8
  %33 = bitcast [1024 x [1024 x double]]* %32 to i8*
  call void @free(i8* %33) #6
  %34 = load [1024 x [1024 x double]]** %B, align 8
  %35 = bitcast [1024 x [1024 x double]]* %34 to i8*
  call void @free(i8* %35) #6
  %36 = load [1024 x [1024 x double]]** %C, align 8
  %37 = bitcast [1024 x [1024 x double]]* %36 to i8*
  call void @free(i8* %37) #6
  %38 = load [1024 x [1024 x double]]** %D, align 8
