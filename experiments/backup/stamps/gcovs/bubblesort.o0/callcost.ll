...
; Function Attrs: nounwind uwtable
define i32 @main() #0 {
  %1 = call i32 (i32, ...)* @init_PAPI(i32 2)
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 0, i32* %2
...
; <label>:12                                      ; preds = %4
  %13 = call i32 (...)* @print_results()
  ret i32 0
}

declare void @PAPI_shutdown() #2

declare void @start_measures(i32, ...) #2

declare void @get_results(...) #2

declare i32 @init_PAPI(i32, ...) #2

declare i32 @print_results(...) #2

attributes #0 = { nounwind uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #2 = { "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf"="8" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "unsafe-fp-math"="false" "use-soft-float"="false" }
