...
define %0* @list_new() #0 {
  ...
  %2 = call noalias i8* @malloc(i64 24) #6
  call void (...)* @get_results()
  %3 = bitcast i8* %2 to %0*
...
define i32 @main(i32, i8**) #0 {
  %3 = call i32 (i32, ...)* @init_PAPI(i32 31)
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i8**, align 8
  %7 = alloca i32, align 4
...
; <label>:11                                      ; preds = %2
  ...
  call void (i32, ...)* @start_measures(i32 29)
...
; <label>:23                                      ; preds = %19
  %24 = call i32 @test_lists()
  store i32 %24, i32* %8, align 4
  br label %19

; <label>:25                                      ; preds = %19
  %26 = load i32* %8, align 4
  call void (i32, ...)* @start_measures(i32 30)
  %27 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @12, i32 0, i32 0), i32 %26)
  call void (...)* @get_results()
  %28 = call i32 (...)* @print_results()
  ret i32 0
}
