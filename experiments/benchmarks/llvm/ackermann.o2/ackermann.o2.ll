...
entry:
  ...
  br i1 %cmp11, label %if.then, label %if.end.preheader, !dbg !41

if.end.preheader:                                 ; preds = %entry
  br label %if.end, !dbg !42

if.then.loopexit:                                 ; preds = %tailrecurse.backedge
  %N.tr.be.lcssa = phi i32 [ %N.tr.be, %tailrecurse.backedge ]
  br label %if.then

if.then:                                          ; preds = %if.then.loopexit, %entry
  %N.tr.lcssa = phi i32 [ %N, %entry ], [ %N.tr.be.lcssa, %if.then.loopexit ]
  %add = add nsw i32 %N.tr.lcssa, 1, !dbg !44
  ret i32 %add, !dbg !46

if.end:                                           ; preds = %if.end.preheader, %tailrecurse.backedge
  %N.tr13 = phi i32 [ %N.tr.be, %tailrecurse.backedge ], [ %N, %if.end.preheader ]
  %M.tr12 = phi i32 [ %sub, %tailrecurse.backedge ], [ %M, %if.end.preheader ]
  %cmp1 = icmp eq i32 %N.tr13, 0, !dbg !42
...
tailrecurse.backedge:                             ; preds = %if.end3, %if.end
  ...
  br i1 %cmp, label %if.then.loopexit, label %if.end, !dbg !41
}
...
cond.true:                                        ; preds = %entry
  ...
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !63, metadata !36) #4, !dbg !65
  %call.i = tail call i64 @strtol(i8* nocapture %0, i8** null, i32 10) #4, !dbg !66
  %conv.i = trunc i64 %call.i to i32, !dbg !67
  br label %cond.end, !dbg !56

cond.end:                                         ; preds = %entry, %cond.true
  %cond = phi i32 [ %conv.i, %cond.true ], [ 8, %entry ], !dbg !56
  tail call void @llvm.dbg.value(metadata i32 %cond, i64 0, metadata !23, metadata !36), !dbg !68
  %call1 = tail call i32 @Ack(i32 3, i32 %cond), !dbg !69
  %call2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %cond, i32 %call1) #4, !dbg !70
  ret i32 0, !dbg !71
}
...
!42 = !MDLocation(line: 12, column: 9, scope: !43)
!43 = !{!"0xb\0012\009\001", !1, !10}             ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/ackermann.c]
!44 = !MDLocation(line: 11, column: 25, scope: !45)
!45 = !{!"0xb\001", !1, !40}                      ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/ackermann.c]
!46 = !MDLocation(line: 14, column: 1, scope: !10)
!47 = !MDLocation(line: 12, column: 29, scope: !48)
!48 = !{!"0xb\001", !1, !43}                      ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/ackermann.c]
...
!62 = !{!"Simple C/C++ TBAA"}
!63 = !{!"0x101\00__nptr\0016777494\000", !24, !26, !29, !64} ; [ DW_TAG_arg_variable ] [__nptr] [line 278]
!64 = !MDLocation(line: 18, column: 28, scope: !17)
!65 = !MDLocation(line: 278, column: 1, scope: !24, inlinedAt: !64)
!66 = !MDLocation(line: 280, column: 16, scope: !24, inlinedAt: !64)
!67 = !MDLocation(line: 280, column: 10, scope: !24, inlinedAt: !64)
!68 = !MDLocation(line: 18, column: 9, scope: !17)
!69 = !MDLocation(line: 20, column: 34, scope: !17)
!70 = !MDLocation(line: 20, column: 5, scope: !17)
!71 = !MDLocation(line: 21, column: 5, scope: !17)
