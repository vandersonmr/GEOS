...
entry:
  ...
  %6 = insertelement <2 x double> undef, double %1, i32 0, !dbg !106
  %7 = insertelement <2 x double> %6, double %0, i32 1, !dbg !106
  %8 = insertelement <2 x double> undef, double %2, i32 0, !dbg !110
  %9 = insertelement <2 x double> %8, double %1, i32 1, !dbg !110
  %10 = insertelement <2 x double> undef, double %3, i32 0, !dbg !114
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %add = fadd double %0, %v.055, !dbg !116
  tail call void @llvm.dbg.value(metadata double %add, i64 0, metadata !15, metadata !80), !dbg !103
  %mul8 = fmul double %div6, %add, !dbg !117
  tail call void @llvm.dbg.value(metadata double %mul8, i64 0, metadata !14, metadata !80), !dbg !118
  %mul13 = fmul double %mul8, %5, !dbg !119
  %add14 = fadd double %4, %mul13, !dbg !112
  %11 = insertelement <2 x double> undef, double %mul8, i32 0, !dbg !114
  %12 = insertelement <2 x double> %11, double %mul8, i32 1, !dbg !114
  %13 = insertelement <2 x double> %10, double %add14, i32 1, !dbg !114
  %14 = fmul <2 x double> %12, %13, !dbg !114
  %15 = fadd <2 x double> %9, %14, !dbg !110
  %16 = fmul <2 x double> %15, %12, !dbg !120
  %17 = fadd <2 x double> %7, %16, !dbg !106
  %18 = extractelement <2 x double> %17, i32 0, !dbg !121
  %19 = extractelement <2 x double> %17, i32 1, !dbg !121
  %div19 = fdiv double %18, %19, !dbg !121
  %add20 = fadd double %s.056, %div19, !dbg !122
  tail call void @llvm.dbg.value(metadata double %add20, i64 0, metadata !13, metadata !80), !dbg !102
  %inc = add nuw nsw i64 %i.057, 1, !dbg !123
  tail call void @llvm.dbg.value(metadata i64 %inc, i64 0, metadata !20, metadata !80), !dbg !105
  %exitcond = icmp eq i64 %inc, 312500000, !dbg !115
  br i1 %exitcond, label %for.end, label %for.body, !dbg !115

for.end:                                          ; preds = %for.body
  %add20.lcssa = phi double [ %add20, %for.body ]
  %add21 = fadd double %1, %2, !dbg !124
  %add22 = fadd double %add21, %3, !dbg !124
  %add23 = fadd double %1, %0, !dbg !125
  %add24 = fadd double %add23, %4, !dbg !125
  %add25 = fadd double %add24, %5, !dbg !125
  %div26 = fdiv double %add22, %add25, !dbg !126
  %add27 = fadd double %div26, %1, !dbg !127
  %20 = load double* @two, align 8, !dbg !128, !tbaa !83
  %mul28 = fmul double %add20.lcssa, %20, !dbg !128
  %add29 = fadd double %add27, %mul28, !dbg !127
  %mul30 = fmul double %div6, %add29, !dbg !129
  %div31 = fdiv double %mul30, %20, !dbg !129
  store double %div31, double* @sa, align 8, !dbg !130, !tbaa !83
  %div32 = fdiv double %0, %div31, !dbg !131
  store double %div32, double* @sb, align 8, !dbg !132, !tbaa !83
  %sub38 = fadd double %div32, -2.520000e+01, !dbg !133
  store double %sub38, double* @sc, align 8, !dbg !134, !tbaa !83
  %mul39 = fmul double %sub38, 1.000000e-30, !dbg !135
...
!114 = !MDLocation(line: 248, column: 24, scope: !107)
!115 = !MDLocation(line: 244, column: 4, scope: !109)
!116 = !MDLocation(line: 246, column: 10, scope: !107)
!117 = !MDLocation(line: 247, column: 10, scope: !107)
!118 = !MDLocation(line: 179, column: 13, scope: !7)
!119 = !MDLocation(line: 248, column: 46, scope: !107)
!120 = !MDLocation(line: 248, column: 18, scope: !107)
!121 = !MDLocation(line: 248, column: 14, scope: !107)
!122 = !MDLocation(line: 248, column: 10, scope: !107)
!123 = !MDLocation(line: 244, column: 28, scope: !108)
!124 = !MDLocation(line: 251, column: 10, scope: !7)
!125 = !MDLocation(line: 251, column: 21, scope: !7)
!126 = !MDLocation(line: 251, column: 9, scope: !7)
!127 = !MDLocation(line: 254, column: 15, scope: !7)
!128 = !MDLocation(line: 254, column: 25, scope: !7)
!129 = !MDLocation(line: 254, column: 9, scope: !7)
!130 = !MDLocation(line: 254, column: 4, scope: !7)
!131 = !MDLocation(line: 255, column: 9, scope: !7)
!132 = !MDLocation(line: 255, column: 4, scope: !7)
!133 = !MDLocation(line: 257, column: 9, scope: !7)
!134 = !MDLocation(line: 257, column: 4, scope: !7)
!135 = !MDLocation(line: 263, column: 11, scope: !7)
!136 = !MDLocation(line: 262, column: 4, scope: !7)
!137 = !MDLocation(line: 266, column: 4, scope: !7)
