...
for.end:                                          ; preds = %for.body
  %9 = load double* @piref, align 8, !dbg !128, !tbaa !83
  %10 = load double* @three, align 8, !dbg !129, !tbaa !83
  %div22 = fdiv double %9, %10, !dbg !128
  tail call void @llvm.dbg.value(metadata double %div22, i64 0, metadata !13, metadata !80), !dbg !117
  %mul23 = fmul double %div22, %div22, !dbg !130
  tail call void @llvm.dbg.value(metadata double %mul23, i64 0, metadata !15, metadata !80), !dbg !119
  %11 = load double* @A6, align 8, !dbg !131, !tbaa !83
  %mul24 = fmul double %11, %mul23, !dbg !131
  %12 = load double* @A5, align 8, !dbg !132, !tbaa !83
  %sub25 = fsub double %mul24, %12, !dbg !131
  %mul26 = fmul double %mul23, %sub25, !dbg !133
  %13 = load double* @A4, align 8, !dbg !134, !tbaa !83
  %add27 = fadd double %13, %mul26, !dbg !133
  %mul28 = fmul double %mul23, %add27, !dbg !135
  %14 = load double* @A3, align 8, !dbg !136, !tbaa !83
  %sub29 = fsub double %mul28, %14, !dbg !135
  %mul30 = fmul double %mul23, %sub29, !dbg !137
  %15 = load double* @A2, align 8, !dbg !138, !tbaa !83
  %add31 = fadd double %15, %mul30, !dbg !137
  %mul32 = fmul double %mul23, %add31, !dbg !139
  %16 = load double* @A1, align 8, !dbg !140, !tbaa !83
  %add33 = fadd double %16, %mul32, !dbg !139
  %mul34 = fmul double %mul23, %add33, !dbg !141
  %17 = load double* @one, align 8, !dbg !142, !tbaa !83
  %add35 = fadd double %17, %mul34, !dbg !141
  %mul36 = fmul double %div22, %add35, !dbg !143
  %18 = load double* @two, align 8, !dbg !144, !tbaa !83
  %mul37 = fmul double %add21, %18, !dbg !144
  %add38 = fadd double %mul37, %mul36, !dbg !145
  %mul39 = fmul double %div, %add38, !dbg !146
  %div40 = fdiv double %mul39, %18, !dbg !146
  store double %div40, double* @sa, align 8, !dbg !147, !tbaa !83
  store double 5.000000e-01, double* @sb, align 8, !dbg !148, !tbaa !83
  %sub41 = fadd double %div40, -5.000000e-01, !dbg !149
  store double %sub41, double* @sc, align 8, !dbg !150, !tbaa !83
  %mul42 = fmul double %sub41, 1.000000e-30, !dbg !151
  %call43 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %mul42, double 0.000000e+00, double 0.000000e+00) #3, !dbg !152
  ret i32 0, !dbg !153
}
...
!129 = !MDLocation(line: 251, column: 17, scope: !6)
!130 = !MDLocation(line: 252, column: 9, scope: !6)
!131 = !MDLocation(line: 253, column: 19, scope: !6)
!132 = !MDLocation(line: 253, column: 24, scope: !6)
!133 = !MDLocation(line: 253, column: 18, scope: !6)
!134 = !MDLocation(line: 253, column: 30, scope: !6)
!135 = !MDLocation(line: 253, column: 17, scope: !6)
!136 = !MDLocation(line: 253, column: 36, scope: !6)
!137 = !MDLocation(line: 253, column: 16, scope: !6)
!138 = !MDLocation(line: 253, column: 42, scope: !6)
!139 = !MDLocation(line: 253, column: 15, scope: !6)
!140 = !MDLocation(line: 253, column: 48, scope: !6)
!141 = !MDLocation(line: 253, column: 14, scope: !6)
!142 = !MDLocation(line: 253, column: 54, scope: !6)
!143 = !MDLocation(line: 253, column: 9, scope: !6)
!144 = !MDLocation(line: 255, column: 20, scope: !6)
!145 = !MDLocation(line: 255, column: 15, scope: !6)
!146 = !MDLocation(line: 255, column: 9, scope: !6)
!147 = !MDLocation(line: 255, column: 4, scope: !6)
!148 = !MDLocation(line: 256, column: 4, scope: !6)
!149 = !MDLocation(line: 257, column: 9, scope: !6)
!150 = !MDLocation(line: 257, column: 4, scope: !6)
!151 = !MDLocation(line: 263, column: 11, scope: !6)
!152 = !MDLocation(line: 262, column: 4, scope: !6)
!153 = !MDLocation(line: 267, column: 4, scope: !6)
