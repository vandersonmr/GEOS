...
for.end:                                          ; preds = %for.body
  %11 = load double* @piref, align 8, !dbg !132, !tbaa !83
  %12 = load double* @three, align 8, !dbg !133, !tbaa !83
  %div23 = fdiv double %11, %12, !dbg !132
  tail call void @llvm.dbg.value(metadata double %div23, i64 0, metadata !13, metadata !80), !dbg !122
  %mul24 = fmul double %div23, %div23, !dbg !134
  tail call void @llvm.dbg.value(metadata double %mul24, i64 0, metadata !15, metadata !80), !dbg !124
  %13 = load double* @B6, align 8, !dbg !135, !tbaa !83
  %mul25 = fmul double %13, %mul24, !dbg !135
  %14 = load double* @B5, align 8, !dbg !136, !tbaa !83
  %add26 = fadd double %mul25, %14, !dbg !135
  %mul27 = fmul double %mul24, %add26, !dbg !137
  %15 = load double* @B4, align 8, !dbg !138, !tbaa !83
  %add28 = fadd double %15, %mul27, !dbg !137
  %mul29 = fmul double %mul24, %add28, !dbg !139
  %16 = load double* @B3, align 8, !dbg !140, !tbaa !83
  %add30 = fadd double %16, %mul29, !dbg !139
  %mul31 = fmul double %mul24, %add30, !dbg !141
  %17 = load double* @B2, align 8, !dbg !142, !tbaa !83
  %add32 = fadd double %17, %mul31, !dbg !141
  %mul33 = fmul double %mul24, %add32, !dbg !143
  %18 = load double* @B1, align 8, !dbg !144, !tbaa !83
  %add34 = fadd double %18, %mul33, !dbg !143
  %mul35 = fmul double %mul24, %add34, !dbg !145
  %19 = load double* @one, align 8, !dbg !146, !tbaa !83
  %add36 = fadd double %19, %mul35, !dbg !145
  %add37 = fadd double %19, %add36, !dbg !147
  %20 = load double* @two, align 8, !dbg !148, !tbaa !83
  %mul38 = fmul double %add22, %20, !dbg !148
  %add39 = fadd double %mul38, %add37, !dbg !147
  %mul40 = fmul double %div, %add39, !dbg !149
  %div41 = fdiv double %mul40, %20, !dbg !149
  store double %div41, double* @sa, align 8, !dbg !150, !tbaa !83
  %21 = load double* @piref, align 8, !dbg !151, !tbaa !83
  %22 = load double* @three, align 8, !dbg !152, !tbaa !83
  %div42 = fdiv double %21, %22, !dbg !151
  tail call void @llvm.dbg.value(metadata double %div42, i64 0, metadata !13, metadata !80), !dbg !122
  %mul43 = fmul double %div42, %div42, !dbg !153
  tail call void @llvm.dbg.value(metadata double %mul43, i64 0, metadata !15, metadata !80), !dbg !124
  %23 = load double* @A6, align 8, !dbg !154, !tbaa !83
  %mul44 = fmul double %23, %mul43, !dbg !154
  %24 = load double* @A5, align 8, !dbg !155, !tbaa !83
  %add45 = fadd double %mul44, %24, !dbg !154
  %mul46 = fmul double %mul43, %add45, !dbg !156
  %25 = load double* @A4, align 8, !dbg !157, !tbaa !83
  %add47 = fadd double %25, %mul46, !dbg !156
  %mul48 = fmul double %mul43, %add47, !dbg !158
  %26 = load double* @A3, align 8, !dbg !159, !tbaa !83
  %add49 = fadd double %26, %mul48, !dbg !158
  %mul50 = fmul double %mul43, %add49, !dbg !160
  %27 = load double* @A2, align 8, !dbg !161, !tbaa !83
  %add51 = fadd double %27, %mul50, !dbg !160
  %mul52 = fmul double %mul43, %add51, !dbg !162
  %28 = load double* @A1, align 8, !dbg !163, !tbaa !83
  %add53 = fadd double %28, %mul52, !dbg !162
  %mul54 = fmul double %mul43, %add53, !dbg !164
  %29 = load double* @A0, align 8, !dbg !165, !tbaa !83
  %add55 = fadd double %29, %mul54, !dbg !164
  %mul56 = fmul double %div42, %add55, !dbg !166
  store double %mul56, double* @sb, align 8, !dbg !167, !tbaa !83
  %30 = load double* @sa, align 8, !dbg !168, !tbaa !83
  %sub57 = fsub double %30, %mul56, !dbg !168
  store double %sub57, double* @sc, align 8, !dbg !169, !tbaa !83
  %mul58 = fmul double %sub57, 1.000000e-30, !dbg !170
  %call59 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %mul58, double 0.000000e+00, double 0.000000e+00) #3, !dbg !171
  ret i32 0, !dbg !172
}
...
!133 = !MDLocation(line: 251, column: 17, scope: !6)
!134 = !MDLocation(line: 252, column: 9, scope: !6)
!135 = !MDLocation(line: 253, column: 24, scope: !6)
!136 = !MDLocation(line: 253, column: 29, scope: !6)
!137 = !MDLocation(line: 253, column: 21, scope: !6)
!138 = !MDLocation(line: 253, column: 33, scope: !6)
!139 = !MDLocation(line: 253, column: 18, scope: !6)
!140 = !MDLocation(line: 253, column: 37, scope: !6)
!141 = !MDLocation(line: 253, column: 15, scope: !6)
!142 = !MDLocation(line: 253, column: 41, scope: !6)
!143 = !MDLocation(line: 253, column: 12, scope: !6)
!144 = !MDLocation(line: 253, column: 45, scope: !6)
!145 = !MDLocation(line: 253, column: 9, scope: !6)
!146 = !MDLocation(line: 253, column: 49, scope: !6)
!147 = !MDLocation(line: 255, column: 15, scope: !6)
!148 = !MDLocation(line: 255, column: 26, scope: !6)
!149 = !MDLocation(line: 255, column: 9, scope: !6)
!150 = !MDLocation(line: 255, column: 4, scope: !6)
!151 = !MDLocation(line: 256, column: 9, scope: !6)
!152 = !MDLocation(line: 256, column: 17, scope: !6)
!153 = !MDLocation(line: 257, column: 9, scope: !6)
!154 = !MDLocation(line: 258, column: 19, scope: !6)
!155 = !MDLocation(line: 258, column: 24, scope: !6)
!156 = !MDLocation(line: 258, column: 18, scope: !6)
!157 = !MDLocation(line: 258, column: 30, scope: !6)
!158 = !MDLocation(line: 258, column: 17, scope: !6)
!159 = !MDLocation(line: 258, column: 36, scope: !6)
!160 = !MDLocation(line: 258, column: 16, scope: !6)
!161 = !MDLocation(line: 258, column: 42, scope: !6)
!162 = !MDLocation(line: 258, column: 15, scope: !6)
!163 = !MDLocation(line: 258, column: 48, scope: !6)
!164 = !MDLocation(line: 258, column: 14, scope: !6)
!165 = !MDLocation(line: 258, column: 54, scope: !6)
!166 = !MDLocation(line: 258, column: 9, scope: !6)
!167 = !MDLocation(line: 258, column: 4, scope: !6)
!168 = !MDLocation(line: 259, column: 9, scope: !6)
!169 = !MDLocation(line: 259, column: 4, scope: !6)
!170 = !MDLocation(line: 265, column: 11, scope: !6)
!171 = !MDLocation(line: 264, column: 4, scope: !6)
!172 = !MDLocation(line: 269, column: 4, scope: !6)
