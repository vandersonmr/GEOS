...
for.body:                                         ; preds = %for.body, %entry
  ...
  %mul33 = fmul double %mul20, %add32, !dbg !136
  %add34 = fadd double %s.0106, %mul33, !dbg !137
...
for.end:                                          ; preds = %for.body
  ...
  %16 = load double* @four, align 8, !dbg !140, !tbaa !83
  ...
  store double 2.500000e-01, double* @sb, align 8, !dbg !173, !tbaa !83
  %sub67 = fadd double %div66, -2.500000e-01, !dbg !174
...
!131 = !MDLocation(line: 248, column: 27, scope: !105)
!132 = !MDLocation(line: 248, column: 24, scope: !105)
!133 = !MDLocation(line: 248, column: 21, scope: !105)
!134 = !MDLocation(line: 248, column: 18, scope: !105)
!135 = !MDLocation(line: 248, column: 15, scope: !105)
...
!176 = !MDLocation(line: 265, column: 11, scope: !6)
!177 = !MDLocation(line: 264, column: 4, scope: !6)
!178 = !MDLocation(line: 269, column: 4, scope: !6)
