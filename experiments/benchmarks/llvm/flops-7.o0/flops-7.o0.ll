...
entry:
  ...
  store double 0.000000e+00, double* %s, align 8, !dbg !105
  %2 = load double* @one, align 8, !dbg !106
  store double %2, double* %w, align 8, !dbg !107
  store double 0x40599541F7F192A4, double* @sa, align 8, !dbg !108
  %3 = load double* @sa, align 8, !dbg !109
  %4 = load i64* %m, align 8, !dbg !110
  %conv = sitofp i64 %4 to double, !dbg !111
  %div = fdiv double %3, %conv, !dbg !109
  store double %div, double* %v, align 8, !dbg !112
  store i64 1, i64* %i, align 8, !dbg !113
  br label %for.cond, !dbg !113

for.cond:                                         ; preds = %for.inc, %entry
  %5 = load i64* %i, align 8, !dbg !115
  %6 = load i64* %m, align 8, !dbg !119
  %sub = sub nsw i64 %6, 1, !dbg !119
  %cmp = icmp sle i64 %5, %sub, !dbg !120
  br i1 %cmp, label %for.body, label %for.end, !dbg !121

for.body:                                         ; preds = %for.cond
  %7 = load i64* %i, align 8, !dbg !122
  %conv5 = sitofp i64 %7 to double, !dbg !124
  %8 = load double* %v, align 8, !dbg !125
  %mul6 = fmul double %conv5, %8, !dbg !124
  store double %mul6, double* %x, align 8, !dbg !126
  %9 = load double* %x, align 8, !dbg !127
  %10 = load double* %x, align 8, !dbg !128
  %mul7 = fmul double %9, %10, !dbg !127
  store double %mul7, double* %u, align 8, !dbg !129
  %11 = load double* %s, align 8, !dbg !130
  %12 = load double* %w, align 8, !dbg !131
  %13 = load double* %x, align 8, !dbg !132
  %14 = load double* %w, align 8, !dbg !133
  %add = fadd double %13, %14, !dbg !132
  %div8 = fdiv double %12, %add, !dbg !131
  %sub9 = fsub double %11, %div8, !dbg !130
  %15 = load double* %x, align 8, !dbg !134
  %16 = load double* %u, align 8, !dbg !135
  %17 = load double* %w, align 8, !dbg !136
  %add10 = fadd double %16, %17, !dbg !135
  %div11 = fdiv double %15, %add10, !dbg !134
  %sub12 = fsub double %sub9, %div11, !dbg !130
  %18 = load double* %u, align 8, !dbg !137
  %19 = load double* %x, align 8, !dbg !138
  %20 = load double* %u, align 8, !dbg !139
  %mul13 = fmul double %19, %20, !dbg !138
  %21 = load double* %w, align 8, !dbg !140
  %add14 = fadd double %mul13, %21, !dbg !138
  %div15 = fdiv double %18, %add14, !dbg !137
  %sub16 = fsub double %sub12, %div15, !dbg !130
  store double %sub16, double* %s, align 8, !dbg !141
  br label %for.inc, !dbg !142

for.inc:                                          ; preds = %for.body
  %22 = load i64* %i, align 8, !dbg !143
  %inc = add nsw i64 %22, 1, !dbg !143
  store i64 %inc, i64* %i, align 8, !dbg !143
  br label %for.cond, !dbg !144

for.end:                                          ; preds = %for.cond
  %23 = load double* @sa, align 8, !dbg !145
  store double %23, double* %x, align 8, !dbg !146
  %24 = load double* %x, align 8, !dbg !147
  %25 = load double* %x, align 8, !dbg !148
  %mul17 = fmul double %24, %25, !dbg !147
  store double %mul17, double* %u, align 8, !dbg !149
  %26 = load double* %w, align 8, !dbg !150
  %sub18 = fsub double -0.000000e+00, %26, !dbg !151
  %27 = load double* %w, align 8, !dbg !152
  %28 = load double* %x, align 8, !dbg !153
  %29 = load double* %w, align 8, !dbg !154
  %add19 = fadd double %28, %29, !dbg !153
  %div20 = fdiv double %27, %add19, !dbg !152
  %sub21 = fsub double %sub18, %div20, !dbg !151
  %30 = load double* %x, align 8, !dbg !155
  %31 = load double* %u, align 8, !dbg !156
  %32 = load double* %w, align 8, !dbg !157
  %add22 = fadd double %31, %32, !dbg !156
  %div23 = fdiv double %30, %add22, !dbg !155
  %sub24 = fsub double %sub21, %div23, !dbg !151
  %33 = load double* %u, align 8, !dbg !158
  %34 = load double* %x, align 8, !dbg !159
  %35 = load double* %u, align 8, !dbg !160
  %mul25 = fmul double %34, %35, !dbg !159
  %36 = load double* %w, align 8, !dbg !161
  %add26 = fadd double %mul25, %36, !dbg !159
  %div27 = fdiv double %33, %add26, !dbg !158
  %sub28 = fsub double %sub24, %div27, !dbg !151
  store double %sub28, double* @sa, align 8, !dbg !162
  %37 = load double* %v, align 8, !dbg !163
  %mul29 = fmul double 1.800000e+01, %37, !dbg !164
  %38 = load double* @sa, align 8, !dbg !165
  %39 = load double* @two, align 8, !dbg !166
  %40 = load double* %s, align 8, !dbg !167
  %mul30 = fmul double %39, %40, !dbg !166
  %add31 = fadd double %38, %mul30, !dbg !165
  %mul32 = fmul double %mul29, %add31, !dbg !164
  store double %mul32, double* @sa, align 8, !dbg !168
  %41 = load double* @sa, align 8, !dbg !169
  %conv33 = fptosi double %41 to i64, !dbg !170
  %mul34 = mul nsw i64 -2000, %conv33, !dbg !171
  store i64 %mul34, i64* %m, align 8, !dbg !172
  %42 = load i64* %m, align 8, !dbg !173
  %conv35 = sitofp i64 %42 to double, !dbg !174
  %43 = load double* @scale, align 8, !dbg !175
  %div36 = fdiv double %conv35, %43, !dbg !174
  %conv37 = fptosi double %div36 to i64, !dbg !176
  store i64 %conv37, i64* %m, align 8, !dbg !177
  %44 = load double* @sa, align 8, !dbg !178
  %add38 = fadd double %44, 5.002000e+02, !dbg !178
  store double %add38, double* @sc, align 8, !dbg !179
  %45 = load double* @sc, align 8, !dbg !180
  %mul39 = fmul double %45, 1.000000e-30, !dbg !180
  %call40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i32 0, i32 0), double %mul39, double 0.000000e+00, double 0.000000e+00), !dbg !181
  ret i32 0, !dbg !182
}
...
!0 = !{!"0x11\0012\00clang version 3.6.0 (https://github.com/llvm-mirror/clang f06a0c83eb2f36bf182224a127ad378f42ab5094) (https://github.com/llvm-mirror/llvm 0b37b7bf52b92f9e1e7ffaff4063fd1184d2eec3)\000\00\000\00\001", !1, !2, !3, !6, !12, !2} ; [ DW_TAG_compile_unit ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c] [DW_LANG_C99]
...
!103 = !MDLocation(line: 226, column: 8, scope: !7)
!104 = !MDLocation(line: 226, column: 4, scope: !7)
!105 = !MDLocation(line: 242, column: 4, scope: !7)
!106 = !MDLocation(line: 243, column: 8, scope: !7)
!107 = !MDLocation(line: 243, column: 4, scope: !7)
!108 = !MDLocation(line: 244, column: 4, scope: !7)
!109 = !MDLocation(line: 245, column: 8, scope: !7)
!110 = !MDLocation(line: 245, column: 21, scope: !7)
!111 = !MDLocation(line: 245, column: 13, scope: !7)
!112 = !MDLocation(line: 245, column: 4, scope: !7)
!113 = !MDLocation(line: 247, column: 10, scope: !114)
!114 = !{!"0xb\00247\004\000", !1, !7}            ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c]
!115 = !MDLocation(line: 247, column: 18, scope: !116)
!116 = !{!"0xb\002", !1, !117}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c]
!117 = !{!"0xb\001", !1, !118}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c]
!118 = !{!"0xb\00247\004\001", !1, !114}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c]
!119 = !MDLocation(line: 247, column: 23, scope: !118)
!120 = !MDLocation(line: 247, column: 18, scope: !118)
!121 = !MDLocation(line: 247, column: 4, scope: !114)
!122 = !MDLocation(line: 249, column: 16, scope: !123)
!123 = !{!"0xb\00248\004\002", !1, !118}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-7.c]
!124 = !MDLocation(line: 249, column: 8, scope: !123)
!125 = !MDLocation(line: 249, column: 20, scope: !123)
!126 = !MDLocation(line: 249, column: 4, scope: !123)
!127 = !MDLocation(line: 250, column: 8, scope: !123)
!128 = !MDLocation(line: 250, column: 12, scope: !123)
!129 = !MDLocation(line: 250, column: 4, scope: !123)
!130 = !MDLocation(line: 251, column: 8, scope: !123)
!131 = !MDLocation(line: 251, column: 12, scope: !123)
!132 = !MDLocation(line: 251, column: 18, scope: !123)
!133 = !MDLocation(line: 251, column: 22, scope: !123)
!134 = !MDLocation(line: 251, column: 28, scope: !123)
!135 = !MDLocation(line: 251, column: 34, scope: !123)
!136 = !MDLocation(line: 251, column: 38, scope: !123)
!137 = !MDLocation(line: 251, column: 44, scope: !123)
!138 = !MDLocation(line: 251, column: 50, scope: !123)
!139 = !MDLocation(line: 251, column: 54, scope: !123)
!140 = !MDLocation(line: 251, column: 58, scope: !123)
!141 = !MDLocation(line: 251, column: 4, scope: !123)
!142 = !MDLocation(line: 252, column: 4, scope: !123)
!143 = !MDLocation(line: 247, column: 29, scope: !118)
!144 = !MDLocation(line: 247, column: 4, scope: !118)
!145 = !MDLocation(line: 256, column: 9, scope: !7)
!146 = !MDLocation(line: 256, column: 4, scope: !7)
!147 = !MDLocation(line: 257, column: 9, scope: !7)
!148 = !MDLocation(line: 257, column: 13, scope: !7)
!149 = !MDLocation(line: 257, column: 4, scope: !7)
!150 = !MDLocation(line: 258, column: 10, scope: !7)
!151 = !MDLocation(line: 258, column: 9, scope: !7)
!152 = !MDLocation(line: 258, column: 14, scope: !7)
!153 = !MDLocation(line: 258, column: 20, scope: !7)
!154 = !MDLocation(line: 258, column: 24, scope: !7)
!155 = !MDLocation(line: 258, column: 30, scope: !7)
!156 = !MDLocation(line: 258, column: 36, scope: !7)
!157 = !MDLocation(line: 258, column: 40, scope: !7)
!158 = !MDLocation(line: 258, column: 46, scope: !7)
!159 = !MDLocation(line: 258, column: 52, scope: !7)
!160 = !MDLocation(line: 258, column: 56, scope: !7)
!161 = !MDLocation(line: 258, column: 60, scope: !7)
!162 = !MDLocation(line: 258, column: 4, scope: !7)
!163 = !MDLocation(line: 259, column: 16, scope: !7)
!164 = !MDLocation(line: 259, column: 9, scope: !7)
!165 = !MDLocation(line: 259, column: 21, scope: !7)
!166 = !MDLocation(line: 259, column: 26, scope: !7)
!167 = !MDLocation(line: 259, column: 32, scope: !7)
!168 = !MDLocation(line: 259, column: 4, scope: !7)
!169 = !MDLocation(line: 261, column: 23, scope: !7)
!170 = !MDLocation(line: 261, column: 17, scope: !7)
!171 = !MDLocation(line: 261, column: 9, scope: !7)
!172 = !MDLocation(line: 261, column: 4, scope: !7)
!173 = !MDLocation(line: 262, column: 24, scope: !7)
!174 = !MDLocation(line: 262, column: 16, scope: !7)
!175 = !MDLocation(line: 262, column: 28, scope: !7)
!176 = !MDLocation(line: 262, column: 8, scope: !7)
!177 = !MDLocation(line: 262, column: 4, scope: !7)
!178 = !MDLocation(line: 264, column: 9, scope: !7)
!179 = !MDLocation(line: 264, column: 4, scope: !7)
!180 = !MDLocation(line: 270, column: 11, scope: !7)
!181 = !MDLocation(line: 269, column: 4, scope: !7)
!182 = !MDLocation(line: 275, column: 4, scope: !7)
