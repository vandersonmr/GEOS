...
for.end:                                          ; preds = %for.body
  %15 = load double* @piref, align 8, !dbg !138, !tbaa !83
  %16 = load double* @three, align 8, !dbg !139, !tbaa !83
  %div36 = fdiv double %15, %16, !dbg !138
  tail call void @llvm.dbg.value(metadata double %div36, i64 0, metadata !13, metadata !80), !dbg !122
  %mul37 = fmul double %div36, %div36, !dbg !140
  tail call void @llvm.dbg.value(metadata double %mul37, i64 0, metadata !15, metadata !80), !dbg !124
  %17 = load double* @A6, align 8, !dbg !141, !tbaa !83
  %mul38 = fmul double %17, %mul37, !dbg !141
  %18 = load double* @A5, align 8, !dbg !142, !tbaa !83
  %add39 = fadd double %mul38, %18, !dbg !141
  %mul40 = fmul double %mul37, %add39, !dbg !143
  %19 = load double* @A4, align 8, !dbg !144, !tbaa !83
  %add41 = fadd double %19, %mul40, !dbg !143
  %mul42 = fmul double %mul37, %add41, !dbg !145
  %20 = load double* @A3, align 8, !dbg !146, !tbaa !83
  %add43 = fadd double %20, %mul42, !dbg !145
  %mul44 = fmul double %mul37, %add43, !dbg !147
  %21 = load double* @A2, align 8, !dbg !148, !tbaa !83
  %add45 = fadd double %21, %mul44, !dbg !147
  %mul46 = fmul double %mul37, %add45, !dbg !149
  %22 = load double* @A1, align 8, !dbg !150, !tbaa !83
  %add47 = fadd double %22, %mul46, !dbg !149
  %mul48 = fmul double %mul37, %add47, !dbg !151
  %23 = load double* @one, align 8, !dbg !152, !tbaa !83
  %add49 = fadd double %23, %mul48, !dbg !151
  %mul50 = fmul double %div36, %add49, !dbg !153
  store double %mul50, double* @sa, align 8, !dbg !154, !tbaa !83
  %24 = load double* @B6, align 8, !dbg !155, !tbaa !83
  %mul51 = fmul double %mul37, %24, !dbg !155
  %25 = load double* @B5, align 8, !dbg !156, !tbaa !83
  %add52 = fadd double %mul51, %25, !dbg !155
  %mul53 = fmul double %mul37, %add52, !dbg !157
  %26 = load double* @B4, align 8, !dbg !158, !tbaa !83
  %add54 = fadd double %26, %mul53, !dbg !157
  %mul55 = fmul double %mul37, %add54, !dbg !159
  %27 = load double* @B3, align 8, !dbg !160, !tbaa !83
  %add56 = fadd double %27, %mul55, !dbg !159
  %mul57 = fmul double %mul37, %add56, !dbg !161
  %28 = load double* @B2, align 8, !dbg !162, !tbaa !83
  %add58 = fadd double %28, %mul57, !dbg !161
  %mul59 = fmul double %mul37, %add58, !dbg !163
  %29 = load double* @B1, align 8, !dbg !164, !tbaa !83
  %add60 = fadd double %29, %mul59, !dbg !163
  %mul61 = fmul double %mul37, %add60, !dbg !165
  %30 = load double* @one, align 8, !dbg !166, !tbaa !83
  %add62 = fadd double %30, %mul61, !dbg !165
  %31 = load double* @sa, align 8, !dbg !167, !tbaa !83
  %mul63 = fmul double %31, %add62, !dbg !167
  %mul64 = fmul double %add62, %mul63, !dbg !167
  %32 = load double* @two, align 8, !dbg !168, !tbaa !83
  %mul65 = fmul double %add35, %32, !dbg !168
  %add66 = fadd double %mul65, %mul64, !dbg !169
  %mul67 = fmul double %div, %add66, !dbg !170
  %div68 = fdiv double %mul67, %32, !dbg !170
  store double %div68, double* @sa, align 8, !dbg !171, !tbaa !83
  store double 0x3FD2AAAAAAAAAAAB, double* @sb, align 8, !dbg !172, !tbaa !83
  %sub69 = fadd double %div68, 0xBFD2AAAAAAAAAAAB, !dbg !173
  store double %sub69, double* @sc, align 8, !dbg !174, !tbaa !83
  %mul70 = fmul double %sub69, 1.000000e-30, !dbg !175
  %call71 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %mul70, double 0.000000e+00, double 0.000000e+00) #3, !dbg !176
  ret i32 0, !dbg !177
}
...
!139 = !MDLocation(line: 253, column: 17, scope: !6)
!140 = !MDLocation(line: 254, column: 9, scope: !6)
!141 = !MDLocation(line: 255, column: 17, scope: !6)
!142 = !MDLocation(line: 255, column: 22, scope: !6)
!143 = !MDLocation(line: 255, column: 16, scope: !6)
!144 = !MDLocation(line: 255, column: 28, scope: !6)
!145 = !MDLocation(line: 255, column: 15, scope: !6)
!146 = !MDLocation(line: 255, column: 34, scope: !6)
!147 = !MDLocation(line: 255, column: 14, scope: !6)
!148 = !MDLocation(line: 255, column: 40, scope: !6)
!149 = !MDLocation(line: 255, column: 13, scope: !6)
!150 = !MDLocation(line: 255, column: 46, scope: !6)
!151 = !MDLocation(line: 255, column: 12, scope: !6)
!152 = !MDLocation(line: 255, column: 52, scope: !6)
!153 = !MDLocation(line: 255, column: 9, scope: !6)
!154 = !MDLocation(line: 255, column: 4, scope: !6)
!155 = !MDLocation(line: 256, column: 24, scope: !6)
!156 = !MDLocation(line: 256, column: 29, scope: !6)
!157 = !MDLocation(line: 256, column: 21, scope: !6)
!158 = !MDLocation(line: 256, column: 33, scope: !6)
!159 = !MDLocation(line: 256, column: 18, scope: !6)
!160 = !MDLocation(line: 256, column: 37, scope: !6)
!161 = !MDLocation(line: 256, column: 15, scope: !6)
!162 = !MDLocation(line: 256, column: 41, scope: !6)
!163 = !MDLocation(line: 256, column: 12, scope: !6)
!164 = !MDLocation(line: 256, column: 45, scope: !6)
!165 = !MDLocation(line: 256, column: 9, scope: !6)
!166 = !MDLocation(line: 256, column: 49, scope: !6)
!167 = !MDLocation(line: 257, column: 9, scope: !6)
!168 = !MDLocation(line: 259, column: 20, scope: !6)
!169 = !MDLocation(line: 259, column: 15, scope: !6)
!170 = !MDLocation(line: 259, column: 9, scope: !6)
!171 = !MDLocation(line: 259, column: 4, scope: !6)
!172 = !MDLocation(line: 260, column: 4, scope: !6)
!173 = !MDLocation(line: 261, column: 9, scope: !6)
!174 = !MDLocation(line: 261, column: 4, scope: !6)
!175 = !MDLocation(line: 267, column: 11, scope: !6)
!176 = !MDLocation(line: 266, column: 4, scope: !6)
!177 = !MDLocation(line: 271, column: 4, scope: !6)
