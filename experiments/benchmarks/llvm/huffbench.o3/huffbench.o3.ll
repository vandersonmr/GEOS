...
cond.true.lr.ph:                                  ; preds = %entry
  ...
  br i1 %cmp10, label %if.then12.us.preheader, label %for.cond.preheader

if.then12.us.preheader:                           ; preds = %cond.true.lr.ph
  br label %if.then12.us, !dbg !544

for.cond.preheader:                               ; preds = %cond.true.lr.ph
  %backedge.overflow = icmp eq i32 %argc, 1
  br i1 %backedge.overflow, label %for.cond.preheader92, label %overflow.checked

for.cond.preheader92:                             ; preds = %middle.block, %for.cond.preheader
  %i.082.ph = phi i32 [ 1, %for.cond.preheader ], [ %resume.val, %middle.block ]
  %2 = add i32 %i.082.ph, 1
  %3 = icmp sgt i32 %argc, %2
  %smax = select i1 %3, i32 %argc, i32 %2
  %4 = sub i32 %smax, %i.082.ph
  %xtraiter = and i32 %4, 7
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  %lcmp.overflow = icmp eq i32 %4, 0
  %lcmp.or = or i1 %lcmp.overflow, %lcmp.mod
  br i1 %lcmp.or, label %for.cond.prol, label %for.cond.preheader92.split

for.cond.prol:                                    ; preds = %for.cond.prol, %for.cond.preheader92
  %i.082.prol = phi i32 [ %inc.prol, %for.cond.prol ], [ %i.082.ph, %for.cond.preheader92 ]
  %prol.iter = phi i32 [ %xtraiter, %for.cond.preheader92 ], [ %prol.iter.sub, %for.cond.prol ]
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.prol = add nuw nsw i32 %i.082.prol, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc.prol, i64 0, metadata !81, metadata !131), !dbg !547
  %cmp1.prol = icmp slt i32 %inc.prol, %argc, !dbg !548
  %prol.iter.sub = sub i32 %prol.iter, 1, !dbg !549
  %prol.iter.cmp = icmp ne i32 %prol.iter.sub, 0, !dbg !549
  br i1 %prol.iter.cmp, label %for.cond.prol, label %for.cond.preheader92.split, !llvm.loop !550

for.cond.preheader92.split:                       ; preds = %for.cond.prol, %for.cond.preheader92
  %i.082.unr = phi i32 [ %i.082.ph, %for.cond.preheader92 ], [ %inc.prol, %for.cond.prol ]
  %5 = icmp ult i32 %4, 8
  br i1 %5, label %if.end44.loopexit93, label %for.cond.preheader92.split.split

for.cond.preheader92.split.split:                 ; preds = %for.cond.preheader92.split
  br label %for.cond, !dbg !544

overflow.checked:                                 ; preds = %for.cond.preheader
  %6 = add i32 %argc, -1, !dbg !544
  %n.vec = and i32 %6, -32, !dbg !546
  %end.idx.rnd.down91 = or i32 %n.vec, 1, !dbg !546
  %cmp.zero = icmp eq i32 %end.idx.rnd.down91, 1, !dbg !546
...
vector.body.preheader:                            ; preds = %overflow.checked
  ...
  %11 = lshr i32 %10, 5
  %12 = add i32 %11, 1
  %xtraiter94 = and i32 %12, 7
  %lcmp.mod95 = icmp ne i32 %xtraiter94, 0
  %lcmp.overflow96 = icmp eq i32 %12, 0
  %lcmp.or97 = or i1 %lcmp.overflow96, %lcmp.mod95
  br i1 %lcmp.or97, label %vector.body.prol, label %vector.body.preheader.split

vector.body.prol:                                 ; preds = %vector.body.prol, %vector.body.preheader
  %index.prol = phi i32 [ %index.next.prol, %vector.body.prol ], [ 1, %vector.body.preheader ], !dbg !546
  %prol.iter98 = phi i32 [ %xtraiter94, %vector.body.preheader ], [ %prol.iter98.sub, %vector.body.prol ]
  %index.next.prol = add i32 %index.prol, 32, !dbg !546
  %13 = icmp eq i32 %index.next.prol, %end.idx.rnd.down91, !dbg !546
  %prol.iter98.sub = sub i32 %prol.iter98, 1, !dbg !546
  %prol.iter98.cmp = icmp ne i32 %prol.iter98.sub, 0, !dbg !546
  br i1 %prol.iter98.cmp, label %vector.body.prol, label %vector.body.preheader.split, !llvm.loop !551

vector.body.preheader.split:                      ; preds = %vector.body.prol, %vector.body.preheader
  %index.unr = phi i32 [ 1, %vector.body.preheader ], [ %index.next.prol, %vector.body.prol ]
  %14 = icmp ult i32 %12, 8
  br i1 %14, label %middle.block.loopexit, label %vector.body.preheader.split.split

vector.body.preheader.split.split:                ; preds = %vector.body.preheader.split
  br label %vector.body, !dbg !546

vector.body:                                      ; preds = %vector.body, %vector.body.preheader.split.split
  %index = phi i32 [ %index.unr, %vector.body.preheader.split.split ], [ %index.next.7, %vector.body ], !dbg !546
  %index.next = add i32 %index, 32, !dbg !546
  %index.next.1 = add i32 %index.next, 32, !dbg !546
  %index.next.2 = add i32 %index.next.1, 32, !dbg !546
  %index.next.3 = add i32 %index.next.2, 32, !dbg !546
  %index.next.4 = add i32 %index.next.3, 32, !dbg !546
  %index.next.5 = add i32 %index.next.4, 32, !dbg !546
  %index.next.6 = add i32 %index.next.5, 32, !dbg !546
  %index.next.7 = add i32 %index.next.6, 32, !dbg !546
  %15 = icmp eq i32 %index.next.7, %end.idx.rnd.down91, !dbg !546
  br i1 %15, label %middle.block.loopexit.unr-lcssa, label %vector.body, !dbg !546, !llvm.loop !552
...
middle.block:                                     ; preds = %middle.block.loopexit, %overflow.checked
  %resume.val = phi i32 [ 1, %overflow.checked ], [ %end.idx.rnd.down91, %middle.block.loopexit ]
  %cmp.n = icmp eq i32 %resume.val, %argc
  br i1 %cmp.n, label %if.end44, label %for.cond.preheader92

for.cond.us:                                      ; preds = %if.then12.us, %if.then22.us, %if.end38.us
  %inc.us86 = add nuw nsw i32 %i.082.us, 1, !dbg !546
  %cmp1.us = icmp slt i32 %inc.us86, %argc, !dbg !548
  br i1 %cmp1.us, label %if.then12.us, label %if.end44.loopexit, !dbg !549

if.then12.us:                                     ; preds = %if.then12.us.preheader, %for.cond.us
  %i.082.us = phi i32 [ %inc.us86, %for.cond.us ], [ 1, %if.then12.us.preheader ]
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %16 = load i8* %arrayidx14, align 1, !dbg !534, !tbaa !163
  %cmp20.us = icmp eq i8 %16, 103, !dbg !555
  br i1 %cmp20.us, label %if.then22.us, label %for.cond.us, !dbg !557

if.then22.us:                                     ; preds = %if.then12.us
  %17 = load i8* %arrayidx24, align 1, !dbg !537, !tbaa !163
  %cmp30.us = icmp eq i8 %17, 97, !dbg !558
  br i1 %cmp30.us, label %if.end38.us, label %for.cond.us, !dbg !560

if.end38.us:                                      ; preds = %if.then22.us
  %18 = load i8* %arrayidx34, align 1, !dbg !541, !tbaa !163
  %tobool.us = icmp eq i8 %18, 0, !dbg !561
  br i1 %tobool.us, label %if.end44.loopexit, label %for.cond.us, !dbg !561

for.cond:                                         ; preds = %for.cond, %for.cond.preheader92.split.split
  %i.082 = phi i32 [ %i.082.unr, %for.cond.preheader92.split.split ], [ %inc.7, %for.cond ]
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc = add nuw nsw i32 %i.082, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.1 = add nuw nsw i32 %inc, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.2 = add nuw nsw i32 %inc.1, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.3 = add nuw nsw i32 %inc.2, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.4 = add nuw nsw i32 %inc.3, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.5 = add nuw nsw i32 %inc.4, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.6 = add nuw nsw i32 %inc.5, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata i64 3, i64 0, metadata !92, metadata !131), !dbg !544
  tail call void @llvm.dbg.value(metadata i8* %0, i64 0, metadata !93, metadata !131), !dbg !545
  %inc.7 = add nuw nsw i32 %inc.6, 1, !dbg !546
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !81, metadata !131), !dbg !547
  %cmp1.7 = icmp slt i32 %inc.7, %argc, !dbg !548
  br i1 %cmp1.7, label %for.cond, label %if.end44.loopexit93.unr-lcssa, !dbg !549, !llvm.loop !562

if.end44.loopexit:                                ; preds = %if.end38.us, %for.cond.us
  %ga_testing.0.ph = phi i1 [ false, %for.cond.us ], [ true, %if.end38.us ]
  br label %if.end44

if.end44.loopexit93.unr-lcssa:                    ; preds = %for.cond
  br label %if.end44.loopexit93

if.end44.loopexit93:                              ; preds = %for.cond.preheader92.split, %if.end44.loopexit93.unr-lcssa
  br label %if.end44

if.end44:                                         ; preds = %if.end44.loopexit93, %if.end44.loopexit, %middle.block, %entry
  %ga_testing.0 = phi i1 [ false, %entry ], [ false, %middle.block ], [ %ga_testing.0.ph, %if.end44.loopexit ], [ false, %if.end44.loopexit93 ]
  tail call void @llvm.dbg.value(metadata i64 10000000, i64 0, metadata !563, metadata !131) #3, !dbg !565
  tail call void @llvm.dbg.value(metadata !2, i64 0, metadata !566, metadata !131) #3, !dbg !567
  %call.i = tail call noalias i8* @malloc(i64 10000000) #3, !dbg !568
  tail call void @llvm.dbg.value(metadata i8* %call.i, i64 0, metadata !569, metadata !131) #3, !dbg !570
  tail call void @llvm.dbg.value(metadata i8* %call.i, i64 0, metadata !571, metadata !131) #3, !dbg !572
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !573, metadata !131) #3, !dbg !574
  br label %for.body.i, !dbg !575

for.body.i:                                       ; preds = %for.body.i, %if.end44
  %indvars.iv.i = phi i64 [ 0, %if.end44 ], [ %indvars.iv.next.i, %for.body.i ], !dbg !564
  %ptr.010.i = phi i8* [ %call.i, %if.end44 ], [ %incdec.ptr.i, %for.body.i ], !dbg !564
  %19 = load i64* @seed, align 8, !dbg !576, !tbaa !145
  %xor.i.i = xor i64 %19, 123459876, !dbg !576
  %div.i.i = sdiv i64 %xor.i.i, 127773, !dbg !578
  tail call void @llvm.dbg.value(metadata i64 %div.i.i, i64 0, metadata !579, metadata !131) #3, !dbg !580
  %20 = mul i64 %div.i.i, -127773, !dbg !581
  %sub6.i7.i78 = add i64 %xor.i.i, %20, !dbg !581
  %mul1.i.i = mul nsw i64 %sub6.i7.i78, 16807, !dbg !582
  %21 = mul i64 %div.i.i, -2836, !dbg !582
  %sub37.i8.i79 = add i64 %mul1.i.i, %21, !dbg !582
  %cmp.i.i = icmp slt i64 %sub37.i8.i79, 0, !dbg !583
  %add.i.i = add nsw i64 %sub37.i8.i79, 2147483647, !dbg !584
  %add.sub3.i.i = select i1 %cmp.i.i, i64 %add.i.i, i64 %sub37.i8.i79, !dbg !585
  %rem.i.i = srem i64 %add.sub3.i.i, 32, !dbg !586
  tail call void @llvm.dbg.value(metadata i64 %rem.i.i, i64 0, metadata !587, metadata !131) #3, !dbg !588
  %xor4.i.i = xor i64 %add.sub3.i.i, 123459876, !dbg !589
  store i64 %xor4.i.i, i64* @seed, align 8, !dbg !589, !tbaa !145
  %arrayidx.i = getelementptr inbounds [33 x i8]* @.str, i64 0, i64 %rem.i.i, !dbg !590
  %22 = load i8* %arrayidx.i, align 1, !dbg !590, !tbaa !163
  store i8 %22, i8* %ptr.010.i, align 1, !dbg !591, !tbaa !163
  %incdec.ptr.i = getelementptr inbounds i8* %ptr.010.i, i64 1, !dbg !592
  tail call void @llvm.dbg.value(metadata i8* %incdec.ptr.i, i64 0, metadata !571, metadata !131) #3, !dbg !572
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1, !dbg !575
  %exitcond.i = icmp eq i64 %indvars.iv.i, 9999999, !dbg !575
  br i1 %exitcond.i, label %for.cond47.preheader, label %for.body.i, !dbg !575

for.cond47.preheader:                             ; preds = %for.body.i
  tail call void @compdecomp(i8* %call.i, i64 10000000), !dbg !593
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @compdecomp(i8* %call.i, i64 10000000), !dbg !593
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @compdecomp(i8* %call.i, i64 10000000), !dbg !593
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !81, metadata !131), !dbg !547
  ...
  tail call void @compdecomp(i8* %call.i, i64 10000000), !dbg !593
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !81, metadata !131), !dbg !547
  tail call void @llvm.dbg.value(metadata double 0.000000e+00, i64 0, metadata !97, metadata !131), !dbg !596
  tail call void @free(i8* %call.i) #3, !dbg !597
  %23 = load %struct._IO_FILE** @stdout, align 8, !dbg !598, !tbaa !375
  br i1 %ga_testing.0, label %if.then56, label %if.else, !dbg !600

if.then56:                                        ; preds = %for.cond47.preheader
  %call57 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([3 x i8]* @.str5, i64 0, i64 0), double 0.000000e+00) #3, !dbg !601
  br label %if.end59, !dbg !601

if.else:                                          ; preds = %for.cond47.preheader
  %call58 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %23, i8* getelementptr inbounds ([35 x i8]* @.str6, i64 0, i64 0), double 0.000000e+00) #3, !dbg !602
  br label %if.end59

if.end59:                                         ; preds = %if.else, %if.then56
  %24 = load %struct._IO_FILE** @stdout, align 8, !dbg !603, !tbaa !375
  %call60 = tail call i32 @fflush(%struct._IO_FILE* %24) #3, !dbg !604
  ret i32 0, !dbg !605
}
...
!544 = !MDLocation(line: 445, column: 18, scope: !85)
!545 = !MDLocation(line: 445, column: 18, scope: !94)
!546 = !MDLocation(line: 443, column: 31, scope: !88)
!547 = !MDLocation(line: 436, column: 9, scope: !74)
!548 = !MDLocation(line: 443, column: 21, scope: !88)
!549 = !MDLocation(line: 443, column: 9, scope: !89)
!550 = distinct !{!550, !201}
!551 = distinct !{!551, !201}
!552 = distinct !{!552, !553, !554}
!553 = !{!"llvm.loop.vectorize.width", i32 1}
!554 = !{!"llvm.loop.interleave.count", i32 1}
!555 = !MDLocation(line: 445, column: 18, scope: !556)
!556 = !{!"0xb\009", !1, !540}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/huffbench.c]
!557 = !MDLocation(line: 445, column: 18, scope: !536)
!558 = !MDLocation(line: 445, column: 18, scope: !559)
!559 = !{!"0xb\0013", !1, !543}                   ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/huffbench.c]
!560 = !MDLocation(line: 445, column: 18, scope: !539)
!561 = !MDLocation(line: 445, column: 17, scope: !87)
!562 = distinct !{!562, !553, !554}
!563 = !{!"0x101\00n\0016777304\000", !18, !19, !7, !564} ; [ DW_TAG_arg_variable ] [n] [line 88]
!564 = !MDLocation(line: 454, column: 24, scope: !74)
!565 = !MDLocation(line: 88, column: 34, scope: !18, inlinedAt: !564)
!566 = !{!"0x100\00codes\0090\000", !18, !19, !25, !564} ; [ DW_TAG_auto_variable ] [codes] [line 90]
!567 = !MDLocation(line: 90, column: 12, scope: !18, inlinedAt: !564)
!568 = !MDLocation(line: 92, column: 29, scope: !18, inlinedAt: !564)
!569 = !{!"0x100\00result\0092\000", !18, !19, !4, !564} ; [ DW_TAG_auto_variable ] [result] [line 92]
!570 = !MDLocation(line: 92, column: 12, scope: !18, inlinedAt: !564)
!571 = !{!"0x100\00ptr\0093\000", !18, !19, !4, !564} ; [ DW_TAG_auto_variable ] [ptr] [line 93]
!572 = !MDLocation(line: 93, column: 12, scope: !18, inlinedAt: !564)
!573 = !{!"0x100\00i\0095\000", !18, !19, !29, !564} ; [ DW_TAG_auto_variable ] [i] [line 95]
!574 = !MDLocation(line: 95, column: 9, scope: !18, inlinedAt: !564)
!575 = !MDLocation(line: 96, column: 5, scope: !140, inlinedAt: !564)
!576 = !MDLocation(line: 52, column: 5, scope: !110, inlinedAt: !577)
!577 = !MDLocation(line: 98, column: 28, scope: !144, inlinedAt: !564)
!578 = !MDLocation(line: 53, column: 9, scope: !110, inlinedAt: !577)
!579 = !{!"0x100\00k\0049\000", !110, !19, !115, !577} ; [ DW_TAG_auto_variable ] [k] [line 49]
!580 = !MDLocation(line: 49, column: 10, scope: !110, inlinedAt: !577)
!581 = !MDLocation(line: 54, column: 18, scope: !110, inlinedAt: !577)
!582 = !MDLocation(line: 54, column: 12, scope: !110, inlinedAt: !577)
!583 = !MDLocation(line: 56, column: 9, scope: !155, inlinedAt: !577)
!584 = !MDLocation(line: 57, column: 9, scope: !155, inlinedAt: !577)
!585 = !MDLocation(line: 56, column: 9, scope: !110, inlinedAt: !577)
!586 = !MDLocation(line: 59, column: 23, scope: !110, inlinedAt: !577)
!587 = !{!"0x100\00result\0050\000", !110, !19, !7, !577} ; [ DW_TAG_auto_variable ] [result] [line 50]
!588 = !MDLocation(line: 50, column: 12, scope: !110, inlinedAt: !577)
!589 = !MDLocation(line: 60, column: 5, scope: !110, inlinedAt: !577)
!590 = !MDLocation(line: 98, column: 22, scope: !144, inlinedAt: !564)
!591 = !MDLocation(line: 98, column: 9, scope: !144, inlinedAt: !564)
!592 = !MDLocation(line: 99, column: 9, scope: !144, inlinedAt: !564)
!593 = !MDLocation(line: 468, column: 9, scope: !594)
!594 = !{!"0xb\00467\005\0077", !1, !595}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/huffbench.c]
!595 = !{!"0xb\00467\005\0076", !1, !74}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/huffbench.c]
!596 = !MDLocation(line: 472, column: 12, scope: !74)
!597 = !MDLocation(line: 481, column: 5, scope: !74)
!598 = !MDLocation(line: 485, column: 17, scope: !599)
!599 = !{!"0xb\00484\009\0078", !1, !74}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/huffbench.c]
!600 = !MDLocation(line: 484, column: 9, scope: !74)
!601 = !MDLocation(line: 485, column: 9, scope: !599)
!602 = !MDLocation(line: 487, column: 9, scope: !599)
!603 = !MDLocation(line: 489, column: 12, scope: !74)
!604 = !MDLocation(line: 489, column: 5, scope: !74)
!605 = !MDLocation(line: 492, column: 5, scope: !74)
