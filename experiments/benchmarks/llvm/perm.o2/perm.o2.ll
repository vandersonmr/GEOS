...
entry:
  ...
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !142, !tbaa !134
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !142, !tbaa !134
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !142, !tbaa !134
  store i32 3, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 4), align 16, !dbg !142, !tbaa !134
  store i32 4, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 5), align 4, !dbg !142, !tbaa !134
  store i32 5, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 6), align 8, !dbg !142, !tbaa !134
  store i32 6, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 7), align 4, !dbg !142, !tbaa !134
  ret void, !dbg !146
}
...
entry:
  tail call void @llvm.dbg.value(metadata i32 %n, i64 0, metadata !27, metadata !130), !dbg !147
  %0 = load i32* @pctr, align 4, !dbg !148, !tbaa !134
  %add = add i32 %0, 1, !dbg !148
  store i32 %add, i32* @pctr, align 4, !dbg !149, !tbaa !134
  %cmp = icmp eq i32 %n, 1, !dbg !150
  br i1 %cmp, label %if.end, label %if.then, !dbg !152

if.then:                                          ; preds = %entry
  %sub = add nsw i32 %n, -1, !dbg !153
  tail call void @Permute(i32 %sub), !dbg !155
  tail call void @llvm.dbg.value(metadata i32 %sub, i64 0, metadata !28, metadata !130), !dbg !156
  %cmp218 = icmp sgt i32 %n, 1, !dbg !157
  br i1 %cmp218, label %for.body.lr.ph, label %if.end, !dbg !162

for.body.lr.ph:                                   ; preds = %if.then
  %idxprom = sext i32 %n to i64, !dbg !163
  %arrayidx = getelementptr inbounds [11 x i32]* @permarray, i64 0, i64 %idxprom, !dbg !163
  br label %for.body, !dbg !162

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %indvars.iv.in = phi i64 [ %idxprom, %for.body.lr.ph ], [ %indvars.iv, %for.body ]
  %indvars.iv = add nsw i64 %indvars.iv.in, -1, !dbg !162
  %arrayidx4 = getelementptr inbounds [11 x i32]* @permarray, i64 0, i64 %indvars.iv, !dbg !165
  tail call void @llvm.dbg.value(metadata i32* %arrayidx, i64 0, metadata !166, metadata !130), !dbg !168
  tail call void @llvm.dbg.value(metadata i32* %arrayidx4, i64 0, metadata !169, metadata !130), !dbg !170
  %1 = load i32* %arrayidx, align 4, !dbg !171, !tbaa !134
  tail call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !172, metadata !130), !dbg !173
  %2 = load i32* %arrayidx4, align 4, !dbg !174, !tbaa !134
  store i32 %2, i32* %arrayidx, align 4, !dbg !175, !tbaa !134
  store i32 %1, i32* %arrayidx4, align 4, !dbg !176, !tbaa !134
  tail call void @Permute(i32 %sub), !dbg !177
  tail call void @llvm.dbg.value(metadata i32* %arrayidx, i64 0, metadata !178, metadata !130), !dbg !180
  tail call void @llvm.dbg.value(metadata i32* %arrayidx4, i64 0, metadata !181, metadata !130), !dbg !182
  %3 = load i32* %arrayidx, align 4, !dbg !183, !tbaa !134
  tail call void @llvm.dbg.value(metadata i32 %3, i64 0, metadata !184, metadata !130), !dbg !185
  %4 = load i32* %arrayidx4, align 4, !dbg !186, !tbaa !134
  store i32 %4, i32* %arrayidx, align 4, !dbg !187, !tbaa !134
  store i32 %3, i32* %arrayidx4, align 4, !dbg !188, !tbaa !134
  %cmp2 = icmp sgt i64 %indvars.iv, 1, !dbg !157
  br i1 %cmp2, label %for.body, label %if.end.loopexit, !dbg !162
...
define void @Perm() #0 {
entry:
  store i32 0, i32* @pctr, align 4, !dbg !190, !tbaa !134
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !31, metadata !130), !dbg !191
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !192, metadata !130), !dbg !197
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !198, !tbaa !134
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !198, !tbaa !134
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !198, !tbaa !134
  store i32 3, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 4), align 16, !dbg !198, !tbaa !134
  store i32 4, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 5), align 4, !dbg !198, !tbaa !134
  store i32 5, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 6), align 8, !dbg !198, !tbaa !134
  store i32 6, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 7), align 4, !dbg !198, !tbaa !134
  tail call void @Permute(i32 7), !dbg !199
  tail call void @llvm.dbg.value(metadata i32 2, i64 0, metadata !31, metadata !130), !dbg !191
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !192, metadata !130), !dbg !197
  store i32 0, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 1), align 4, !dbg !198, !tbaa !134
  store i32 1, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 2), align 8, !dbg !198, !tbaa !134
  store i32 2, i32* getelementptr inbounds ([11 x i32]* @permarray, i64 0, i64 3), align 4, !dbg !198, !tbaa !134
  ...
  tail call void @Permute(i32 7), !dbg !199
  tail call void @llvm.dbg.value(metadata i32 2, i64 0, metadata !31, metadata !130), !dbg !191
  %0 = load i32* @pctr, align 4, !dbg !200, !tbaa !134
  %cmp1 = icmp eq i32 %0, 43300, !dbg !200
  br i1 %cmp1, label %if.end, label %if.then, !dbg !202

if.then:                                          ; preds = %entry
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @str, i64 0, i64 0)), !dbg !203
  %.pre = load i32* @pctr, align 4, !dbg !204, !tbaa !134
  br label %if.end, !dbg !203

if.end:                                           ; preds = %entry, %if.then
  %1 = phi i32 [ 43300, %entry ], [ %.pre, %if.then ]
  %call2 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %1) #3, !dbg !205
  ret void, !dbg !206
}
...
define i32 @main() #0 {
entry:
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !34, metadata !130), !dbg !207
  br label %for.body, !dbg !208

for.body:                                         ; preds = %for.body, %entry
  %i.02 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  tail call void @Perm(), !dbg !210
  %inc = add nuw nsw i32 %i.02, 1, !dbg !213
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !34, metadata !130), !dbg !207
  %exitcond = icmp eq i32 %inc, 100, !dbg !208
...
!142 = !MDLocation(line: 134, column: 6, scope: !143)
!143 = !{!"0xb\00133\0029\002", !1, !144}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!144 = !{!"0xb\00133\002\001", !1, !145}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!145 = !{!"0xb\00133\002\000", !1, !20}           ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!146 = !MDLocation(line: 136, column: 1, scope: !20)
!147 = !MDLocation(line: 138, column: 19, scope: !23)
!148 = !MDLocation(line: 140, column: 9, scope: !23)
!149 = !MDLocation(line: 140, column: 2, scope: !23)
!150 = !MDLocation(line: 141, column: 7, scope: !151)
!151 = !{!"0xb\00141\007\003", !1, !23}           ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!152 = !MDLocation(line: 141, column: 7, scope: !23)
!153 = !MDLocation(line: 142, column: 14, scope: !154)
!154 = !{!"0xb\00141\0015\004", !1, !151}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!155 = !MDLocation(line: 142, column: 6, scope: !154)
!156 = !MDLocation(line: 139, column: 6, scope: !23)
!157 = !MDLocation(line: 143, column: 21, scope: !158)
!158 = !{!"0xb\002", !1, !159}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!159 = !{!"0xb\001", !1, !160}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!160 = !{!"0xb\00143\006\006", !1, !161}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!161 = !{!"0xb\00143\006\005", !1, !154}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!162 = !MDLocation(line: 143, column: 6, scope: !161)
!163 = !MDLocation(line: 144, column: 9, scope: !164)
!164 = !{!"0xb\00143\0035\007", !1, !160}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!165 = !MDLocation(line: 144, column: 23, scope: !164)
!166 = !{!"0x101\00a\0016777342\000", !12, !7, !15, !167} ; [ DW_TAG_arg_variable ] [a] [line 126]
!167 = !MDLocation(line: 144, column: 4, scope: !164)
!168 = !MDLocation(line: 126, column: 18, scope: !12, inlinedAt: !167)
!169 = !{!"0x101\00b\0033554558\000", !12, !7, !15, !167} ; [ DW_TAG_arg_variable ] [b] [line 126]
!170 = !MDLocation(line: 126, column: 26, scope: !12, inlinedAt: !167)
!171 = !MDLocation(line: 128, column: 6, scope: !12, inlinedAt: !167)
!172 = !{!"0x100\00t\00127\000", !12, !7, !4, !167} ; [ DW_TAG_auto_variable ] [t] [line 127]
!173 = !MDLocation(line: 127, column: 6, scope: !12, inlinedAt: !167)
!174 = !MDLocation(line: 128, column: 16, scope: !12, inlinedAt: !167)
!175 = !MDLocation(line: 128, column: 11, scope: !12, inlinedAt: !167)
!176 = !MDLocation(line: 128, column: 21, scope: !12, inlinedAt: !167)
!177 = !MDLocation(line: 145, column: 4, scope: !164)
!178 = !{!"0x101\00a\0016777342\000", !12, !7, !15, !179} ; [ DW_TAG_arg_variable ] [a] [line 126]
!179 = !MDLocation(line: 146, column: 4, scope: !164)
!180 = !MDLocation(line: 126, column: 18, scope: !12, inlinedAt: !179)
!181 = !{!"0x101\00b\0033554558\000", !12, !7, !15, !179} ; [ DW_TAG_arg_variable ] [b] [line 126]
!182 = !MDLocation(line: 126, column: 26, scope: !12, inlinedAt: !179)
!183 = !MDLocation(line: 128, column: 6, scope: !12, inlinedAt: !179)
!184 = !{!"0x100\00t\00127\000", !12, !7, !4, !179} ; [ DW_TAG_auto_variable ] [t] [line 127]
!185 = !MDLocation(line: 127, column: 6, scope: !12, inlinedAt: !179)
!186 = !MDLocation(line: 128, column: 16, scope: !12, inlinedAt: !179)
!187 = !MDLocation(line: 128, column: 11, scope: !12, inlinedAt: !179)
!188 = !MDLocation(line: 128, column: 21, scope: !12, inlinedAt: !179)
!189 = !MDLocation(line: 149, column: 1, scope: !23)
!190 = !MDLocation(line: 153, column: 5, scope: !29)
!191 = !MDLocation(line: 152, column: 9, scope: !29)
!192 = !{!"0x100\00i\00132\000", !20, !7, !4, !193} ; [ DW_TAG_auto_variable ] [i] [line 132]
!193 = !MDLocation(line: 155, column: 3, scope: !194)
!194 = !{!"0xb\00154\0032\0010", !1, !195}        ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!195 = !{!"0xb\00154\005\009", !1, !196}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!196 = !{!"0xb\00154\005\008", !1, !29}           ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!197 = !MDLocation(line: 132, column: 6, scope: !20, inlinedAt: !193)
!198 = !MDLocation(line: 134, column: 6, scope: !143, inlinedAt: !193)
!199 = !MDLocation(line: 156, column: 3, scope: !194)
!200 = !MDLocation(line: 158, column: 10, scope: !201)
!201 = !{!"0xb\00158\0010\0011", !1, !29}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!202 = !MDLocation(line: 158, column: 10, scope: !29)
!203 = !MDLocation(line: 159, column: 2, scope: !201)
!204 = !MDLocation(line: 160, column: 17, scope: !29)
!205 = !MDLocation(line: 160, column: 2, scope: !29)
!206 = !MDLocation(line: 161, column: 1, scope: !29)
!207 = !MDLocation(line: 165, column: 6, scope: !32)
!208 = !MDLocation(line: 166, column: 2, scope: !209)
!209 = !{!"0xb\00166\002\0012", !1, !32}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!210 = !MDLocation(line: 166, column: 28, scope: !211)
!211 = !{!"0xb\002", !1, !212}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!212 = !{!"0xb\00166\002\0013", !1, !209}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!213 = !MDLocation(line: 166, column: 23, scope: !214)
!214 = !{!"0xb\003", !1, !212}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/perm.c]
!215 = !MDLocation(line: 167, column: 2, scope: !32)
