...
for.body:                                         ; preds = %for.body, %entry
  ...
  %div33 = fdiv double %43, %add32, !dbg !132
  %add34 = fadd double %s.0106, %div33, !dbg !133
...
for.end:                                          ; preds = %for.body
  ...
  store double 0x3FE62E42FEFA39EF, double* @sb, align 8, !dbg !155, !tbaa !83
  %sub67 = fadd double %div66, 0xBFE62E42FEFA39EF, !dbg !156
...
!131 = !MDLocation(line: 248, column: 17, scope: !105)
...
!158 = !MDLocation(line: 262, column: 11, scope: !6)
!159 = !MDLocation(line: 261, column: 4, scope: !6)
!160 = !MDLocation(line: 266, column: 4, scope: !6)
