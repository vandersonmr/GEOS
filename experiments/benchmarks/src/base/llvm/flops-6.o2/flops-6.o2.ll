...
@.str4 = private unnamed_addr constant [36 x i8] c"     6   %13.4lf  %10.4lf  %10.4lf\0A\00", align 1
...
entry:
  ...
  %1 = load double* @four, align 8, !dbg !99, !tbaa !83
  ...
  %15 = insertelement <2 x double> undef, double %8, i32 0, !dbg !120
  %16 = insertelement <2 x double> %15, double %14, i32 1, !dbg !120
  %17 = insertelement <2 x double> undef, double %7, i32 0, !dbg !121
  %18 = insertelement <2 x double> %17, double %13, i32 1, !dbg !121
  %19 = insertelement <2 x double> undef, double %6, i32 0, !dbg !122
  %20 = insertelement <2 x double> %19, double %12, i32 1, !dbg !122
  %21 = insertelement <2 x double> undef, double %5, i32 0, !dbg !123
  %22 = insertelement <2 x double> %21, double %11, i32 1, !dbg !123
  %23 = insertelement <2 x double> undef, double %4, i32 0, !dbg !124
  %24 = insertelement <2 x double> %23, double %10, i32 1, !dbg !124
  br label %for.body, !dbg !125

for.body:                                         ; preds = %for.body, %entry
  %s.0106 = phi double [ 0.000000e+00, %entry ], [ %add34, %for.body ]
  %i.0105 = phi i64 [ 1, %entry ], [ %inc, %for.body ]
  %conv6 = sitofp i64 %i.0105 to double, !dbg !126
  %mul7 = fmul double %div, %conv6, !dbg !126
  tail call void @llvm.dbg.value(metadata double %mul7, i64 0, metadata !13, metadata !80), !dbg !127
  %mul8 = fmul double %mul7, %mul7, !dbg !128
  tail call void @llvm.dbg.value(metadata double %mul8, i64 0, metadata !15, metadata !80), !dbg !129
  %mul9 = fmul double %mul8, %2, !dbg !104
  %add = fadd double %mul9, %3, !dbg !104
  tail call void @llvm.dbg.value(metadata double undef, i64 0, metadata !14, metadata !80), !dbg !102
  %25 = insertelement <2 x double> undef, double %mul8, i32 0, !dbg !124
  %26 = insertelement <2 x double> %25, double %mul8, i32 1, !dbg !124
  %27 = insertelement <2 x double> undef, double %add, i32 0, !dbg !124
  %28 = insertelement <2 x double> %27, double %9, i32 1, !dbg !124
  %29 = fmul <2 x double> %26, %28, !dbg !124
  %30 = fadd <2 x double> %29, %24, !dbg !124
  %31 = fmul <2 x double> %30, %26, !dbg !123
  %32 = fadd <2 x double> %22, %31, !dbg !123
  %33 = fmul <2 x double> %32, %26, !dbg !122
  %34 = fadd <2 x double> %20, %33, !dbg !122
  %35 = fmul <2 x double> %34, %26, !dbg !121
  %36 = fadd <2 x double> %18, %35, !dbg !121
  %37 = fmul <2 x double> %36, %26, !dbg !120
  %38 = fadd <2 x double> %16, %37, !dbg !120
  %39 = insertelement <2 x double> undef, double %mul7, i32 0, !dbg !130
  %40 = insertelement <2 x double> %39, double %mul8, i32 1, !dbg !130
  %41 = fmul <2 x double> %40, %38, !dbg !130
  %42 = extractelement <2 x double> %41, i32 1, !dbg !131
  %add32 = fadd double %8, %42, !dbg !131
  %43 = extractelement <2 x double> %41, i32 0, !dbg !132
  %mul33 = fmul double %43, %add32, !dbg !132
  %add34 = fadd double %s.0106, %mul33, !dbg !133
  tail call void @llvm.dbg.value(metadata double %add34, i64 0, metadata !12, metadata !80), !dbg !101
  %inc = add nuw nsw i64 %i.0105, 1, !dbg !134
  tail call void @llvm.dbg.value(metadata i64 %inc, i64 0, metadata !20, metadata !80), !dbg !103
  %exitcond = icmp eq i64 %inc, 156250000, !dbg !125
  br i1 %exitcond, label %for.end, label %for.body, !dbg !125

for.end:                                          ; preds = %for.body
  %add34.lcssa = phi double [ %add34, %for.body ]
  %div35 = fdiv double %0, %1, !dbg !135
  tail call void @llvm.dbg.value(metadata double %div35, i64 0, metadata !13, metadata !80), !dbg !127
  %mul36 = fmul double %div35, %div35, !dbg !136
  tail call void @llvm.dbg.value(metadata double %mul36, i64 0, metadata !15, metadata !80), !dbg !129
  %mul37 = fmul double %2, %mul36, !dbg !137
  %add38 = fadd double %mul37, %3, !dbg !137
  %mul39 = fmul double %mul36, %add38, !dbg !138
  %add40 = fadd double %4, %mul39, !dbg !138
  %mul41 = fmul double %mul36, %add40, !dbg !139
  %add42 = fadd double %5, %mul41, !dbg !139
  %mul43 = fmul double %mul36, %add42, !dbg !140
  %add44 = fadd double %6, %mul43, !dbg !140
  %mul45 = fmul double %mul36, %add44, !dbg !141
  %add46 = fadd double %7, %mul45, !dbg !141
  %mul47 = fmul double %mul36, %add46, !dbg !142
  %add48 = fadd double %8, %mul47, !dbg !142
  %mul49 = fmul double %div35, %add48, !dbg !143
  %mul50 = fmul double %mul36, %9, !dbg !144
  %add51 = fadd double %mul50, %10, !dbg !144
  %mul52 = fmul double %mul36, %add51, !dbg !145
  %add53 = fadd double %11, %mul52, !dbg !145
  %mul54 = fmul double %mul36, %add53, !dbg !146
  %add55 = fadd double %12, %mul54, !dbg !146
  %mul56 = fmul double %mul36, %add55, !dbg !147
  %add57 = fadd double %13, %mul56, !dbg !147
  %mul58 = fmul double %mul36, %add57, !dbg !148
  %add59 = fadd double %14, %mul58, !dbg !148
  %mul60 = fmul double %mul36, %add59, !dbg !149
  %add61 = fadd double %8, %mul60, !dbg !149
  %mul62 = fmul double %mul49, %add61, !dbg !150
  %44 = load double* @two, align 8, !dbg !151, !tbaa !83
  %mul63 = fmul double %add34.lcssa, %44, !dbg !151
  %add64 = fadd double %mul63, %mul62, !dbg !152
  %mul65 = fmul double %div, %add64, !dbg !153
  %div66 = fdiv double %mul65, %44, !dbg !153
  store double %div66, double* @sa, align 8, !dbg !154, !tbaa !83
  store double 2.500000e-01, double* @sb, align 8, !dbg !155, !tbaa !83
  %sub67 = fadd double %div66, -2.500000e-01, !dbg !156
  store double %sub67, double* @sc, align 8, !dbg !157, !tbaa !83
  %mul68 = fmul double %sub67, 1.000000e-30, !dbg !158
  %call69 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([36 x i8]* @.str4, i64 0, i64 0), double %mul68, double 0.000000e+00, double 0.000000e+00) #3, !dbg !159
  ret i32 0, !dbg !160
}
...
!0 = !{!"0x11\0012\00clang version 3.6.0 (https://github.com/llvm-mirror/clang f06a0c83eb2f36bf182224a127ad378f42ab5094) (https://github.com/llvm-mirror/llvm 0b37b7bf52b92f9e1e7ffaff4063fd1184d2eec3)\001\00\000\00\001", !1, !2, !3, !5, !23, !2} ; [ DW_TAG_compile_unit ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-6.c] [DW_LANG_C99]
!1 = !{!"flops-6.c", !"/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base"}
!2 = !{}
!3 = !{!4}
...
!7 = !{!"0x29", !1}                               ; [ DW_TAG_file_type ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-6.c]
...
!105 = !{!"0xb\00244\004\002", !1, !106}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-6.c]
!106 = !{!"0xb\00243\004\001", !1, !107}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-6.c]
!107 = !{!"0xb\00243\004\000", !1, !6}            ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/flops-6.c]
...
!114 = !MDLocation(line: 248, column: 30, scope: !105)
!115 = !MDLocation(line: 248, column: 35, scope: !105)
!116 = !MDLocation(line: 248, column: 39, scope: !105)
!117 = !MDLocation(line: 248, column: 43, scope: !105)
!118 = !MDLocation(line: 248, column: 47, scope: !105)
!119 = !MDLocation(line: 248, column: 51, scope: !105)
!120 = !MDLocation(line: 247, column: 13, scope: !105)
!121 = !MDLocation(line: 247, column: 14, scope: !105)
!122 = !MDLocation(line: 247, column: 15, scope: !105)
!123 = !MDLocation(line: 247, column: 16, scope: !105)
!124 = !MDLocation(line: 247, column: 17, scope: !105)
!125 = !MDLocation(line: 243, column: 4, scope: !107)
!126 = !MDLocation(line: 245, column: 8, scope: !105)
!127 = !MDLocation(line: 179, column: 13, scope: !6)
!128 = !MDLocation(line: 246, column: 8, scope: !105)
!129 = !MDLocation(line: 179, column: 17, scope: !6)
!130 = !MDLocation(line: 247, column: 8, scope: !105)
!131 = !MDLocation(line: 248, column: 15, scope: !105)
!132 = !MDLocation(line: 248, column: 12, scope: !105)
!133 = !MDLocation(line: 248, column: 8, scope: !105)
!134 = !MDLocation(line: 243, column: 28, scope: !106)
!135 = !MDLocation(line: 251, column: 9, scope: !6)
!136 = !MDLocation(line: 252, column: 9, scope: !6)
!137 = !MDLocation(line: 253, column: 17, scope: !6)
!138 = !MDLocation(line: 253, column: 16, scope: !6)
!139 = !MDLocation(line: 253, column: 15, scope: !6)
!140 = !MDLocation(line: 253, column: 14, scope: !6)
!141 = !MDLocation(line: 253, column: 13, scope: !6)
!142 = !MDLocation(line: 253, column: 12, scope: !6)
!143 = !MDLocation(line: 253, column: 9, scope: !6)
!144 = !MDLocation(line: 254, column: 24, scope: !6)
!145 = !MDLocation(line: 254, column: 21, scope: !6)
!146 = !MDLocation(line: 254, column: 18, scope: !6)
!147 = !MDLocation(line: 254, column: 15, scope: !6)
!148 = !MDLocation(line: 254, column: 12, scope: !6)
!149 = !MDLocation(line: 254, column: 9, scope: !6)
!150 = !MDLocation(line: 255, column: 9, scope: !6)
!151 = !MDLocation(line: 257, column: 20, scope: !6)
!152 = !MDLocation(line: 257, column: 15, scope: !6)
!153 = !MDLocation(line: 257, column: 9, scope: !6)
!154 = !MDLocation(line: 257, column: 4, scope: !6)
