...
for.end:                                          ; preds = %complex_mul_cont
  %add.i.lcssa = phi double [ %add.i, %complex_mul_cont ]
  %add.r18.lcssa = phi double [ %add.r18, %complex_mul_cont ]
  tail call void @llvm.dbg.declare(metadata { double, double }* undef, metadata !86, metadata !46), !dbg !88
  %accum.real.i = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !89
  %accum.imag.i = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !89
  %add.r.i = fadd double %add.r18.lcssa, %accum.real.i, !dbg !89
  %add.i.i = fadd double %add.i.lcssa, %accum.imag.i, !dbg !89
  store volatile double %add.r.i, double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !89
  store volatile double %add.i.i, double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !89
  %inc32 = add nuw nsw i32 %y.044, 1, !dbg !90
  tail call void @llvm.dbg.value(metadata i32 %inc32, i64 0, metadata !19, metadata !46), !dbg !91
  %exitcond = icmp eq i32 %inc32, 5000, !dbg !54
  br i1 %exitcond, label %for.inc34, label %for.body3, !dbg !54

for.inc34:                                        ; preds = %for.end
  %inc35 = add nuw nsw i32 %x.045, 1, !dbg !92
...
define i32 @main() #0 {
entry:
  tail call void @mandel(), !dbg !94
  %accum.real = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 0), align 8, !dbg !95
  %accum.imag = load volatile double* getelementptr inbounds ({ double, double }* @accum, i64 0, i32 1), align 8, !dbg !95
  %conv = fptosi double %accum.real to i32, !dbg !96
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i64 0, i64 0), i32 %conv) #3, !dbg !97
  ret i32 0, !dbg !98
}
...
!86 = !{!"0x101\00X\0016777241\000", !7, !8, !11, !87} ; [ DW_TAG_arg_variable ] [X] [line 25]
!87 = !MDLocation(line: 41, column: 7, scope: !22)
!88 = !MDLocation(line: 25, column: 30, scope: !7, inlinedAt: !87)
!89 = !MDLocation(line: 26, column: 3, scope: !7, inlinedAt: !87)
!90 = !MDLocation(line: 32, column: 33, scope: !23)
!91 = !MDLocation(line: 30, column: 10, scope: !14)
!92 = !MDLocation(line: 31, column: 31, scope: !26)
!93 = !MDLocation(line: 44, column: 1, scope: !14)
!94 = !MDLocation(line: 47, column: 3, scope: !29)
!95 = !MDLocation(line: 48, column: 23, scope: !29)
!96 = !MDLocation(line: 48, column: 18, scope: !29)
!97 = !MDLocation(line: 48, column: 3, scope: !29)
!98 = !MDLocation(line: 49, column: 3, scope: !29)
