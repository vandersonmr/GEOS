...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.backedge
  ...
  %1 = load i32* %arrayidx, align 4, !dbg !167, !tbaa !154
  %tobool1 = icmp eq i32 %1, 0, !dbg !168
  br i1 %tobool1, label %while.cond.backedge, label %land.lhs.true, !dbg !168

land.lhs.true:                                    ; preds = %while.body
  %2 = add nsw i64 %indvars.iv.next, %0, !dbg !169
  %arrayidx4 = getelementptr inbounds i32* %a, i64 %2, !dbg !170
  %3 = load i32* %arrayidx4, align 4, !dbg !170, !tbaa !154
  %tobool5 = icmp eq i32 %3, 0, !dbg !168
...
land.lhs.true6:                                   ; preds = %land.lhs.true
  ...
  %add7 = add i32 %sub, %5, !dbg !156
  %idxprom8 = sext i32 %add7 to i64, !dbg !171
  %arrayidx9 = getelementptr inbounds i32* %c, i64 %idxprom8, !dbg !171
  %6 = load i32* %arrayidx9, align 4, !dbg !171, !tbaa !154
  %tobool10 = icmp eq i32 %6, 0, !dbg !168
  br i1 %tobool10, label %while.cond.backedge, label %if.then, !dbg !168

if.then:                                          ; preds = %land.lhs.true6
  %7 = trunc i64 %indvars.iv.next to i32, !dbg !159
  store i32 %7, i32* %arrayidx12, align 4, !dbg !159, !tbaa !154
...
if.then23:                                        ; preds = %if.then
  ...
  %8 = load i32* %q, align 4, !dbg !177, !tbaa !154
  %tobool25 = icmp eq i32 %8, 0, !dbg !179
  br i1 %tobool25, label %if.then26, label %while.cond.backedge, !dbg !179
...
if.then26:                                        ; preds = %if.then23
  ...
  br label %while.cond.backedge, !dbg !184

if.else:                                          ; preds = %if.then
  store i32 1, i32* %q, align 4, !dbg !185, !tbaa !154
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.else, %if.then26, %while.body, %land.lhs.true, %land.lhs.true6, %if.then23
  %9 = load i32* %q, align 4, !dbg !186, !tbaa !154
  %tobool = icmp eq i32 %9, 0, !dbg !165
  %10 = trunc i64 %indvars.iv.next to i32, !dbg !187
  %cmp = icmp ne i32 %10, 8, !dbg !187
  %or.cond = and i1 %cmp, %tobool, !dbg !165
  br i1 %or.cond, label %while.body, label %while.end, !dbg !165
...
for.body:                                         ; preds = %for.body, %entry
  %i.02 = phi i32 [ 1, %entry ], [ %inc, %for.body ]
  tail call void @Doit(), !dbg !227
  %inc = add nuw nsw i32 %i.02, 1, !dbg !230
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !46, metadata !145), !dbg !224
  %exitcond = icmp eq i32 %inc, 51, !dbg !225
  br i1 %exitcond, label %for.end, label %for.body, !dbg !225

for.end:                                          ; preds = %for.body
  %add = add nsw i32 %run, 1, !dbg !232
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %add) #2, !dbg !233
  ret void, !dbg !234
}
...
define i32 @main() #0 {
entry:
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !49, metadata !145), !dbg !235
  br label %for.body, !dbg !236

for.body:                                         ; preds = %for.body, %entry
  %i.03 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  tail call void @Queens(i32 %i.03), !dbg !238
  %inc = add nuw nsw i32 %i.03, 1, !dbg !240
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !49, metadata !145), !dbg !235
  %exitcond = icmp eq i32 %inc, 100, !dbg !236
  br i1 %exitcond, label %for.end, label %for.body, !dbg !236
...
!184 = !MDLocation(line: 155, column: 5, scope: !181)
!185 = !MDLocation(line: 157, column: 12, scope: !162)
!186 = !MDLocation(line: 141, column: 13, scope: !12)
...
!225 = !MDLocation(line: 179, column: 5, scope: !226)
!226 = !{!"0xb\00179\005\0012", !1, !41}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!227 = !MDLocation(line: 179, column: 33, scope: !228)
!228 = !{!"0xb\002", !1, !229}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!229 = !{!"0xb\00179\005\0013", !1, !226}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!230 = !MDLocation(line: 179, column: 27, scope: !231)
!231 = !{!"0xb\003", !1, !229}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!232 = !MDLocation(line: 180, column: 18, scope: !41)
!233 = !MDLocation(line: 180, column: 3, scope: !41)
!234 = !MDLocation(line: 181, column: 1, scope: !41)
!235 = !MDLocation(line: 185, column: 6, scope: !47)
!236 = !MDLocation(line: 186, column: 2, scope: !237)
!237 = !{!"0xb\00186\002\0014", !1, !47}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!238 = !MDLocation(line: 186, column: 28, scope: !239)
!239 = !{!"0xb\00186\002\0015", !1, !237}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!240 = !MDLocation(line: 186, column: 23, scope: !241)
!241 = !{!"0xb\003", !1, !239}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!242 = !MDLocation(line: 187, column: 2, scope: !47)
