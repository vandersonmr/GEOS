...
while.body.lr.ph:
  ...
  br i1 %cmp22, label %while.body.us.preheader, label %while.body.preheader

while.body.preheader:                             ; preds = %while.body.lr.ph
  br label %while.body, !dbg !165

while.body.us.preheader:                          ; preds = %while.body.lr.ph
  br label %while.body.us, !dbg !165

while.body.us:                                    ; preds = %while.body.us.preheader, %while.cond.backedge.us
  %indvars.iv76 = phi i64 [ %indvars.iv.next77, %while.cond.backedge.us ], [ 0, %while.body.us.preheader ]
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1, !dbg !165
  store i32 0, i32* %q, align 4, !dbg !166, !tbaa !154
  %arrayidx.us = getelementptr inbounds i32* %b, i64 %indvars.iv.next77, !dbg !167
  %0 = load i32* %arrayidx.us, align 4, !dbg !167, !tbaa !154
  %tobool1.us = icmp eq i32 %0, 0, !dbg !168
  br i1 %tobool1.us, label %while.cond.backedge.us, label %land.lhs.true.us, !dbg !168

land.lhs.true.us:                                 ; preds = %while.body.us
  %1 = add nsw i64 %indvars.iv.next77, %idxprom11, !dbg !169
  %arrayidx4.us = getelementptr inbounds i32* %a, i64 %1, !dbg !170
  %2 = load i32* %arrayidx4.us, align 4, !dbg !170, !tbaa !154
  %tobool5.us = icmp eq i32 %2, 0, !dbg !168
  br i1 %tobool5.us, label %while.cond.backedge.us, label %land.lhs.true6.us, !dbg !168

land.lhs.true6.us:                                ; preds = %land.lhs.true.us
  %3 = xor i64 %indvars.iv76, 4294967295
  %4 = trunc i64 %3 to i32, !dbg !156
  %add7.us = add i32 %sub, %4, !dbg !156
  %idxprom8.us = sext i32 %add7.us to i64, !dbg !171
  %arrayidx9.us = getelementptr inbounds i32* %c, i64 %idxprom8.us, !dbg !171
  %5 = load i32* %arrayidx9.us, align 4, !dbg !171, !tbaa !154
  %tobool10.us = icmp eq i32 %5, 0, !dbg !168
  br i1 %tobool10.us, label %while.cond.backedge.us, label %if.then23.us, !dbg !168

if.then23.us:                                     ; preds = %land.lhs.true6.us
  %6 = trunc i64 %indvars.iv.next77 to i32, !dbg !159
  store i32 %6, i32* %arrayidx12, align 4, !dbg !159, !tbaa !154
  store i32 0, i32* %arrayidx.us, align 4, !dbg !172, !tbaa !154
  store i32 0, i32* %arrayidx4.us, align 4, !dbg !173, !tbaa !154
  store i32 0, i32* %arrayidx9.us, align 4, !dbg !174, !tbaa !154
  tail call void @Try(i32 %add24, i32* %q, i32* %a, i32* %b, i32* %c, i32* %x), !dbg !175
  %7 = load i32* %q, align 4, !dbg !176, !tbaa !154
  %tobool25.us = icmp eq i32 %7, 0, !dbg !178
  br i1 %tobool25.us, label %if.then26.us, label %while.cond.backedge.us, !dbg !178

if.then26.us:                                     ; preds = %if.then23.us
  store i32 1, i32* %arrayidx.us, align 4, !dbg !179, !tbaa !154
  store i32 1, i32* %arrayidx4.us, align 4, !dbg !181, !tbaa !154
  store i32 1, i32* %arrayidx9.us, align 4, !dbg !182, !tbaa !154
  br label %while.cond.backedge.us, !dbg !183

while.cond.backedge.us:                           ; preds = %if.then26.us, %if.then23.us, %land.lhs.true6.us, %land.lhs.true.us, %while.body.us
  %8 = load i32* %q, align 4, !dbg !184, !tbaa !154
  %tobool.us = icmp eq i32 %8, 0, !dbg !165
  %9 = trunc i64 %indvars.iv.next77 to i32, !dbg !185
  %cmp.us = icmp ne i32 %9, 8, !dbg !185
  %or.cond.us = and i1 %cmp.us, %tobool.us, !dbg !165
  br i1 %or.cond.us, label %while.body.us, label %while.end.loopexit, !dbg !165
...
while.body:                                       ; preds = %while.body.preheader, %while.cond.backedge
  ...
  %10 = load i32* %arrayidx, align 4, !dbg !167, !tbaa !154
  %tobool1 = icmp eq i32 %10, 0, !dbg !168
  br i1 %tobool1, label %while.cond.backedge, label %land.lhs.true, !dbg !168

land.lhs.true:                                    ; preds = %while.body
  %11 = add nsw i64 %indvars.iv.next, %idxprom11, !dbg !169
  %arrayidx4 = getelementptr inbounds i32* %a, i64 %11, !dbg !170
  %12 = load i32* %arrayidx4, align 4, !dbg !170, !tbaa !154
  %tobool5 = icmp eq i32 %12, 0, !dbg !168
  br i1 %tobool5, label %while.cond.backedge, label %land.lhs.true6, !dbg !168

land.lhs.true6:                                   ; preds = %land.lhs.true
  %13 = xor i64 %indvars.iv, 4294967295
  %14 = trunc i64 %13 to i32, !dbg !156
  %add7 = add i32 %sub, %14, !dbg !156
  %idxprom8 = sext i32 %add7 to i64, !dbg !171
  %arrayidx9 = getelementptr inbounds i32* %c, i64 %idxprom8, !dbg !171
  %15 = load i32* %arrayidx9, align 4, !dbg !171, !tbaa !154
  %tobool10 = icmp eq i32 %15, 0, !dbg !168
  br i1 %tobool10, label %while.cond.backedge, label %if.else, !dbg !168

if.else:                                          ; preds = %land.lhs.true6
  %16 = trunc i64 %indvars.iv.next to i32, !dbg !159
  store i32 %16, i32* %arrayidx12, align 4, !dbg !159, !tbaa !154
  ...
  store i32 1, i32* %q, align 4, !dbg !187, !tbaa !154
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.else, %while.body, %land.lhs.true, %land.lhs.true6
  %17 = load i32* %q, align 4, !dbg !184, !tbaa !154
  %tobool = icmp eq i32 %17, 0, !dbg !165
  %18 = trunc i64 %indvars.iv.next to i32, !dbg !185
  %cmp = icmp ne i32 %18, 8, !dbg !185
  %or.cond = and i1 %cmp, %tobool, !dbg !165
  br i1 %or.cond, label %while.body, label %while.end.loopexit81, !dbg !165

while.end.loopexit:                               ; preds = %while.cond.backedge.us
  br label %while.end

while.end.loopexit81:                             ; preds = %while.cond.backedge
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit81, %while.end.loopexit
  ret void, !dbg !188
}
...
entry:
  ...
  %0 = bitcast [9 x i32]* %a to i8*, !dbg !189
  call void @llvm.lifetime.start(i64 36, i8* %0) #2, !dbg !189
  tail call void @llvm.dbg.declare(metadata [9 x i32]* %a, metadata !28, metadata !145), !dbg !190
  %1 = bitcast [17 x i32]* %b to i8*, !dbg !189
  call void @llvm.lifetime.start(i64 68, i8* %1) #2, !dbg !189
  tail call void @llvm.dbg.declare(metadata [17 x i32]* %b, metadata !32, metadata !145), !dbg !191
  %2 = bitcast [15 x i32]* %c to i8*, !dbg !189
  call void @llvm.lifetime.start(i64 60, i8* %2) #2, !dbg !189
  tail call void @llvm.dbg.declare(metadata [15 x i32]* %c, metadata !36, metadata !145), !dbg !192
  %3 = bitcast [9 x i32]* %x to i8*, !dbg !189
  call void @llvm.lifetime.start(i64 36, i8* %3) #2, !dbg !189
  tail call void @llvm.dbg.declare(metadata [9 x i32]* %x, metadata !40, metadata !145), !dbg !193
  tail call void @llvm.dbg.value(metadata i32 -7, i64 0, metadata !26, metadata !145), !dbg !194
  br label %while.body, !dbg !195

while.body:                                       ; preds = %if.end12, %entry
  %indvars.iv = phi i64 [ -7, %entry ], [ %indvars.iv.next, %if.end12 ]
  %4 = add i64 %indvars.iv, 4294967295, !dbg !196
  %5 = trunc i64 %4 to i32, !dbg !196
  %6 = icmp ult i32 %5, 8, !dbg !196
  br i1 %6, label %if.then, label %if.end, !dbg !196

if.then:                                          ; preds = %while.body
  %arrayidx = getelementptr inbounds [9 x i32]* %a, i64 0, i64 %indvars.iv, !dbg !198
  store i32 1, i32* %arrayidx, align 4, !dbg !198, !tbaa !154
  br label %if.end, !dbg !198

if.end:                                           ; preds = %if.then, %while.body
  %cmp3 = icmp sgt i64 %indvars.iv, 1, !dbg !200
  br i1 %cmp3, label %if.end7, label %if.then9, !dbg !202

if.end7:                                          ; preds = %if.end
  %arrayidx6 = getelementptr inbounds [17 x i32]* %b, i64 0, i64 %indvars.iv, !dbg !203
  store i32 1, i32* %arrayidx6, align 4, !dbg !203, !tbaa !154
  %cmp8 = icmp slt i64 %indvars.iv, 8, !dbg !204
  br i1 %cmp8, label %if.then9, label %if.end12, !dbg !206

if.then9:                                         ; preds = %if.end, %if.end7
  %7 = add nsw i64 %indvars.iv, 7, !dbg !207
  %arrayidx11 = getelementptr inbounds [15 x i32]* %c, i64 0, i64 %7, !dbg !209
  store i32 1, i32* %arrayidx11, align 4, !dbg !209, !tbaa !154
  br label %if.end12, !dbg !209

if.end12:                                         ; preds = %if.then9, %if.end7
  %indvars.iv.next = add nsw i64 %indvars.iv, 1, !dbg !195
  %exitcond = icmp eq i64 %indvars.iv.next, 17, !dbg !195
  br i1 %exitcond, label %while.end, label %while.body, !dbg !195

while.end:                                        ; preds = %if.end12
  %arraydecay = getelementptr inbounds [17 x i32]* %b, i64 0, i64 0, !dbg !210
  %arraydecay14 = getelementptr inbounds [9 x i32]* %a, i64 0, i64 0, !dbg !211
  %arraydecay15 = getelementptr inbounds [15 x i32]* %c, i64 0, i64 0, !dbg !212
  %arraydecay16 = getelementptr inbounds [9 x i32]* %x, i64 0, i64 0, !dbg !213
  tail call void @llvm.dbg.value(metadata i32* %q, i64 0, metadata !27, metadata !145), !dbg !214
  call void @Try(i32 1, i32* %q, i32* %arraydecay, i32* %arraydecay14, i32* %arraydecay15, i32* %arraydecay16), !dbg !215
  tail call void @llvm.dbg.value(metadata i32* %q, i64 0, metadata !27, metadata !145), !dbg !214
  %8 = load i32* %q, align 4, !dbg !216, !tbaa !154
  %tobool = icmp eq i32 %8, 0, !dbg !218
  br i1 %tobool, label %if.then17, label %if.end18, !dbg !218

if.then17:                                        ; preds = %while.end
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)), !dbg !219
  br label %if.end18, !dbg !219

if.end18:                                         ; preds = %while.end, %if.then17
  call void @llvm.lifetime.end(i64 36, i8* %3) #2, !dbg !221
  call void @llvm.lifetime.end(i64 60, i8* %2) #2, !dbg !221
  call void @llvm.lifetime.end(i64 68, i8* %1) #2, !dbg !221
  call void @llvm.lifetime.end(i64 36, i8* %0) #2, !dbg !221
  ret void, !dbg !221
}
...
entry:
  ...
  tail call void @llvm.dbg.value(metadata i32 %run, i64 0, metadata !45, metadata !145), !dbg !222
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !46, metadata !145), !dbg !223
  %0 = bitcast i32* %q.i to i8*, !dbg !224
  %1 = bitcast [9 x i32]* %a.i to i8*, !dbg !224
  %2 = bitcast [17 x i32]* %b.i to i8*, !dbg !224
  %3 = bitcast [15 x i32]* %c.i to i8*, !dbg !224
  %4 = bitcast [9 x i32]* %x.i to i8*, !dbg !224
  %arraydecay.i = getelementptr inbounds [17 x i32]* %b.i, i64 0, i64 0, !dbg !229
  %arraydecay14.i = getelementptr inbounds [9 x i32]* %a.i, i64 0, i64 0, !dbg !230
  %arraydecay15.i = getelementptr inbounds [15 x i32]* %c.i, i64 0, i64 0, !dbg !231
  %arraydecay16.i = getelementptr inbounds [9 x i32]* %x.i, i64 0, i64 0, !dbg !232
  br label %for.body, !dbg !233

for.body:                                         ; preds = %Doit.exit, %entry
  %i.02 = phi i32 [ 1, %entry ], [ %inc, %Doit.exit ]
  call void @llvm.lifetime.start(i64 4, i8* %0), !dbg !224
  call void @llvm.lifetime.start(i64 36, i8* %1) #2, !dbg !224
  tail call void @llvm.dbg.declare(metadata [9 x i32]* %a.i, metadata !234, metadata !145) #2, !dbg !235
  call void @llvm.lifetime.start(i64 68, i8* %2) #2, !dbg !224
  tail call void @llvm.dbg.declare(metadata [17 x i32]* %b.i, metadata !236, metadata !145) #2, !dbg !237
  call void @llvm.lifetime.start(i64 60, i8* %3) #2, !dbg !224
  tail call void @llvm.dbg.declare(metadata [15 x i32]* %c.i, metadata !238, metadata !145) #2, !dbg !239
  call void @llvm.lifetime.start(i64 36, i8* %4) #2, !dbg !224
  tail call void @llvm.dbg.declare(metadata [9 x i32]* %x.i, metadata !240, metadata !145) #2, !dbg !241
  tail call void @llvm.dbg.value(metadata i32 -7, i64 0, metadata !242, metadata !145) #2, !dbg !243
  br label %while.body.i, !dbg !244

while.body.i:                                     ; preds = %if.end12.i, %for.body
  %indvars.iv.i = phi i64 [ -7, %for.body ], [ %indvars.iv.next.i, %if.end12.i ], !dbg !225
  %5 = add nsw i64 %indvars.iv.i, 4294967295, !dbg !245
  %6 = trunc i64 %5 to i32, !dbg !245
  %7 = icmp ult i32 %6, 8, !dbg !245
  br i1 %7, label %if.then.i, label %if.end.i, !dbg !245

if.then.i:                                        ; preds = %while.body.i
  %arrayidx.i = getelementptr inbounds [9 x i32]* %a.i, i64 0, i64 %indvars.iv.i, !dbg !246
  store i32 1, i32* %arrayidx.i, align 4, !dbg !246, !tbaa !154
  br label %if.end.i, !dbg !246

if.end.i:                                         ; preds = %if.then.i, %while.body.i
  %cmp3.i = icmp sgt i64 %indvars.iv.i, 1, !dbg !247
  br i1 %cmp3.i, label %if.end7.i, label %if.then9.i, !dbg !248

if.end7.i:                                        ; preds = %if.end.i
  %arrayidx6.i = getelementptr inbounds [17 x i32]* %b.i, i64 0, i64 %indvars.iv.i, !dbg !249
  store i32 1, i32* %arrayidx6.i, align 4, !dbg !249, !tbaa !154
  %cmp8.i = icmp slt i64 %indvars.iv.i, 8, !dbg !250
  br i1 %cmp8.i, label %if.then9.i, label %if.end12.i, !dbg !251

if.then9.i:                                       ; preds = %if.end7.i, %if.end.i
  %8 = add nsw i64 %indvars.iv.i, 7, !dbg !252
  %arrayidx11.i = getelementptr inbounds [15 x i32]* %c.i, i64 0, i64 %8, !dbg !253
  store i32 1, i32* %arrayidx11.i, align 4, !dbg !253, !tbaa !154
  br label %if.end12.i, !dbg !253

if.end12.i:                                       ; preds = %if.then9.i, %if.end7.i
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, 1, !dbg !244
  %exitcond.i = icmp eq i64 %indvars.iv.next.i, 17, !dbg !244
  br i1 %exitcond.i, label %while.end.i, label %while.body.i, !dbg !244

while.end.i:                                      ; preds = %if.end12.i
  tail call void @llvm.dbg.value(metadata i32* %q.i, i64 0, metadata !254, metadata !145) #2, !dbg !255
  call void @Try(i32 1, i32* %q.i, i32* %arraydecay.i, i32* %arraydecay14.i, i32* %arraydecay15.i, i32* %arraydecay16.i) #2, !dbg !256
  tail call void @llvm.dbg.value(metadata i32* %q.i, i64 0, metadata !254, metadata !145) #2, !dbg !255
  %9 = load i32* %q.i, align 4, !dbg !257, !tbaa !154
  %tobool.i = icmp eq i32 %9, 0, !dbg !258
  br i1 %tobool.i, label %if.then17.i, label %Doit.exit, !dbg !258

if.then17.i:                                      ; preds = %while.end.i
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([18 x i8]* @str, i64 0, i64 0)) #2, !dbg !259
  br label %Doit.exit, !dbg !259

Doit.exit:                                        ; preds = %while.end.i, %if.then17.i
  call void @llvm.lifetime.end(i64 36, i8* %4) #2, !dbg !260
  call void @llvm.lifetime.end(i64 60, i8* %3) #2, !dbg !260
  call void @llvm.lifetime.end(i64 68, i8* %2) #2, !dbg !260
  call void @llvm.lifetime.end(i64 36, i8* %1) #2, !dbg !260
  call void @llvm.lifetime.end(i64 4, i8* %0), !dbg !260
  %inc = add nuw nsw i32 %i.02, 1, !dbg !261
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !46, metadata !145), !dbg !223
  %exitcond = icmp eq i32 %inc, 51, !dbg !233
  br i1 %exitcond, label %for.end, label %for.body, !dbg !233

for.end:                                          ; preds = %Doit.exit
  %add = add nsw i32 %run, 1, !dbg !263
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %add) #2, !dbg !264
  ret void, !dbg !265
}
...
define i32 @main() #0 {
entry:
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !49, metadata !145), !dbg !266
  br label %for.body, !dbg !267

for.body:                                         ; preds = %for.body, %entry
  %i.03 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  tail call void @Queens(i32 %i.03), !dbg !269
  %inc = add nuw nsw i32 %i.03, 1, !dbg !271
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !49, metadata !145), !dbg !266
  %exitcond = icmp eq i32 %inc, 100, !dbg !267
  br i1 %exitcond, label %for.end, label %for.body, !dbg !267
...
!175 = !MDLocation(line: 150, column: 8, scope: !164)
!176 = !MDLocation(line: 151, column: 12, scope: !177)
!177 = !{!"0xb\00151\0010\005", !1, !164}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!178 = !MDLocation(line: 151, column: 10, scope: !164)
!179 = !MDLocation(line: 152, column: 6, scope: !180)
!180 = !{!"0xb\00151\0017\006", !1, !177}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!181 = !MDLocation(line: 153, column: 9, scope: !180)
!182 = !MDLocation(line: 154, column: 9, scope: !180)
!183 = !MDLocation(line: 155, column: 5, scope: !180)
!184 = !MDLocation(line: 141, column: 13, scope: !12)
!185 = !MDLocation(line: 141, column: 21, scope: !186)
!186 = !{!"0xb\003", !1, !12}                     ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!187 = !MDLocation(line: 157, column: 12, scope: !162)
!188 = !MDLocation(line: 160, column: 1, scope: !12)
!189 = !MDLocation(line: 164, column: 2, scope: !24)
!190 = !MDLocation(line: 164, column: 6, scope: !24)
!191 = !MDLocation(line: 164, column: 12, scope: !24)
!192 = !MDLocation(line: 164, column: 19, scope: !24)
!193 = !MDLocation(line: 164, column: 26, scope: !24)
!194 = !MDLocation(line: 163, column: 6, scope: !24)
!195 = !MDLocation(line: 166, column: 2, scope: !24)
!196 = !MDLocation(line: 167, column: 8, scope: !197)
!197 = !{!"0xb\00166\0020\007", !1, !24}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!198 = !MDLocation(line: 167, column: 31, scope: !199)
!199 = !{!"0xb\00167\008\008", !1, !197}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!200 = !MDLocation(line: 168, column: 11, scope: !201)
!201 = !{!"0xb\00168\0011\009", !1, !197}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!202 = !MDLocation(line: 168, column: 11, scope: !197)
!203 = !MDLocation(line: 168, column: 20, scope: !201)
!204 = !MDLocation(line: 169, column: 11, scope: !205)
!205 = !{!"0xb\00169\0011\0010", !1, !197}        ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!206 = !MDLocation(line: 169, column: 11, scope: !197)
!207 = !MDLocation(line: 169, column: 22, scope: !208)
!208 = !{!"0xb\001", !1, !205}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!209 = !MDLocation(line: 169, column: 20, scope: !205)
!210 = !MDLocation(line: 173, column: 13, scope: !24)
!211 = !MDLocation(line: 173, column: 16, scope: !24)
!212 = !MDLocation(line: 173, column: 19, scope: !24)
!213 = !MDLocation(line: 173, column: 22, scope: !24)
!214 = !MDLocation(line: 163, column: 8, scope: !24)
!215 = !MDLocation(line: 173, column: 2, scope: !24)
!216 = !MDLocation(line: 174, column: 8, scope: !217)
!217 = !{!"0xb\00174\007\0011", !1, !24}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!218 = !MDLocation(line: 174, column: 7, scope: !24)
!219 = !MDLocation(line: 174, column: 12, scope: !220)
!220 = !{!"0xb\001", !1, !217}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!221 = !MDLocation(line: 175, column: 1, scope: !24)
!222 = !MDLocation(line: 177, column: 18, scope: !41)
!223 = !MDLocation(line: 178, column: 9, scope: !41)
!224 = !MDLocation(line: 164, column: 2, scope: !24, inlinedAt: !225)
!225 = !MDLocation(line: 179, column: 33, scope: !226)
!226 = !{!"0xb\002", !1, !227}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!227 = !{!"0xb\00179\005\0013", !1, !228}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!228 = !{!"0xb\00179\005\0012", !1, !41}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!229 = !MDLocation(line: 173, column: 13, scope: !24, inlinedAt: !225)
!230 = !MDLocation(line: 173, column: 16, scope: !24, inlinedAt: !225)
!231 = !MDLocation(line: 173, column: 19, scope: !24, inlinedAt: !225)
!232 = !MDLocation(line: 173, column: 22, scope: !24, inlinedAt: !225)
!233 = !MDLocation(line: 179, column: 5, scope: !228)
!234 = !{!"0x100\00a\00164\000", !24, !7, !29, !225} ; [ DW_TAG_auto_variable ] [a] [line 164]
!235 = !MDLocation(line: 164, column: 6, scope: !24, inlinedAt: !225)
!236 = !{!"0x100\00b\00164\000", !24, !7, !33, !225} ; [ DW_TAG_auto_variable ] [b] [line 164]
!237 = !MDLocation(line: 164, column: 12, scope: !24, inlinedAt: !225)
!238 = !{!"0x100\00c\00164\000", !24, !7, !37, !225} ; [ DW_TAG_auto_variable ] [c] [line 164]
!239 = !MDLocation(line: 164, column: 19, scope: !24, inlinedAt: !225)
!240 = !{!"0x100\00x\00164\000", !24, !7, !29, !225} ; [ DW_TAG_auto_variable ] [x] [line 164]
!241 = !MDLocation(line: 164, column: 26, scope: !24, inlinedAt: !225)
!242 = !{!"0x100\00i\00163\000", !24, !7, !4, !225} ; [ DW_TAG_auto_variable ] [i] [line 163]
!243 = !MDLocation(line: 163, column: 6, scope: !24, inlinedAt: !225)
!244 = !MDLocation(line: 166, column: 2, scope: !24, inlinedAt: !225)
!245 = !MDLocation(line: 167, column: 8, scope: !197, inlinedAt: !225)
!246 = !MDLocation(line: 167, column: 31, scope: !199, inlinedAt: !225)
!247 = !MDLocation(line: 168, column: 11, scope: !201, inlinedAt: !225)
!248 = !MDLocation(line: 168, column: 11, scope: !197, inlinedAt: !225)
!249 = !MDLocation(line: 168, column: 20, scope: !201, inlinedAt: !225)
!250 = !MDLocation(line: 169, column: 11, scope: !205, inlinedAt: !225)
!251 = !MDLocation(line: 169, column: 11, scope: !197, inlinedAt: !225)
!252 = !MDLocation(line: 169, column: 22, scope: !208, inlinedAt: !225)
!253 = !MDLocation(line: 169, column: 20, scope: !205, inlinedAt: !225)
!254 = !{!"0x100\00q\00163\000", !24, !7, !4, !225} ; [ DW_TAG_auto_variable ] [q] [line 163]
!255 = !MDLocation(line: 163, column: 8, scope: !24, inlinedAt: !225)
!256 = !MDLocation(line: 173, column: 2, scope: !24, inlinedAt: !225)
!257 = !MDLocation(line: 174, column: 8, scope: !217, inlinedAt: !225)
!258 = !MDLocation(line: 174, column: 7, scope: !24, inlinedAt: !225)
!259 = !MDLocation(line: 174, column: 12, scope: !220, inlinedAt: !225)
!260 = !MDLocation(line: 175, column: 1, scope: !24, inlinedAt: !225)
!261 = !MDLocation(line: 179, column: 27, scope: !262)
!262 = !{!"0xb\003", !1, !227}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!263 = !MDLocation(line: 180, column: 18, scope: !41)
!264 = !MDLocation(line: 180, column: 3, scope: !41)
!265 = !MDLocation(line: 181, column: 1, scope: !41)
!266 = !MDLocation(line: 185, column: 6, scope: !47)
!267 = !MDLocation(line: 186, column: 2, scope: !268)
!268 = !{!"0xb\00186\002\0014", !1, !47}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!269 = !MDLocation(line: 186, column: 28, scope: !270)
!270 = !{!"0xb\00186\002\0015", !1, !268}         ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!271 = !MDLocation(line: 186, column: 23, scope: !272)
!272 = !{!"0xb\003", !1, !270}                    ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/queens.c]
!273 = !MDLocation(line: 187, column: 2, scope: !47)
