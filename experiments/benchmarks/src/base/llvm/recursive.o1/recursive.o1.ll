...
entry:
  ...
  br i1 %cmp7, label %if.then, label %if.end, !dbg !55

if.then:                                          ; preds = %tailrecurse.backedge, %entry
  %y.tr.lcssa = phi i32 [ %y, %entry ], [ %y.tr.be, %tailrecurse.backedge ]
  %add = add nsw i32 %y.tr.lcssa, 1, !dbg !56
  ret i32 %add, !dbg !58

if.end:                                           ; preds = %entry, %tailrecurse.backedge
  %y.tr9 = phi i32 [ %y.tr.be, %tailrecurse.backedge ], [ %y, %entry ]
  %x.tr8 = phi i32 [ %sub, %tailrecurse.backedge ], [ %x, %entry ]
  %sub = add nsw i32 %x.tr8, -1, !dbg !59
...
entry:
  ...
  br i1 %cmp5, label %return, label %if.end, !dbg !66

if.end:                                           ; preds = %entry, %if.end
  %n.tr7 = phi i32 [ %sub1, %if.end ], [ %n, %entry ]
  %accumulator.tr6 = phi i32 [ %add, %if.end ], [ 1, %entry ]
  ...
  br i1 %cmp, label %return, label %if.end, !dbg !66
...
entry:
  ...
  br i1 %cmp15, label %if.then, label %return, !dbg !85
...
if.then:                                          ; preds = %entry, %if.then
  ...
  br i1 %cmp, label %if.then, label %return, !dbg !85
...
entry:
  ...
  br i1 %cmp15, label %if.then, label %return, !dbg !99
...
if.then:                                          ; preds = %entry, %if.then
  ...
  br i1 %cmp, label %if.then, label %return, !dbg !99
...
!56 = !MDLocation(line: 12, column: 12, scope: !57)
!57 = !{!"0xb\0011\0015\001", !1, !54}            ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/base/recursive.c]
!58 = !MDLocation(line: 16, column: 1, scope: !4)
!59 = !MDLocation(line: 15, column: 14, scope: !4)
