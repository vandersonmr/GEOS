...
vector.body:                                      ; preds = %vector.body, %for.body.i
  ...
  %.sum78 = or i64 %index, 2, !dbg !99
  %2 = getelementptr [1024 x double]* %arraydecay2, i64 %indvars.iv3.i, i64 %.sum78, !dbg !99
  ...
  %.sum78.1 = or i64 %index.next, 2, !dbg !99
  %6 = getelementptr [1024 x double]* %arraydecay2, i64 %indvars.iv3.i, i64 %.sum78.1, !dbg !99
  ...
  %.sum78.2 = or i64 %index.next.1, 2, !dbg !99
  %10 = getelementptr [1024 x double]* %arraydecay2, i64 %indvars.iv3.i, i64 %.sum78.2, !dbg !99
  ...
  %.sum78.3 = or i64 %index.next.2, 2, !dbg !99
  %14 = getelementptr [1024 x double]* %arraydecay2, i64 %indvars.iv3.i, i64 %.sum78.3, !dbg !99
...
for.cond.loopexit.i.loopexit:                     ; preds = %for.end40.i
  br label %for.cond.loopexit.i

for.cond.loopexit.i:                              ; preds = %for.cond.loopexit.i.loopexit, %for.end.i
  %indvars.iv.next15.i = add nuw nsw i64 %indvars.iv14.i, 1, !dbg !110
  %exitcond21.i = icmp eq i64 %indvars.iv.next19.i, 1024, !dbg !110
  br i1 %exitcond21.i, label %kernel_cholesky.exit, label %for.body.i70, !dbg !110

for.body.i70:                                     ; preds = %for.body.i70.preheader, %for.cond.loopexit.i
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.cond.loopexit.i ], [ 0, %for.body.i70.preheader ], !dbg !109
  %indvars.iv14.i = phi i64 [ %indvars.iv.next15.i, %for.cond.loopexit.i ], [ 1, %for.body.i70.preheader ], !dbg !109
  %17 = add i64 %indvars.iv18.i, -1, !dbg !105
  %18 = icmp sgt i64 %17, 0
  %smax79 = select i1 %18, i64 %17, i64 0
  %19 = add i64 %smax79, 1, !dbg !105
  %20 = add i64 %indvars.iv18.i, -1, !dbg !105
  %21 = icmp sgt i64 %20, 0
  %smax = select i1 %21, i64 %20, i64 0
  %22 = add i64 %smax, 1, !dbg !105
  %arrayidx2.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv18.i, !dbg !105
  ...
  %24 = add nsw i64 %indvars.iv18.i, -1, !dbg !115
  %cmp41.i = icmp slt i64 %indvars.iv18.i, 1, !dbg !118
...
for.body5.i.prol:                                 ; preds = %for.body5.i.prol.preheader, %for.body5.i.prol
  ...
  %arrayidx9.i.prol = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.i71.prol, !dbg !120
...
for.body5.i:                                      ; preds = %for.body5.i, %for.body5.i.preheader.split.split
  ...
  %arrayidx9.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.i71, !dbg !120
  ...
  %arrayidx9.i.1 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.next.i72, !dbg !120
  ...
  %arrayidx9.i.2 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.next.i72.1, !dbg !120
  ...
  %arrayidx9.i.3 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.next.i72.2, !dbg !120
...
for.end.i:                                        ; preds = %for.end.i.loopexit, %for.body.i70
  ...
  %arrayidx16.i = getelementptr inbounds double* %arraydecay, i64 %indvars.iv18.i, !dbg !126
  ...
  %cmp189.i = icmp slt i64 %indvars.iv.next19.i, 1024, !dbg !127
  br i1 %cmp189.i, label %for.body19.i.preheader, label %for.cond.loopexit.i, !dbg !130

for.body19.i.preheader:                           ; preds = %for.end.i
  br label %for.body19.i, !dbg !131

for.body19.i:                                     ; preds = %for.body19.i.preheader, %for.end40.i
  %indvars.iv16.i = phi i64 [ %indvars.iv.next17.i, %for.end40.i ], [ %indvars.iv14.i, %for.body19.i.preheader ], !dbg !109
  %arrayidx23.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv16.i, !dbg !131
  %31 = load double* %arrayidx23.i, align 8, !dbg !131, !tbaa !93
  tail call void @llvm.dbg.value(metadata double %31, i64 0, metadata !111, metadata !75) #4, !dbg !112
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !133, metadata !75) #4, !dbg !134
  br i1 %cmp41.i, label %for.end40.i, label %for.body27.i.preheader, !dbg !135

for.body27.i.preheader:                           ; preds = %for.body19.i
  %xtraiter80 = and i64 %19, 1
  %lcmp.mod81 = icmp ne i64 %xtraiter80, 0
  %lcmp.overflow82 = icmp eq i64 %19, 0
  %lcmp.or83 = or i1 %lcmp.overflow82, %lcmp.mod81
  br i1 %lcmp.or83, label %for.body27.i.prol.preheader, label %for.body27.i.preheader.split

for.body27.i.prol.preheader:                      ; preds = %for.body27.i.preheader
  br label %for.body27.i.prol, !dbg !137
...
for.body27.i.prol:                                ; preds = %for.body27.i.prol.preheader, %for.body27.i.prol
  ...
  %x.17.i.prol = phi double [ %sub37.i.prol, %for.body27.i.prol ], [ %31, %for.body27.i.prol.preheader ], !dbg !109
  %prol.iter84 = phi i64 [ %prol.iter84.sub, %for.body27.i.prol ], [ %xtraiter80, %for.body27.i.prol.preheader ]
  %arrayidx31.i.prol = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv16.i, i64 %indvars.iv12.i.prol, !dbg !137
  %32 = load double* %arrayidx31.i.prol, align 8, !dbg !137, !tbaa !93
  %arrayidx35.i.prol = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv12.i.prol, !dbg !139
  %33 = load double* %arrayidx35.i.prol, align 8, !dbg !139, !tbaa !93
  %mul36.i.prol = fmul double %32, %33, !dbg !137
  %sub37.i.prol = fsub double %x.17.i.prol, %mul36.i.prol, !dbg !140
  tail call void @llvm.dbg.value(metadata double %sub37.i.prol, i64 0, metadata !111, metadata !75) #4, !dbg !112
  %indvars.iv.next13.i.prol = add nuw nsw i64 %indvars.iv12.i.prol, 1, !dbg !135
  %cmp26.i.prol = icmp slt i64 %indvars.iv12.i.prol, %24, !dbg !141
  %prol.iter84.sub = sub i64 %prol.iter84, 1, !dbg !135
  %prol.iter84.cmp = icmp ne i64 %prol.iter84.sub, 0, !dbg !135
  br i1 %prol.iter84.cmp, label %for.body27.i.prol, label %for.body27.i.preheader.split.loopexit, !llvm.loop !142
...
for.body27.i.preheader.split:                     ; preds = %for.body27.i.preheader.split.loopexit, %for.body27.i.preheader
  %indvars.iv12.i.unr = phi i64 [ 0, %for.body27.i.preheader ], [ %indvars.iv12.i.unr.ph, %for.body27.i.preheader.split.loopexit ]
  %x.17.i.unr = phi double [ %31, %for.body27.i.preheader ], [ %x.17.i.unr.ph, %for.body27.i.preheader.split.loopexit ]
  %sub37.i.lcssa.unr = phi double [ 0.000000e+00, %for.body27.i.preheader ], [ %sub37.i.lcssa.unr.ph, %for.body27.i.preheader.split.loopexit ]
  %34 = icmp ult i64 %19, 2
  br i1 %34, label %for.end40.i.loopexit, label %for.body27.i.preheader.split.split

for.body27.i.preheader.split.split:               ; preds = %for.body27.i.preheader.split
  br label %for.body27.i, !dbg !137

for.body27.i:                                     ; preds = %for.body27.i, %for.body27.i.preheader.split.split
  %indvars.iv12.i = phi i64 [ %indvars.iv12.i.unr, %for.body27.i.preheader.split.split ], [ %indvars.iv.next13.i.1, %for.body27.i ], !dbg !109
  %x.17.i = phi double [ %x.17.i.unr, %for.body27.i.preheader.split.split ], [ %sub37.i.1, %for.body27.i ], !dbg !109
  %arrayidx31.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv16.i, i64 %indvars.iv12.i, !dbg !137
  %35 = load double* %arrayidx31.i, align 8, !dbg !137, !tbaa !93
  %arrayidx35.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv12.i, !dbg !139
  %36 = load double* %arrayidx35.i, align 8, !dbg !139, !tbaa !93
  %mul36.i = fmul double %35, %36, !dbg !137
  %sub37.i = fsub double %x.17.i, %mul36.i, !dbg !140
  tail call void @llvm.dbg.value(metadata double %sub37.i, i64 0, metadata !111, metadata !75) #4, !dbg !112
  %indvars.iv.next13.i = add nuw nsw i64 %indvars.iv12.i, 1, !dbg !135
  %arrayidx31.i.1 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv16.i, i64 %indvars.iv.next13.i, !dbg !137
  %37 = load double* %arrayidx31.i.1, align 8, !dbg !137, !tbaa !93
  %arrayidx35.i.1 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv18.i, i64 %indvars.iv.next13.i, !dbg !139
  %38 = load double* %arrayidx35.i.1, align 8, !dbg !139, !tbaa !93
  %mul36.i.1 = fmul double %37, %38, !dbg !137
  %sub37.i.1 = fsub double %sub37.i, %mul36.i.1, !dbg !140
  tail call void @llvm.dbg.value(metadata double %sub37.i, i64 0, metadata !111, metadata !75) #4, !dbg !112
  %indvars.iv.next13.i.1 = add nuw nsw i64 %indvars.iv.next13.i, 1, !dbg !135
  %cmp26.i.1 = icmp slt i64 %indvars.iv.next13.i, %24, !dbg !141
  br i1 %cmp26.i.1, label %for.body27.i, label %for.end40.i.loopexit.unr-lcssa, !dbg !135

for.end40.i.loopexit.unr-lcssa:                   ; preds = %for.body27.i
  %sub37.i.lcssa.ph = phi double [ %sub37.i.1, %for.body27.i ]
  br label %for.end40.i.loopexit

for.end40.i.loopexit:                             ; preds = %for.body27.i.preheader.split, %for.end40.i.loopexit.unr-lcssa
  %sub37.i.lcssa = phi double [ %sub37.i.lcssa.unr, %for.body27.i.preheader.split ], [ %sub37.i.lcssa.ph, %for.end40.i.loopexit.unr-lcssa ]
  br label %for.end40.i

for.end40.i:                                      ; preds = %for.end40.i.loopexit, %for.body19.i
  %x.1.lcssa.i = phi double [ %31, %for.body19.i ], [ %sub37.i.lcssa, %for.end40.i.loopexit ], !dbg !109
  %39 = load double* %arrayidx16.i, align 8, !dbg !143, !tbaa !93
  %mul43.i = fmul double %x.1.lcssa.i, %39, !dbg !144
  %arrayidx47.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv16.i, i64 %indvars.iv18.i, !dbg !145
  store double %mul43.i, double* %arrayidx47.i, align 8, !dbg !145, !tbaa !93
  %indvars.iv.next17.i = add nuw nsw i64 %indvars.iv16.i, 1, !dbg !130
  %lftr.wideiv = trunc i64 %indvars.iv16.i to i32, !dbg !130
  %exitcond76 = icmp eq i32 %lftr.wideiv, 1023, !dbg !130
  br i1 %exitcond76, label %for.cond.loopexit.i.loopexit, label %for.body19.i, !dbg !130
...
if.end41:                                         ; preds = %kernel_cholesky.exit
  ...
  tail call void @llvm.dbg.value(metadata i8* %40, i64 0, metadata !42, metadata !75), !dbg !149
  %40 = load i8** %argv, align 8, !dbg !150, !tbaa !152
  %41 = load i8* %40, align 1, !dbg !150, !tbaa !154
  %phitmp = icmp eq i8 %41, 0, !dbg !148
...
for.body3.split.i:                                ; preds = %for.body3.split.i.preheader, %for.inc.i
  %indvars.iv.i6875 = phi i64 [ %indvars.iv.next.i69, %for.inc.i ], [ 0, %for.body3.split.i.preheader ]
  %42 = load %struct._IO_FILE** @stderr, align 8, !dbg !155, !tbaa !152
  %arrayidx5.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 0, i64 %indvars.iv.i6875, !dbg !164
  %43 = load double* %arrayidx5.i, align 8, !dbg !164, !tbaa !93
  %call.i = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %42, i8* getelementptr inbounds ([8 x i8]* @.str1, i64 0, i64 0), double %43) #5, !dbg !165
  %44 = trunc i64 %indvars.iv.i6875 to i32, !dbg !166
  %rem.i = srem i32 %44, 20, !dbg !166
  %cmp6.i = icmp eq i32 %rem.i, 0, !dbg !166
  br i1 %cmp6.i, label %if.then.i, label %for.inc.i, !dbg !168

if.then.i:                                        ; preds = %for.body3.split.i
  %45 = load %struct._IO_FILE** @stderr, align 8, !dbg !169, !tbaa !152
  %fputc.i = tail call i32 @fputc(i32 10, %struct._IO_FILE* %45) #5, !dbg !171
  br label %for.inc.i, !dbg !171

for.inc.i:                                        ; preds = %if.then.i, %for.body3.split.i
  %indvars.iv.next.i69 = add nuw nsw i64 %indvars.iv.i6875, 1, !dbg !172
...
!131 = !MDLocation(line: 75, column: 6, scope: !132, inlinedAt: !109)
!132 = !{!"0xb\0074\007\0021", !1, !128}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/kernels/cholesky/cholesky.c]
!133 = !{!"0x100\00k\0062\000", !53, !26, !29, !109} ; [ DW_TAG_auto_variable ] [k] [line 62]
!134 = !MDLocation(line: 62, column: 13, scope: !53, inlinedAt: !109)
!135 = !MDLocation(line: 76, column: 2, scope: !136, inlinedAt: !109)
!136 = !{!"0xb\0076\002\0022", !1, !132}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/kernels/cholesky/cholesky.c]
!137 = !MDLocation(line: 77, column: 12, scope: !138, inlinedAt: !109)
!138 = !{!"0xb\0076\002\0023", !1, !136}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/kernels/cholesky/cholesky.c]
!139 = !MDLocation(line: 77, column: 22, scope: !138, inlinedAt: !109)
!140 = !MDLocation(line: 77, column: 8, scope: !138, inlinedAt: !109)
!141 = !MDLocation(line: 76, column: 14, scope: !138, inlinedAt: !109)
!142 = distinct !{!142, !123}
!143 = !MDLocation(line: 78, column: 16, scope: !132, inlinedAt: !109)
!144 = !MDLocation(line: 78, column: 12, scope: !132, inlinedAt: !109)
!145 = !MDLocation(line: 78, column: 2, scope: !132, inlinedAt: !109)
