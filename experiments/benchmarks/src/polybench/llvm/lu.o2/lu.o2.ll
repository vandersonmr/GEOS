...
vector.body:                                      ; preds = %vector.body, %for.cond1.preheader.i
  ...
  %induction7879 = or i64 %index, 1, !dbg !75
  %1 = or i64 %index, 1, !dbg !85
  %2 = add nuw nsw i64 %induction7879, 1, !dbg !85
  ...
  %12 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv3.i, i64 %induction7879, !dbg !88
...
for.cond.loopexit.i68.loopexit:                   ; preds = %for.inc41.i
  br label %for.cond.loopexit.i68

for.cond.loopexit.i68:                            ; preds = %for.cond.loopexit.i68.loopexit, %for.body.i
  %indvars.iv.next17.i = add nuw nsw i64 %indvars.iv16.i, 1, !dbg !96
  %exitcond24.i = icmp eq i64 %indvars.iv.next23.i, 1024, !dbg !96
  br i1 %exitcond24.i, label %kernel_lu.exit, label %for.body.i, !dbg !96

for.body.i:                                       ; preds = %for.body.i.preheader, %for.cond.loopexit.i68
  %indvars.iv22.i = phi i64 [ %indvars.iv.next23.i, %for.cond.loopexit.i68 ], [ 0, %for.body.i.preheader ], !dbg !98
  %indvars.iv16.i = phi i64 [ %indvars.iv.next17.i, %for.cond.loopexit.i68 ], [ 1, %for.body.i.preheader ], !dbg !98
  %14 = mul i64 %indvars.iv22.i, -1, !dbg !96
  %15 = add i64 %14, 1023, !dbg !96
  %16 = trunc i64 %15 to i32
  %17 = mul i64 %indvars.iv22.i, -1, !dbg !96
  %18 = add i64 %17, 1023, !dbg !96
  %19 = trunc i64 %18 to i32
  %indvars.iv.next23.i = add nuw nsw i64 %indvars.iv22.i, 1, !dbg !96
  %cmp21.i = icmp slt i64 %indvars.iv.next23.i, 1024, !dbg !99
  br i1 %cmp21.i, label %for.body3.lr.ph.i, label %for.cond.loopexit.i68, !dbg !104

for.body3.lr.ph.i:                                ; preds = %for.body.i
  %arrayidx9.i = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv22.i, !dbg !105
...
for.body3.i72.prol:                               ; preds = %for.body3.i72.prol.preheader, %for.body3.i72.prol
  %indvars.iv8.i.prol = phi i64 [ %indvars.iv.next9.i.prol, %for.body3.i72.prol ], [ %indvars.iv16.i, %for.body3.i72.prol.preheader ], !dbg !98
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body3.i72.prol ], [ %xtraiter, %for.body3.i72.prol.preheader ]
  %arrayidx5.i69.prol = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv8.i.prol, !dbg !106
...
for.body3.lr.ph.i.split:                          ; preds = %for.body3.lr.ph.i.split.loopexit, %for.body3.lr.ph.i
  %indvars.iv8.i.unr = phi i64 [ %indvars.iv16.i, %for.body3.lr.ph.i ], [ %indvars.iv8.i.unr.ph, %for.body3.lr.ph.i.split.loopexit ]
  %22 = icmp ult i32 %19, 4
  br i1 %22, label %for.body21.lr.ph.i.preheader, label %for.body3.lr.ph.i.split.split
...
for.body3.i72:                                    ; preds = %for.body3.i72, %for.body3.lr.ph.i.split.split
  ...
  %arrayidx5.i69 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv8.i, !dbg !106
  %23 = load double* %arrayidx5.i69, align 8, !dbg !106, !tbaa !89
  %24 = load double* %arrayidx9.i, align 8, !dbg !105, !tbaa !89
  %div.i70 = fdiv double %23, %24, !dbg !106
  ...
  %arrayidx5.i69.1 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv.next9.i, !dbg !106
  %25 = load double* %arrayidx5.i69.1, align 8, !dbg !106, !tbaa !89
  %26 = load double* %arrayidx9.i, align 8, !dbg !105, !tbaa !89
  %div.i70.1 = fdiv double %25, %26, !dbg !106
  ...
  %arrayidx5.i69.2 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv.next9.i.1, !dbg !106
  %27 = load double* %arrayidx5.i69.2, align 8, !dbg !106, !tbaa !89
  %28 = load double* %arrayidx9.i, align 8, !dbg !105, !tbaa !89
  %div.i70.2 = fdiv double %27, %28, !dbg !106
  ...
  %arrayidx5.i69.3 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv.next9.i.2, !dbg !106
  %29 = load double* %arrayidx5.i69.3, align 8, !dbg !106, !tbaa !89
  %30 = load double* %arrayidx9.i, align 8, !dbg !105, !tbaa !89
  %div.i70.3 = fdiv double %29, %30, !dbg !106
  ...
  br i1 %exitcond.3, label %for.body21.lr.ph.i.preheader.unr-lcssa, label %for.body3.i72, !dbg !104

for.body21.lr.ph.i.preheader.unr-lcssa:           ; preds = %for.body3.i72
  br label %for.body21.lr.ph.i.preheader

for.body21.lr.ph.i.preheader:                     ; preds = %for.body3.lr.ph.i.split, %for.body21.lr.ph.i.preheader.unr-lcssa
  br label %for.body21.lr.ph.i, !dbg !110

for.body21.lr.ph.i:                               ; preds = %for.body21.lr.ph.i.preheader, %for.inc41.i
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.inc41.i ], [ %indvars.iv16.i, %for.body21.lr.ph.i.preheader ], !dbg !98
  %arrayidx29.i = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv18.i, i64 %indvars.iv22.i, !dbg !110
  %xtraiter80 = and i32 %16, 1
  %lcmp.mod81 = icmp ne i32 %xtraiter80, 0
  %lcmp.overflow82 = icmp eq i32 %16, 0
  %lcmp.or83 = or i1 %lcmp.overflow82, %lcmp.mod81
  br i1 %lcmp.or83, label %for.body21.i.prol.preheader, label %for.body21.lr.ph.i.split

for.body21.i.prol.preheader:                      ; preds = %for.body21.lr.ph.i
  br label %for.body21.i.prol, !dbg !115

for.body21.i.prol:                                ; preds = %for.body21.i.prol.preheader, %for.body21.i.prol
  %indvars.iv12.i.prol = phi i64 [ %indvars.iv.next13.i.prol, %for.body21.i.prol ], [ %indvars.iv16.i, %for.body21.i.prol.preheader ], !dbg !98
  %prol.iter84 = phi i32 [ %prol.iter84.sub, %for.body21.i.prol ], [ %xtraiter80, %for.body21.i.prol.preheader ]
  %arrayidx25.i.prol = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv18.i, i64 %indvars.iv12.i.prol, !dbg !115
  %31 = load double* %arrayidx25.i.prol, align 8, !dbg !115, !tbaa !89
  %32 = load double* %arrayidx29.i, align 8, !dbg !110, !tbaa !89
  %arrayidx33.i.prol = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv12.i.prol, !dbg !116
  %33 = load double* %arrayidx33.i.prol, align 8, !dbg !116, !tbaa !89
  %mul.i73.prol = fmul double %32, %33, !dbg !110
  %sub.i.prol = fsub double %31, %mul.i73.prol, !dbg !115
  store double %sub.i.prol, double* %arrayidx25.i.prol, align 8, !dbg !117, !tbaa !89
  %indvars.iv.next13.i.prol = add nuw nsw i64 %indvars.iv12.i.prol, 1, !dbg !118
  %lftr.wideiv74.prol = trunc i64 %indvars.iv12.i.prol to i32, !dbg !118
  %exitcond75.prol = icmp eq i32 %lftr.wideiv74.prol, 1023, !dbg !118
  %prol.iter84.sub = sub i32 %prol.iter84, 1, !dbg !118
  %prol.iter84.cmp = icmp ne i32 %prol.iter84.sub, 0, !dbg !118
  br i1 %prol.iter84.cmp, label %for.body21.i.prol, label %for.body21.lr.ph.i.split.loopexit, !llvm.loop !119

for.body21.lr.ph.i.split.loopexit:                ; preds = %for.body21.i.prol
  %indvars.iv12.i.unr.ph = phi i64 [ %indvars.iv.next13.i.prol, %for.body21.i.prol ]
  br label %for.body21.lr.ph.i.split

for.body21.lr.ph.i.split:                         ; preds = %for.body21.lr.ph.i.split.loopexit, %for.body21.lr.ph.i
  %indvars.iv12.i.unr = phi i64 [ %indvars.iv16.i, %for.body21.lr.ph.i ], [ %indvars.iv12.i.unr.ph, %for.body21.lr.ph.i.split.loopexit ]
  %34 = icmp ult i32 %16, 2
  br i1 %34, label %for.inc41.i, label %for.body21.lr.ph.i.split.split

for.body21.lr.ph.i.split.split:                   ; preds = %for.body21.lr.ph.i.split
  br label %for.body21.i, !dbg !118

for.body21.i:                                     ; preds = %for.body21.i, %for.body21.lr.ph.i.split.split
  %indvars.iv12.i = phi i64 [ %indvars.iv12.i.unr, %for.body21.lr.ph.i.split.split ], [ %indvars.iv.next13.i.1, %for.body21.i ], !dbg !98
  %arrayidx25.i = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv18.i, i64 %indvars.iv12.i, !dbg !115
  %35 = load double* %arrayidx25.i, align 8, !dbg !115, !tbaa !89
  %36 = load double* %arrayidx29.i, align 8, !dbg !110, !tbaa !89
  %arrayidx33.i = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv12.i, !dbg !116
  %37 = load double* %arrayidx33.i, align 8, !dbg !116, !tbaa !89
  %mul.i73 = fmul double %36, %37, !dbg !110
  %sub.i = fsub double %35, %mul.i73, !dbg !115
  store double %sub.i, double* %arrayidx25.i, align 8, !dbg !117, !tbaa !89
  %indvars.iv.next13.i = add nuw nsw i64 %indvars.iv12.i, 1, !dbg !118
  %lftr.wideiv74 = trunc i64 %indvars.iv12.i to i32, !dbg !118
  %arrayidx25.i.1 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv18.i, i64 %indvars.iv.next13.i, !dbg !115
  %38 = load double* %arrayidx25.i.1, align 8, !dbg !115, !tbaa !89
  %39 = load double* %arrayidx29.i, align 8, !dbg !110, !tbaa !89
  %arrayidx33.i.1 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv22.i, i64 %indvars.iv.next13.i, !dbg !116
  %40 = load double* %arrayidx33.i.1, align 8, !dbg !116, !tbaa !89
  %mul.i73.1 = fmul double %39, %40, !dbg !110
  %sub.i.1 = fsub double %38, %mul.i73.1, !dbg !115
  store double %sub.i.1, double* %arrayidx25.i.1, align 8, !dbg !117, !tbaa !89
  %indvars.iv.next13.i.1 = add nuw nsw i64 %indvars.iv.next13.i, 1, !dbg !118
  %lftr.wideiv74.1 = trunc i64 %indvars.iv.next13.i to i32, !dbg !118
  %exitcond75.1 = icmp eq i32 %lftr.wideiv74.1, 1023, !dbg !118
  br i1 %exitcond75.1, label %for.inc41.i.unr-lcssa, label %for.body21.i, !dbg !118

for.inc41.i.unr-lcssa:                            ; preds = %for.body21.i
  br label %for.inc41.i

for.inc41.i:                                      ; preds = %for.body21.lr.ph.i.split, %for.inc41.i.unr-lcssa
  %indvars.iv.next19.i = add nuw nsw i64 %indvars.iv18.i, 1, !dbg !120
  %lftr.wideiv76 = trunc i64 %indvars.iv18.i to i32, !dbg !120
  %exitcond77 = icmp eq i32 %lftr.wideiv76, 1023, !dbg !120
  br i1 %exitcond77, label %for.cond.loopexit.i68.loopexit, label %for.body21.lr.ph.i, !dbg !120
...
!110 = !MDLocation(line: 67, column: 24, scope: !111, inlinedAt: !98)
!111 = !{!"0xb\0066\002\0022", !1, !112}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/solvers/lu/lu.c]
!112 = !{!"0xb\0066\002\0021", !1, !113}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/solvers/lu/lu.c]
!113 = !{!"0xb\0065\007\0020", !1, !114}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/solvers/lu/lu.c]
!114 = !{!"0xb\0065\007\0019", !1, !102}          ; [ DW_TAG_lexical_block ] [/home/vanderson/dev/repos/GEOS1.0/GEOS/experiments/benchmarks/src/polybench/linear-algebra/solvers/lu/lu.c]
!115 = !MDLocation(line: 67, column: 14, scope: !111, inlinedAt: !98)
!116 = !MDLocation(line: 67, column: 34, scope: !111, inlinedAt: !98)
!117 = !MDLocation(line: 67, column: 4, scope: !111, inlinedAt: !98)
!118 = !MDLocation(line: 66, column: 2, scope: !112, inlinedAt: !98)
!119 = distinct !{!119, !109}
!120 = !MDLocation(line: 65, column: 7, scope: !114, inlinedAt: !98)
