...
for.inc17.i:                                      ; preds = %for.body3.i
  ...
  br i1 %exitcond5.i, label %for.cond1.preheader.split.us.i.preheader, label %for.cond1.preheader.i, !dbg !93

for.cond1.preheader.split.us.i.preheader:         ; preds = %for.inc17.i
  br label %for.cond1.preheader.split.us.i, !dbg !109

for.cond1.preheader.split.us.i:                   ; preds = %for.cond1.preheader.split.us.i.preheader, %for.inc21.i
  %indvar = phi i32 [ 0, %for.cond1.preheader.split.us.i.preheader ], [ %indvar.next, %for.inc21.i ]
  %indvars.iv = phi i32 [ %indvars.iv.next, %for.inc21.i ], [ 1, %for.cond1.preheader.split.us.i.preheader ]
  %indvars.iv11.i = phi i64 [ %indvars.iv.next12.i, %for.inc21.i ], [ 1, %for.cond1.preheader.split.us.i.preheader ], !dbg !113
  %3 = add i32 %indvar, 1, !dbg !109
  br label %for.body6.lr.ph.us.i, !dbg !109

for.inc18.us.i.unr-lcssa:                         ; preds = %for.body6.us.i
  br label %for.inc18.us.i

for.inc18.us.i:                                   ; preds = %for.body6.lr.ph.us.i.split, %for.inc18.us.i.unr-lcssa
  %indvars.iv.next9.i = add nuw nsw i64 %indvars.iv8.i, 1, !dbg !109
  %exitcond10.i73 = icmp eq i64 %indvars.iv.next9.i, 1024, !dbg !109
  br i1 %exitcond10.i73, label %for.inc21.i, label %for.body6.lr.ph.us.i, !dbg !109

for.body6.us.i:                                   ; preds = %for.body6.us.i, %for.body6.lr.ph.us.i.split.split
  %4 = phi double [ %.unr, %for.body6.lr.ph.us.i.split.split ], [ %add.us.i.1, %for.body6.us.i ], !dbg !114
  %indvars.iv.i74 = phi i64 [ %indvars.iv.i74.unr, %for.body6.lr.ph.us.i.split.split ], [ %indvars.iv.next.i75.1, %for.body6.us.i ], !dbg !113
  %arrayidx8.us.i = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv11.i, i64 %indvars.iv.i74, !dbg !114
  %5 = load double* %arrayidx8.us.i, align 8, !dbg !114, !tbaa !104
  %mul.us.i = fmul double %5, 3.241200e+04, !dbg !118
  %arrayidx12.us.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv8.i, i64 %indvars.iv.i74, !dbg !119
  %6 = load double* %arrayidx12.us.i, align 8, !dbg !119, !tbaa !104
  %mul13.us.i = fmul double %mul.us.i, %6, !dbg !118
  %add.us.i = fadd double %4, %mul13.us.i, !dbg !120
  store double %add.us.i, double* %arrayidx17.us.i, align 8, !dbg !120, !tbaa !104
  %indvars.iv.next.i75 = add nuw nsw i64 %indvars.iv.i74, 1, !dbg !121
  %lftr.wideiv = trunc i64 %indvars.iv.next.i75 to i32, !dbg !121
  %arrayidx8.us.i.1 = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv11.i, i64 %indvars.iv.next.i75, !dbg !114
  %7 = load double* %arrayidx8.us.i.1, align 8, !dbg !114, !tbaa !104
  %mul.us.i.1 = fmul double %7, 3.241200e+04, !dbg !118
  %arrayidx12.us.i.1 = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv8.i, i64 %indvars.iv.next.i75, !dbg !119
  %8 = load double* %arrayidx12.us.i.1, align 8, !dbg !119, !tbaa !104
  %mul13.us.i.1 = fmul double %mul.us.i.1, %8, !dbg !118
  %add.us.i.1 = fadd double %add.us.i, %mul13.us.i.1, !dbg !120
  store double %add.us.i.1, double* %arrayidx17.us.i, align 8, !dbg !120, !tbaa !104
  %indvars.iv.next.i75.1 = add nuw nsw i64 %indvars.iv.next.i75, 1, !dbg !121
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next.i75.1 to i32, !dbg !121
  %exitcond.1 = icmp eq i32 %lftr.wideiv.1, %indvars.iv, !dbg !121
  br i1 %exitcond.1, label %for.inc18.us.i.unr-lcssa, label %for.body6.us.i, !dbg !121

for.body6.lr.ph.us.i:                             ; preds = %for.inc18.us.i, %for.cond1.preheader.split.us.i
  %indvars.iv8.i = phi i64 [ %indvars.iv.next9.i, %for.inc18.us.i ], [ 0, %for.cond1.preheader.split.us.i ], !dbg !113
  %arrayidx17.us.i = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv11.i, i64 %indvars.iv8.i, !dbg !120
  %.pre.i = load double* %arrayidx17.us.i, align 8, !dbg !120, !tbaa !104
  %xtraiter = and i32 %3, 1
  %lcmp.mod = icmp ne i32 %xtraiter, 0
  %lcmp.overflow = icmp eq i32 %3, 0
  %lcmp.or = or i1 %lcmp.overflow, %lcmp.mod
  br i1 %lcmp.or, label %for.body6.us.i.prol.preheader, label %for.body6.lr.ph.us.i.split

for.body6.us.i.prol.preheader:                    ; preds = %for.body6.lr.ph.us.i
  br label %for.body6.us.i.prol, !dbg !114

for.body6.us.i.prol:                              ; preds = %for.body6.us.i.prol.preheader, %for.body6.us.i.prol
  %9 = phi double [ %add.us.i.prol, %for.body6.us.i.prol ], [ %.pre.i, %for.body6.us.i.prol.preheader ], !dbg !114
  %indvars.iv.i74.prol = phi i64 [ %indvars.iv.next.i75.prol, %for.body6.us.i.prol ], [ 0, %for.body6.us.i.prol.preheader ], !dbg !113
  %prol.iter = phi i32 [ %prol.iter.sub, %for.body6.us.i.prol ], [ %xtraiter, %for.body6.us.i.prol.preheader ]
  %arrayidx8.us.i.prol = getelementptr inbounds [1024 x double]* %arraydecay, i64 %indvars.iv11.i, i64 %indvars.iv.i74.prol, !dbg !114
  %10 = load double* %arrayidx8.us.i.prol, align 8, !dbg !114, !tbaa !104
  %mul.us.i.prol = fmul double %10, 3.241200e+04, !dbg !118
  %arrayidx12.us.i.prol = getelementptr inbounds [1024 x double]* %arraydecay2, i64 %indvars.iv8.i, i64 %indvars.iv.i74.prol, !dbg !119
  %11 = load double* %arrayidx12.us.i.prol, align 8, !dbg !119, !tbaa !104
  %mul13.us.i.prol = fmul double %mul.us.i.prol, %11, !dbg !118
  %add.us.i.prol = fadd double %9, %mul13.us.i.prol, !dbg !120
  store double %add.us.i.prol, double* %arrayidx17.us.i, align 8, !dbg !120, !tbaa !104
  %indvars.iv.next.i75.prol = add nuw nsw i64 %indvars.iv.i74.prol, 1, !dbg !121
  %lftr.wideiv.prol = trunc i64 %indvars.iv.next.i75.prol to i32, !dbg !121
  ...
  br i1 %prol.iter.cmp, label %for.body6.us.i.prol, label %for.body6.lr.ph.us.i.split.loopexit, !llvm.loop !122

for.body6.lr.ph.us.i.split.loopexit:              ; preds = %for.body6.us.i.prol
  %.unr.ph = phi double [ %add.us.i.prol, %for.body6.us.i.prol ]
  %indvars.iv.i74.unr.ph = phi i64 [ %indvars.iv.next.i75.prol, %for.body6.us.i.prol ]
  br label %for.body6.lr.ph.us.i.split

for.body6.lr.ph.us.i.split:                       ; preds = %for.body6.lr.ph.us.i.split.loopexit, %for.body6.lr.ph.us.i
  %.unr = phi double [ %.pre.i, %for.body6.lr.ph.us.i ], [ %.unr.ph, %for.body6.lr.ph.us.i.split.loopexit ]
  %indvars.iv.i74.unr = phi i64 [ 0, %for.body6.lr.ph.us.i ], [ %indvars.iv.i74.unr.ph, %for.body6.lr.ph.us.i.split.loopexit ]
  %12 = icmp ult i32 %3, 2
  br i1 %12, label %for.inc18.us.i, label %for.body6.lr.ph.us.i.split.split

for.body6.lr.ph.us.i.split.split:                 ; preds = %for.body6.lr.ph.us.i.split
  br label %for.body6.us.i, !dbg !121

for.inc21.i:                                      ; preds = %for.inc18.us.i
  %indvars.iv.next12.i = add nuw nsw i64 %indvars.iv11.i, 1, !dbg !124
  ...
  %exitcond13.i = icmp eq i64 %indvars.iv.next12.i, 1024, !dbg !124
  %indvar.next = add i32 %indvar, 1, !dbg !124
  br i1 %exitcond13.i, label %kernel_trmm.exit, label %for.cond1.preheader.split.us.i, !dbg !124
...
!114 = !MDLocation(line: 71, column: 28, scope: !115, inlinedAt: !113)
...
!118 = !MDLocation(line: 71, column: 20, scope: !115, inlinedAt: !113)
!119 = !MDLocation(line: 71, column: 38, scope: !115, inlinedAt: !113)
!120 = !MDLocation(line: 71, column: 9, scope: !115, inlinedAt: !113)
